...
DescribeScalingActivityDetailResult::DescribeScalingActivityDetailResult() :
	ServiceResult()
{}

DescribeScalingActivityDetailResult::DescribeScalingActivityDetailResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
