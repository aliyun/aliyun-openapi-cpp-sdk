...
using AlibabaCloud::Ess::Model::CreateEciScalingConfigurationRequest;

CreateEciScalingConfigurationRequest::CreateEciScalingConfigurationRequest()
    : RpcServiceRequest("ess", "2014-08-28", "CreateEciScalingConfiguration") {
  setMethod(HttpRequest::Method::Post);
}

CreateEciScalingConfigurationRequest::~CreateEciScalingConfigurationRequest() {}

std::vector<CreateEciScalingConfigurationRequest::Container> CreateEciScalingConfigurationRequest::getContainer() const {
  return container_;
}

void CreateEciScalingConfigurationRequest::setContainer(const std::vector<CreateEciScalingConfigurationRequest::Container> &container) {
  ...
  std::string containerObjStr = std::string("Container") + "." + std::to_string(dep1 + 1);
    ...
    std::string environmentVarObjStr = containerObjStr + ".EnvironmentVar" + "." + std::to_string(dep2 + 1);
      setParameter(environmentVarObjStr + ".FieldRefFieldPath", environmentVarObj.fieldRefFieldPath);
...
std::vector<std::string> CreateEciScalingConfigurationRequest::getNtpServer() const {
  return ntpServer_;
}

void CreateEciScalingConfigurationRequest::setNtpServer(const std::vector<std::string> &ntpServer) {
  ntpServer_ = ntpServer;
}

float CreateEciScalingConfigurationRequest::getSpotPriceLimit() const {
  return spotPriceLimit_;
}

void CreateEciScalingConfigurationRequest::setSpotPriceLimit(float spotPriceLimit) {
  spotPriceLimit_ = spotPriceLimit;
  setParameter(std::string("SpotPriceLimit"), std::to_string(spotPriceLimit));
}

bool CreateEciScalingConfigurationRequest::getEnableSls() const {
  return enableSls_;
}

void CreateEciScalingConfigurationRequest::setEnableSls(bool enableSls) {
  enableSls_ = enableSls;
  setParameter(std::string("EnableSls"), enableSls ? "true" : "false");
}

std::string CreateEciScalingConfigurationRequest::getResourceGroupId() const {
  return resourceGroupId_;
}

void CreateEciScalingConfigurationRequest::setResourceGroupId(const std::string &resourceGroupId) {
  resourceGroupId_ = resourceGroupId;
  setParameter(std::string("ResourceGroupId"), resourceGroupId);
}

std::string CreateEciScalingConfigurationRequest::getHostName() const {
  return hostName_;
}

void CreateEciScalingConfigurationRequest::setHostName(const std::string &hostName) {
  hostName_ = hostName;
  setParameter(std::string("HostName"), hostName);
}

long CreateEciScalingConfigurationRequest::getActiveDeadlineSeconds() const {
  return activeDeadlineSeconds_;
}

void CreateEciScalingConfigurationRequest::setActiveDeadlineSeconds(long activeDeadlineSeconds) {
...
long CreateEciScalingConfigurationRequest::getEgressBandwidth() const {
  return egressBandwidth_;
}

void CreateEciScalingConfigurationRequest::setEgressBandwidth(long egressBandwidth) {
  egressBandwidth_ = egressBandwidth;
  setParameter(std::string("EgressBandwidth"), std::to_string(egressBandwidth));
}

std::vector<std::string> CreateEciScalingConfigurationRequest::getDnsConfigSearch() const {
  return dnsConfigSearch_;
}

void CreateEciScalingConfigurationRequest::setDnsConfigSearch(const std::vector<std::string> &dnsConfigSearch) {
  dnsConfigSearch_ = dnsConfigSearch;
}

std::vector<CreateEciScalingConfigurationRequest::HostAliase> CreateEciScalingConfigurationRequest::getHostAliase() const {
  return hostAliase_;
}

void CreateEciScalingConfigurationRequest::setHostAliase(const std::vector<CreateEciScalingConfigurationRequest::HostAliase> &hostAliase) {
...
std::string CreateEciScalingConfigurationRequest::getImageSnapshotId() const {
  return imageSnapshotId_;
}

void CreateEciScalingConfigurationRequest::setImageSnapshotId(const std::string &imageSnapshotId) {
  imageSnapshotId_ = imageSnapshotId;
  setParameter(std::string("ImageSnapshotId"), imageSnapshotId);
}

std::vector<CreateEciScalingConfigurationRequest::Tag> CreateEciScalingConfigurationRequest::getTag() const {
  return tag_;
}

void CreateEciScalingConfigurationRequest::setTag(const std::vector<CreateEciScalingConfigurationRequest::Tag> &tag) {
  tag_ = tag;
...
int CreateEciScalingConfigurationRequest::getCpuOptionsThreadsPerCore() const {
  return cpuOptionsThreadsPerCore_;
}

void CreateEciScalingConfigurationRequest::setCpuOptionsThreadsPerCore(int cpuOptionsThreadsPerCore) {
...
std::string CreateEciScalingConfigurationRequest::getDataCachePL() const {
  return dataCachePL_;
}

void CreateEciScalingConfigurationRequest::setDataCachePL(const std::string &dataCachePL) {
  dataCachePL_ = dataCachePL;
  setParameter(std::string("DataCachePL"), dataCachePL);
}

int CreateEciScalingConfigurationRequest::getIpv6AddressCount() const {
  return ipv6AddressCount_;
}

void CreateEciScalingConfigurationRequest::setIpv6AddressCount(int ipv6AddressCount) {
  ipv6AddressCount_ = ipv6AddressCount;
  setParameter(std::string("Ipv6AddressCount"), std::to_string(ipv6AddressCount));
}

float CreateEciScalingConfigurationRequest::getCpu() const {
  return cpu_;
}

void CreateEciScalingConfigurationRequest::setCpu(float cpu) {
  cpu_ = cpu;
  setParameter(std::string("Cpu"), std::to_string(cpu));
}

long CreateEciScalingConfigurationRequest::getOwnerId() const {
  return ownerId_;
}

void CreateEciScalingConfigurationRequest::setOwnerId(long ownerId) {
  ownerId_ = ownerId;
  setParameter(std::string("OwnerId"), std::to_string(ownerId));
}

std::string CreateEciScalingConfigurationRequest::getScalingConfigurationName() const {
  return scalingConfigurationName_;
}

void CreateEciScalingConfigurationRequest::setScalingConfigurationName(const std::string &scalingConfigurationName) {
...
std::string CreateEciScalingConfigurationRequest::getSpotStrategy() const {
  return spotStrategy_;
}

void CreateEciScalingConfigurationRequest::setSpotStrategy(const std::string &spotStrategy) {
  spotStrategy_ = spotStrategy;
  setParameter(std::string("SpotStrategy"), spotStrategy);
}

std::vector<CreateEciScalingConfigurationRequest::Volume> CreateEciScalingConfigurationRequest::getVolume() const {
  return volume_;
}

void CreateEciScalingConfigurationRequest::setVolume(const std::vector<CreateEciScalingConfigurationRequest::Volume> &volume) {
  volume_ = volume;
...
std::string CreateEciScalingConfigurationRequest::getInstanceFamilyLevel() const {
  return instanceFamilyLevel_;
}

void CreateEciScalingConfigurationRequest::setInstanceFamilyLevel(const std::string &instanceFamilyLevel) {
  instanceFamilyLevel_ = instanceFamilyLevel;
  setParameter(std::string("InstanceFamilyLevel"), instanceFamilyLevel);
}

std::vector<CreateEciScalingConfigurationRequest::DnsConfigOption> CreateEciScalingConfigurationRequest::getDnsConfigOption() const {
  return dnsConfigOption_;
}

void CreateEciScalingConfigurationRequest::setDnsConfigOption(const std::vector<CreateEciScalingConfigurationRequest::DnsConfigOption> &dnsConfigOption) {
...
int CreateEciScalingConfigurationRequest::getEphemeralStorage() const {
  return ephemeralStorage_;
}

void CreateEciScalingConfigurationRequest::setEphemeralStorage(int ephemeralStorage) {
  ephemeralStorage_ = ephemeralStorage;
  setParameter(std::string("EphemeralStorage"), std::to_string(ephemeralStorage));
}

int CreateEciScalingConfigurationRequest::getDataCacheProvisionedIops() const {
  return dataCacheProvisionedIops_;
}

void CreateEciScalingConfigurationRequest::setDataCacheProvisionedIops(int dataCacheProvisionedIops) {
...
int CreateEciScalingConfigurationRequest::getEipBandwidth() const {
  return eipBandwidth_;
}

void CreateEciScalingConfigurationRequest::setEipBandwidth(int eipBandwidth) {
  eipBandwidth_ = eipBandwidth;
  setParameter(std::string("EipBandwidth"), std::to_string(eipBandwidth));
}

std::string CreateEciScalingConfigurationRequest::getGpuDriverVersion() const {
  return gpuDriverVersion_;
}

void CreateEciScalingConfigurationRequest::setGpuDriverVersion(const std::string &gpuDriverVersion) {
  gpuDriverVersion_ = gpuDriverVersion;
  setParameter(std::string("GpuDriverVersion"), gpuDriverVersion);
}

bool CreateEciScalingConfigurationRequest::getCostOptimization() const {
  return costOptimization_;
}

void CreateEciScalingConfigurationRequest::setCostOptimization(bool costOptimization) {
  costOptimization_ = costOptimization;
  setParameter(std::string("CostOptimization"), costOptimization ? "true" : "false");
}

bool CreateEciScalingConfigurationRequest::getDataCacheBurstingEnabled() const {
  return dataCacheBurstingEnabled_;
}

void CreateEciScalingConfigurationRequest::setDataCacheBurstingEnabled(bool dataCacheBurstingEnabled) {
...
float CreateEciScalingConfigurationRequest::getMemory() const {
  return memory_;
}

void CreateEciScalingConfigurationRequest::setMemory(float memory) {
  memory_ = memory;
  setParameter(std::string("Memory"), std::to_string(memory));
}

std::string CreateEciScalingConfigurationRequest::getScalingGroupId() const {
  return scalingGroupId_;
}

void CreateEciScalingConfigurationRequest::setScalingGroupId(const std::string &scalingGroupId) {
  scalingGroupId_ = scalingGroupId;
  setParameter(std::string("ScalingGroupId"), scalingGroupId);
}

std::string CreateEciScalingConfigurationRequest::getSecurityGroupId() const {
  return securityGroupId_;
}

void CreateEciScalingConfigurationRequest::setSecurityGroupId(const std::string &securityGroupId) {
  securityGroupId_ = securityGroupId;
  setParameter(std::string("SecurityGroupId"), securityGroupId);
}

std::string CreateEciScalingConfigurationRequest::getDescription() const {
  return description_;
}

void CreateEciScalingConfigurationRequest::setDescription(const std::string &description) {
  description_ = description;
  setParameter(std::string("Description"), description);
}

long CreateEciScalingConfigurationRequest::getIngressBandwidth() const {
  return ingressBandwidth_;
}

void CreateEciScalingConfigurationRequest::setIngressBandwidth(long ingressBandwidth) {
  ingressBandwidth_ = ingressBandwidth;
  setParameter(std::string("IngressBandwidth"), std::to_string(ingressBandwidth));
}

std::string CreateEciScalingConfigurationRequest::getDnsPolicy() const {
  return dnsPolicy_;
}

void CreateEciScalingConfigurationRequest::setDnsPolicy(const std::string &dnsPolicy) {
  dnsPolicy_ = dnsPolicy;
  setParameter(std::string("DnsPolicy"), dnsPolicy);
}

std::vector<CreateEciScalingConfigurationRequest::SecurityContextSysctl> CreateEciScalingConfigurationRequest::getSecurityContextSysctl() const {
  return securityContextSysctl_;
}

void CreateEciScalingConfigurationRequest::setSecurityContextSysctl(const std::vector<CreateEciScalingConfigurationRequest::SecurityContextSysctl> &securityContextSysctl) {
...
std::string CreateEciScalingConfigurationRequest::getAccessKeyId() const {
  return accessKeyId_;
}

void CreateEciScalingConfigurationRequest::setAccessKeyId(const std::string &accessKeyId) {
  accessKeyId_ = accessKeyId;
  setParameter(std::string("AccessKeyId"), accessKeyId);
}

std::string CreateEciScalingConfigurationRequest::getDataCacheBucket() const {
  return dataCacheBucket_;
}

void CreateEciScalingConfigurationRequest::setDataCacheBucket(const std::string &dataCacheBucket) {
  dataCacheBucket_ = dataCacheBucket;
  setParameter(std::string("DataCacheBucket"), dataCacheBucket);
}

std::vector<std::string> CreateEciScalingConfigurationRequest::getDnsConfigNameServer() const {
  return dnsConfigNameServer_;
}

void CreateEciScalingConfigurationRequest::setDnsConfigNameServer(const std::vector<std::string> &dnsConfigNameServer) {
  dnsConfigNameServer_ = dnsConfigNameServer;
}

std::vector<CreateEciScalingConfigurationRequest::InitContainer> CreateEciScalingConfigurationRequest::getInitContainer() const {
  return initContainer_;
}

void CreateEciScalingConfigurationRequest::setInitContainer(const std::vector<CreateEciScalingConfigurationRequest::InitContainer> &initContainer) {
  ...
  std::string initContainerObjStr = std::string("InitContainer") + "." + std::to_string(dep1 + 1);
    ...
    std::string initContainerEnvironmentVarObjStr = initContainerObjStr + ".InitContainerEnvironmentVar" + "." + std::to_string(dep2 + 1);
      setParameter(initContainerEnvironmentVarObjStr + ".FieldRefFieldPath", initContainerEnvironmentVarObj.fieldRefFieldPath);
...
std::vector<std::string> CreateEciScalingConfigurationRequest::getInstanceType() const {
  return instanceType_;
}

void CreateEciScalingConfigurationRequest::setInstanceType(const std::vector<std::string> &instanceType) {
  instanceType_ = instanceType;
}

long CreateEciScalingConfigurationRequest::getTerminationGracePeriodSeconds() const {
  return terminationGracePeriodSeconds_;
}

void CreateEciScalingConfigurationRequest::setTerminationGracePeriodSeconds(long terminationGracePeriodSeconds) {
...
std::vector<CreateEciScalingConfigurationRequest::ImageRegistryCredential> CreateEciScalingConfigurationRequest::getImageRegistryCredential() const {
  return imageRegistryCredential_;
}

void CreateEciScalingConfigurationRequest::setImageRegistryCredential(const std::vector<CreateEciScalingConfigurationRequest::ImageRegistryCredential> &imageRegistryCredential) {
...
std::string CreateEciScalingConfigurationRequest::getResourceOwnerAccount() const {
  return resourceOwnerAccount_;
}

void CreateEciScalingConfigurationRequest::setResourceOwnerAccount(const std::string &resourceOwnerAccount) {
  resourceOwnerAccount_ = resourceOwnerAccount;
  setParameter(std::string("ResourceOwnerAccount"), resourceOwnerAccount);
}

std::string CreateEciScalingConfigurationRequest::getRestartPolicy() const {
  return restartPolicy_;
}

void CreateEciScalingConfigurationRequest::setRestartPolicy(const std::string &restartPolicy) {
  restartPolicy_ = restartPolicy;
  setParameter(std::string("RestartPolicy"), restartPolicy);
}

int CreateEciScalingConfigurationRequest::getCpuOptionsCore() const {
  return cpuOptionsCore_;
}

void CreateEciScalingConfigurationRequest::setCpuOptionsCore(int cpuOptionsCore) {
  cpuOptionsCore_ = cpuOptionsCore;
  setParameter(std::string("CpuOptionsCore"), std::to_string(cpuOptionsCore));
}

std::string CreateEciScalingConfigurationRequest::getRamRoleName() const {
  return ramRoleName_;
}

void CreateEciScalingConfigurationRequest::setRamRoleName(const std::string &ramRoleName) {
  ramRoleName_ = ramRoleName;
  setParameter(std::string("RamRoleName"), ramRoleName);
}

std::vector<CreateEciScalingConfigurationRequest::AcrRegistryInfo> CreateEciScalingConfigurationRequest::getAcrRegistryInfo() const {
  return acrRegistryInfo_;
}

void CreateEciScalingConfigurationRequest::setAcrRegistryInfo(const std::vector<CreateEciScalingConfigurationRequest::AcrRegistryInfo> &acrRegistryInfo) {
...
bool CreateEciScalingConfigurationRequest::getAutoMatchImageCache() const {
  return autoMatchImageCache_;
}

void CreateEciScalingConfigurationRequest::setAutoMatchImageCache(bool autoMatchImageCache) {
  autoMatchImageCache_ = autoMatchImageCache;
  setParameter(std::string("AutoMatchImageCache"), autoMatchImageCache ? "true" : "false");
}

int CreateEciScalingConfigurationRequest::getLoadBalancerWeight() const {
  return loadBalancerWeight_;
}

void CreateEciScalingConfigurationRequest::setLoadBalancerWeight(int loadBalancerWeight) {
  loadBalancerWeight_ = loadBalancerWeight;
  setParameter(std::string("LoadBalancerWeight"), std::to_string(loadBalancerWeight));
}

std::string CreateEciScalingConfigurationRequest::getContainerGroupName() const {
  return containerGroupName_;
}

void CreateEciScalingConfigurationRequest::setContainerGroupName(const std::string &containerGroupName) {
  containerGroupName_ = containerGroupName;
  setParameter(std::string("ContainerGroupName"), containerGroupName);
}

bool CreateEciScalingConfigurationRequest::getAutoCreateEip() const {
  return autoCreateEip_;
}

void CreateEciScalingConfigurationRequest::setAutoCreateEip(bool autoCreateEip) {
