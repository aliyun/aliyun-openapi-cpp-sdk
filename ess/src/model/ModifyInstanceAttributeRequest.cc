...
using AlibabaCloud::Ess::Model::ModifyInstanceAttributeRequest;

ModifyInstanceAttributeRequest::ModifyInstanceAttributeRequest()
    : RpcServiceRequest("ess", "2014-08-28", "ModifyInstanceAttribute") {
  setMethod(HttpRequest::Method::Post);
}

ModifyInstanceAttributeRequest::~ModifyInstanceAttributeRequest() {}

std::string ModifyInstanceAttributeRequest::getScalingGroupId() const {
  return scalingGroupId_;
}

void ModifyInstanceAttributeRequest::setScalingGroupId(const std::string &scalingGroupId) {
...
bool ModifyInstanceAttributeRequest::getEntrusted() const {
  return entrusted_;
}

void ModifyInstanceAttributeRequest::setEntrusted(bool entrusted) {
...
std::vector<std::string> ModifyInstanceAttributeRequest::getInstanceIds() const {
  return instanceIds_;
}

void ModifyInstanceAttributeRequest::setInstanceIds(const std::vector<std::string> &instanceIds) {
