...
CreateLifecycleHookResult::CreateLifecycleHookResult() :
	ServiceResult()
{}

CreateLifecycleHookResult::CreateLifecycleHookResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
std::string CreateLifecycleHookResult::getLifecycleHookId()const
{
