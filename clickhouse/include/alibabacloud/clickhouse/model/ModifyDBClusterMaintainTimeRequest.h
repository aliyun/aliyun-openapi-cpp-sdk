...
#ifndef ALIBABACLOUD_CLICKHOUSE_MODEL_MODIFYDBCLUSTERMAINTAINTIMEREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_CLICKHOUSE_EXPORT ModifyDBClusterMaintainTimeRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLICKHOUSE_MODEL_MODIFYDBCLUSTERMAINTAINTIMEREQUEST_H_
