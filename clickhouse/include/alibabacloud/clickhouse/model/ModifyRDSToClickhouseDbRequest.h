...
#ifndef ALIBABACLOUD_CLICKHOUSE_MODEL_MODIFYRDSTOCLICKHOUSEDBREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_CLICKHOUSE_EXPORT ModifyRDSToClickhouseDbRequest : public RpcServiceRequest {
public:
	...
	std::string getRdsSynTables() const;
	void setRdsSynTables(const std::string &rdsSynTables);
	...
	std::string getRdsSynDb() const;
	void setRdsSynDb(const std::string &rdsSynDb);
...
#endif // !ALIBABACLOUD_CLICKHOUSE_MODEL_MODIFYRDSTOCLICKHOUSEDBREQUEST_H_
