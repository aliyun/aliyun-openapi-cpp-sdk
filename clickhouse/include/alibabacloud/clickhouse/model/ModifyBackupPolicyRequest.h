...
#ifndef ALIBABACLOUD_CLICKHOUSE_MODEL_MODIFYBACKUPPOLICYREQUEST_H_
#define ALIBABACLOUD_CLICKHOUSE_MODEL_MODIFYBACKUPPOLICYREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_CLICKHOUSE_EXPORT ModifyBackupPolicyRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLICKHOUSE_MODEL_MODIFYBACKUPPOLICYREQUEST_H_
