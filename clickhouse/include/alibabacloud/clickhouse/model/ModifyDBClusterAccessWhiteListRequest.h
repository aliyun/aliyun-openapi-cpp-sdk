...
#ifndef ALIBABACLOUD_CLICKHOUSE_MODEL_MODIFYDBCLUSTERACCESSWHITELISTREQUEST_H_
#define ALIBABACLOUD_CLICKHOUSE_MODEL_MODIFYDBCLUSTERACCESSWHITELISTREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_CLICKHOUSE_EXPORT ModifyDBClusterAccessWhiteListRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLICKHOUSE_MODEL_MODIFYDBCLUSTERACCESSWHITELISTREQUEST_H_
