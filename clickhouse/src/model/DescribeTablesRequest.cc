...
using AlibabaCloud::Clickhouse::Model::DescribeTablesRequest;

DescribeTablesRequest::DescribeTablesRequest()
    : RpcServiceRequest("clickhouse", "2019-11-11", "DescribeTables") {
...
std::string DescribeTablesRequest::getTableName() const {
  return tableName_;
}

void DescribeTablesRequest::setTableName(const std::string &tableName) {
