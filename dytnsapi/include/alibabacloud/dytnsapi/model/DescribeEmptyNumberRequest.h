...
#ifndef ALIBABACLOUD_DYTNSAPI_MODEL_DESCRIBEEMPTYNUMBERREQUEST_H_
#define ALIBABACLOUD_DYTNSAPI_MODEL_DESCRIBEEMPTYNUMBERREQUEST_H_
...
namespace Dytnsapi {
namespace Model {
class ALIBABACLOUD_DYTNSAPI_EXPORT DescribeEmptyNumberRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_DYTNSAPI_MODEL_DESCRIBEEMPTYNUMBERREQUEST_H_
