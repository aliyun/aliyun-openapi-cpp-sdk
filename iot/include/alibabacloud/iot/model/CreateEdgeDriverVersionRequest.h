...
#ifndef ALIBABACLOUD_IOT_MODEL_CREATEEDGEDRIVERVERSIONREQUEST_H_
#define ALIBABACLOUD_IOT_MODEL_CREATEEDGEDRIVERVERSIONREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Iot
	{
		namespace Model
		{
			class ALIBABACLOUD_IOT_EXPORT CreateEdgeDriverVersionRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_IOT_MODEL_CREATEEDGEDRIVERVERSIONREQUEST_H_