...
#ifndef ALIBABACLOUD_IOT_MODEL_CREATETHINGMODELREQUEST_H_
#define ALIBABACLOUD_IOT_MODEL_CREATETHINGMODELREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Iot
	{
		namespace Model
		{
			class ALIBABACLOUD_IOT_EXPORT CreateThingModelRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_IOT_MODEL_CREATETHINGMODELREQUEST_H_