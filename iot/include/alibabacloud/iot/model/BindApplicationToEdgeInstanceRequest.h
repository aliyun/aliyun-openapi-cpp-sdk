...
#ifndef ALIBABACLOUD_IOT_MODEL_BINDAPPLICATIONTOEDGEINSTANCEREQUEST_H_
#define ALIBABACLOUD_IOT_MODEL_BINDAPPLICATIONTOEDGEINSTANCEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Iot
	{
		namespace Model
		{
			class ALIBABACLOUD_IOT_EXPORT BindApplicationToEdgeInstanceRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_IOT_MODEL_BINDAPPLICATIONTOEDGEINSTANCEREQUEST_H_