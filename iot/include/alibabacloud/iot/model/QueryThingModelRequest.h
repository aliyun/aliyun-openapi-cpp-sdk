...
#ifndef ALIBABACLOUD_IOT_MODEL_QUERYTHINGMODELREQUEST_H_
#define ALIBABACLOUD_IOT_MODEL_QUERYTHINGMODELREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Iot
	{
		namespace Model
		{
			class ALIBABACLOUD_IOT_EXPORT QueryThingModelRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_IOT_MODEL_QUERYTHINGMODELREQUEST_H_