...
#ifndef ALIBABACLOUD_IOT_MODEL_COPYTHINGMODELREQUEST_H_
#define ALIBABACLOUD_IOT_MODEL_COPYTHINGMODELREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Iot
	{
		namespace Model
		{
			class ALIBABACLOUD_IOT_EXPORT CopyThingModelRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_IOT_MODEL_COPYTHINGMODELREQUEST_H_