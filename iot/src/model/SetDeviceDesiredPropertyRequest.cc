...
using AlibabaCloud::Iot::Model::SetDeviceDesiredPropertyRequest;
...
{
	versions_ = versions;
	setCoreParameter("Versions", std::to_string(versions));
}
...
{
	items_ = items;
	setCoreParameter("Items", std::to_string(items));
}
