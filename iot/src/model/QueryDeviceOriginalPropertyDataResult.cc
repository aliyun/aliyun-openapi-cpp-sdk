...
QueryDeviceOriginalPropertyDataResult::QueryDeviceOriginalPropertyDataResult() :
	ServiceResult()
{}

QueryDeviceOriginalPropertyDataResult::QueryDeviceOriginalPropertyDataResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryDeviceOriginalPropertyDataResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
QueryDeviceOriginalPropertyDataResult::Data QueryDeviceOriginalPropertyDataResult::getData()const
{
	return data_;
}

std::string QueryDeviceOriginalPropertyDataResult::getErrorMessage()const
{
	return errorMessage_;
}

std::string QueryDeviceOriginalPropertyDataResult::getCode()const
{
	return code_;
}

bool QueryDeviceOriginalPropertyDataResult::getSuccess()const
{
	return success_;
}
