...
BatchImportVehicleDeviceResult::BatchImportVehicleDeviceResult() :
	ServiceResult()
{}

BatchImportVehicleDeviceResult::BatchImportVehicleDeviceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void BatchImportVehicleDeviceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
BatchImportVehicleDeviceResult::Data BatchImportVehicleDeviceResult::getData()const
{
	return data_;
}

std::string BatchImportVehicleDeviceResult::getErrorMessage()const
{
	return errorMessage_;
}

std::string BatchImportVehicleDeviceResult::getCode()const
{
	return code_;
}

bool BatchImportVehicleDeviceResult::getSuccess()const
{
	return success_;
}
