...
BatchGetEdgeInstanceDriverConfigsResult::BatchGetEdgeInstanceDriverConfigsResult() :
	ServiceResult()
{}

BatchGetEdgeInstanceDriverConfigsResult::BatchGetEdgeInstanceDriverConfigsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void BatchGetEdgeInstanceDriverConfigsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<BatchGetEdgeInstanceDriverConfigsResult::DriverConfig> BatchGetEdgeInstanceDriverConfigsResult::getDriverConfigList()const
{
	return driverConfigList_;
}

std::string BatchGetEdgeInstanceDriverConfigsResult::getErrorMessage()const
{
	return errorMessage_;
}

std::string BatchGetEdgeInstanceDriverConfigsResult::getCode()const
{
	return code_;
}

bool BatchGetEdgeInstanceDriverConfigsResult::getSuccess()const
{
	return success_;
}
