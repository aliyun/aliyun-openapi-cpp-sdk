...
QueryDeviceOriginalServiceDataResult::QueryDeviceOriginalServiceDataResult() :
	ServiceResult()
{}

QueryDeviceOriginalServiceDataResult::QueryDeviceOriginalServiceDataResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryDeviceOriginalServiceDataResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
QueryDeviceOriginalServiceDataResult::Data QueryDeviceOriginalServiceDataResult::getData()const
{
	return data_;
}

std::string QueryDeviceOriginalServiceDataResult::getErrorMessage()const
{
	return errorMessage_;
}

std::string QueryDeviceOriginalServiceDataResult::getCode()const
{
	return code_;
}

bool QueryDeviceOriginalServiceDataResult::getSuccess()const
{
	return success_;
}
