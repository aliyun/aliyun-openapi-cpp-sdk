...
ListOTAJobByDeviceResult::ListOTAJobByDeviceResult() :
	ServiceResult()
{}

ListOTAJobByDeviceResult::ListOTAJobByDeviceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListOTAJobByDeviceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
int ListOTAJobByDeviceResult::getPageSize()const
{
	return pageSize_;
}

int ListOTAJobByDeviceResult::getPageCount()const
{
	return pageCount_;
}

int ListOTAJobByDeviceResult::getCurrentPage()const
{
	return currentPage_;
}

int ListOTAJobByDeviceResult::getTotal()const
{
	return total_;
}

std::vector<ListOTAJobByDeviceResult::SimpleOTAJobInfo> ListOTAJobByDeviceResult::getData()const
{
	return data_;
}

std::string ListOTAJobByDeviceResult::getErrorMessage()const
{
	return errorMessage_;
}

std::string ListOTAJobByDeviceResult::getCode()const
{
	return code_;
}

bool ListOTAJobByDeviceResult::getSuccess()const
{
	return success_;
}
