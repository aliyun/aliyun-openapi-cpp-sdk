...
QuerySpeechPushJobSpeechResult::QuerySpeechPushJobSpeechResult() :
	ServiceResult()
{}

QuerySpeechPushJobSpeechResult::QuerySpeechPushJobSpeechResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QuerySpeechPushJobSpeechResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
QuerySpeechPushJobSpeechResult::Data QuerySpeechPushJobSpeechResult::getData()const
{
	return data_;
}

std::string QuerySpeechPushJobSpeechResult::getErrorMessage()const
{
	return errorMessage_;
}

std::string QuerySpeechPushJobSpeechResult::getCode()const
{
	return code_;
}

bool QuerySpeechPushJobSpeechResult::getSuccess()const
{
	return success_;
}
