...
#ifndef ALIBABACLOUD_SAE_MODEL_CREATEAPPLICATIONSCALINGRULERESULT_H_
#define ALIBABACLOUD_SAE_MODEL_CREATEAPPLICATIONSCALINGRULERESULT_H_
...
namespace AlibabaCloud
{
	namespace Sae
	{
		namespace Model
		{
			class ALIBABACLOUD_SAE_EXPORT CreateApplicationScalingRuleResult : public ServiceResult
			{
			public:
				struct Data
				{
...
#endif // !ALIBABACLOUD_SAE_MODEL_CREATEAPPLICATIONSCALINGRULERESULT_H_