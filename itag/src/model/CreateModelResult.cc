...
std::string CreateModelResult::getMsg()const
{
	return msg_;
}

long CreateModelResult::getRt()const
{
	return rt_;
}

bool CreateModelResult::getSucc()const
{
	return succ_;
}

std::string CreateModelResult::getHost()const
{
	return host_;
}

std::string CreateModelResult::getErrorCode()const
{
	return errorCode_;
}

std::string CreateModelResult::getErrInfo()const
{
	return errInfo_;
}
...
long CreateModelResult::getResult()const
{
	return result_;
}
