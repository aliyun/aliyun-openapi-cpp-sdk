...
AbandonItemByAdminResult::AbandonItemByAdminResult() :
	ServiceResult()
{}

AbandonItemByAdminResult::AbandonItemByAdminResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void AbandonItemByAdminResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string AbandonItemByAdminResult::getMsg()const
{
	return msg_;
}

bool AbandonItemByAdminResult::getSucc()const
{
	return succ_;
}

std::string AbandonItemByAdminResult::getErrorCode()const
{
	return errorCode_;
}

std::string AbandonItemByAdminResult::getErrInfo()const
{
	return errInfo_;
}

std::string AbandonItemByAdminResult::getCode()const
{
	return code_;
}

AbandonItemByAdminResult::Result AbandonItemByAdminResult::getResult()const
{
	return result_;
}
