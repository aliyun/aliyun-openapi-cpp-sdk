...
GetBizPersonSummaryResult::GetBizPersonSummaryResult() :
	ServiceResult()
{}

GetBizPersonSummaryResult::GetBizPersonSummaryResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetBizPersonSummaryResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetBizPersonSummaryResult::getMsg()const
{
	return msg_;
}

bool GetBizPersonSummaryResult::getSucc()const
{
	return succ_;
}

std::string GetBizPersonSummaryResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetBizPersonSummaryResult::getErrInfo()const
{
	return errInfo_;
}

std::string GetBizPersonSummaryResult::getCode()const
{
	return code_;
}

GetBizPersonSummaryResult::Result GetBizPersonSummaryResult::getResult()const
{
	return result_;
}
