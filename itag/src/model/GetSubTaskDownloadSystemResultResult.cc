...
GetSubTaskDownloadSystemResultResult::GetSubTaskDownloadSystemResultResult() :
	ServiceResult()
{}

GetSubTaskDownloadSystemResultResult::GetSubTaskDownloadSystemResultResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetSubTaskDownloadSystemResultResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetSubTaskDownloadSystemResultResult::getMsg()const
{
	return msg_;
}

bool GetSubTaskDownloadSystemResultResult::getSucc()const
{
	return succ_;
}

std::string GetSubTaskDownloadSystemResultResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetSubTaskDownloadSystemResultResult::getErrInfo()const
{
	return errInfo_;
}

std::string GetSubTaskDownloadSystemResultResult::getCode()const
{
	return code_;
}

GetSubTaskDownloadSystemResultResult::Result GetSubTaskDownloadSystemResultResult::getResult()const
{
	return result_;
}
