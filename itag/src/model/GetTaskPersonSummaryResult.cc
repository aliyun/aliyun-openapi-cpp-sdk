...
GetTaskPersonSummaryResult::GetTaskPersonSummaryResult() :
	ServiceResult()
{}

GetTaskPersonSummaryResult::GetTaskPersonSummaryResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetTaskPersonSummaryResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetTaskPersonSummaryResult::getMsg()const
{
	return msg_;
}

bool GetTaskPersonSummaryResult::getSucc()const
{
	return succ_;
}

std::string GetTaskPersonSummaryResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetTaskPersonSummaryResult::getErrInfo()const
{
	return errInfo_;
}

std::string GetTaskPersonSummaryResult::getCode()const
{
	return code_;
}

GetTaskPersonSummaryResult::Result GetTaskPersonSummaryResult::getResult()const
{
	return result_;
}
