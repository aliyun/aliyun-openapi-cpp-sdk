...
GetMarkPersonDetailResult::GetMarkPersonDetailResult() :
	ServiceResult()
{}

GetMarkPersonDetailResult::GetMarkPersonDetailResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetMarkPersonDetailResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetMarkPersonDetailResult::getMsg()const
{
	return msg_;
}

bool GetMarkPersonDetailResult::getSucc()const
{
	return succ_;
}

std::string GetMarkPersonDetailResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetMarkPersonDetailResult::getErrInfo()const
{
	return errInfo_;
}

std::string GetMarkPersonDetailResult::getCode()const
{
	return code_;
}

GetMarkPersonDetailResult::Result GetMarkPersonDetailResult::getResult()const
{
	return result_;
}
