...
RemoveUserInGroupResult::RemoveUserInGroupResult() :
	ServiceResult()
{}

RemoveUserInGroupResult::RemoveUserInGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RemoveUserInGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string RemoveUserInGroupResult::getMsg()const
{
	return msg_;
}

bool RemoveUserInGroupResult::getSucc()const
{
	return succ_;
}

std::string RemoveUserInGroupResult::getErrorCode()const
{
	return errorCode_;
}

std::string RemoveUserInGroupResult::getErrInfo()const
{
	return errInfo_;
}

std::string RemoveUserInGroupResult::getCode()const
{
	return code_;
}

RemoveUserInGroupResult::Result RemoveUserInGroupResult::getResult()const
{
	return result_;
}
