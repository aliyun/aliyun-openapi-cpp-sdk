...
GetGroupTaskPersonDetailResult::GetGroupTaskPersonDetailResult() :
	ServiceResult()
{}

GetGroupTaskPersonDetailResult::GetGroupTaskPersonDetailResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetGroupTaskPersonDetailResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetGroupTaskPersonDetailResult::getMsg()const
{
	return msg_;
}

bool GetGroupTaskPersonDetailResult::getSucc()const
{
	return succ_;
}

std::string GetGroupTaskPersonDetailResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetGroupTaskPersonDetailResult::getErrInfo()const
{
	return errInfo_;
}

std::string GetGroupTaskPersonDetailResult::getCode()const
{
	return code_;
}

GetGroupTaskPersonDetailResult::Result GetGroupTaskPersonDetailResult::getResult()const
{
	return result_;
}
