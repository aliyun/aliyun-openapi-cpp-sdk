...
std::string CreateDatasetResult::getMsg()const
{
	return msg_;
}

bool CreateDatasetResult::getSucc()const
{
	return succ_;
}

std::string CreateDatasetResult::getErrorCode()const
{
	return errorCode_;
}

std::string CreateDatasetResult::getErrInfo()const
{
	return errInfo_;
}
