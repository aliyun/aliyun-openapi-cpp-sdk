...
GetCheckUserDetailResult::GetCheckUserDetailResult() :
	ServiceResult()
{}

GetCheckUserDetailResult::GetCheckUserDetailResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetCheckUserDetailResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetCheckUserDetailResult::getMsg()const
{
	return msg_;
}

bool GetCheckUserDetailResult::getSucc()const
{
	return succ_;
}

std::string GetCheckUserDetailResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetCheckUserDetailResult::getErrInfo()const
{
	return errInfo_;
}

std::string GetCheckUserDetailResult::getCode()const
{
	return code_;
}

GetCheckUserDetailResult::Result GetCheckUserDetailResult::getResult()const
{
	return result_;
}
