...
PollingSampleMarkItemsResult::PollingSampleMarkItemsResult() :
	ServiceResult()
{}

PollingSampleMarkItemsResult::PollingSampleMarkItemsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void PollingSampleMarkItemsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	if(!resultNode["HasNonCompleteTask"].isNull())
		result_.hasNonCompleteTask = std::stoi(resultNode["HasNonCompleteTask"].asString());
	if(!resultNode["SampleRecordId"].isNull())
		result_.sampleRecordId = resultNode["SampleRecordId"].asString();
	if(!resultNode["NeedPolling"].isNull())
		result_.needPolling = resultNode["NeedPolling"].asString() == "true";
	if(!resultNode["TotalMarkItemCount"].isNull())
		result_.totalMarkItemCount = resultNode["TotalMarkItemCount"].asString();
	auto iTagMarkableWorkTaskDTONode = resultNode["ITagMarkableWorkTaskDTO"];
	...
	{
		Result::ITagMarkableWorkTaskDTO::ITagSimpleUserMarkItemDTO iTagSimpleUserMarkItemDTOObject;
		...
		{
			Result::ITagMarkableWorkTaskDTO::ITagSimpleUserMarkItemDTO::ITagSimpleUserMarkResultDTO markResultListObject;
		...
		result_.iTagMarkableWorkTaskDTO.markItemList.push_back(iTagSimpleUserMarkItemDTOObject);
	}
	auto taskInfoNode = iTagMarkableWorkTaskDTONode["TaskInfo"];
	if(!taskInfoNode["TaskName"].isNull())
		result_.iTagMarkableWorkTaskDTO.taskInfo.taskName = taskInfoNode["TaskName"].asString();
	if(!taskInfoNode["TaskId"].isNull())
		result_.iTagMarkableWorkTaskDTO.taskInfo.taskId = taskInfoNode["TaskId"].asString();
	if(!taskInfoNode["TaskType"].isNull())
		result_.iTagMarkableWorkTaskDTO.taskInfo.taskType = taskInfoNode["TaskType"].asString();
	if(!taskInfoNode["Channel"].isNull())
		result_.iTagMarkableWorkTaskDTO.taskInfo.channel = taskInfoNode["Channel"].asString();
	if(!taskInfoNode["SafetyLevel"].isNull())
		result_.iTagMarkableWorkTaskDTO.taskInfo.safetyLevel = std::stoi(taskInfoNode["SafetyLevel"].asString());
	auto bizInfoNode = taskInfoNode["BizInfo"];
	if(!bizInfoNode["BizCode"].isNull())
		result_.iTagMarkableWorkTaskDTO.taskInfo.bizInfo.bizCode = bizInfoNode["BizCode"].asString();
	if(!bizInfoNode["BizNo"].isNull())
		result_.iTagMarkableWorkTaskDTO.taskInfo.bizInfo.bizNo = bizInfoNode["BizNo"].asString();
	if(!bizInfoNode["BizClassify"].isNull())
		result_.iTagMarkableWorkTaskDTO.taskInfo.bizInfo.bizClassify = bizInfoNode["BizClassify"].asString();
	auto subTaskNode = iTagMarkableWorkTaskDTONode["SubTask"];
	if(!subTaskNode["SubTaskId"].isNull())
		result_.iTagMarkableWorkTaskDTO.subTask.subTaskId = subTaskNode["SubTaskId"].asString();
	if(!subTaskNode["TaskId"].isNull())
		result_.iTagMarkableWorkTaskDTO.subTask.taskId = subTaskNode["TaskId"].asString();
	auto handlerNode = subTaskNode["Handler"];
	if(!handlerNode["UserId"].isNull())
		result_.iTagMarkableWorkTaskDTO.subTask.handler.userId = handlerNode["UserId"].asString();
	if(!handlerNode["UserName"].isNull())
		result_.iTagMarkableWorkTaskDTO.subTask.handler.userName = handlerNode["UserName"].asString();
	if(!handlerNode["AccountType"].isNull())
		result_.iTagMarkableWorkTaskDTO.subTask.handler.accountType = handlerNode["AccountType"].asString();
	if(!handlerNode["AccountNo"].isNull())
		result_.iTagMarkableWorkTaskDTO.subTask.handler.accountNo = handlerNode["AccountNo"].asString();
	auto subUserTaskNode = iTagMarkableWorkTaskDTONode["SubUserTask"];
	if(!subUserTaskNode["UserSubTaskId"].isNull())
		result_.iTagMarkableWorkTaskDTO.subUserTask.userSubTaskId = subUserTaskNode["UserSubTaskId"].asString();
	if(!subUserTaskNode["SubTaskId"].isNull())
		result_.iTagMarkableWorkTaskDTO.subUserTask.subTaskId = subUserTaskNode["SubTaskId"].asString();
	if(!subUserTaskNode["WorkNode"].isNull())
		result_.iTagMarkableWorkTaskDTO.subUserTask.workNode = subUserTaskNode["WorkNode"].asString();
	if(!subUserTaskNode["State"].isNull())
		result_.iTagMarkableWorkTaskDTO.subUserTask.state = subUserTaskNode["State"].asString();
	if(!subUserTaskNode["VoteIdx"].isNull())
		result_.iTagMarkableWorkTaskDTO.subUserTask.voteIdx = std::stoi(subUserTaskNode["VoteIdx"].asString());
	if(!subUserTaskNode["LastUserSubTaskId"].isNull())
		result_.iTagMarkableWorkTaskDTO.subUserTask.lastUserSubTaskId = subUserTaskNode["LastUserSubTaskId"].asString();
	if(!subUserTaskNode["OperateFlag"].isNull())
		result_.iTagMarkableWorkTaskDTO.subUserTask.operateFlag = subUserTaskNode["OperateFlag"].asString();
	if(!subUserTaskNode["RejectFlag"].isNull())
		result_.iTagMarkableWorkTaskDTO.subUserTask.rejectFlag = std::stoi(subUserTaskNode["RejectFlag"].asString());
	if(!subUserTaskNode["RejectRemark"].isNull())
		result_.iTagMarkableWorkTaskDTO.subUserTask.rejectRemark = subUserTaskNode["RejectRemark"].asString();
	if(!subUserTaskNode["GmtTimeout"].isNull())
		result_.iTagMarkableWorkTaskDTO.subUserTask.gmtTimeout = subUserTaskNode["GmtTimeout"].asString();
	if(!subUserTaskNode["ExternalBizNo"].isNull())
		result_.iTagMarkableWorkTaskDTO.subUserTask.externalBizNo = subUserTaskNode["ExternalBizNo"].asString();
	auto handler1Node = subUserTaskNode["Handler"];
	if(!handler1Node["UserId"].isNull())
		result_.iTagMarkableWorkTaskDTO.subUserTask.handler1.userId = handler1Node["UserId"].asString();
	if(!handler1Node["UserName"].isNull())
		result_.iTagMarkableWorkTaskDTO.subUserTask.handler1.userName = handler1Node["UserName"].asString();
	if(!handler1Node["AccountType"].isNull())
		result_.iTagMarkableWorkTaskDTO.subUserTask.handler1.accountType = handler1Node["AccountType"].asString();
	if(!handler1Node["AccountNo"].isNull())
		result_.iTagMarkableWorkTaskDTO.subUserTask.handler1.accountNo = handler1Node["AccountNo"].asString();
	auto optionTemplateNode = iTagMarkableWorkTaskDTONode["OptionTemplate"];
	if(!optionTemplateNode["Id"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.id = optionTemplateNode["Id"].asString();
	if(!optionTemplateNode["Name"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.name = optionTemplateNode["Name"].asString();
	if(!optionTemplateNode["TntInstId"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.tntInstId = optionTemplateNode["TntInstId"].asString();
	if(!optionTemplateNode["Description"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.description = optionTemplateNode["Description"].asString();
	if(!optionTemplateNode["Exif"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.exif = optionTemplateNode["Exif"].asString();
	if(!optionTemplateNode["Status"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.status = std::stoi(optionTemplateNode["Status"].asString());
	if(!optionTemplateNode["SharedMode"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.sharedMode = optionTemplateNode["SharedMode"].asString();
	if(!optionTemplateNode["Type"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.type = optionTemplateNode["Type"].asString();
	if(!optionTemplateNode["Classify"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.classify = optionTemplateNode["Classify"].asString();
	if(!optionTemplateNode["GmtCreate"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.gmtCreate = optionTemplateNode["GmtCreate"].asString();
	if(!optionTemplateNode["GmtModified"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.gmtModified = optionTemplateNode["GmtModified"].asString();
	...
	{
		Result::ITagMarkableWorkTaskDTO::OptionTemplate::QuestionConfigDTO questionConfigDTOObject;
		...
		{
			Result::ITagMarkableWorkTaskDTO::OptionTemplate::QuestionConfigDTO::QuestionOption optionsObject;
		...
		{
			Result::ITagMarkableWorkTaskDTO::OptionTemplate::QuestionConfigDTO::TemplateRobotConfig robotConfigsObject;
			...
			{
				Result::ITagMarkableWorkTaskDTO::OptionTemplate::QuestionConfigDTO::TemplateRobotConfig::RobotParam paramsObject;
		...
		result_.iTagMarkableWorkTaskDTO.optionTemplate.questionConfigs.push_back(questionConfigDTOObject);
	}
	...
	{
		Result::ITagMarkableWorkTaskDTO::OptionTemplate::ViewConfigs::DisplayFieldDTO displayFieldDTOObject;
		...
		result_.iTagMarkableWorkTaskDTO.optionTemplate.viewConfigs.fields.push_back(displayFieldDTOObject);
	}
	auto creatorNode = optionTemplateNode["Creator"];
	if(!creatorNode["UserId"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.creator.userId = creatorNode["UserId"].asString();
	if(!creatorNode["UserName"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.creator.userName = creatorNode["UserName"].asString();
	if(!creatorNode["AccountType"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.creator.accountType = creatorNode["AccountType"].asString();
	if(!creatorNode["AccountNo"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.creator.accountNo = creatorNode["AccountNo"].asString();
	auto modifierNode = optionTemplateNode["Modifier"];
	if(!modifierNode["UserId"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.modifier.userId = modifierNode["UserId"].asString();
	if(!modifierNode["UserName"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.modifier.userName = modifierNode["UserName"].asString();
	if(!modifierNode["AccountType"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.modifier.accountType = modifierNode["AccountType"].asString();
	if(!modifierNode["AccountNo"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.modifier.accountNo = modifierNode["AccountNo"].asString();
	auto robotConfigNode = optionTemplateNode["RobotConfig"];
	if(!robotConfigNode["Source"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.robotConfig.source = robotConfigNode["Source"].asString();
	...
	{
		Result::ITagMarkableWorkTaskDTO::OptionTemplate::RobotConfig::ModelServiceConfig modelServiceConfigObject;
		...
		{
			Result::ITagMarkableWorkTaskDTO::OptionTemplate::RobotConfig::ModelServiceConfig::ModelServiceConfig$PostParamPair postParamsObject;
		...
		{
			Result::ITagMarkableWorkTaskDTO::OptionTemplate::RobotConfig::ModelServiceConfig::ModelServiceConfig$ResultMappingPair resultMappingsObject;
		...
		result_.iTagMarkableWorkTaskDTO.optionTemplate.robotConfig.modelServiceConfigs.push_back(modelServiceConfigObject);
	}
	auto effectStepNode = robotConfigNode["EffectStep"];
	if(!effectStepNode["PreProcess"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.robotConfig.effectStep.preProcess = effectStepNode["PreProcess"].asString() == "true";
	if(!effectStepNode["PreLabel"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.robotConfig.effectStep.preLabel = effectStepNode["PreLabel"].asString() == "true";
	if(!effectStepNode["Label"].isNull())
		result_.iTagMarkableWorkTaskDTO.optionTemplate.robotConfig.effectStep.label = effectStepNode["Label"].asString() == "true";
	auto processConfigNode = effectStepNode["ProcessConfig"];
		...
		for (auto value : allRelateColumn)
			result_.iTagMarkableWorkTaskDTO.optionTemplate.robotConfig.effectStep.processConfig.relateColumn.push_back(value.asString());
		auto allTags = optionTemplateNode["Tags"]["String"];
		for (auto value : allTags)
			result_.iTagMarkableWorkTaskDTO.optionTemplate.tags.push_back(value.asString());
		auto allAbandonReasons = optionTemplateNode["AbandonReasons"]["String"];
		for (auto value : allAbandonReasons)
			result_.iTagMarkableWorkTaskDTO.optionTemplate.abandonReasons.push_back(value.asString());
...
std::string PollingSampleMarkItemsResult::getMsg()const
{
	return msg_;
}

bool PollingSampleMarkItemsResult::getSucc()const
{
	return succ_;
}

std::string PollingSampleMarkItemsResult::getErrorCode()const
{
	return errorCode_;
}

std::string PollingSampleMarkItemsResult::getErrInfo()const
{
	return errInfo_;
}

std::string PollingSampleMarkItemsResult::getCode()const
{
	return code_;
}

PollingSampleMarkItemsResult::Result PollingSampleMarkItemsResult::getResult()const
{
	return result_;
}
