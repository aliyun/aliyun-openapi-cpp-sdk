...
GetCheckUserEfficiencyResult::GetCheckUserEfficiencyResult() :
	ServiceResult()
{}

GetCheckUserEfficiencyResult::GetCheckUserEfficiencyResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetCheckUserEfficiencyResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetCheckUserEfficiencyResult::getMsg()const
{
	return msg_;
}

std::string GetCheckUserEfficiencyResult::getRequestId()const
{
	return requestId_;
}

bool GetCheckUserEfficiencyResult::getSucc()const
{
	return succ_;
}

std::string GetCheckUserEfficiencyResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetCheckUserEfficiencyResult::getErrInfo()const
{
	return errInfo_;
}

int GetCheckUserEfficiencyResult::getCode()const
{
	return code_;
}

GetCheckUserEfficiencyResult::Result GetCheckUserEfficiencyResult::getResult()const
{
	return result_;
}
