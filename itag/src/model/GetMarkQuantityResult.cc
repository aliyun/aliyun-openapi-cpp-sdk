...
GetMarkQuantityResult::GetMarkQuantityResult() :
	ServiceResult()
{}

GetMarkQuantityResult::GetMarkQuantityResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetMarkQuantityResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetMarkQuantityResult::getMsg()const
{
	return msg_;
}

std::string GetMarkQuantityResult::getRequestId()const
{
	return requestId_;
}

bool GetMarkQuantityResult::getSucc()const
{
	return succ_;
}

std::string GetMarkQuantityResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetMarkQuantityResult::getErrInfo()const
{
	return errInfo_;
}

int GetMarkQuantityResult::getCode()const
{
	return code_;
}

GetMarkQuantityResult::Result GetMarkQuantityResult::getResult()const
{
	return result_;
}
