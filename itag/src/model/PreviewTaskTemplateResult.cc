...
PreviewTaskTemplateResult::PreviewTaskTemplateResult() :
	ServiceResult()
{}

PreviewTaskTemplateResult::PreviewTaskTemplateResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void PreviewTaskTemplateResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string PreviewTaskTemplateResult::getMsg()const
{
	return msg_;
}

bool PreviewTaskTemplateResult::getSucc()const
{
	return succ_;
}

std::string PreviewTaskTemplateResult::getErrInfo()const
{
	return errInfo_;
}

std::string PreviewTaskTemplateResult::getCode()const
{
	return code_;
}

PreviewTaskTemplateResult::Result PreviewTaskTemplateResult::getResult()const
{
	return result_;
}
