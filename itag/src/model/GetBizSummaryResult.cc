...
GetBizSummaryResult::GetBizSummaryResult() :
	ServiceResult()
{}

GetBizSummaryResult::GetBizSummaryResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetBizSummaryResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetBizSummaryResult::getMsg()const
{
	return msg_;
}

bool GetBizSummaryResult::getSucc()const
{
	return succ_;
}

std::string GetBizSummaryResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetBizSummaryResult::getErrInfo()const
{
	return errInfo_;
}

std::string GetBizSummaryResult::getCode()const
{
	return code_;
}

GetBizSummaryResult::Result GetBizSummaryResult::getResult()const
{
	return result_;
}
