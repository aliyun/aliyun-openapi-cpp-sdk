...
GetTaskSummaryResult::GetTaskSummaryResult() :
	ServiceResult()
{}

GetTaskSummaryResult::GetTaskSummaryResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetTaskSummaryResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetTaskSummaryResult::getMsg()const
{
	return msg_;
}

bool GetTaskSummaryResult::getSucc()const
{
	return succ_;
}

std::string GetTaskSummaryResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetTaskSummaryResult::getErrInfo()const
{
	return errInfo_;
}

std::string GetTaskSummaryResult::getCode()const
{
	return code_;
}

GetTaskSummaryResult::Result GetTaskSummaryResult::getResult()const
{
	return result_;
}
