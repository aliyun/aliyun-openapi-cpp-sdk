...
std::string AddUserToGroupResult::getMsg()const
{
	return msg_;
}

bool AddUserToGroupResult::getSucc()const
{
	return succ_;
}

std::string AddUserToGroupResult::getErrorCode()const
{
	return errorCode_;
}

std::string AddUserToGroupResult::getErrInfo()const
{
	return errInfo_;
}

std::string AddUserToGroupResult::getCode()const
{
	return code_;
}

AddUserToGroupResult::Result AddUserToGroupResult::getResult()const
{
	return result_;
}
