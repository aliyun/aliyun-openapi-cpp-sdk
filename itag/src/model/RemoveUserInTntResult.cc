...
RemoveUserInTntResult::RemoveUserInTntResult() :
	ServiceResult()
{}

RemoveUserInTntResult::RemoveUserInTntResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RemoveUserInTntResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string RemoveUserInTntResult::getMsg()const
{
	return msg_;
}

bool RemoveUserInTntResult::getSucc()const
{
	return succ_;
}

std::string RemoveUserInTntResult::getErrorCode()const
{
	return errorCode_;
}

std::string RemoveUserInTntResult::getErrInfo()const
{
	return errInfo_;
}

std::string RemoveUserInTntResult::getCode()const
{
	return code_;
}

RemoveUserInTntResult::Result RemoveUserInTntResult::getResult()const
{
	return result_;
}
