...
GetPersonSummaryResult::GetPersonSummaryResult() :
	ServiceResult()
{}

GetPersonSummaryResult::GetPersonSummaryResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetPersonSummaryResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetPersonSummaryResult::getMsg()const
{
	return msg_;
}

bool GetPersonSummaryResult::getSucc()const
{
	return succ_;
}

std::string GetPersonSummaryResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetPersonSummaryResult::getErrInfo()const
{
	return errInfo_;
}

std::string GetPersonSummaryResult::getCode()const
{
	return code_;
}

GetPersonSummaryResult::Result GetPersonSummaryResult::getResult()const
{
	return result_;
}
