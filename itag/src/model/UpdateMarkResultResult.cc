...
UpdateMarkResultResult::UpdateMarkResultResult() :
	ServiceResult()
{}

UpdateMarkResultResult::UpdateMarkResultResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateMarkResultResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string UpdateMarkResultResult::getMsg()const
{
	return msg_;
}

bool UpdateMarkResultResult::getSucc()const
{
	return succ_;
}

std::string UpdateMarkResultResult::getErrorCode()const
{
	return errorCode_;
}

std::string UpdateMarkResultResult::getErrInfo()const
{
	return errInfo_;
}

std::string UpdateMarkResultResult::getCode()const
{
	return code_;
}

UpdateMarkResultResult::Result UpdateMarkResultResult::getResult()const
{
	return result_;
}
