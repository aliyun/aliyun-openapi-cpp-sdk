...
PageviewSubTaskResult::PageviewSubTaskResult() :
	ServiceResult()
{}

PageviewSubTaskResult::PageviewSubTaskResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void PageviewSubTaskResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string PageviewSubTaskResult::getMsg()const
{
	return msg_;
}

bool PageviewSubTaskResult::getSucc()const
{
	return succ_;
}

std::string PageviewSubTaskResult::getErrorCode()const
{
	return errorCode_;
}

std::string PageviewSubTaskResult::getErrInfo()const
{
	return errInfo_;
}

std::string PageviewSubTaskResult::getCode()const
{
	return code_;
}

PageviewSubTaskResult::Result PageviewSubTaskResult::getResult()const
{
	return result_;
}
