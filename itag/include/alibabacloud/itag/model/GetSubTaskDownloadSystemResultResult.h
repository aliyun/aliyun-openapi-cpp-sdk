...
#ifndef ALIBABACLOUD_ITAG_MODEL_GETSUBTASKDOWNLOADSYSTEMRESULTRESULT_H_
#define ALIBABACLOUD_ITAG_MODEL_GETSUBTASKDOWNLOADSYSTEMRESULTRESULT_H_
...
namespace AlibabaCloud
{
	namespace Itag
	{
		namespace Model
		{
			class ALIBABACLOUD_ITAG_EXPORT GetSubTaskDownloadSystemResultResult : public ServiceResult
			{
			public:
				struct Result
				{
				...
				explicit GetSubTaskDownloadSystemResultResult(const std::string &payload);
				~GetSubTaskDownloadSystemResultResult();
...
#endif // !ALIBABACLOUD_ITAG_MODEL_GETSUBTASKDOWNLOADSYSTEMRESULTRESULT_H_