...
#ifndef ALIBABACLOUD_ITAG_MODEL_GETMARKUSEREFFICIENCYRESULT_H_
...
namespace AlibabaCloud
{
	namespace Itag
	{
		namespace Model
		{
			class ALIBABACLOUD_ITAG_EXPORT GetMarkUserEfficiencyResult : public ServiceResult
			{
			public:
				struct Result
				{
				...
				explicit GetMarkUserEfficiencyResult(const std::string &payload);
				~GetMarkUserEfficiencyResult();
...
#endif // !ALIBABACLOUD_ITAG_MODEL_GETMARKUSEREFFICIENCYRESULT_H_