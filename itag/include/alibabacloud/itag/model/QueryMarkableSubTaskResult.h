...
#ifndef ALIBABACLOUD_ITAG_MODEL_QUERYMARKABLESUBTASKRESULT_H_
#define ALIBABACLOUD_ITAG_MODEL_QUERYMARKABLESUBTASKRESULT_H_
...
namespace AlibabaCloud
{
	namespace Itag
	{
		namespace Model
		{
			class ALIBABACLOUD_ITAG_EXPORT QueryMarkableSubTaskResult : public ServiceResult
			{
			public:
				struct Result
				{
					...
					struct MarkItemListItem
					{
						...
						long abandonFlag;
						long fixedFlag;
						std::vector<MarkItemListItem::MarkResultListItem> markResultList;
						long weight;
						std::string datasetId;
					};
					TaskInfo taskInfo;
					SubUserTask subUserTask;
					std::vector<MarkItemListItem> markItemList;
					OptionTemplate optionTemplate;
					SubTask subTask;
				};


				QueryMarkableSubTaskResult();
				explicit QueryMarkableSubTaskResult(const std::string &payload);
				~QueryMarkableSubTaskResult();
...
#endif // !ALIBABACLOUD_ITAG_MODEL_QUERYMARKABLESUBTASKRESULT_H_