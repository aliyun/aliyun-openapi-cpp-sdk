...
#ifndef ALIBABACLOUD_ITAG_MODEL_PREVIEWTASKTEMPLATERESULT_H_
#define ALIBABACLOUD_ITAG_MODEL_PREVIEWTASKTEMPLATERESULT_H_
...
namespace AlibabaCloud
{
	namespace Itag
	{
		namespace Model
		{
			class ALIBABACLOUD_ITAG_EXPORT PreviewTaskTemplateResult : public ServiceResult
			{
			public:
				struct Result
				{
				...
				explicit PreviewTaskTemplateResult(const std::string &payload);
				~PreviewTaskTemplateResult();
...
#endif // !ALIBABACLOUD_ITAG_MODEL_PREVIEWTASKTEMPLATERESULT_H_