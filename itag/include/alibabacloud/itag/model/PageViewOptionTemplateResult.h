...
#ifndef ALIBABACLOUD_ITAG_MODEL_PAGEVIEWOPTIONTEMPLATERESULT_H_
#define ALIBABACLOUD_ITAG_MODEL_PAGEVIEWOPTIONTEMPLATERESULT_H_
...
namespace AlibabaCloud
{
	namespace Itag
	{
		namespace Model
		{
			class ALIBABACLOUD_ITAG_EXPORT PageViewOptionTemplateResult : public ServiceResult
			{
			public:
				struct Result
				{
					struct ListItem
					{
						...
						std::vector<ListItem::QuestionConfigDTO> questionConfigs;
						std::string id;
				...
				PageViewOptionTemplateResult();
				explicit PageViewOptionTemplateResult(const std::string &payload);
				~PageViewOptionTemplateResult();
...
#endif // !ALIBABACLOUD_ITAG_MODEL_PAGEVIEWOPTIONTEMPLATERESULT_H_