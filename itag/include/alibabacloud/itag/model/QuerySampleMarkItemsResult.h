...
#ifndef ALIBABACLOUD_ITAG_MODEL_QUERYSAMPLEMARKITEMSRESULT_H_
#define ALIBABACLOUD_ITAG_MODEL_QUERYSAMPLEMARKITEMSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Itag
	{
		namespace Model
		{
			class ALIBABACLOUD_ITAG_EXPORT QuerySampleMarkItemsResult : public ServiceResult
			{
			public:
				struct Result
				{
				...
				explicit QuerySampleMarkItemsResult(const std::string &payload);
				~QuerySampleMarkItemsResult();
...
#endif // !ALIBABACLOUD_ITAG_MODEL_QUERYSAMPLEMARKITEMSRESULT_H_