...
#ifndef ALIBABACLOUD_ITAG_MODEL_PAGEVIEWDATASETPROXYRESULT_H_
...
namespace AlibabaCloud
{
	namespace Itag
	{
		namespace Model
		{
			class ALIBABACLOUD_ITAG_EXPORT PageViewDatasetProxyResult : public ServiceResult
			{
			public:
				struct Result
				{
				...
				explicit PageViewDatasetProxyResult(const std::string &payload);
				~PageViewDatasetProxyResult();
...
#endif // !ALIBABACLOUD_ITAG_MODEL_PAGEVIEWDATASETPROXYRESULT_H_