...
#ifndef ALIBABACLOUD_ITAG_MODEL_GETMODELBYIDRESULT_H_
#define ALIBABACLOUD_ITAG_MODEL_GETMODELBYIDRESULT_H_
...
namespace AlibabaCloud
{
	namespace Itag
	{
		namespace Model
		{
			class ALIBABACLOUD_ITAG_EXPORT GetModelByIdResult : public ServiceResult
			{
			public:
				struct Result
				{
				...
				GetModelByIdResult();
				explicit GetModelByIdResult(const std::string &payload);
				~GetModelByIdResult();
...
#endif // !ALIBABACLOUD_ITAG_MODEL_GETMODELBYIDRESULT_H_