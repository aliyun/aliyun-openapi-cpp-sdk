...
#ifndef ALIBABACLOUD_ITAG_MODEL_GETTASKRESULT_H_
#define ALIBABACLOUD_ITAG_MODEL_GETTASKRESULT_H_
...
namespace AlibabaCloud
{
	namespace Itag
	{
		namespace Model
		{
			class ALIBABACLOUD_ITAG_EXPORT GetTaskResult : public ServiceResult
			{
			public:
				struct Result
				{
					...
					bool archived;
					std::string exif;
					std::vector<ITagTaskWorkflowConfig> taskWorkFlow;
					...
					std::vector<TaskDatasetProxyRelation> datasetProxyRelations;
					int alertTime;
					std::string mineConfigs;
					int safetyLevel;
					std::string gmtCreate;
					std::string taskName;
					std::vector<ITagSimpleUserVO> admins;
...
#endif // !ALIBABACLOUD_ITAG_MODEL_GETTASKRESULT_H_