...
#ifndef ALIBABACLOUD_ITAG_MODEL_GETUSERRESULT_H_
...
namespace AlibabaCloud
{
	namespace Itag
	{
		namespace Model
		{
			class ALIBABACLOUD_ITAG_EXPORT GetUserResult : public ServiceResult
			{
			public:
				struct Result
				{
...
#endif // !ALIBABACLOUD_ITAG_MODEL_GETUSERRESULT_H_