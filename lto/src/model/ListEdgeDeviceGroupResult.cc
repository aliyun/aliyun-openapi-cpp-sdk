...
ListEdgeDeviceGroupResult::ListEdgeDeviceGroupResult() :
	ServiceResult()
{}

ListEdgeDeviceGroupResult::ListEdgeDeviceGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListEdgeDeviceGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	for (auto dataNodePageDataMemberInfo : allPageDataNode)
	{
		...
		if(!dataNodePageDataMemberInfo["EdgeName"].isNull())
			memberInfoObject.edgeName = dataNodePageDataMemberInfo["EdgeName"].asString();
...
std::string ListEdgeDeviceGroupResult::getMessage()const
{
	return message_;
}

int ListEdgeDeviceGroupResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

ListEdgeDeviceGroupResult::Data ListEdgeDeviceGroupResult::getData()const
{
	return data_;
}

std::string ListEdgeDeviceGroupResult::getCode()const
{
	return code_;
}

bool ListEdgeDeviceGroupResult::getSuccess()const
{
	return success_;
}
