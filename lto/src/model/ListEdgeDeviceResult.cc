...
ListEdgeDeviceResult::ListEdgeDeviceResult() :
	ServiceResult()
{}

ListEdgeDeviceResult::ListEdgeDeviceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListEdgeDeviceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string ListEdgeDeviceResult::getMessage()const
{
	return message_;
}

int ListEdgeDeviceResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

ListEdgeDeviceResult::Data ListEdgeDeviceResult::getData()const
{
	return data_;
}

std::string ListEdgeDeviceResult::getCode()const
{
	return code_;
}

bool ListEdgeDeviceResult::getSuccess()const
{
	return success_;
}
