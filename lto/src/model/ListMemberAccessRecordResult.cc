...
ListMemberAccessRecordResult::ListMemberAccessRecordResult() :
	ServiceResult()
{}

ListMemberAccessRecordResult::ListMemberAccessRecordResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListMemberAccessRecordResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	for (auto dataNodePageDataMemberInfo : allPageDataNode)
	{
		...
		if(!dataNodePageDataMemberInfo["AccessStatus"].isNull())
			memberInfoObject.accessStatus = dataNodePageDataMemberInfo["AccessStatus"].asString();
		if(!dataNodePageDataMemberInfo["AccessDate"].isNull())
			memberInfoObject.accessDate = std::stol(dataNodePageDataMemberInfo["AccessDate"].asString());
		if(!dataNodePageDataMemberInfo["MemberResponseDate"].isNull())
			memberInfoObject.memberResponseDate = std::stol(dataNodePageDataMemberInfo["MemberResponseDate"].asString());
...
std::string ListMemberAccessRecordResult::getMessage()const
{
	return message_;
}

int ListMemberAccessRecordResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

ListMemberAccessRecordResult::Data ListMemberAccessRecordResult::getData()const
{
	return data_;
}

std::string ListMemberAccessRecordResult::getCode()const
{
	return code_;
}

bool ListMemberAccessRecordResult::getSuccess()const
{
	return success_;
}
