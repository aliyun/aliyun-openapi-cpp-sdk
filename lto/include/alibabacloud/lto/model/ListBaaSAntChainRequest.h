...
#ifndef ALIBABACLOUD_LTO_MODEL_LISTBAASANTCHAINREQUEST_H_
...
namespace Lto {
namespace Model {
class ALIBABACLOUD_LTO_EXPORT ListBaaSAntChainRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LTO_MODEL_LISTBAASANTCHAINREQUEST_H_
