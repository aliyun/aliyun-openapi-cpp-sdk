...
#ifndef ALIBABACLOUD_LTO_MODEL_LISTBIZCHAINREQUEST_H_
...
namespace Lto {
namespace Model {
class ALIBABACLOUD_LTO_EXPORT ListBizChainRequest : public RpcServiceRequest {
public:
	ListBizChainRequest();
	~ListBizChainRequest();
	int getNum() const;
...
#endif // !ALIBABACLOUD_LTO_MODEL_LISTBIZCHAINREQUEST_H_
