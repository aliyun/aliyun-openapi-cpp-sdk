...
#ifndef ALIBABACLOUD_LTO_MODEL_UPDATEPRIVACYRULEREQUEST_H_
#define ALIBABACLOUD_LTO_MODEL_UPDATEPRIVACYRULEREQUEST_H_
...
namespace Lto {
namespace Model {
class ALIBABACLOUD_LTO_EXPORT UpdatePrivacyRuleRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LTO_MODEL_UPDATEPRIVACYRULEREQUEST_H_
