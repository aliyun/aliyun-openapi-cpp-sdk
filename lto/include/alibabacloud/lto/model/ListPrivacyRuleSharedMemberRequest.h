...
#ifndef ALIBABACLOUD_LTO_MODEL_LISTPRIVACYRULESHAREDMEMBERREQUEST_H_
...
namespace Lto {
namespace Model {
class ALIBABACLOUD_LTO_EXPORT ListPrivacyRuleSharedMemberRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LTO_MODEL_LISTPRIVACYRULESHAREDMEMBERREQUEST_H_
