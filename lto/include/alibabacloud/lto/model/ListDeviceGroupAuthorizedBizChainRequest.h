...
#ifndef ALIBABACLOUD_LTO_MODEL_LISTDEVICEGROUPAUTHORIZEDBIZCHAINREQUEST_H_
...
namespace Lto {
namespace Model {
class ALIBABACLOUD_LTO_EXPORT ListDeviceGroupAuthorizedBizChainRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LTO_MODEL_LISTDEVICEGROUPAUTHORIZEDBIZCHAINREQUEST_H_
