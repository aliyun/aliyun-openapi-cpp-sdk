...
#ifndef ALIBABACLOUD_LTO_MODEL_QUERYBLOCKCHAINMETADATAREQUEST_H_
#define ALIBABACLOUD_LTO_MODEL_QUERYBLOCKCHAINMETADATAREQUEST_H_
...
namespace Lto {
namespace Model {
class ALIBABACLOUD_LTO_EXPORT QueryBlockchainMetadataRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LTO_MODEL_QUERYBLOCKCHAINMETADATAREQUEST_H_
