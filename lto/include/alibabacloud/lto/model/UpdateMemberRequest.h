...
#ifndef ALIBABACLOUD_LTO_MODEL_UPDATEMEMBERREQUEST_H_
#define ALIBABACLOUD_LTO_MODEL_UPDATEMEMBERREQUEST_H_
...
namespace Lto {
namespace Model {
class ALIBABACLOUD_LTO_EXPORT UpdateMemberRequest : public RpcServiceRequest {
public:
	UpdateMemberRequest();
	~UpdateMemberRequest();
...
#endif // !ALIBABACLOUD_LTO_MODEL_UPDATEMEMBERREQUEST_H_
