...
using AlibabaCloud::PaiFeatureStore::Model::DeleteFeatureViewRequest;
...
std::string DeleteFeatureViewRequest::getInstanceId() const {
  return instanceId_;
}

void DeleteFeatureViewRequest::setInstanceId(const std::string &instanceId) {
  instanceId_ = instanceId;
  setParameter(std::string("InstanceId"), instanceId);
}

std::string DeleteFeatureViewRequest::getFeatureViewId() const {
  return featureViewId_;
}

void DeleteFeatureViewRequest::setFeatureViewId(const std::string &featureViewId) {
