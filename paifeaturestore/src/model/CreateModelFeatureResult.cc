...
CreateModelFeatureResult::CreateModelFeatureResult() :
	ServiceResult()
{}

CreateModelFeatureResult::CreateModelFeatureResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CreateModelFeatureResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string CreateModelFeatureResult::getModelFeatureId()const
{
