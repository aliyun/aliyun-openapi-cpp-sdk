...
WriteFeatureViewTableResult::WriteFeatureViewTableResult() :
	ServiceResult()
{}

WriteFeatureViewTableResult::WriteFeatureViewTableResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void WriteFeatureViewTableResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
