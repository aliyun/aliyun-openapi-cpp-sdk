...
CreateLabelTableResult::CreateLabelTableResult() :
	ServiceResult()
{}

CreateLabelTableResult::CreateLabelTableResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CreateLabelTableResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string CreateLabelTableResult::getLabelTableId()const
{
