...
CreateFeatureViewResult::CreateFeatureViewResult() :
	ServiceResult()
{}

CreateFeatureViewResult::CreateFeatureViewResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CreateFeatureViewResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string CreateFeatureViewResult::getFeatureViewId()const
{
