...
#ifndef ALIBABACLOUD_SOPHONSOAR_MODEL_VERIFYPYTHONFILEREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_SOPHONSOAR_EXPORT VerifyPythonFileRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SOPHONSOAR_MODEL_VERIFYPYTHONFILEREQUEST_H_
