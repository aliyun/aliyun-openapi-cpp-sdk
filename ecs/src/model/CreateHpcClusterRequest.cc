...
bool CreateHpcClusterRequest::getResourceOwnerId()const
{
	return resourceOwnerId_;
}

void CreateHpcClusterRequest::setResourceOwnerId(bool resourceOwnerId)
{
...
bool CreateHpcClusterRequest::getCallerParentId()const
{
	return callerParentId_;
}

void CreateHpcClusterRequest::setCallerParentId(bool callerParentId)
{
...
bool CreateHpcClusterRequest::getCallerUid()const
{
	return callerUid_;
}

void CreateHpcClusterRequest::setCallerUid(bool callerUid)
{
...
bool CreateHpcClusterRequest::getOwnerId()const
{
	return ownerId_;
}

void CreateHpcClusterRequest::setOwnerId(bool ownerId)
{
	ownerId_ = ownerId;
