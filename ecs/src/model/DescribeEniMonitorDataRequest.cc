...
bool DescribeEniMonitorDataRequest::getResourceOwnerId()const
{
	return resourceOwnerId_;
}

void DescribeEniMonitorDataRequest::setResourceOwnerId(bool resourceOwnerId)
{
	resourceOwnerId_ = resourceOwnerId;
	setCoreParameter("ResourceOwnerId", resourceOwnerId ? "true" : "false");
}

bool DescribeEniMonitorDataRequest::getCallerParentId()const
{
	return callerParentId_;
}

void DescribeEniMonitorDataRequest::setCallerParentId(bool callerParentId)
{
...
bool DescribeEniMonitorDataRequest::getCallerUid()const
{
	return callerUid_;
}

void DescribeEniMonitorDataRequest::setCallerUid(bool callerUid)
{
...
bool DescribeEniMonitorDataRequest::getOwnerId()const
{
	return ownerId_;
}

void DescribeEniMonitorDataRequest::setOwnerId(bool ownerId)
{
	ownerId_ = ownerId;
