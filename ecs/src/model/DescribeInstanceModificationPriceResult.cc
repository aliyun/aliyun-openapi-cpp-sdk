...
#include <alibabacloud/ecs/model/DescribeInstanceModificationPriceResult.h>
#include <json/json.h>

using namespace AlibabaCloud::Ecs;
using namespace AlibabaCloud::Ecs::Model;

DescribeInstanceModificationPriceResult::DescribeInstanceModificationPriceResult() :
	ServiceResult()
{}

DescribeInstanceModificationPriceResult::DescribeInstanceModificationPriceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeInstanceModificationPriceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
DescribeInstanceModificationPriceResult::PriceInfo DescribeInstanceModificationPriceResult::getPriceInfo()const
{
	return priceInfo_;
}
