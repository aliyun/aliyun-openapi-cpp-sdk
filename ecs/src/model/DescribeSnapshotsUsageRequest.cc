...
bool DescribeSnapshotsUsageRequest::getResourceOwnerId()const
{
	return resourceOwnerId_;
}

void DescribeSnapshotsUsageRequest::setResourceOwnerId(bool resourceOwnerId)
{
	resourceOwnerId_ = resourceOwnerId;
	setCoreParameter("ResourceOwnerId", resourceOwnerId ? "true" : "false");
}

bool DescribeSnapshotsUsageRequest::getCallerParentId()const
{
	return callerParentId_;
}

void DescribeSnapshotsUsageRequest::setCallerParentId(bool callerParentId)
{
...
bool DescribeSnapshotsUsageRequest::getCallerUid()const
{
	return callerUid_;
}

void DescribeSnapshotsUsageRequest::setCallerUid(bool callerUid)
{
...
bool DescribeSnapshotsUsageRequest::getOwnerId()const
{
	return ownerId_;
}

void DescribeSnapshotsUsageRequest::setOwnerId(bool ownerId)
{
	ownerId_ = ownerId;
