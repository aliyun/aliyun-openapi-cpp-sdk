...
bool AssignIpv6AddressesRequest::getResourceOwnerId()const
{
	return resourceOwnerId_;
}

void AssignIpv6AddressesRequest::setResourceOwnerId(bool resourceOwnerId)
{
	resourceOwnerId_ = resourceOwnerId;
	setCoreParameter("ResourceOwnerId", resourceOwnerId ? "true" : "false");
}

bool AssignIpv6AddressesRequest::getCallerParentId()const
{
	return callerParentId_;
}

void AssignIpv6AddressesRequest::setCallerParentId(bool callerParentId)
{
...
bool AssignIpv6AddressesRequest::getCallerUid()const
{
	return callerUid_;
}

void AssignIpv6AddressesRequest::setCallerUid(bool callerUid)
{
...
bool AssignIpv6AddressesRequest::getOwnerId()const
{
	return ownerId_;
}

void AssignIpv6AddressesRequest::setOwnerId(bool ownerId)
{
	ownerId_ = ownerId;
