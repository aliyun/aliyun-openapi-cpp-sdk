...
bool GetInstanceConsoleOutputRequest::getResourceOwnerId()const
{
	return resourceOwnerId_;
}

void GetInstanceConsoleOutputRequest::setResourceOwnerId(bool resourceOwnerId)
{
	resourceOwnerId_ = resourceOwnerId;
	setCoreParameter("ResourceOwnerId", resourceOwnerId ? "true" : "false");
}

bool GetInstanceConsoleOutputRequest::getCallerParentId()const
{
	return callerParentId_;
}

void GetInstanceConsoleOutputRequest::setCallerParentId(bool callerParentId)
{
...
bool GetInstanceConsoleOutputRequest::getCallerUid()const
{
	return callerUid_;
}

void GetInstanceConsoleOutputRequest::setCallerUid(bool callerUid)
{
...
bool GetInstanceConsoleOutputRequest::getOwnerId()const
{
	return ownerId_;
}

void GetInstanceConsoleOutputRequest::setOwnerId(bool ownerId)
{
	ownerId_ = ownerId;
