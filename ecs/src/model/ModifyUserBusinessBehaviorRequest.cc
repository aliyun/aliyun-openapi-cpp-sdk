...
bool ModifyUserBusinessBehaviorRequest::getResourceOwnerId()const
{
	return resourceOwnerId_;
}

void ModifyUserBusinessBehaviorRequest::setResourceOwnerId(bool resourceOwnerId)
{
	resourceOwnerId_ = resourceOwnerId;
	setCoreParameter("ResourceOwnerId", resourceOwnerId ? "true" : "false");
}

bool ModifyUserBusinessBehaviorRequest::getCallerParentId()const
{
	return callerParentId_;
}

void ModifyUserBusinessBehaviorRequest::setCallerParentId(bool callerParentId)
{
...
bool ModifyUserBusinessBehaviorRequest::getCallerUid()const
{
	return callerUid_;
}

void ModifyUserBusinessBehaviorRequest::setCallerUid(bool callerUid)
{
...
bool ModifyUserBusinessBehaviorRequest::getOwnerId()const
{
	return ownerId_;
}

void ModifyUserBusinessBehaviorRequest::setOwnerId(bool ownerId)
{
	ownerId_ = ownerId;
