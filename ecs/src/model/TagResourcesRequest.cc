...
bool TagResourcesRequest::getResourceOwnerId()const
{
	return resourceOwnerId_;
}

void TagResourcesRequest::setResourceOwnerId(bool resourceOwnerId)
{
	resourceOwnerId_ = resourceOwnerId;
	setCoreParameter("ResourceOwnerId", resourceOwnerId ? "true" : "false");
}

bool TagResourcesRequest::getCallerParentId()const
{
	return callerParentId_;
}

void TagResourcesRequest::setCallerParentId(bool callerParentId)
{
...
bool TagResourcesRequest::getCallerUid()const
{
	return callerUid_;
}

void TagResourcesRequest::setCallerUid(bool callerUid)
{
...
bool TagResourcesRequest::getOwnerId()const
{
	return ownerId_;
}

void TagResourcesRequest::setOwnerId(bool ownerId)
{
	ownerId_ = ownerId;
