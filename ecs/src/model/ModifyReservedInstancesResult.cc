...
ModifyReservedInstancesResult::ModifyReservedInstancesResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ModifyReservedInstancesResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<std::string> ModifyReservedInstancesResult::getReservedInstanceIdSets()const
{
