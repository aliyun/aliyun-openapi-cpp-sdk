...
void DescribeSecurityGroupReferencesResult::parse(const std::string &payload)
{
	...
	auto allSecurityGroupReferencesNode = value["SecurityGroupReferences"]["SecurityGroupReference"];
	for (auto valueSecurityGroupReferencesSecurityGroupReference : allSecurityGroupReferencesNode)
	{
