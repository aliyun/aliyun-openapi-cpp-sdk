...
ImportImageResult::ImportImageResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ImportImageResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string ImportImageResult::getTaskId()const
{
	return taskId_;
}
