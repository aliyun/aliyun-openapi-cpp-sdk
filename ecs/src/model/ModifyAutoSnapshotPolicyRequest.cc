...
bool ModifyAutoSnapshotPolicyRequest::getResourceOwnerId()const
{
	return resourceOwnerId_;
}

void ModifyAutoSnapshotPolicyRequest::setResourceOwnerId(bool resourceOwnerId)
{
...
bool ModifyAutoSnapshotPolicyRequest::getOwnerId()const
{
	return ownerId_;
}

void ModifyAutoSnapshotPolicyRequest::setOwnerId(bool ownerId)
{
	ownerId_ = ownerId;
