...
#ifndef ALIBABACLOUD_ECS_MODEL_DESCRIBEAVAILABLERESOURCERESULT_H_
...
namespace Ecs {
namespace Model {
class ALIBABACLOUD_ECS_EXPORT DescribeAvailableResourceResult
...
#endif // !ALIBABACLOUD_ECS_MODEL_DESCRIBEAVAILABLERESOURCERESULT_H_