...
#ifndef ALIBABACLOUD_ECS_MODEL_MODIFYFORWARDENTRYREQUEST_H_
#define ALIBABACLOUD_ECS_MODEL_MODIFYFORWARDENTRYREQUEST_H_
...
namespace Ecs {
namespace Model {
class ALIBABACLOUD_ECS_EXPORT ModifyForwardEntryRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ECS_MODEL_MODIFYFORWARDENTRYREQUEST_H_
