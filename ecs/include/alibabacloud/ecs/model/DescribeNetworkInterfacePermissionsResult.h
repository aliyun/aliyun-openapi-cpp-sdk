...
namespace Ecs {
namespace Model {
class ALIBABACLOUD_ECS_EXPORT DescribeNetworkInterfacePermissionsResult
...
public:
  ...
  explicit DescribeNetworkInterfacePermissionsResult(
      const std::string &payload);
  ~DescribeNetworkInterfacePermissionsResult();
  int getTotalCount() const;
  int getPageSize() const;
  int getPageNumber() const;
  std::vector<NetworkInterfacePermission>
  getNetworkInterfacePermissions() const;
