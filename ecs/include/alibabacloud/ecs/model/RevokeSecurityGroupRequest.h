...
#ifndef ALIBABACLOUD_ECS_MODEL_REVOKESECURITYGROUPREQUEST_H_
#define ALIBABACLOUD_ECS_MODEL_REVOKESECURITYGROUPREQUEST_H_
	...
	namespace Ecs
	{
		namespace Model
		{
			...
			public:
				...
				bool getSourceGroupOwnerId()const;
				void setSourceGroupOwnerId(bool sourceGroupOwnerId);
