...
public:
  ...
  void setSecurityEnhancementStrategy(
      const std::string &securityEnhancementStrategy);
  ...
  void setCapacityReservationPreference(
      const std::string &capacityReservationPreference);
  ...
  void
  setNetworkInterface(const std::vector<NetworkInterface> &networkInterface);
