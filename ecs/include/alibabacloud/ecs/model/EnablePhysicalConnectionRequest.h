...
#ifndef ALIBABACLOUD_ECS_MODEL_ENABLEPHYSICALCONNECTIONREQUEST_H_
...
namespace Ecs {
namespace Model {
class ALIBABACLOUD_ECS_EXPORT EnablePhysicalConnectionRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ECS_MODEL_ENABLEPHYSICALCONNECTIONREQUEST_H_
