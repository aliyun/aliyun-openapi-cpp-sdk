...
namespace Ecs {
namespace Model {
class ALIBABACLOUD_ECS_EXPORT DescribeNetworkInterfacePermissionsRequest
...
public:
  ...
  void setNetworkInterfacePermissionId(
      const std::vector<std::string> &networkInterfacePermissionId);
