...
namespace Ecs {
namespace Model {
class ALIBABACLOUD_ECS_EXPORT DescribeAutoProvisioningGroupsRequest
...
public:
  ...
  void setAutoProvisioningGroupStatus(
      const std::vector<std::string> &autoProvisioningGroupStatus);
  ...
  void setAutoProvisioningGroupId(
      const std::vector<std::string> &autoProvisioningGroupId);
