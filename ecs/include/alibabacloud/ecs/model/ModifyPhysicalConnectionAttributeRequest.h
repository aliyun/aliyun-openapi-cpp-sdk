...
namespace Ecs {
namespace Model {
class ALIBABACLOUD_ECS_EXPORT ModifyPhysicalConnectionAttributeRequest
...
public:
  ...
  void setRedundantPhysicalConnectionId(
      const std::string &redundantPhysicalConnectionId);
