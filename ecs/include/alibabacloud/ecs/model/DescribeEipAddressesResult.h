...
#ifndef ALIBABACLOUD_ECS_MODEL_DESCRIBEEIPADDRESSESRESULT_H_
#define ALIBABACLOUD_ECS_MODEL_DESCRIBEEIPADDRESSESRESULT_H_
...
namespace Ecs {
namespace Model {
class ALIBABACLOUD_ECS_EXPORT DescribeEipAddressesResult
...
#endif // !ALIBABACLOUD_ECS_MODEL_DESCRIBEEIPADDRESSESRESULT_H_