...
public:
  ...
  void
  setDataDisk3PerformanceLevel(const std::string &dataDisk3PerformanceLevel);
  ...
  void
  setSystemDiskPerformanceLevel(const std::string &systemDiskPerformanceLevel);
  ...
  void
  setDataDisk4PerformanceLevel(const std::string &dataDisk4PerformanceLevel);
  ...
  void
  setDataDisk1PerformanceLevel(const std::string &dataDisk1PerformanceLevel);
  ...
  void
  setDataDisk2PerformanceLevel(const std::string &dataDisk2PerformanceLevel);
