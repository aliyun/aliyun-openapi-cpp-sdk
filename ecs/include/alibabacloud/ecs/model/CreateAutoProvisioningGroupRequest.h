...
namespace Ecs {
namespace Model {
class ALIBABACLOUD_ECS_EXPORT CreateAutoProvisioningGroupRequest
...
public:
  ...
  void
  setAutoProvisioningGroupType(const std::string &autoProvisioningGroupType);
  ...
  void
  setTerminateInstancesWithExpiration(bool terminateInstancesWithExpiration);
  ...
  void setPayAsYouGoAllocationStrategy(
      const std::string &payAsYouGoAllocationStrategy);
  std::string getDefaultTargetCapacityType() const;
  void
  setDefaultTargetCapacityType(const std::string &defaultTargetCapacityType);
  std::string getExcessCapacityTerminationPolicy() const;
  void setExcessCapacityTerminationPolicy(
      const std::string &excessCapacityTerminationPolicy);
  std::vector<LaunchTemplateConfig> getLaunchTemplateConfig() const;
  void setLaunchTemplateConfig(
      const std::vector<LaunchTemplateConfig> &launchTemplateConfig);
  ...
  void setSpotInstanceInterruptionBehavior(
      const std::string &spotInstanceInterruptionBehavior);
  ...
  void
  setAutoProvisioningGroupName(const std::string &autoProvisioningGroupName);
