...
#ifndef ALIBABACLOUD_ECS_MODEL_DESCRIBEAUTOSNAPSHOTPOLICYEXREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Ecs
	{
		namespace Model
		{
			class ALIBABACLOUD_ECS_EXPORT DescribeAutoSnapshotPolicyExRequest : public EcsRequest
			{
...
#endif // !ALIBABACLOUD_ECS_MODEL_DESCRIBEAUTOSNAPSHOTPOLICYEXREQUEST_H_