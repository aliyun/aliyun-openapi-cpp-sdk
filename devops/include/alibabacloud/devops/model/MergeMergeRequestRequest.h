...
#ifndef ALIBABACLOUD_DEVOPS_MODEL_MERGEMERGEREQUESTREQUEST_H_
...
namespace Devops {
namespace Model {
class ALIBABACLOUD_DEVOPS_EXPORT MergeMergeRequestRequest : public RoaServiceRequest {
public:
	struct Body {
...
#endif // !ALIBABACLOUD_DEVOPS_MODEL_MERGEMERGEREQUESTREQUEST_H_
