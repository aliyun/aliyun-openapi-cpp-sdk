...
#ifndef ALIBABACLOUD_DEVOPS_MODEL_UPDATEHOSTGROUPREQUEST_H_
...
namespace Devops {
namespace Model {
class ALIBABACLOUD_DEVOPS_EXPORT UpdateHostGroupRequest : public RoaServiceRequest {
public:
...
#endif // !ALIBABACLOUD_DEVOPS_MODEL_UPDATEHOSTGROUPREQUEST_H_
