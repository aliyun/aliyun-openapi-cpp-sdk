...
#ifndef ALIBABACLOUD_DEVOPS_MODEL_GETMERGEREQUESTCHANGETREEREQUEST_H_
#define ALIBABACLOUD_DEVOPS_MODEL_GETMERGEREQUESTCHANGETREEREQUEST_H_
...
namespace Devops {
namespace Model {
class ALIBABACLOUD_DEVOPS_EXPORT GetMergeRequestChangeTreeRequest : public RoaServiceRequest {
public:
...
#endif // !ALIBABACLOUD_DEVOPS_MODEL_GETMERGEREQUESTCHANGETREEREQUEST_H_
