...
#ifndef ALIBABACLOUD_DEVOPS_MODEL_GETREPOSITORYTAGRESULT_H_
...
namespace AlibabaCloud
{
	namespace Devops
	{
		namespace Model
		{
			class ALIBABACLOUD_DEVOPS_EXPORT GetRepositoryTagResult : public ServiceResult
			{
			public:
				struct Result
				{
...
#endif // !ALIBABACLOUD_DEVOPS_MODEL_GETREPOSITORYTAGRESULT_H_