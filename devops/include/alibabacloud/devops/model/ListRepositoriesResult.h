...
#ifndef ALIBABACLOUD_DEVOPS_MODEL_LISTREPOSITORIESRESULT_H_
...
namespace AlibabaCloud
{
	namespace Devops
	{
		namespace Model
		{
			class ALIBABACLOUD_DEVOPS_EXPORT ListRepositoriesResult : public ServiceResult
			{
			public:
				struct ResultItem
				{
...
#endif // !ALIBABACLOUD_DEVOPS_MODEL_LISTREPOSITORIESRESULT_H_