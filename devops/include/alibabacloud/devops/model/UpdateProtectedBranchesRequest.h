...
#ifndef ALIBABACLOUD_DEVOPS_MODEL_UPDATEPROTECTEDBRANCHESREQUEST_H_
#define ALIBABACLOUD_DEVOPS_MODEL_UPDATEPROTECTEDBRANCHESREQUEST_H_
...
namespace Devops {
namespace Model {
class ALIBABACLOUD_DEVOPS_EXPORT UpdateProtectedBranchesRequest : public RoaServiceRequest {
public:
	struct Body {
		int integer;
...
#endif // !ALIBABACLOUD_DEVOPS_MODEL_UPDATEPROTECTEDBRANCHESREQUEST_H_
