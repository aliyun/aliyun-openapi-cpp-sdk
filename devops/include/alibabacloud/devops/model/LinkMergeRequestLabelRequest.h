...
#ifndef ALIBABACLOUD_DEVOPS_MODEL_LINKMERGEREQUESTLABELREQUEST_H_
...
namespace Devops {
namespace Model {
class ALIBABACLOUD_DEVOPS_EXPORT LinkMergeRequestLabelRequest : public RoaServiceRequest {
public:
	struct Body {
		std::string string;
...
#endif // !ALIBABACLOUD_DEVOPS_MODEL_LINKMERGEREQUESTLABELREQUEST_H_
