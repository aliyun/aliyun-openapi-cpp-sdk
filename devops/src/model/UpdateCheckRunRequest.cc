...
using AlibabaCloud::Devops::Model::UpdateCheckRunRequest;

UpdateCheckRunRequest::UpdateCheckRunRequest()
    : RoaServiceRequest("devops", "2021-06-25") {
  setResourcePath("/api/v4/projects/check_runs/update_check_run"};
  setMethod(HttpRequest::Method::Post);
}

UpdateCheckRunRequest::~UpdateCheckRunRequest() {}

std::string UpdateCheckRunRequest::getOrganizationId() const {
  return organizationId_;
}

void UpdateCheckRunRequest::setOrganizationId(const std::string &organizationId) {
  organizationId_ = organizationId;
  setParameter(std::string("organizationId"), organizationId);
}

std::string UpdateCheckRunRequest::getRepositoryIdentity() const {
  return repositoryIdentity_;
}

void UpdateCheckRunRequest::setRepositoryIdentity(const std::string &repositoryIdentity) {
  repositoryIdentity_ = repositoryIdentity;
  setParameter(std::string("repositoryIdentity"), repositoryIdentity);
}

std::string UpdateCheckRunRequest::getAccessToken() const {
  return accessToken_;
}

void UpdateCheckRunRequest::setAccessToken(const std::string &accessToken) {
  accessToken_ = accessToken;
  setParameter(std::string("accessToken"), accessToken);
}

long UpdateCheckRunRequest::getCheckRunId() const {
  return checkRunId_;
}

void UpdateCheckRunRequest::setCheckRunId(long checkRunId) {
  checkRunId_ = checkRunId;
  setParameter(std::string("checkRunId"), std::to_string(checkRunId));
}

UpdateCheckRunRequest::body UpdateCheckRunRequest::getBody() const {
  return body_;
}

void UpdateCheckRunRequest::setBody(const UpdateCheckRunRequest::body &body) {
  body_ = body;
