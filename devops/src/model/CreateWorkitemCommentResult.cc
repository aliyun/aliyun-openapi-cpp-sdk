...
CreateWorkitemCommentResult::CreateWorkitemCommentResult() :
	ServiceResult()
{}

CreateWorkitemCommentResult::CreateWorkitemCommentResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CreateWorkitemCommentResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	if(!commentNode["Id"].isNull())
		comment_.id = std::stol(commentNode["Id"].asString());
	...
	if(!userNode["targetType"].isNull())
		comment_.user.targetType = userNode["targetType"].asString();
...
CreateWorkitemCommentResult::Comment CreateWorkitemCommentResult::getComment()const
{
	return comment_;
}

std::string CreateWorkitemCommentResult::getRequestId()const
{
	return requestId_;
}

std::string CreateWorkitemCommentResult::getErrorMsg()const
{
	return errorMsg_;
}

std::string CreateWorkitemCommentResult::getErrorCode()const
{
	return errorCode_;
}

std::string CreateWorkitemCommentResult::getSuccess()const
{
	return success_;
}
