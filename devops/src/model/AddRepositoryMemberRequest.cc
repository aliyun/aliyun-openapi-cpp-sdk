...
using AlibabaCloud::Devops::Model::AddRepositoryMemberRequest;

AddRepositoryMemberRequest::AddRepositoryMemberRequest()
    : RoaServiceRequest("devops", "2021-06-25") {
  setResourcePath("/repository/[repositoryId]/members"};
...
long AddRepositoryMemberRequest::getRepositoryId() const {
  return repositoryId_;
}

void AddRepositoryMemberRequest::setRepositoryId(long repositoryId) {
...
AddRepositoryMemberRequest::body AddRepositoryMemberRequest::getBody() const {
  return body_;
}

void AddRepositoryMemberRequest::setBody(const AddRepositoryMemberRequest::body &body) {
  body_ = body;
