...
using AlibabaCloud::Devops::Model::ListRepositoryMemberWithInheritedRequest;

ListRepositoryMemberWithInheritedRequest::ListRepositoryMemberWithInheritedRequest()
    : RoaServiceRequest("devops", "2021-06-25") {
  setResourcePath("/repository/[repositoryId]/members/list"};
...
long ListRepositoryMemberWithInheritedRequest::getRepositoryId() const {
  return repositoryId_;
}

void ListRepositoryMemberWithInheritedRequest::setRepositoryId(long repositoryId) {
