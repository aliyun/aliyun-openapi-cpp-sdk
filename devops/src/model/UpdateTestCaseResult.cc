...
UpdateTestCaseResult::UpdateTestCaseResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateTestCaseResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
UpdateTestCaseResult::Testcase UpdateTestCaseResult::getTestcase()const
{
	return testcase_;
}

std::string UpdateTestCaseResult::getRequestId()const
{
	return requestId_;
}

std::string UpdateTestCaseResult::getErrorMsg()const
{
	return errorMsg_;
}

std::string UpdateTestCaseResult::getErrorCode()const
{
	return errorCode_;
}

bool UpdateTestCaseResult::getSuccess()const
{
	return success_;
}
