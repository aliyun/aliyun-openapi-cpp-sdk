...
UpdatePushRuleResult::UpdatePushRuleResult() :
	ServiceResult()
{}

UpdatePushRuleResult::UpdatePushRuleResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdatePushRuleResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string UpdatePushRuleResult::getRequestId()const
{
	return requestId_;
}

std::string UpdatePushRuleResult::getErrorCode()const
{
	return errorCode_;
}

std::string UpdatePushRuleResult::getErrorMessage()const
{
	return errorMessage_;
}

bool UpdatePushRuleResult::getSuccess()const
{
	return success_;
}

UpdatePushRuleResult::Result UpdatePushRuleResult::getResult()const
{
	return result_;
}
