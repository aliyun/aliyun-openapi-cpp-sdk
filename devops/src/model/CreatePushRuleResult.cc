...
CreatePushRuleResult::CreatePushRuleResult() :
	ServiceResult()
{}

CreatePushRuleResult::CreatePushRuleResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CreatePushRuleResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string CreatePushRuleResult::getRequestId()const
{
	return requestId_;
}

std::string CreatePushRuleResult::getErrorCode()const
{
	return errorCode_;
}

std::string CreatePushRuleResult::getErrorMessage()const
{
	return errorMessage_;
}

bool CreatePushRuleResult::getSuccess()const
{
	return success_;
}

CreatePushRuleResult::Result CreatePushRuleResult::getResult()const
{
	return result_;
}
