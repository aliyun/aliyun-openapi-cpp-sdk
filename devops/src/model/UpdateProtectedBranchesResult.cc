...
UpdateProtectedBranchesResult::UpdateProtectedBranchesResult() :
	ServiceResult()
{}

UpdateProtectedBranchesResult::UpdateProtectedBranchesResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateProtectedBranchesResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string UpdateProtectedBranchesResult::getRequestId()const
{
	return requestId_;
}

std::string UpdateProtectedBranchesResult::getErrorCode()const
{
	return errorCode_;
}

std::string UpdateProtectedBranchesResult::getErrorMessage()const
{
	return errorMessage_;
}

bool UpdateProtectedBranchesResult::getSuccess()const
{
	return success_;
}

UpdateProtectedBranchesResult::Result UpdateProtectedBranchesResult::getResult()const
{
	return result_;
}
