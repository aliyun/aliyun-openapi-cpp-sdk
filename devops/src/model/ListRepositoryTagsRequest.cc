...
using AlibabaCloud::Devops::Model::ListRepositoryTagsRequest;

ListRepositoryTagsRequest::ListRepositoryTagsRequest()
    : RoaServiceRequest("devops", "2021-06-25") {
  setResourcePath("/repository/[repositoryId]/tag/list"};
...
long ListRepositoryTagsRequest::getRepositoryId() const {
  return repositoryId_;
}

void ListRepositoryTagsRequest::setRepositoryId(long repositoryId) {
