...
GetCheckRunResult::GetCheckRunResult() :
	ServiceResult()
{}

GetCheckRunResult::GetCheckRunResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetCheckRunResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetCheckRunResult::getRequestId()const
{
	return requestId_;
}

std::string GetCheckRunResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetCheckRunResult::getErrorMessage()const
{
	return errorMessage_;
}

bool GetCheckRunResult::getSuccess()const
{
	return success_;
}

GetCheckRunResult::Result GetCheckRunResult::getResult()const
{
	return result_;
}
