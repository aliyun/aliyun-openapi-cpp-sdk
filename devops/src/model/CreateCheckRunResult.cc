...
CreateCheckRunResult::CreateCheckRunResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CreateCheckRunResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string CreateCheckRunResult::getRequestId()const
{
	return requestId_;
}

std::string CreateCheckRunResult::getErrorCode()const
{
	return errorCode_;
}

std::string CreateCheckRunResult::getErrorMessage()const
{
	return errorMessage_;
}

bool CreateCheckRunResult::getSuccess()const
{
	return success_;
}

CreateCheckRunResult::Result CreateCheckRunResult::getResult()const
{
	return result_;
}
