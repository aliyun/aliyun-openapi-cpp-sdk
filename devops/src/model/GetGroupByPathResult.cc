...
GetGroupByPathResult::GetGroupByPathResult() :
	ServiceResult()
{}

GetGroupByPathResult::GetGroupByPathResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetGroupByPathResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	if(!resultNode["parentId"].isNull())
		result_.parentId = resultNode["parentId"].asString();
...
std::string GetGroupByPathResult::getRequestId()const
{
	return requestId_;
}

std::string GetGroupByPathResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetGroupByPathResult::getErrorMessage()const
{
	return errorMessage_;
}

bool GetGroupByPathResult::getSuccess()const
{
	return success_;
}

GetGroupByPathResult::Result GetGroupByPathResult::getResult()const
{
	return result_;
}
