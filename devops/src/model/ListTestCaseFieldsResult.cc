...
ListTestCaseFieldsResult::ListTestCaseFieldsResult() :
	ServiceResult()
{}

ListTestCaseFieldsResult::ListTestCaseFieldsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListTestCaseFieldsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string ListTestCaseFieldsResult::getRequestId()const
{
	return requestId_;
}

std::string ListTestCaseFieldsResult::getErrorMsg()const
{
	return errorMsg_;
}

std::string ListTestCaseFieldsResult::getErrorCode()const
{
	return errorCode_;
}

std::vector<ListTestCaseFieldsResult::Field> ListTestCaseFieldsResult::getfields()const
{
	return fields_;
}

bool ListTestCaseFieldsResult::getSuccess()const
{
	return success_;
}
