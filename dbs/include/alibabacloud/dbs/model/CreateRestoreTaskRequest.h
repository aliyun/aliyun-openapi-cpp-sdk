...
namespace Dbs {
namespace Model {
class ALIBABACLOUD_DBS_EXPORT CreateRestoreTaskRequest
...
public:
  ...
  void
  setDestinationEndpointRegion(const std::string &destinationEndpointRegion);
  ...
  void setDestinationEndpointDatabaseName(
      const std::string &destinationEndpointDatabaseName);
  std::string getDestinationEndpointUserName() const;
  void setDestinationEndpointUserName(
      const std::string &destinationEndpointUserName);
  ...
  void setDestinationEndpointPassword(
      const std::string &destinationEndpointPassword);
