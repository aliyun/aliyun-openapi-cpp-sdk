...
namespace Dbs {
namespace Model {
class ALIBABACLOUD_DBS_EXPORT ConfigureBackupPlanRequest
...
public:
  ...
  void
  setSourceEndpointDatabaseName(const std::string &sourceEndpointDatabaseName);
  int getBackupRetentionPeriod() const;
  void setBackupRetentionPeriod(int backupRetentionPeriod);
  int getDuplicationInfrequentAccessPeriod() const;
  void
  setDuplicationInfrequentAccessPeriod(int duplicationInfrequentAccessPeriod);
  ...
  void
  setSourceEndpointInstanceType(const std::string &sourceEndpointInstanceType);
