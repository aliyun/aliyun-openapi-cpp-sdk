...
#ifndef ALIBABACLOUD_OUTBOUNDBOT_MODEL_MODIFYBATCHJOBSREQUEST_H_
#define ALIBABACLOUD_OUTBOUNDBOT_MODEL_MODIFYBATCHJOBSREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_OUTBOUNDBOT_EXPORT ModifyBatchJobsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_OUTBOUNDBOT_MODEL_MODIFYBATCHJOBSREQUEST_H_
