...
#ifndef ALIBABACLOUD_OUTBOUNDBOT_MODEL_SUSPENDJOBSREQUEST_H_
#define ALIBABACLOUD_OUTBOUNDBOT_MODEL_SUSPENDJOBSREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_OUTBOUNDBOT_EXPORT SuspendJobsRequest : public RpcServiceRequest {
public:
	SuspendJobsRequest();
	~SuspendJobsRequest();
	bool getAll() const;
...
#endif // !ALIBABACLOUD_OUTBOUNDBOT_MODEL_SUSPENDJOBSREQUEST_H_
