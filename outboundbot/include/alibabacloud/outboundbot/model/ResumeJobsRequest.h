...
#ifndef ALIBABACLOUD_OUTBOUNDBOT_MODEL_RESUMEJOBSREQUEST_H_
#define ALIBABACLOUD_OUTBOUNDBOT_MODEL_RESUMEJOBSREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_OUTBOUNDBOT_EXPORT ResumeJobsRequest : public RpcServiceRequest {
public:
	ResumeJobsRequest();
	~ResumeJobsRequest();
	bool getAll() const;
...
#endif // !ALIBABACLOUD_OUTBOUNDBOT_MODEL_RESUMEJOBSREQUEST_H_
