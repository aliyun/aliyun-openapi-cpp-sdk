...
public:
	...
	long getEndActualTimeFilter() const;
	void setEndActualTimeFilter(long endActualTimeFilter);
	...
	long getStartActualTimeFilter() const;
	void setStartActualTimeFilter(long startActualTimeFilter);
	...
	std::string getJobFailureReasonsFilter() const;
	void setJobFailureReasonsFilter(const std::string &jobFailureReasonsFilter);
