...
ModifyScriptResult::ModifyScriptResult() :
	ServiceResult()
{}

ModifyScriptResult::ModifyScriptResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ModifyScriptResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
ModifyScriptResult::Script ModifyScriptResult::getScript()const
{
	return script_;
}

std::string ModifyScriptResult::getChatbotId()const
{
	return chatbotId_;
}

std::string ModifyScriptResult::getMessage()const
{
	return message_;
}

int ModifyScriptResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::string ModifyScriptResult::getCode()const
{
	return code_;
}

bool ModifyScriptResult::getSuccess()const
{
	return success_;
}
