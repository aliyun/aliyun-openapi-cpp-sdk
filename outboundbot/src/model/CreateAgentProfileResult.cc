...
CreateAgentProfileResult::CreateAgentProfileResult() :
	ServiceResult()
{}

CreateAgentProfileResult::CreateAgentProfileResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CreateAgentProfileResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string CreateAgentProfileResult::getMessage()const
{
	return message_;
}

int CreateAgentProfileResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

CreateAgentProfileResult::Data CreateAgentProfileResult::getData()const
{
	return data_;
}

std::string CreateAgentProfileResult::getCode()const
{
	return code_;
}

bool CreateAgentProfileResult::getSuccess()const
{
	return success_;
}
