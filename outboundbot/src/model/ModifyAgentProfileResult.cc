...
ModifyAgentProfileResult::ModifyAgentProfileResult() :
	ServiceResult()
{}

ModifyAgentProfileResult::ModifyAgentProfileResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ModifyAgentProfileResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string ModifyAgentProfileResult::getMessage()const
{
	return message_;
}

int ModifyAgentProfileResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

ModifyAgentProfileResult::Data ModifyAgentProfileResult::getData()const
{
	return data_;
}

std::string ModifyAgentProfileResult::getCode()const
{
	return code_;
}

bool ModifyAgentProfileResult::getSuccess()const
{
	return success_;
}
