...
ModifyJobGroupResult::ModifyJobGroupResult() :
	ServiceResult()
{}

ModifyJobGroupResult::ModifyJobGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ModifyJobGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
ModifyJobGroupResult::JobGroup ModifyJobGroupResult::getJobGroup()const
{
	return jobGroup_;
}

std::string ModifyJobGroupResult::getMessage()const
{
	return message_;
}

int ModifyJobGroupResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::string ModifyJobGroupResult::getCode()const
{
	return code_;
}

bool ModifyJobGroupResult::getSuccess()const
{
	return success_;
}
