...
WithdrawScriptResult::WithdrawScriptResult() :
	ServiceResult()
{}

WithdrawScriptResult::WithdrawScriptResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void WithdrawScriptResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
WithdrawScriptResult::Script WithdrawScriptResult::getScript()const
{
	return script_;
}

std::string WithdrawScriptResult::getMessage()const
{
	return message_;
}

int WithdrawScriptResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::string WithdrawScriptResult::getCode()const
{
	return code_;
}

bool WithdrawScriptResult::getSuccess()const
{
	return success_;
}
