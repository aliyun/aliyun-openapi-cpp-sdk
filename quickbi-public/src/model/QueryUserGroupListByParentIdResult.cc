...
QueryUserGroupListByParentIdResult::QueryUserGroupListByParentIdResult() :
	ServiceResult()
{}

QueryUserGroupListByParentIdResult::QueryUserGroupListByParentIdResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryUserGroupListByParentIdResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
bool QueryUserGroupListByParentIdResult::getSuccess()const
{
	return success_;
}

std::vector<QueryUserGroupListByParentIdResult::Data> QueryUserGroupListByParentIdResult::getResult()const
{
	return result_;
}
