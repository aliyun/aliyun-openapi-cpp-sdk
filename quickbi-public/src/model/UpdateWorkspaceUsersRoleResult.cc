...
UpdateWorkspaceUsersRoleResult::UpdateWorkspaceUsersRoleResult() :
	ServiceResult()
{}

UpdateWorkspaceUsersRoleResult::UpdateWorkspaceUsersRoleResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateWorkspaceUsersRoleResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
bool UpdateWorkspaceUsersRoleResult::getSuccess()const
{
	return success_;
}

UpdateWorkspaceUsersRoleResult::Result UpdateWorkspaceUsersRoleResult::getResult()const
{
	return result_;
}
