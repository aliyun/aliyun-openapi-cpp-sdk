...
ListFavoriteReportsResult::ListFavoriteReportsResult() :
	ServiceResult()
{}

ListFavoriteReportsResult::ListFavoriteReportsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListFavoriteReportsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
bool ListFavoriteReportsResult::getSuccess()const
{
	return success_;
}

ListFavoriteReportsResult::Result ListFavoriteReportsResult::getResult()const
{
	return result_;
}
