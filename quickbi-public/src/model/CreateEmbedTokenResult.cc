...
CreateEmbedTokenResult::CreateEmbedTokenResult() :
	ServiceResult()
{}

CreateEmbedTokenResult::CreateEmbedTokenResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CreateEmbedTokenResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
bool CreateEmbedTokenResult::getSuccess()const
{
	return success_;
}

CreateEmbedTokenResult::Result CreateEmbedTokenResult::getResult()const
{
	return result_;
}
