...
QueryWorksByOrganizationResult::QueryWorksByOrganizationResult() :
	ServiceResult()
{}

QueryWorksByOrganizationResult::QueryWorksByOrganizationResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryWorksByOrganizationResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
bool QueryWorksByOrganizationResult::getSuccess()const
{
	return success_;
}

QueryWorksByOrganizationResult::Result QueryWorksByOrganizationResult::getResult()const
{
	return result_;
}
