...
QueryEmbeddedInfoResult::QueryEmbeddedInfoResult() :
	ServiceResult()
{}

QueryEmbeddedInfoResult::QueryEmbeddedInfoResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryEmbeddedInfoResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
bool QueryEmbeddedInfoResult::getSuccess()const
{
	return success_;
}

QueryEmbeddedInfoResult::Result QueryEmbeddedInfoResult::getResult()const
{
	return result_;
}
