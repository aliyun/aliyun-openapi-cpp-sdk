...
GetUserGroupInfoResult::GetUserGroupInfoResult() :
	ServiceResult()
{}

GetUserGroupInfoResult::GetUserGroupInfoResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetUserGroupInfoResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
bool GetUserGroupInfoResult::getSuccess()const
{
	return success_;
}

std::vector<GetUserGroupInfoResult::Data> GetUserGroupInfoResult::getResult()const
{
	return result_;
}
