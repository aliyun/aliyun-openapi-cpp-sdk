...
QueryReadableResourcesListByUserIdResult::QueryReadableResourcesListByUserIdResult() :
	ServiceResult()
{}

QueryReadableResourcesListByUserIdResult::QueryReadableResourcesListByUserIdResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryReadableResourcesListByUserIdResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
bool QueryReadableResourcesListByUserIdResult::getSuccess()const
{
	return success_;
}

std::vector<QueryReadableResourcesListByUserIdResult::Data> QueryReadableResourcesListByUserIdResult::getResult()const
{
	return result_;
}
