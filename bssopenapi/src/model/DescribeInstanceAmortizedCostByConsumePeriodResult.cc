...
DescribeInstanceAmortizedCostByConsumePeriodResult::DescribeInstanceAmortizedCostByConsumePeriodResult() :
	ServiceResult()
{}

DescribeInstanceAmortizedCostByConsumePeriodResult::DescribeInstanceAmortizedCostByConsumePeriodResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeInstanceAmortizedCostByConsumePeriodResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeInstanceAmortizedCostByConsumePeriodResult::getMessage()const
{
	return message_;
}

DescribeInstanceAmortizedCostByConsumePeriodResult::Data DescribeInstanceAmortizedCostByConsumePeriodResult::getData()const
{
	return data_;
}

std::string DescribeInstanceAmortizedCostByConsumePeriodResult::getCode()const
{
	return code_;
}

bool DescribeInstanceAmortizedCostByConsumePeriodResult::getSuccess()const
{
	return success_;
}
