...
DescribeInstanceAmortizedCostByAmortizationPeriodResult::DescribeInstanceAmortizedCostByAmortizationPeriodResult() :
	ServiceResult()
{}

DescribeInstanceAmortizedCostByAmortizationPeriodResult::DescribeInstanceAmortizedCostByAmortizationPeriodResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeInstanceAmortizedCostByAmortizationPeriodResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeInstanceAmortizedCostByAmortizationPeriodResult::getMessage()const
{
	return message_;
}

DescribeInstanceAmortizedCostByAmortizationPeriodResult::Data DescribeInstanceAmortizedCostByAmortizationPeriodResult::getData()const
{
	return data_;
}

std::string DescribeInstanceAmortizedCostByAmortizationPeriodResult::getCode()const
{
	return code_;
}

bool DescribeInstanceAmortizedCostByAmortizationPeriodResult::getSuccess()const
{
	return success_;
}
