...
#include <alibabacloud/bssopenapi/model/DescribeProductAmortizedCostByAmortizationPeriodResult.h>
#include <json/json.h>

using namespace AlibabaCloud::BssOpenApi;
using namespace AlibabaCloud::BssOpenApi::Model;

DescribeProductAmortizedCostByAmortizationPeriodResult::DescribeProductAmortizedCostByAmortizationPeriodResult() :
	ServiceResult()
{}

DescribeProductAmortizedCostByAmortizationPeriodResult::DescribeProductAmortizedCostByAmortizationPeriodResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeProductAmortizedCostByAmortizationPeriodResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeProductAmortizedCostByAmortizationPeriodResult::getMessage()const
{
	return message_;
}

DescribeProductAmortizedCostByAmortizationPeriodResult::Data DescribeProductAmortizedCostByAmortizationPeriodResult::getData()const
{
	return data_;
}

std::string DescribeProductAmortizedCostByAmortizationPeriodResult::getCode()const
{
	return code_;
}

bool DescribeProductAmortizedCostByAmortizationPeriodResult::getSuccess()const
{
	return success_;
}
