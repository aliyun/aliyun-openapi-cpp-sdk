...
DescribeProjectOperateLogsResult::DescribeProjectOperateLogsResult() :
	ServiceResult()
{}

DescribeProjectOperateLogsResult::DescribeProjectOperateLogsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeProjectOperateLogsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	for (auto valueResultProjectMessage : allResultNode)
	{
		...
		if(!valueResultProjectMessage["Description"].isNull())
			resultObject.description = valueResultProjectMessage["Description"].asString();
...
bool DescribeProjectOperateLogsResult::getSuccess()const
{
	return success_;
}

std::vector<DescribeProjectOperateLogsResult::ProjectMessage> DescribeProjectOperateLogsResult::getResult()const
{
	return result_;
}
