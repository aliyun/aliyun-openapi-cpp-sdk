...
using AlibabaCloud::Mse::Model::ListServiceSourceRequest;
...
void ListServiceSourceRequest::setGatewayUniqueId(const std::string &gatewayUniqueId) {
  gatewayUniqueId_ = gatewayUniqueId;
  setParameter(std::string("GatewayUniqueId"), gatewayUniqueId);
}

std::string ListServiceSourceRequest::getAcceptLanguage() const {
  return acceptLanguage_;
}

void ListServiceSourceRequest::setAcceptLanguage(const std::string &acceptLanguage) {
