...
CreateCircuitBreakerRuleResult::CreateCircuitBreakerRuleResult() :
	ServiceResult()
{}

CreateCircuitBreakerRuleResult::CreateCircuitBreakerRuleResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CreateCircuitBreakerRuleResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string CreateCircuitBreakerRuleResult::getMessage()const
{
	return message_;
}

CreateCircuitBreakerRuleResult::Data CreateCircuitBreakerRuleResult::getData()const
{
	return data_;
}

std::string CreateCircuitBreakerRuleResult::getCode()const
{
	return code_;
}

bool CreateCircuitBreakerRuleResult::getSuccess()const
{
	return success_;
}
