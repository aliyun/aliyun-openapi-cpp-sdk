...
using AlibabaCloud::Mse::Model::QuerySlbSpecRequest;

QuerySlbSpecRequest::QuerySlbSpecRequest()
    : RpcServiceRequest("mse", "2019-05-31", "QuerySlbSpec") {
...
void QuerySlbSpecRequest::setAcceptLanguage(const std::string &acceptLanguage) {
