...
UpdateFlowRuleResult::UpdateFlowRuleResult() :
	ServiceResult()
{}

UpdateFlowRuleResult::UpdateFlowRuleResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateFlowRuleResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string UpdateFlowRuleResult::getMessage()const
{
	return message_;
}

UpdateFlowRuleResult::Data UpdateFlowRuleResult::getData()const
{
	return data_;
}

std::string UpdateFlowRuleResult::getCode()const
{
	return code_;
}

bool UpdateFlowRuleResult::getSuccess()const
{
	return success_;
}
