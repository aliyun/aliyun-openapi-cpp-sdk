...
std::string UpdateGatewayServiceVersionRequest::getMseSessionId() const {
  return mseSessionId_;
}

void UpdateGatewayServiceVersionRequest::setMseSessionId(const std::string &mseSessionId) {
