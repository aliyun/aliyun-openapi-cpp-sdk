...
using AlibabaCloud::Mse::Model::ListClusterTypesRequest;

ListClusterTypesRequest::ListClusterTypesRequest()
    : RpcServiceRequest("mse", "2019-05-31", "ListClusterTypes") {
...
void ListClusterTypesRequest::setAcceptLanguage(const std::string &acceptLanguage) {
