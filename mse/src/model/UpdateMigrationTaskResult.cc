...
#include <alibabacloud/mse/model/UpdateMigrationTaskResult.h>
#include <json/json.h>

using namespace AlibabaCloud::Mse;
using namespace AlibabaCloud::Mse::Model;

UpdateMigrationTaskResult::UpdateMigrationTaskResult() :
	ServiceResult()
{}

UpdateMigrationTaskResult::UpdateMigrationTaskResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateMigrationTaskResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string UpdateMigrationTaskResult::getHttpCode()const
{
	return httpCode_;
}

std::string UpdateMigrationTaskResult::getMessage()const
{
	return message_;
}

UpdateMigrationTaskResult::Data UpdateMigrationTaskResult::getData()const
{
	return data_;
}

std::string UpdateMigrationTaskResult::getErrorCode()const
{
	return errorCode_;
}

bool UpdateMigrationTaskResult::getSuccess()const
{
	return success_;
}
