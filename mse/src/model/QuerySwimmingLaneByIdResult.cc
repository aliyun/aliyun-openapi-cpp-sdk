...
std::string QuerySwimmingLaneByIdResult::getMessage()const
{
	return message_;
}

int QuerySwimmingLaneByIdResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

QuerySwimmingLaneByIdResult::Data QuerySwimmingLaneByIdResult::getData()const
{
	return data_;
}

std::string QuerySwimmingLaneByIdResult::getErrorCode()const
{
	return errorCode_;
}

int QuerySwimmingLaneByIdResult::getCode()const
{
	return code_;
}

bool QuerySwimmingLaneByIdResult::getSuccess()const
{
	return success_;
}
