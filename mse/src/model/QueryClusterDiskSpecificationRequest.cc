...
using AlibabaCloud::Mse::Model::QueryClusterDiskSpecificationRequest;

QueryClusterDiskSpecificationRequest::QueryClusterDiskSpecificationRequest()
    : RpcServiceRequest("mse", "2019-05-31", "QueryClusterDiskSpecification") {
...
void QueryClusterDiskSpecificationRequest::setClusterType(const std::string &clusterType) {
  clusterType_ = clusterType;
  setParameter(std::string("ClusterType"), clusterType);
}

std::string QueryClusterDiskSpecificationRequest::getAcceptLanguage() const {
  return acceptLanguage_;
}

void QueryClusterDiskSpecificationRequest::setAcceptLanguage(const std::string &acceptLanguage) {
