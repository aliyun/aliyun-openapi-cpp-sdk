...
#include <alibabacloud/mse/model/QueryClusterInfoResult.h>
#include <json/json.h>

using namespace AlibabaCloud::Mse;
using namespace AlibabaCloud::Mse::Model;

QueryClusterInfoResult::QueryClusterInfoResult() :
	ServiceResult()
{}

QueryClusterInfoResult::QueryClusterInfoResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryClusterInfoResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string QueryClusterInfoResult::getMessage()const
{
	return message_;
}

QueryClusterInfoResult::Data QueryClusterInfoResult::getData()const
{
	return data_;
}

std::string QueryClusterInfoResult::getErrorCode()const
{
	return errorCode_;
}

bool QueryClusterInfoResult::getSuccess()const
{
	return success_;
}
