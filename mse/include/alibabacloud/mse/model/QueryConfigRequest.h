...
#ifndef ALIBABACLOUD_MSE_MODEL_QUERYCONFIGREQUEST_H_
#define ALIBABACLOUD_MSE_MODEL_QUERYCONFIGREQUEST_H_
...
namespace Mse {
namespace Model {
class ALIBABACLOUD_MSE_EXPORT QueryConfigRequest : public RpcServiceRequest {
public:
	QueryConfigRequest();
	~QueryConfigRequest();
...
#endif // !ALIBABACLOUD_MSE_MODEL_QUERYCONFIGREQUEST_H_
