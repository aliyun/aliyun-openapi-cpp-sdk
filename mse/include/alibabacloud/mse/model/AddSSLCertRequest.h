...
#ifndef ALIBABACLOUD_MSE_MODEL_ADDSSLCERTREQUEST_H_
#define ALIBABACLOUD_MSE_MODEL_ADDSSLCERTREQUEST_H_
...
namespace Mse {
namespace Model {
class ALIBABACLOUD_MSE_EXPORT AddSSLCertRequest : public RpcServiceRequest {
public:
	AddSSLCertRequest();
	~AddSSLCertRequest();
...
#endif // !ALIBABACLOUD_MSE_MODEL_ADDSSLCERTREQUEST_H_
