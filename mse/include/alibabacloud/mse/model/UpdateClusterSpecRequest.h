...
#ifndef ALIBABACLOUD_MSE_MODEL_UPDATECLUSTERSPECREQUEST_H_
#define ALIBABACLOUD_MSE_MODEL_UPDATECLUSTERSPECREQUEST_H_
...
namespace Mse {
namespace Model {
class ALIBABACLOUD_MSE_EXPORT UpdateClusterSpecRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_MSE_MODEL_UPDATECLUSTERSPECREQUEST_H_
