...
#ifndef ALIBABACLOUD_MSE_MODEL_UPDATESSLCERTREQUEST_H_
...
namespace Mse {
namespace Model {
class ALIBABACLOUD_MSE_EXPORT UpdateSSLCertRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_MSE_MODEL_UPDATESSLCERTREQUEST_H_
