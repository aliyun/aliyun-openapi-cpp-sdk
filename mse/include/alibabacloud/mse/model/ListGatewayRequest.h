...
#ifndef ALIBABACLOUD_MSE_MODEL_LISTGATEWAYREQUEST_H_
#define ALIBABACLOUD_MSE_MODEL_LISTGATEWAYREQUEST_H_
...
namespace Mse {
namespace Model {
class ALIBABACLOUD_MSE_EXPORT ListGatewayRequest : public RpcServiceRequest {
public:
	struct FilterParams {
...
#endif // !ALIBABACLOUD_MSE_MODEL_LISTGATEWAYREQUEST_H_
