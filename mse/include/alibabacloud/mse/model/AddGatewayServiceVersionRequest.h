...
#ifndef ALIBABACLOUD_MSE_MODEL_ADDGATEWAYSERVICEVERSIONREQUEST_H_
...
namespace Mse {
namespace Model {
class ALIBABACLOUD_MSE_EXPORT AddGatewayServiceVersionRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_MSE_MODEL_ADDGATEWAYSERVICEVERSIONREQUEST_H_
