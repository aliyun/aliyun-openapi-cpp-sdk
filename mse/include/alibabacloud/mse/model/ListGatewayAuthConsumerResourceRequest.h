...
#ifndef ALIBABACLOUD_MSE_MODEL_LISTGATEWAYAUTHCONSUMERRESOURCEREQUEST_H_
...
namespace Mse {
namespace Model {
class ALIBABACLOUD_MSE_EXPORT ListGatewayAuthConsumerResourceRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_MSE_MODEL_LISTGATEWAYAUTHCONSUMERRESOURCEREQUEST_H_
