...
#ifndef ALIBABACLOUD_MSE_MODEL_QUERYCLUSTERDETAILRESULT_H_
#define ALIBABACLOUD_MSE_MODEL_QUERYCLUSTERDETAILRESULT_H_
...
namespace AlibabaCloud
{
	namespace Mse
	{
		namespace Model
		{
			class ALIBABACLOUD_MSE_EXPORT QueryClusterDetailResult : public ServiceResult
			{
			public:
				struct Data
				{
...
#endif // !ALIBABACLOUD_MSE_MODEL_QUERYCLUSTERDETAILRESULT_H_