...
#ifndef ALIBABACLOUD_MSE_MODEL_UPDATEGATEWAYAUTHCONSUMERRESOURCEREQUEST_H_
#define ALIBABACLOUD_MSE_MODEL_UPDATEGATEWAYAUTHCONSUMERRESOURCEREQUEST_H_
...
namespace Mse {
namespace Model {
class ALIBABACLOUD_MSE_EXPORT UpdateGatewayAuthConsumerResourceRequest : public RpcServiceRequest {
public:
	struct ResourceList {
		long routeId;
...
#endif // !ALIBABACLOUD_MSE_MODEL_UPDATEGATEWAYAUTHCONSUMERRESOURCEREQUEST_H_
