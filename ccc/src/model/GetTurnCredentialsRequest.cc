...
GetTurnCredentialsRequest::GetTurnCredentialsRequest()
    : RpcServiceRequest("ccc", "2020-07-01", "GetTurnCredentials") {
  setMethod(HttpRequest::Method::Post);
}

GetTurnCredentialsRequest::~GetTurnCredentialsRequest() {}

std::string GetTurnCredentialsRequest::getUserId() const {
  return userId_;
}

void GetTurnCredentialsRequest::setUserId(const std::string &userId) {
  userId_ = userId;
