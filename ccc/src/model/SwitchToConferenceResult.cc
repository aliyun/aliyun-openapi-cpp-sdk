...
#include <alibabacloud/ccc/model/SwitchToConferenceResult.h>
#include <json/json.h>

using namespace AlibabaCloud::CCC;
using namespace AlibabaCloud::CCC::Model;

SwitchToConferenceResult::SwitchToConferenceResult() :
	ServiceResult()
{}

SwitchToConferenceResult::SwitchToConferenceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void SwitchToConferenceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string SwitchToConferenceResult::getMessage()const
{
	return message_;
}

int SwitchToConferenceResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> SwitchToConferenceResult::getParams()const
{
	return params_;
}

SwitchToConferenceResult::Data SwitchToConferenceResult::getData()const
{
	return data_;
}

std::string SwitchToConferenceResult::getCode()const
{
	return code_;
}
