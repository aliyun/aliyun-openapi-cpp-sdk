...
PollUserStatusResult::PollUserStatusResult() :
	ServiceResult()
{}

PollUserStatusResult::PollUserStatusResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void PollUserStatusResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string PollUserStatusResult::getMessage()const
{
	return message_;
}

int PollUserStatusResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> PollUserStatusResult::getParams()const
{
	return params_;
}

PollUserStatusResult::Data PollUserStatusResult::getData()const
{
	return data_;
}

std::string PollUserStatusResult::getCode()const
{
	return code_;
}
