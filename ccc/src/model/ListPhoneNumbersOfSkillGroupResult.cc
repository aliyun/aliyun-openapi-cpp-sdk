...
ListPhoneNumbersOfSkillGroupResult::ListPhoneNumbersOfSkillGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListPhoneNumbersOfSkillGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string ListPhoneNumbersOfSkillGroupResult::getMessage()const
{
	return message_;
}

int ListPhoneNumbersOfSkillGroupResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

ListPhoneNumbersOfSkillGroupResult::Data ListPhoneNumbersOfSkillGroupResult::getData()const
{
	return data_;
}

std::string ListPhoneNumbersOfSkillGroupResult::getCode()const
{
	return code_;
}
