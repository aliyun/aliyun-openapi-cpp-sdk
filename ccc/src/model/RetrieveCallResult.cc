...
RetrieveCallResult::RetrieveCallResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RetrieveCallResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string RetrieveCallResult::getMessage()const
{
	return message_;
}

int RetrieveCallResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> RetrieveCallResult::getParams()const
{
	return params_;
}

RetrieveCallResult::Data RetrieveCallResult::getData()const
{
	return data_;
}

std::string RetrieveCallResult::getCode()const
{
	return code_;
}
