...
ResetAgentStateResult::ResetAgentStateResult() :
	ServiceResult()
{}

ResetAgentStateResult::ResetAgentStateResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ResetAgentStateResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string ResetAgentStateResult::getMessage()const
{
	return message_;
}

int ResetAgentStateResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> ResetAgentStateResult::getParams()const
{
	return params_;
}

ResetAgentStateResult::Data ResetAgentStateResult::getData()const
{
	return data_;
}

std::string ResetAgentStateResult::getCode()const
{
	return code_;
}
