...
ListBriefSkillGroupsResult::ListBriefSkillGroupsResult() :
	ServiceResult()
{}

ListBriefSkillGroupsResult::ListBriefSkillGroupsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListBriefSkillGroupsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string ListBriefSkillGroupsResult::getMessage()const
{
	return message_;
}

int ListBriefSkillGroupsResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

ListBriefSkillGroupsResult::Data ListBriefSkillGroupsResult::getData()const
{
	return data_;
}

std::string ListBriefSkillGroupsResult::getCode()const
{
	return code_;
}
