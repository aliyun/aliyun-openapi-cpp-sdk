...
ReadyForServiceResult::ReadyForServiceResult() :
	ServiceResult()
{}

ReadyForServiceResult::ReadyForServiceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ReadyForServiceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string ReadyForServiceResult::getMessage()const
{
	return message_;
}

int ReadyForServiceResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> ReadyForServiceResult::getParams()const
{
	return params_;
}

ReadyForServiceResult::Data ReadyForServiceResult::getData()const
{
	return data_;
}

std::string ReadyForServiceResult::getCode()const
{
	return code_;
}
