...
InterceptCallResult::InterceptCallResult() :
	ServiceResult()
{}

InterceptCallResult::InterceptCallResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void InterceptCallResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string InterceptCallResult::getMessage()const
{
	return message_;
}

int InterceptCallResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> InterceptCallResult::getParams()const
{
	return params_;
}

InterceptCallResult::Data InterceptCallResult::getData()const
{
	return data_;
}

std::string InterceptCallResult::getCode()const
{
	return code_;
}
