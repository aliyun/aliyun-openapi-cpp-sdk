...
ModifySurveyResult::ModifySurveyResult() :
	ServiceResult()
{}

ModifySurveyResult::ModifySurveyResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ModifySurveyResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
ModifySurveyResult::Survey ModifySurveyResult::getSurvey()const
{
	return survey_;
}

std::string ModifySurveyResult::getMessage()const
{
	return message_;
}

int ModifySurveyResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::string ModifySurveyResult::getCode()const
{
	return code_;
}

bool ModifySurveyResult::getSuccess()const
{
	return success_;
}
