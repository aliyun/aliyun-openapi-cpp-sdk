...
GetInstanceSummaryReportResult::GetInstanceSummaryReportResult() :
	ServiceResult()
{}

GetInstanceSummaryReportResult::GetInstanceSummaryReportResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetInstanceSummaryReportResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetInstanceSummaryReportResult::getMessage()const
{
	return message_;
}

int GetInstanceSummaryReportResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

GetInstanceSummaryReportResult::InstanceSummaryReport GetInstanceSummaryReportResult::getInstanceSummaryReport()const
{
	return instanceSummaryReport_;
}

std::string GetInstanceSummaryReportResult::getCode()const
{
	return code_;
}

bool GetInstanceSummaryReportResult::getSuccess()const
{
	return success_;
}
