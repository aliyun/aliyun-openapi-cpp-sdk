...
SignInGroupResult::SignInGroupResult() :
	ServiceResult()
{}

SignInGroupResult::SignInGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void SignInGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string SignInGroupResult::getMessage()const
{
	return message_;
}

int SignInGroupResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> SignInGroupResult::getParams()const
{
	return params_;
}

SignInGroupResult::Data SignInGroupResult::getData()const
{
	return data_;
}

std::string SignInGroupResult::getCode()const
{
	return code_;
}
