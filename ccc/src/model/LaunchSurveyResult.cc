...
LaunchSurveyResult::LaunchSurveyResult() :
	ServiceResult()
{}

LaunchSurveyResult::LaunchSurveyResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void LaunchSurveyResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string LaunchSurveyResult::getMessage()const
{
	return message_;
}

int LaunchSurveyResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> LaunchSurveyResult::getParams()const
{
	return params_;
}

LaunchSurveyResult::Data LaunchSurveyResult::getData()const
{
	return data_;
}

std::string LaunchSurveyResult::getCode()const
{
	return code_;
}
