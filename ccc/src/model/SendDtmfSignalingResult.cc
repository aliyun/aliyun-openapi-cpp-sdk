...
SendDtmfSignalingResult::SendDtmfSignalingResult() :
	ServiceResult()
{}

SendDtmfSignalingResult::SendDtmfSignalingResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void SendDtmfSignalingResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string SendDtmfSignalingResult::getMessage()const
{
	return message_;
}

int SendDtmfSignalingResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> SendDtmfSignalingResult::getParams()const
{
	return params_;
}

SendDtmfSignalingResult::Data SendDtmfSignalingResult::getData()const
{
	return data_;
}

std::string SendDtmfSignalingResult::getCode()const
{
	return code_;
}
