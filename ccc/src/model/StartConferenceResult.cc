...
#include <alibabacloud/ccc/model/StartConferenceResult.h>
#include <json/json.h>

using namespace AlibabaCloud::CCC;
using namespace AlibabaCloud::CCC::Model;

StartConferenceResult::StartConferenceResult() :
	ServiceResult()
{}

StartConferenceResult::StartConferenceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void StartConferenceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string StartConferenceResult::getMessage()const
{
	return message_;
}

int StartConferenceResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> StartConferenceResult::getParams()const
{
	return params_;
}

StartConferenceResult::Data StartConferenceResult::getData()const
{
	return data_;
}

std::string StartConferenceResult::getCode()const
{
	return code_;
}
