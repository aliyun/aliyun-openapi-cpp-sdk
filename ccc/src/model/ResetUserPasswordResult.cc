...
std::string ResetUserPasswordResult::getMessage()const
{
	return message_;
}

int ResetUserPasswordResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::string ResetUserPasswordResult::getCode()const
{
	return code_;
}
