...
using AlibabaCloud::CCC::Model::GetTurnServerListRequest;

GetTurnServerListRequest::GetTurnServerListRequest()
    : RpcServiceRequest("ccc", "2020-07-01", "GetTurnServerList") {
  setMethod(HttpRequest::Method::Post);
}

GetTurnServerListRequest::~GetTurnServerListRequest() {}

std::string GetTurnServerListRequest::getInstanceId() const {
  return instanceId_;
}
