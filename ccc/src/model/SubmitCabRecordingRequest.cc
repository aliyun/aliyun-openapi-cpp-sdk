...
std::string SubmitCabRecordingRequest::getEarlyMediaRecording()const
{
	return earlyMediaRecording_;
}

void SubmitCabRecordingRequest::setEarlyMediaRecording(const std::string& earlyMediaRecording)
{
	earlyMediaRecording_ = earlyMediaRecording;
	setParameter("EarlyMediaRecording", earlyMediaRecording);
}
