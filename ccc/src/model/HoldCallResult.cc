...
HoldCallResult::HoldCallResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void HoldCallResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string HoldCallResult::getMessage()const
{
	return message_;
}

int HoldCallResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> HoldCallResult::getParams()const
{
	return params_;
}

HoldCallResult::Data HoldCallResult::getData()const
{
	return data_;
}

std::string HoldCallResult::getCode()const
{
	return code_;
}
