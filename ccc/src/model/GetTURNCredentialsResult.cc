...
std::string GetTURNCredentialsResult::getUsername()const
{
	return username_;
}
...
bool GetTURNCredentialsResult::getSuccess()const
{
	return success_;
}

std::string GetTURNCredentialsResult::getPassword()const
{
	return password_;
}
