...
LaunchAuthenticationResult::LaunchAuthenticationResult() :
	ServiceResult()
{}

LaunchAuthenticationResult::LaunchAuthenticationResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void LaunchAuthenticationResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string LaunchAuthenticationResult::getMessage()const
{
	return message_;
}

int LaunchAuthenticationResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> LaunchAuthenticationResult::getParams()const
{
	return params_;
}

LaunchAuthenticationResult::Data LaunchAuthenticationResult::getData()const
{
	return data_;
}

std::string LaunchAuthenticationResult::getCode()const
{
	return code_;
}
