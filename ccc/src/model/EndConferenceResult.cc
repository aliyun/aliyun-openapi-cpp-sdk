...
#include <alibabacloud/ccc/model/EndConferenceResult.h>
#include <json/json.h>

using namespace AlibabaCloud::CCC;
using namespace AlibabaCloud::CCC::Model;

EndConferenceResult::EndConferenceResult() :
	ServiceResult()
{}

EndConferenceResult::EndConferenceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void EndConferenceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string EndConferenceResult::getMessage()const
{
	return message_;
}

int EndConferenceResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> EndConferenceResult::getParams()const
{
	return params_;
}

EndConferenceResult::Data EndConferenceResult::getData()const
{
	return data_;
}

std::string EndConferenceResult::getCode()const
{
	return code_;
}
