...
#include <alibabacloud/ccc/model/RedialCallResult.h>
#include <json/json.h>

using namespace AlibabaCloud::CCC;
using namespace AlibabaCloud::CCC::Model;

RedialCallResult::RedialCallResult() :
	ServiceResult()
{}

RedialCallResult::RedialCallResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RedialCallResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string RedialCallResult::getMessage()const
{
	return message_;
}

int RedialCallResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> RedialCallResult::getParams()const
{
	return params_;
}

RedialCallResult::Data RedialCallResult::getData()const
{
	return data_;
}

std::string RedialCallResult::getCode()const
{
	return code_;
}
