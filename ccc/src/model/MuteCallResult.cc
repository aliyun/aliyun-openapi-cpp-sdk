...
MuteCallResult::MuteCallResult() :
	ServiceResult()
{}

MuteCallResult::MuteCallResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void MuteCallResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string MuteCallResult::getMessage()const
{
	return message_;
}

int MuteCallResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> MuteCallResult::getParams()const
{
	return params_;
}

MuteCallResult::Data MuteCallResult::getData()const
{
	return data_;
}

std::string MuteCallResult::getCode()const
{
	return code_;
}
