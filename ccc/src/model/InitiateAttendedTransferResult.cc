...
InitiateAttendedTransferResult::InitiateAttendedTransferResult() :
	ServiceResult()
{}

InitiateAttendedTransferResult::InitiateAttendedTransferResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void InitiateAttendedTransferResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string InitiateAttendedTransferResult::getMessage()const
{
	return message_;
}

int InitiateAttendedTransferResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> InitiateAttendedTransferResult::getParams()const
{
	return params_;
}

InitiateAttendedTransferResult::Data InitiateAttendedTransferResult::getData()const
{
	return data_;
}

std::string InitiateAttendedTransferResult::getCode()const
{
	return code_;
}
