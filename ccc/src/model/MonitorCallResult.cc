...
MonitorCallResult::MonitorCallResult() :
	ServiceResult()
{}

MonitorCallResult::MonitorCallResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void MonitorCallResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string MonitorCallResult::getMessage()const
{
	return message_;
}

int MonitorCallResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::vector<std::string> MonitorCallResult::getParams()const
{
	return params_;
}

MonitorCallResult::Data MonitorCallResult::getData()const
{
	return data_;
}

std::string MonitorCallResult::getCode()const
{
	return code_;
}
