...
#ifndef ALIBABACLOUD_CCC_MODEL_SUSPENDPREDICTIVEJOBSREQUEST_H_
#define ALIBABACLOUD_CCC_MODEL_SUSPENDPREDICTIVEJOBSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT SuspendPredictiveJobsRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CCC_MODEL_SUSPENDPREDICTIVEJOBSREQUEST_H_