...
#ifndef ALIBABACLOUD_CCC_MODEL_GETROUTEPOINTREQUEST_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT GetRoutePointRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CCC_MODEL_GETROUTEPOINTREQUEST_H_