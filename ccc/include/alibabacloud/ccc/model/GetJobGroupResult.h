...
#ifndef ALIBABACLOUD_CCC_MODEL_GETJOBGROUPRESULT_H_
#define ALIBABACLOUD_CCC_MODEL_GETJOBGROUPRESULT_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT GetJobGroupResult : public ServiceResult
			{
			public:
				struct JobGroup
				{
				...
				GetJobGroupResult();
				explicit GetJobGroupResult(const std::string &payload);
				~GetJobGroupResult();
...
#endif // !ALIBABACLOUD_CCC_MODEL_GETJOBGROUPRESULT_H_