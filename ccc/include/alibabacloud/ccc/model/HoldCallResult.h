...
#ifndef ALIBABACLOUD_CCC_MODEL_HOLDCALLRESULT_H_
#define ALIBABACLOUD_CCC_MODEL_HOLDCALLRESULT_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT HoldCallResult : public ServiceResult
			{
			public:
				struct Data
				{
...
#endif // !ALIBABACLOUD_CCC_MODEL_HOLDCALLRESULT_H_