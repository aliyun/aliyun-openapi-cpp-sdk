...
#ifndef ALIBABACLOUD_CCC_MODEL_MODIFYSCENARIORESULT_H_
#define ALIBABACLOUD_CCC_MODEL_MODIFYSCENARIORESULT_H_
...
namespace CCC {
namespace Model {
class ALIBABACLOUD_CCC_EXPORT ModifyScenarioResult : public ServiceResult {
public:
  struct Scenario {
    struct Strategy {
      struct TimeFrame {
  ...
  ModifyScenarioResult();
  explicit ModifyScenarioResult(const std::string &payload);
  ~ModifyScenarioResult();
...
#endif // !ALIBABACLOUD_CCC_MODEL_MODIFYSCENARIORESULT_H_