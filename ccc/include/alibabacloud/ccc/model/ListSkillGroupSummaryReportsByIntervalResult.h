...
namespace CCC {
namespace Model {
class ALIBABACLOUD_CCC_EXPORT ListSkillGroupSummaryReportsByIntervalResult
...
public:
  struct PagedSkillGroupSummaryReport {
    struct SkillGroupTimeIntervalReport {
      ...
      std::vector<SkillGroupTimeIntervalReport::SkillGroupSummaryReport>
          intervalList;
      std::string skillGroupId;
    };
    int totalCount;
  ...
  explicit ListSkillGroupSummaryReportsByIntervalResult(
