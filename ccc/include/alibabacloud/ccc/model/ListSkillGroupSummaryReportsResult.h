...
#ifndef ALIBABACLOUD_CCC_MODEL_LISTSKILLGROUPSUMMARYREPORTSRESULT_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT ListSkillGroupSummaryReportsResult : public ServiceResult
			{
			public:
				...
				ListSkillGroupSummaryReportsResult();
				explicit ListSkillGroupSummaryReportsResult(const std::string &payload);
				~ListSkillGroupSummaryReportsResult();
...
#endif // !ALIBABACLOUD_CCC_MODEL_LISTSKILLGROUPSUMMARYREPORTSRESULT_H_