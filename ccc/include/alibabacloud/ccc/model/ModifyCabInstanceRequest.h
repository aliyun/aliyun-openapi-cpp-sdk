...
#ifndef ALIBABACLOUD_CCC_MODEL_MODIFYCABINSTANCEREQUEST_H_
#define ALIBABACLOUD_CCC_MODEL_MODIFYCABINSTANCEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT ModifyCabInstanceRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CCC_MODEL_MODIFYCABINSTANCEREQUEST_H_