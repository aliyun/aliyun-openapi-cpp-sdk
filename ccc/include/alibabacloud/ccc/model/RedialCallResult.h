...
#ifndef ALIBABACLOUD_CCC_MODEL_REDIALCALLRESULT_H_
#define ALIBABACLOUD_CCC_MODEL_REDIALCALLRESULT_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT RedialCallResult : public ServiceResult
			{
			public:
				struct Data
				{
				...
				RedialCallResult();
				explicit RedialCallResult(const std::string &payload);
				~RedialCallResult();
...
#endif // !ALIBABACLOUD_CCC_MODEL_REDIALCALLRESULT_H_