...
#ifndef ALIBABACLOUD_CCC_MODEL_LISTJOBSBYGROUPREQUEST_H_
#define ALIBABACLOUD_CCC_MODEL_LISTJOBSBYGROUPREQUEST_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT ListJobsByGroupRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CCC_MODEL_LISTJOBSBYGROUPREQUEST_H_