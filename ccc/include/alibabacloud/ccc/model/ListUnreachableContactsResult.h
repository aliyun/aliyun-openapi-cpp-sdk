...
#ifndef ALIBABACLOUD_CCC_MODEL_LISTUNREACHABLECONTACTSRESULT_H_
#define ALIBABACLOUD_CCC_MODEL_LISTUNREACHABLECONTACTSRESULT_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT ListUnreachableContactsResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_CCC_MODEL_LISTUNREACHABLECONTACTSRESULT_H_