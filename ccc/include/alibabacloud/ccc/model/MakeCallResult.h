...
#ifndef ALIBABACLOUD_CCC_MODEL_MAKECALLRESULT_H_
#define ALIBABACLOUD_CCC_MODEL_MAKECALLRESULT_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT MakeCallResult : public ServiceResult
			{
			public:
				struct Data
				{
				...
				MakeCallResult();
				explicit MakeCallResult(const std::string &payload);
				~MakeCallResult();
...
#endif // !ALIBABACLOUD_CCC_MODEL_MAKECALLRESULT_H_