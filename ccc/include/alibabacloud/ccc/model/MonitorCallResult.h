...
#ifndef ALIBABACLOUD_CCC_MODEL_MONITORCALLRESULT_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT MonitorCallResult : public ServiceResult
			{
			public:
				struct Data
				{
				...
				MonitorCallResult();
				explicit MonitorCallResult(const std::string &payload);
				~MonitorCallResult();
...
#endif // !ALIBABACLOUD_CCC_MODEL_MONITORCALLRESULT_H_