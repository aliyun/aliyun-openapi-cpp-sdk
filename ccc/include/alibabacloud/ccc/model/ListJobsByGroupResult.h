...
#ifndef ALIBABACLOUD_CCC_MODEL_LISTJOBSBYGROUPRESULT_H_
#define ALIBABACLOUD_CCC_MODEL_LISTJOBSBYGROUPRESULT_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT ListJobsByGroupResult : public ServiceResult
			{
			public:
				struct Jobs
				{
...
#endif // !ALIBABACLOUD_CCC_MODEL_LISTJOBSBYGROUPRESULT_H_