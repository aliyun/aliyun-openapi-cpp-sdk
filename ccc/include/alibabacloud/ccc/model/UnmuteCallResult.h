...
#ifndef ALIBABACLOUD_CCC_MODEL_UNMUTECALLRESULT_H_
#define ALIBABACLOUD_CCC_MODEL_UNMUTECALLRESULT_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT UnmuteCallResult : public ServiceResult
			{
			public:
				struct Data
				{
				...
				UnmuteCallResult();
				explicit UnmuteCallResult(const std::string &payload);
				~UnmuteCallResult();
...
#endif // !ALIBABACLOUD_CCC_MODEL_UNMUTECALLRESULT_H_