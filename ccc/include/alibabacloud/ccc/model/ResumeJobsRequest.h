...
#ifndef ALIBABACLOUD_CCC_MODEL_RESUMEJOBSREQUEST_H_
#define ALIBABACLOUD_CCC_MODEL_RESUMEJOBSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT ResumeJobsRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CCC_MODEL_RESUMEJOBSREQUEST_H_