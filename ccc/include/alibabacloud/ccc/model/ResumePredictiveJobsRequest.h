...
#ifndef ALIBABACLOUD_CCC_MODEL_RESUMEPREDICTIVEJOBSREQUEST_H_
#define ALIBABACLOUD_CCC_MODEL_RESUMEPREDICTIVEJOBSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT ResumePredictiveJobsRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CCC_MODEL_RESUMEPREDICTIVEJOBSREQUEST_H_