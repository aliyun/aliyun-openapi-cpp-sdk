...
#ifndef ALIBABACLOUD_CCC_MODEL_PICKLOCALNUMBERREQUEST_H_
#define ALIBABACLOUD_CCC_MODEL_PICKLOCALNUMBERREQUEST_H_
...
namespace AlibabaCloud
{
	namespace CCC
	{
		namespace Model
		{
			class ALIBABACLOUD_CCC_EXPORT PickLocalNumberRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CCC_MODEL_PICKLOCALNUMBERREQUEST_H_