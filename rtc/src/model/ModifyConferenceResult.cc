...
ModifyConferenceResult::ModifyConferenceResult() :
	ServiceResult()
{}

ModifyConferenceResult::ModifyConferenceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
std::string ModifyConferenceResult::getConferenceId()const
{
