...
CreateConferenceResult::CreateConferenceResult() :
	ServiceResult()
{}

CreateConferenceResult::CreateConferenceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
CreateConferenceResult::AuthInfo CreateConferenceResult::getAuthInfo()const
{
	return authInfo_;
}

std::string CreateConferenceResult::getConferenceId()const
{
