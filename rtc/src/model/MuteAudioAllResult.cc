...
MuteAudioAllResult::MuteAudioAllResult() :
	ServiceResult()
{}

MuteAudioAllResult::MuteAudioAllResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
std::string MuteAudioAllResult::getConferenceId()const
{
	return conferenceId_;
}

std::vector<MuteAudioAllResult::Participant> MuteAudioAllResult::getParticipants()const
{
