...
using AlibabaCloud::Qualitycheck::Model::UpdateUserRequest;

UpdateUserRequest::UpdateUserRequest()
    : RpcServiceRequest("qualitycheck", "2019-01-15", "UpdateUser") {
...
std::string UpdateUserRequest::getJsonStr() const {
  return jsonStr_;
}

void UpdateUserRequest::setJsonStr(const std::string &jsonStr) {
  jsonStr_ = jsonStr;
