...
using AlibabaCloud::Qualitycheck::Model::ListUsersRequest;

ListUsersRequest::ListUsersRequest()
    : RpcServiceRequest("qualitycheck", "2019-01-15", "ListUsers") {
...
std::string ListUsersRequest::getJsonStr() const {
  return jsonStr_;
}

void ListUsersRequest::setJsonStr(const std::string &jsonStr) {
  jsonStr_ = jsonStr;
