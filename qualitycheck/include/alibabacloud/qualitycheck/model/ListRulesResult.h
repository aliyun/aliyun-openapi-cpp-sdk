...
#ifndef ALIBABACLOUD_QUALITYCHECK_MODEL_LISTRULESRESULT_H_
...
namespace AlibabaCloud
{
	namespace Qualitycheck
	{
		namespace Model
		{
			class ALIBABACLOUD_QUALITYCHECK_EXPORT ListRulesResult : public ServiceResult
			{
			public:
				struct Rule
				{
...
#endif // !ALIBABACLOUD_QUALITYCHECK_MODEL_LISTRULESRESULT_H_