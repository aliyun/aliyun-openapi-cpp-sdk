...
#ifndef ALIBABACLOUD_OCEANBASEPRO_MODEL_DESCRIBETOPSQLLISTREQUEST_H_
#define ALIBABACLOUD_OCEANBASEPRO_MODEL_DESCRIBETOPSQLLISTREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_OCEANBASEPRO_EXPORT DescribeTopSQLListRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_OCEANBASEPRO_MODEL_DESCRIBETOPSQLLISTREQUEST_H_
