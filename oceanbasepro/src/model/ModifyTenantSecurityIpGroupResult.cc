...
ModifyTenantSecurityIpGroupResult::ModifyTenantSecurityIpGroupResult() :
	ServiceResult()
{}

ModifyTenantSecurityIpGroupResult::ModifyTenantSecurityIpGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ModifyTenantSecurityIpGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	if(!securityIpGroupNode["SecurityIps"].isNull())
		securityIpGroup_.securityIps = securityIpGroupNode["SecurityIps"].asString();

}

ModifyTenantSecurityIpGroupResult::SecurityIpGroup ModifyTenantSecurityIpGroupResult::getSecurityIpGroup()const
{
