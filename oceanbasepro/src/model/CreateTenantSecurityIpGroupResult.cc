...
CreateTenantSecurityIpGroupResult::CreateTenantSecurityIpGroupResult() :
	ServiceResult()
{}

CreateTenantSecurityIpGroupResult::CreateTenantSecurityIpGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CreateTenantSecurityIpGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
CreateTenantSecurityIpGroupResult::SecurityIpGroup CreateTenantSecurityIpGroupResult::getSecurityIpGroup()const
{
