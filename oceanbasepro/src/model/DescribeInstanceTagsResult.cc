...
DescribeInstanceTagsResult::DescribeInstanceTagsResult() :
	ServiceResult()
{}

DescribeInstanceTagsResult::DescribeInstanceTagsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeInstanceTagsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeInstanceTagsResult::TagResourcesItem> DescribeInstanceTagsResult::getTagResources()const
{
