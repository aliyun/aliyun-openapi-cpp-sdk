...
DeleteSecurityIpGroupResult::DeleteSecurityIpGroupResult() :
	ServiceResult()
{}

DeleteSecurityIpGroupResult::DeleteSecurityIpGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DeleteSecurityIpGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
DeleteSecurityIpGroupResult::SecurityIpGroup DeleteSecurityIpGroupResult::getSecurityIpGroup()const
{
