...
using AlibabaCloud::OceanBasePro::Model::DescribeTenantUserRolesRequest;

DescribeTenantUserRolesRequest::DescribeTenantUserRolesRequest()
    : RpcServiceRequest("oceanbasepro", "2019-09-01", "DescribeTenantUserRoles") {
...
void DescribeTenantUserRolesRequest::setTenantId(const std::string &tenantId) {
  tenantId_ = tenantId;
