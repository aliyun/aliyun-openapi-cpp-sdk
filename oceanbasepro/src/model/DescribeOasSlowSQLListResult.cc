...
DescribeOasSlowSQLListResult::DescribeOasSlowSQLListResult() :
	ServiceResult()
{}

DescribeOasSlowSQLListResult::DescribeOasSlowSQLListResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
std::vector<DescribeOasSlowSQLListResult::DataItem> DescribeOasSlowSQLListResult::getData()const
{
	return data_;
}
