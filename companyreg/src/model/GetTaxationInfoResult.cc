...
GetTaxationInfoResult::GetTaxationInfoResult() :
	ServiceResult()
{}

GetTaxationInfoResult::GetTaxationInfoResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetTaxationInfoResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<GetTaxationInfoResult::TaxItemDetailListItem> GetTaxationInfoResult::getTaxItemDetailList()const
{
	return taxItemDetailList_;
}

std::string GetTaxationInfoResult::getDeclareProcessType()const
{
