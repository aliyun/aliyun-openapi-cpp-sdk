...
#ifndef ALIBABACLOUD_COMPANYREG_MODEL_UPDATECUSTOMERINFORESULT_H_
#define ALIBABACLOUD_COMPANYREG_MODEL_UPDATECUSTOMERINFORESULT_H_
...
namespace AlibabaCloud
{
	namespace Companyreg
	{
		namespace Model
		{
			class ALIBABACLOUD_COMPANYREG_EXPORT UpdateCustomerInfoResult : public ServiceResult
			{
			public:


				UpdateCustomerInfoResult();
				explicit UpdateCustomerInfoResult(const std::string &payload);
				~UpdateCustomerInfoResult();
...
#endif // !ALIBABACLOUD_COMPANYREG_MODEL_UPDATECUSTOMERINFORESULT_H_