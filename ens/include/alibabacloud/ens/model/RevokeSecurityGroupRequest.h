...
#ifndef ALIBABACLOUD_ENS_MODEL_REVOKESECURITYGROUPREQUEST_H_
#define ALIBABACLOUD_ENS_MODEL_REVOKESECURITYGROUPREQUEST_H_
...
namespace Ens {
namespace Model {
class ALIBABACLOUD_ENS_EXPORT RevokeSecurityGroupRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ENS_MODEL_REVOKESECURITYGROUPREQUEST_H_
