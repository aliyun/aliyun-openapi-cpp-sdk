...
#ifndef ALIBABACLOUD_ENS_MODEL_MODIFYEPNINSTANCEREQUEST_H_
...
namespace Ens {
namespace Model {
class ALIBABACLOUD_ENS_EXPORT ModifyEpnInstanceRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ENS_MODEL_MODIFYEPNINSTANCEREQUEST_H_
