...
#ifndef ALIBABACLOUD_ENS_MODEL_SETLOADBALANCERUDPLISTENERATTRIBUTEREQUEST_H_
#define ALIBABACLOUD_ENS_MODEL_SETLOADBALANCERUDPLISTENERATTRIBUTEREQUEST_H_
...
namespace Ens {
namespace Model {
class ALIBABACLOUD_ENS_EXPORT SetLoadBalancerUDPListenerAttributeRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ENS_MODEL_SETLOADBALANCERUDPLISTENERATTRIBUTEREQUEST_H_
