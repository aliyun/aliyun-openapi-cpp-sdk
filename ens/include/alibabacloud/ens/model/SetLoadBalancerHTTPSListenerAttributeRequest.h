...
#ifndef ALIBABACLOUD_ENS_MODEL_SETLOADBALANCERHTTPSLISTENERATTRIBUTEREQUEST_H_
#define ALIBABACLOUD_ENS_MODEL_SETLOADBALANCERHTTPSLISTENERATTRIBUTEREQUEST_H_
...
namespace Ens {
namespace Model {
class ALIBABACLOUD_ENS_EXPORT SetLoadBalancerHTTPSListenerAttributeRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ENS_MODEL_SETLOADBALANCERHTTPSLISTENERATTRIBUTEREQUEST_H_
