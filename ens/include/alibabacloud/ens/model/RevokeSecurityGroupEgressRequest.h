...
#ifndef ALIBABACLOUD_ENS_MODEL_REVOKESECURITYGROUPEGRESSREQUEST_H_
...
namespace Ens {
namespace Model {
class ALIBABACLOUD_ENS_EXPORT RevokeSecurityGroupEgressRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ENS_MODEL_REVOKESECURITYGROUPEGRESSREQUEST_H_
