...
#ifndef ALIBABACLOUD_ENS_MODEL_STARTEPNINSTANCEREQUEST_H_
...
namespace Ens {
namespace Model {
class ALIBABACLOUD_ENS_EXPORT StartEpnInstanceRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ENS_MODEL_STARTEPNINSTANCEREQUEST_H_
