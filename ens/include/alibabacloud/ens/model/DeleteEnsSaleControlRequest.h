...
#ifndef ALIBABACLOUD_ENS_MODEL_DELETEENSSALECONTROLREQUEST_H_
#define ALIBABACLOUD_ENS_MODEL_DELETEENSSALECONTROLREQUEST_H_
...
namespace Ens {
namespace Model {
class ALIBABACLOUD_ENS_EXPORT DeleteEnsSaleControlRequest : public RpcServiceRequest {
public:
	struct SaleControls {
...
#endif // !ALIBABACLOUD_ENS_MODEL_DELETEENSSALECONTROLREQUEST_H_
