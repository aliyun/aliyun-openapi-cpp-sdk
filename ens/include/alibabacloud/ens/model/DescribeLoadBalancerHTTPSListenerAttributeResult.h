...
#ifndef ALIBABACLOUD_ENS_MODEL_DESCRIBELOADBALANCERHTTPSLISTENERATTRIBUTERESULT_H_
#define ALIBABACLOUD_ENS_MODEL_DESCRIBELOADBALANCERHTTPSLISTENERATTRIBUTERESULT_H_
...
namespace AlibabaCloud
{
	namespace Ens
	{
		namespace Model
		{
			class ALIBABACLOUD_ENS_EXPORT DescribeLoadBalancerHTTPSListenerAttributeResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_ENS_MODEL_DESCRIBELOADBALANCERHTTPSLISTENERATTRIBUTERESULT_H_