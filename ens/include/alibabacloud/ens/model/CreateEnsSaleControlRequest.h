...
#ifndef ALIBABACLOUD_ENS_MODEL_CREATEENSSALECONTROLREQUEST_H_
#define ALIBABACLOUD_ENS_MODEL_CREATEENSSALECONTROLREQUEST_H_
...
namespace Ens {
namespace Model {
class ALIBABACLOUD_ENS_EXPORT CreateEnsSaleControlRequest : public RpcServiceRequest {
public:
	struct SaleControls {
...
#endif // !ALIBABACLOUD_ENS_MODEL_CREATEENSSALECONTROLREQUEST_H_
