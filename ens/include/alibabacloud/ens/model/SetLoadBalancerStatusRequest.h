...
#ifndef ALIBABACLOUD_ENS_MODEL_SETLOADBALANCERSTATUSREQUEST_H_
...
namespace Ens {
namespace Model {
class ALIBABACLOUD_ENS_EXPORT SetLoadBalancerStatusRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ENS_MODEL_SETLOADBALANCERSTATUSREQUEST_H_
