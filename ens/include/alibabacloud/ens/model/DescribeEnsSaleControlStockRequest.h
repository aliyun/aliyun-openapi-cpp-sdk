...
#ifndef ALIBABACLOUD_ENS_MODEL_DESCRIBEENSSALECONTROLSTOCKREQUEST_H_
#define ALIBABACLOUD_ENS_MODEL_DESCRIBEENSSALECONTROLSTOCKREQUEST_H_
...
namespace Ens {
namespace Model {
class ALIBABACLOUD_ENS_EXPORT DescribeEnsSaleControlStockRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ENS_MODEL_DESCRIBEENSSALECONTROLSTOCKREQUEST_H_
