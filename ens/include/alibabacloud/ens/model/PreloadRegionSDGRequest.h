...
#ifndef ALIBABACLOUD_ENS_MODEL_PRELOADREGIONSDGREQUEST_H_
#define ALIBABACLOUD_ENS_MODEL_PRELOADREGIONSDGREQUEST_H_
...
namespace Ens {
namespace Model {
class ALIBABACLOUD_ENS_EXPORT PreloadRegionSDGRequest : public RpcServiceRequest {
public:
	...
	int getRedundantNum() const;
	void setRedundantNum(int redundantNum);
...
#endif // !ALIBABACLOUD_ENS_MODEL_PRELOADREGIONSDGREQUEST_H_
