...
#ifndef ALIBABACLOUD_ENS_MODEL_DELETEENSSALECONDITIONCONTROLREQUEST_H_
#define ALIBABACLOUD_ENS_MODEL_DELETEENSSALECONDITIONCONTROLREQUEST_H_
...
namespace Ens {
namespace Model {
class ALIBABACLOUD_ENS_EXPORT DeleteEnsSaleConditionControlRequest : public RpcServiceRequest {
public:
	struct SaleControls {
...
#endif // !ALIBABACLOUD_ENS_MODEL_DELETEENSSALECONDITIONCONTROLREQUEST_H_
