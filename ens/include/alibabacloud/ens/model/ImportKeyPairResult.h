...
#ifndef ALIBABACLOUD_ENS_MODEL_IMPORTKEYPAIRRESULT_H_
...
namespace AlibabaCloud
{
	namespace Ens
	{
		namespace Model
		{
			class ALIBABACLOUD_ENS_EXPORT ImportKeyPairResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_ENS_MODEL_IMPORTKEYPAIRRESULT_H_