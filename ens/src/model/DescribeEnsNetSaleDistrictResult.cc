...
DescribeEnsNetSaleDistrictResult::DescribeEnsNetSaleDistrictResult() :
	ServiceResult()
{}

DescribeEnsNetSaleDistrictResult::DescribeEnsNetSaleDistrictResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeEnsNetSaleDistrictResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	for (auto valueEnsNetDistrictsEnsNetDistrict : allEnsNetDistrictsNode)
	{
		...
		if(!valueEnsNetDistrictsEnsNetDistrict["InstanceCount"].isNull())
			ensNetDistrictsObject.instanceCount = valueEnsNetDistrictsEnsNetDistrict["InstanceCount"].asString();
...
int DescribeEnsNetSaleDistrictResult::getCode()const
{
	return code_;
}

std::vector<DescribeEnsNetSaleDistrictResult::EnsNetDistrict> DescribeEnsNetSaleDistrictResult::getEnsNetDistricts()const
{
