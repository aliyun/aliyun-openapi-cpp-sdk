...
using AlibabaCloud::Ens::Model::DescribeInstanceAutoRenewAttributeRequest;

DescribeInstanceAutoRenewAttributeRequest::DescribeInstanceAutoRenewAttributeRequest()
    : RpcServiceRequest("ens", "2017-11-10", "DescribeInstanceAutoRenewAttribute") {
...
std::string DescribeInstanceAutoRenewAttributeRequest::getInstanceIds() const {
  return instanceIds_;
}

void DescribeInstanceAutoRenewAttributeRequest::setInstanceIds(const std::string &instanceIds) {
