...
using AlibabaCloud::Ens::Model::StopInstanceRequest;

StopInstanceRequest::StopInstanceRequest()
    : RpcServiceRequest("ens", "2017-11-10", "StopInstance") {
  setMethod(HttpRequest::Method::Post);
}

StopInstanceRequest::~StopInstanceRequest() {}

std::string StopInstanceRequest::getForceStop() const {
  return forceStop_;
}

void StopInstanceRequest::setForceStop(const std::string &forceStop) {
