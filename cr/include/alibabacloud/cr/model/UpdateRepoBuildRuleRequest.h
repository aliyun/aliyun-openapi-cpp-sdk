...
#ifndef ALIBABACLOUD_CR_MODEL_UPDATEREPOBUILDRULEREQUEST_H_
#define ALIBABACLOUD_CR_MODEL_UPDATEREPOBUILDRULEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cr
	{
		namespace Model
		{
			class ALIBABACLOUD_CR_EXPORT UpdateRepoBuildRuleRequest : public RoaServiceRequest
			{
...
#endif // !ALIBABACLOUD_CR_MODEL_UPDATEREPOBUILDRULEREQUEST_H_