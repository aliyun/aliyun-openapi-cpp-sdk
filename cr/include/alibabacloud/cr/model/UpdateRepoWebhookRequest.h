...
#ifndef ALIBABACLOUD_CR_MODEL_UPDATEREPOWEBHOOKREQUEST_H_
#define ALIBABACLOUD_CR_MODEL_UPDATEREPOWEBHOOKREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cr
	{
		namespace Model
		{
			class ALIBABACLOUD_CR_EXPORT UpdateRepoWebhookRequest : public RoaServiceRequest
			{
...
#endif // !ALIBABACLOUD_CR_MODEL_UPDATEREPOWEBHOOKREQUEST_H_