...
#ifndef ALIBABACLOUD_CR_MODEL_STARTREPOBUILDBYRULEREQUEST_H_
#define ALIBABACLOUD_CR_MODEL_STARTREPOBUILDBYRULEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cr
	{
		namespace Model
		{
			class ALIBABACLOUD_CR_EXPORT StartRepoBuildByRuleRequest : public RoaServiceRequest
			{
...
#endif // !ALIBABACLOUD_CR_MODEL_STARTREPOBUILDBYRULEREQUEST_H_