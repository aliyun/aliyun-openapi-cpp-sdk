...
#ifndef ALIBABACLOUD_CR_MODEL_UPDATEREPOAUTHORIZATIONREQUEST_H_
#define ALIBABACLOUD_CR_MODEL_UPDATEREPOAUTHORIZATIONREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cr
	{
		namespace Model
		{
			class ALIBABACLOUD_CR_EXPORT UpdateRepoAuthorizationRequest : public RoaServiceRequest
			{
...
#endif // !ALIBABACLOUD_CR_MODEL_UPDATEREPOAUTHORIZATIONREQUEST_H_