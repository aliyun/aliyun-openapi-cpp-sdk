...
#ifndef ALIBABACLOUD_RAM_MODEL_SETSECURITYPREFERENCERESULT_H_
#define ALIBABACLOUD_RAM_MODEL_SETSECURITYPREFERENCERESULT_H_
...
namespace AlibabaCloud
{
	namespace Ram
	{
		namespace Model
		{
			class ALIBABACLOUD_RAM_EXPORT SetSecurityPreferenceResult : public ServiceResult
			{
			public:
				...
				SetSecurityPreferenceResult();
				explicit SetSecurityPreferenceResult(const std::string &payload);
				~SetSecurityPreferenceResult();
...
#endif // !ALIBABACLOUD_RAM_MODEL_SETSECURITYPREFERENCERESULT_H_