...
UploadPublicKeyResult::UploadPublicKeyResult() :
	ServiceResult()
{}

UploadPublicKeyResult::UploadPublicKeyResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UploadPublicKeyResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
UploadPublicKeyResult::PublicKey UploadPublicKeyResult::getPublicKey()const
{
	return publicKey_;
}
