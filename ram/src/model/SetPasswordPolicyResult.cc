...
SetPasswordPolicyResult::SetPasswordPolicyResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
SetPasswordPolicyResult::PasswordPolicy SetPasswordPolicyResult::getPasswordPolicy()const
{
