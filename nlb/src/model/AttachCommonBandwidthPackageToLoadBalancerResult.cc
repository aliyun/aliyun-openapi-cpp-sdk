...
std::string AttachCommonBandwidthPackageToLoadBalancerResult::getMessage()const
{
	return message_;
}

int AttachCommonBandwidthPackageToLoadBalancerResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::string AttachCommonBandwidthPackageToLoadBalancerResult::getDynamicCode()const
{
	return dynamicCode_;
}

std::string AttachCommonBandwidthPackageToLoadBalancerResult::getDynamicMessage()const
{
	return dynamicMessage_;
}

std::string AttachCommonBandwidthPackageToLoadBalancerResult::getCode()const
{
	return code_;
}

bool AttachCommonBandwidthPackageToLoadBalancerResult::getSuccess()const
{
	return success_;
}
