...
using AlibabaCloud::Nlb::Model::ListServerGroupsRequest;

ListServerGroupsRequest::ListServerGroupsRequest()
    : RpcServiceRequest("nlb", "2022-04-30", "ListServerGroups") {
  setMethod(HttpRequest::Method::Post);
}

ListServerGroupsRequest::~ListServerGroupsRequest() {}

std::vector<std::string> ListServerGroupsRequest::getServerGroupNames() const {
  return serverGroupNames_;
}

void ListServerGroupsRequest::setServerGroupNames(const std::vector<std::string> &serverGroupNames) {
...
std::string ListServerGroupsRequest::getRegionId() const {
  return regionId_;
}

void ListServerGroupsRequest::setRegionId(const std::string &regionId) {
  regionId_ = regionId;
...
std::vector<std::string> ListServerGroupsRequest::getServerGroupIds() const {
  return serverGroupIds_;
}

void ListServerGroupsRequest::setServerGroupIds(const std::vector<std::string> &serverGroupIds) {
