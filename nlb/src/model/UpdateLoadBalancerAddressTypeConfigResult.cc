...
std::string UpdateLoadBalancerAddressTypeConfigResult::getMessage()const
{
	return message_;
}

int UpdateLoadBalancerAddressTypeConfigResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::string UpdateLoadBalancerAddressTypeConfigResult::getDynamicCode()const
{
	return dynamicCode_;
}

std::string UpdateLoadBalancerAddressTypeConfigResult::getDynamicMessage()const
{
	return dynamicMessage_;
}

std::string UpdateLoadBalancerAddressTypeConfigResult::getCode()const
{
	return code_;
}

bool UpdateLoadBalancerAddressTypeConfigResult::getSuccess()const
{
	return success_;
}
