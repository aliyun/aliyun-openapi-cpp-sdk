...
std::string LoadBalancerLeaveSecurityGroupResult::getMessage()const
{
	return message_;
}

int LoadBalancerLeaveSecurityGroupResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::string LoadBalancerLeaveSecurityGroupResult::getDynamicCode()const
{
	return dynamicCode_;
}

std::string LoadBalancerLeaveSecurityGroupResult::getDynamicMessage()const
{
	return dynamicMessage_;
}

std::string LoadBalancerLeaveSecurityGroupResult::getCode()const
{
	return code_;
}

bool LoadBalancerLeaveSecurityGroupResult::getSuccess()const
{
	return success_;
}
