...
std::string LoadBalancerJoinSecurityGroupResult::getMessage()const
{
	return message_;
}

int LoadBalancerJoinSecurityGroupResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::string LoadBalancerJoinSecurityGroupResult::getDynamicCode()const
{
	return dynamicCode_;
}

std::string LoadBalancerJoinSecurityGroupResult::getDynamicMessage()const
{
	return dynamicMessage_;
}

std::string LoadBalancerJoinSecurityGroupResult::getCode()const
{
	return code_;
}

bool LoadBalancerJoinSecurityGroupResult::getSuccess()const
{
	return success_;
}
