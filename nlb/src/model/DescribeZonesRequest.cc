...
using AlibabaCloud::Nlb::Model::DescribeZonesRequest;

DescribeZonesRequest::DescribeZonesRequest()
    : RpcServiceRequest("nlb", "2022-04-30", "DescribeZones") {
  setMethod(HttpRequest::Method::Post);
}

DescribeZonesRequest::~DescribeZonesRequest() {}

std::string DescribeZonesRequest::getClientToken() const {
  return clientToken_;
}

void DescribeZonesRequest::setClientToken(const std::string &clientToken) {
...
std::string DescribeZonesRequest::getServiceCode() const {
  return serviceCode_;
}

void DescribeZonesRequest::setServiceCode(const std::string &serviceCode) {
