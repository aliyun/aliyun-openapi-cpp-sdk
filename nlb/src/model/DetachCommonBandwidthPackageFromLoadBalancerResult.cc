...
std::string DetachCommonBandwidthPackageFromLoadBalancerResult::getMessage()const
{
	return message_;
}

int DetachCommonBandwidthPackageFromLoadBalancerResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::string DetachCommonBandwidthPackageFromLoadBalancerResult::getDynamicCode()const
{
	return dynamicCode_;
}

std::string DetachCommonBandwidthPackageFromLoadBalancerResult::getDynamicMessage()const
{
	return dynamicMessage_;
}

std::string DetachCommonBandwidthPackageFromLoadBalancerResult::getCode()const
{
	return code_;
}

bool DetachCommonBandwidthPackageFromLoadBalancerResult::getSuccess()const
{
	return success_;
}
