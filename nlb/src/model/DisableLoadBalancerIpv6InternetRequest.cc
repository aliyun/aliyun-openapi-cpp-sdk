...
using AlibabaCloud::Nlb::Model::DisableLoadBalancerIpv6InternetRequest;

DisableLoadBalancerIpv6InternetRequest::DisableLoadBalancerIpv6InternetRequest()
    : RpcServiceRequest("nlb", "2022-04-30", "DisableLoadBalancerIpv6Internet") {
...
std::string DisableLoadBalancerIpv6InternetRequest::getRegionId() const {
  return regionId_;
}

void DisableLoadBalancerIpv6InternetRequest::setRegionId(const std::string &regionId) {
  regionId_ = regionId;
