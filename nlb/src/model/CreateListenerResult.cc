...
std::string CreateListenerResult::getMessage()const
{
	return message_;
}

int CreateListenerResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::string CreateListenerResult::getDynamicCode()const
{
	return dynamicCode_;
}

std::string CreateListenerResult::getDynamicMessage()const
{
	return dynamicMessage_;
}

std::string CreateListenerResult::getCode()const
{
	return code_;
}

bool CreateListenerResult::getSuccess()const
{
	return success_;
}

std::string CreateListenerResult::getJobId()const
{
	return jobId_;
}
