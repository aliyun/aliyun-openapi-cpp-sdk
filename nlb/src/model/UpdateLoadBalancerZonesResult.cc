...
std::string UpdateLoadBalancerZonesResult::getMessage()const
{
	return message_;
}

int UpdateLoadBalancerZonesResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

std::string UpdateLoadBalancerZonesResult::getDynamicCode()const
{
	return dynamicCode_;
}

std::string UpdateLoadBalancerZonesResult::getDynamicMessage()const
{
	return dynamicMessage_;
}

std::string UpdateLoadBalancerZonesResult::getCode()const
{
	return code_;
}

bool UpdateLoadBalancerZonesResult::getSuccess()const
{
	return success_;
}
