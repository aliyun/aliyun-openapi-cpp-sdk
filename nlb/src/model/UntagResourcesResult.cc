...
std::string UntagResourcesResult::getDynamicCode()const
{
	return dynamicCode_;
}

std::string UntagResourcesResult::getDynamicMessage()const
{
...
std::string UntagResourcesResult::getJobId()const
{
	return jobId_;
}
