...
using AlibabaCloud::Cloud_siem::Model::GetCapacityRequest;

GetCapacityRequest::GetCapacityRequest()
    : RpcServiceRequest("cloud-siem", "2022-06-16", "GetCapacity") {
...
void GetCapacityRequest::setRegionId(const std::string &regionId) {
  regionId_ = regionId;
