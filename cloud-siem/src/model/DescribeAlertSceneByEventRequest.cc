...
using AlibabaCloud::Cloud_siem::Model::DescribeAlertSceneByEventRequest;

DescribeAlertSceneByEventRequest::DescribeAlertSceneByEventRequest()
    : RpcServiceRequest("cloud-siem", "2022-06-16", "DescribeAlertSceneByEvent") {
...
void DescribeAlertSceneByEventRequest::setRegionId(const std::string &regionId) {
  regionId_ = regionId;
...
void DescribeAlertSceneByEventRequest::setIncidentUuid(const std::string &incidentUuid) {
