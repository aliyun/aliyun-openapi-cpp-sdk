...
using AlibabaCloud::Cloud_siem::Model::DescribeAutomateResponseConfigCounterRequest;

DescribeAutomateResponseConfigCounterRequest::DescribeAutomateResponseConfigCounterRequest()
    : RpcServiceRequest("cloud-siem", "2022-06-16", "DescribeAutomateResponseConfigCounter") {
