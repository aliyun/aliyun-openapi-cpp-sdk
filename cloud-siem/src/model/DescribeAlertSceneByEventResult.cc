...
DescribeAlertSceneByEventResult::DescribeAlertSceneByEventResult() :
	ServiceResult()
{}

DescribeAlertSceneByEventResult::DescribeAlertSceneByEventResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeAlertSceneByEventResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeAlertSceneByEventResult::getMessage()const
{
	return message_;
}

std::vector<DescribeAlertSceneByEventResult::DataItem> DescribeAlertSceneByEventResult::getData()const
{
	return data_;
}

int DescribeAlertSceneByEventResult::getCode()const
{
	return code_;
}

bool DescribeAlertSceneByEventResult::getSuccess()const
{
	return success_;
}
