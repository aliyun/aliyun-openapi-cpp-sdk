...
using AlibabaCloud::Cloud_siem::Model::DescribeCloudSiemEventDetailRequest;

DescribeCloudSiemEventDetailRequest::DescribeCloudSiemEventDetailRequest()
    : RpcServiceRequest("cloud-siem", "2022-06-16", "DescribeCloudSiemEventDetail") {
...
void DescribeCloudSiemEventDetailRequest::setIncidentUuid(const std::string &incidentUuid) {
