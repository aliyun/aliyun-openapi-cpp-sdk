...
using AlibabaCloud::Cloud_siem::Model::DescribeCustomizeRuleTestHistogramRequest;

DescribeCustomizeRuleTestHistogramRequest::DescribeCustomizeRuleTestHistogramRequest()
    : RpcServiceRequest("cloud-siem", "2022-06-16", "DescribeCustomizeRuleTestHistogram") {
...
void DescribeCustomizeRuleTestHistogramRequest::setId(long id) {
  id_ = id;
