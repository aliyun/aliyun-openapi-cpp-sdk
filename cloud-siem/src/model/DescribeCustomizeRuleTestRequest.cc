...
using AlibabaCloud::Cloud_siem::Model::DescribeCustomizeRuleTestRequest;

DescribeCustomizeRuleTestRequest::DescribeCustomizeRuleTestRequest()
    : RpcServiceRequest("cloud-siem", "2022-06-16", "DescribeCustomizeRuleTest") {
...
void DescribeCustomizeRuleTestRequest::setRegionId(const std::string &regionId) {
  regionId_ = regionId;
...
void DescribeCustomizeRuleTestRequest::setId(long id) {
  id_ = id;
