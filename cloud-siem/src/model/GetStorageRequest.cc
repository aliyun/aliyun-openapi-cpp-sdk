...
using AlibabaCloud::Cloud_siem::Model::GetStorageRequest;

GetStorageRequest::GetStorageRequest()
    : RpcServiceRequest("cloud-siem", "2022-06-16", "GetStorage") {
...
void GetStorageRequest::setRegionId(const std::string &regionId) {
  regionId_ = regionId;
