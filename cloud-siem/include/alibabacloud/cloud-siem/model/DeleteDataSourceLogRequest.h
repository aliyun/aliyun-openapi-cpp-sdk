...
#ifndef ALIBABACLOUD_CLOUD_SIEM_MODEL_DELETEDATASOURCELOGREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_CLOUD_SIEM_EXPORT DeleteDataSourceLogRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLOUD_SIEM_MODEL_DELETEDATASOURCELOGREQUEST_H_
