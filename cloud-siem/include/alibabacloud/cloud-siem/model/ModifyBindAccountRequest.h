...
#ifndef ALIBABACLOUD_CLOUD_SIEM_MODEL_MODIFYBINDACCOUNTREQUEST_H_
#define ALIBABACLOUD_CLOUD_SIEM_MODEL_MODIFYBINDACCOUNTREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_CLOUD_SIEM_EXPORT ModifyBindAccountRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLOUD_SIEM_MODEL_MODIFYBINDACCOUNTREQUEST_H_
