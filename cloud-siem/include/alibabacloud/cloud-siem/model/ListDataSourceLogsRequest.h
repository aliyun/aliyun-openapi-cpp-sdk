...
#ifndef ALIBABACLOUD_CLOUD_SIEM_MODEL_LISTDATASOURCELOGSREQUEST_H_
#define ALIBABACLOUD_CLOUD_SIEM_MODEL_LISTDATASOURCELOGSREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_CLOUD_SIEM_EXPORT ListDataSourceLogsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLOUD_SIEM_MODEL_LISTDATASOURCELOGSREQUEST_H_
