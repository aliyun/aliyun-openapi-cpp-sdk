...
#ifndef ALIBABACLOUD_CLOUD_SIEM_MODEL_LISTUSERPRODLOGSREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_CLOUD_SIEM_EXPORT ListUserProdLogsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLOUD_SIEM_MODEL_LISTUSERPRODLOGSREQUEST_H_
