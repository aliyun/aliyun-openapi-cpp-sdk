...
#ifndef ALIBABACLOUD_CLOUD_SIEM_MODEL_ADDDATASOURCELOGREQUEST_H_
#define ALIBABACLOUD_CLOUD_SIEM_MODEL_ADDDATASOURCELOGREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_CLOUD_SIEM_EXPORT AddDataSourceLogRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLOUD_SIEM_MODEL_ADDDATASOURCELOGREQUEST_H_
