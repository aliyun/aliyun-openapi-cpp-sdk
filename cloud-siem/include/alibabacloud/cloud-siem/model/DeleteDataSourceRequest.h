...
#ifndef ALIBABACLOUD_CLOUD_SIEM_MODEL_DELETEDATASOURCEREQUEST_H_
#define ALIBABACLOUD_CLOUD_SIEM_MODEL_DELETEDATASOURCEREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_CLOUD_SIEM_EXPORT DeleteDataSourceRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLOUD_SIEM_MODEL_DELETEDATASOURCEREQUEST_H_
