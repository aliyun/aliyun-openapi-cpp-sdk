...
#ifndef ALIBABACLOUD_CLOUD_SIEM_MODEL_DESCRIBEALERTSWITHEVENTRESULT_H_
...
namespace AlibabaCloud
{
	namespace Cloud_siem
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUD_SIEM_EXPORT DescribeAlertsWithEventResult : public ServiceResult
			{
			public:
				struct Data
				{
				...
				DescribeAlertsWithEventResult();
				explicit DescribeAlertsWithEventResult(const std::string &payload);
				~DescribeAlertsWithEventResult();
...
#endif // !ALIBABACLOUD_CLOUD_SIEM_MODEL_DESCRIBEALERTSWITHEVENTRESULT_H_