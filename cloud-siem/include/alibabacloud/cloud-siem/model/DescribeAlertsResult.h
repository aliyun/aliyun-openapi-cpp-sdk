...
#ifndef ALIBABACLOUD_CLOUD_SIEM_MODEL_DESCRIBEALERTSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Cloud_siem
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUD_SIEM_EXPORT DescribeAlertsResult : public ServiceResult
			{
			public:
				struct Data
				{
				...
				DescribeAlertsResult();
				explicit DescribeAlertsResult(const std::string &payload);
				~DescribeAlertsResult();
...
#endif // !ALIBABACLOUD_CLOUD_SIEM_MODEL_DESCRIBEALERTSRESULT_H_