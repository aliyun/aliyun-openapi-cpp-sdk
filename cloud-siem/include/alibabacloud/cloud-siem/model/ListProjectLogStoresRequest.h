...
#ifndef ALIBABACLOUD_CLOUD_SIEM_MODEL_LISTPROJECTLOGSTORESREQUEST_H_
#define ALIBABACLOUD_CLOUD_SIEM_MODEL_LISTPROJECTLOGSTORESREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_CLOUD_SIEM_EXPORT ListProjectLogStoresRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLOUD_SIEM_MODEL_LISTPROJECTLOGSTORESREQUEST_H_
