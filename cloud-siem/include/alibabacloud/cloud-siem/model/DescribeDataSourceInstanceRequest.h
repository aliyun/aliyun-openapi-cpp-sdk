...
#ifndef ALIBABACLOUD_CLOUD_SIEM_MODEL_DESCRIBEDATASOURCEINSTANCEREQUEST_H_
#define ALIBABACLOUD_CLOUD_SIEM_MODEL_DESCRIBEDATASOURCEINSTANCEREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_CLOUD_SIEM_EXPORT DescribeDataSourceInstanceRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLOUD_SIEM_MODEL_DESCRIBEDATASOURCEINSTANCEREQUEST_H_
