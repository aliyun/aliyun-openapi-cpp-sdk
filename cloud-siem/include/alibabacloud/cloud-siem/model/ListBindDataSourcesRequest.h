...
#ifndef ALIBABACLOUD_CLOUD_SIEM_MODEL_LISTBINDDATASOURCESREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_CLOUD_SIEM_EXPORT ListBindDataSourcesRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLOUD_SIEM_MODEL_LISTBINDDATASOURCESREQUEST_H_
