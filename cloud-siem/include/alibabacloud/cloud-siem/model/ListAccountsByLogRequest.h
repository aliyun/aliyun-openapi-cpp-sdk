...
#ifndef ALIBABACLOUD_CLOUD_SIEM_MODEL_LISTACCOUNTSBYLOGREQUEST_H_
#define ALIBABACLOUD_CLOUD_SIEM_MODEL_LISTACCOUNTSBYLOGREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_CLOUD_SIEM_EXPORT ListAccountsByLogRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLOUD_SIEM_MODEL_LISTACCOUNTSBYLOGREQUEST_H_
