...
#ifndef ALIBABACLOUD_CLOUD_SIEM_MODEL_DESCRIBEIMPORTEDLOGCOUNTREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_CLOUD_SIEM_EXPORT DescribeImportedLogCountRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLOUD_SIEM_MODEL_DESCRIBEIMPORTEDLOGCOUNTREQUEST_H_
