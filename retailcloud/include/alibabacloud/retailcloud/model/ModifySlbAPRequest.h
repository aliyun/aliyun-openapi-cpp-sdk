...
#ifndef ALIBABACLOUD_RETAILCLOUD_MODEL_MODIFYSLBAPREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Retailcloud
	{
		namespace Model
		{
			class ALIBABACLOUD_RETAILCLOUD_EXPORT ModifySlbAPRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_RETAILCLOUD_MODEL_MODIFYSLBAPREQUEST_H_