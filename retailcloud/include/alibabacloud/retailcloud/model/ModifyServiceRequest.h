...
#ifndef ALIBABACLOUD_RETAILCLOUD_MODEL_MODIFYSERVICEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Retailcloud
	{
		namespace Model
		{
			class ALIBABACLOUD_RETAILCLOUD_EXPORT ModifyServiceRequest : public RpcServiceRequest
			{
			public:
				struct PortMappings
				{
...
#endif // !ALIBABACLOUD_RETAILCLOUD_MODEL_MODIFYSERVICEREQUEST_H_