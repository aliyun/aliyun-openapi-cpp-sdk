...
#ifndef ALIBABACLOUD_DRDS_MODEL_MYCATCUSTOMIMPORTPRECHECKREQUEST_H_
#define ALIBABACLOUD_DRDS_MODEL_MYCATCUSTOMIMPORTPRECHECKREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Drds
	{
		namespace Model
		{
			class ALIBABACLOUD_DRDS_EXPORT MyCatCustomImportPreCheckRequest : public RpcServiceRequest
			{

			public:
				MyCatCustomImportPreCheckRequest();
				~MyCatCustomImportPreCheckRequest();
...
#endif // !ALIBABACLOUD_DRDS_MODEL_MYCATCUSTOMIMPORTPRECHECKREQUEST_H_