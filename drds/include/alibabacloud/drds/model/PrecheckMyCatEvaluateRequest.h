...
#ifndef ALIBABACLOUD_DRDS_MODEL_PRECHECKMYCATEVALUATEREQUEST_H_
#define ALIBABACLOUD_DRDS_MODEL_PRECHECKMYCATEVALUATEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Drds
	{
		namespace Model
		{
			class ALIBABACLOUD_DRDS_EXPORT PrecheckMyCatEvaluateRequest : public RpcServiceRequest
			{

			public:
				PrecheckMyCatEvaluateRequest();
				~PrecheckMyCatEvaluateRequest();
...
#endif // !ALIBABACLOUD_DRDS_MODEL_PRECHECKMYCATEVALUATEREQUEST_H_