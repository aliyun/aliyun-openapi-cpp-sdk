...
#ifndef ALIBABACLOUD_DRDS_MODEL_SUBMITTABLESHARDINGKEYMODIFYREQUEST_H_
#define ALIBABACLOUD_DRDS_MODEL_SUBMITTABLESHARDINGKEYMODIFYREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Drds
	{
		namespace Model
		{
			class ALIBABACLOUD_DRDS_EXPORT SubmitTableShardingKeyModifyRequest : public RpcServiceRequest
			{

			public:
				SubmitTableShardingKeyModifyRequest();
				~SubmitTableShardingKeyModifyRequest();
...
#endif // !ALIBABACLOUD_DRDS_MODEL_SUBMITTABLESHARDINGKEYMODIFYREQUEST_H_