...
#ifndef ALIBABACLOUD_DRDS_MODEL_GETBATCHEVALUATETASKREPORTRESULT_H_
#define ALIBABACLOUD_DRDS_MODEL_GETBATCHEVALUATETASKREPORTRESULT_H_
...
namespace AlibabaCloud
{
	namespace Drds
	{
		namespace Model
		{
			class ALIBABACLOUD_DRDS_EXPORT GetBatchEvaluateTaskReportResult : public ServiceResult
			{
			public:
				...
				GetBatchEvaluateTaskReportResult();
				explicit GetBatchEvaluateTaskReportResult(const std::string &payload);
				~GetBatchEvaluateTaskReportResult();
...
#endif // !ALIBABACLOUD_DRDS_MODEL_GETBATCHEVALUATETASKREPORTRESULT_H_