...
StopDataImportTaskResult::StopDataImportTaskResult() :
	ServiceResult()
{}

StopDataImportTaskResult::StopDataImportTaskResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void StopDataImportTaskResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
StopDataImportTaskResult::TaskManageResult StopDataImportTaskResult::getTaskManageResult()const
{
	return taskManageResult_;
}

bool StopDataImportTaskResult::getSuccess()const
{
	return success_;
}
