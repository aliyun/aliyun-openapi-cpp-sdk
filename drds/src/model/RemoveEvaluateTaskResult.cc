...
RemoveEvaluateTaskResult::RemoveEvaluateTaskResult() :
	ServiceResult()
{}

RemoveEvaluateTaskResult::RemoveEvaluateTaskResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RemoveEvaluateTaskResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
RemoveEvaluateTaskResult::TaskManageResult RemoveEvaluateTaskResult::getTaskManageResult()const
{
	return taskManageResult_;
}

bool RemoveEvaluateTaskResult::getSuccess()const
{
	return success_;
}
