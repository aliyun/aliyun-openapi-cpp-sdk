...
RemoveDataExportTaskResult::RemoveDataExportTaskResult() :
	ServiceResult()
{}

RemoveDataExportTaskResult::RemoveDataExportTaskResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RemoveDataExportTaskResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
RemoveDataExportTaskResult::TaskManageResult RemoveDataExportTaskResult::getTaskManageResult()const
{
	return taskManageResult_;
}

bool RemoveDataExportTaskResult::getSuccess()const
{
	return success_;
}
