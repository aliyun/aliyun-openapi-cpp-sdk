...
StartEvaluateTaskResult::StartEvaluateTaskResult() :
	ServiceResult()
{}

StartEvaluateTaskResult::StartEvaluateTaskResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void StartEvaluateTaskResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
StartEvaluateTaskResult::TaskManageResult StartEvaluateTaskResult::getTaskManageResult()const
{
	return taskManageResult_;
}

bool StartEvaluateTaskResult::getSuccess()const
{
	return success_;
}
