...
StopEvaluateTaskResult::StopEvaluateTaskResult() :
	ServiceResult()
{}

StopEvaluateTaskResult::StopEvaluateTaskResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void StopEvaluateTaskResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
StopEvaluateTaskResult::TaskManageResult StopEvaluateTaskResult::getTaskManageResult()const
{
	return taskManageResult_;
}

bool StopEvaluateTaskResult::getSuccess()const
{
	return success_;
}
