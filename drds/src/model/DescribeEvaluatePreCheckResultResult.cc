...
DescribeEvaluatePreCheckResultResult::DescribeEvaluatePreCheckResultResult() :
	ServiceResult()
{}

DescribeEvaluatePreCheckResultResult::DescribeEvaluatePreCheckResultResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeEvaluatePreCheckResultResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
DescribeEvaluatePreCheckResultResult::PreCheckResult DescribeEvaluatePreCheckResultResult::getPreCheckResult()const
{
	return preCheckResult_;
}

bool DescribeEvaluatePreCheckResultResult::getSuccess()const
{
	return success_;
}
