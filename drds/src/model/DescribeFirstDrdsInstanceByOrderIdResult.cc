...
DescribeFirstDrdsInstanceByOrderIdResult::DescribeFirstDrdsInstanceByOrderIdResult() :
	ServiceResult()
{}

DescribeFirstDrdsInstanceByOrderIdResult::DescribeFirstDrdsInstanceByOrderIdResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeFirstDrdsInstanceByOrderIdResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
DescribeFirstDrdsInstanceByOrderIdResult::Data DescribeFirstDrdsInstanceByOrderIdResult::getData()const
{
	return data_;
}

bool DescribeFirstDrdsInstanceByOrderIdResult::getSuccess()const
{
	return success_;
}
