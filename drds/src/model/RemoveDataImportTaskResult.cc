...
RemoveDataImportTaskResult::RemoveDataImportTaskResult() :
	ServiceResult()
{}

RemoveDataImportTaskResult::RemoveDataImportTaskResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RemoveDataImportTaskResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
RemoveDataImportTaskResult::TaskManageResult RemoveDataImportTaskResult::getTaskManageResult()const
{
	return taskManageResult_;
}

bool RemoveDataImportTaskResult::getSuccess()const
{
	return success_;
}
