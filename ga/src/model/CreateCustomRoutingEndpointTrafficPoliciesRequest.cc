...
using AlibabaCloud::Ga::Model::CreateCustomRoutingEndpointTrafficPoliciesRequest;
...
std::string CreateCustomRoutingEndpointTrafficPoliciesRequest::getClientToken() const {
  return clientToken_;
}

void CreateCustomRoutingEndpointTrafficPoliciesRequest::setClientToken(const std::string &clientToken) {
  clientToken_ = clientToken;
  setParameter(std::string("ClientToken"), clientToken);
}

std::string CreateCustomRoutingEndpointTrafficPoliciesRequest::getEndpointId() const {
  return endpointId_;
}

void CreateCustomRoutingEndpointTrafficPoliciesRequest::setEndpointId(const std::string &endpointId) {
  endpointId_ = endpointId;
  setParameter(std::string("EndpointId"), endpointId);
}

std::vector<CreateCustomRoutingEndpointTrafficPoliciesRequest::PolicyConfigurations> CreateCustomRoutingEndpointTrafficPoliciesRequest::getPolicyConfigurations() const {
  return policyConfigurations_;
}

void CreateCustomRoutingEndpointTrafficPoliciesRequest::setPolicyConfigurations(const std::vector<CreateCustomRoutingEndpointTrafficPoliciesRequest::PolicyConfigurations> &policyConfigurations) {
...
std::string CreateCustomRoutingEndpointTrafficPoliciesRequest::getRegionId() const {
  return regionId_;
}

void CreateCustomRoutingEndpointTrafficPoliciesRequest::setRegionId(const std::string &regionId) {
  regionId_ = regionId;
