...
void UpdateEndpointGroupRequest::setPortOverrides(const std::vector<PortOverrides>& portOverrides)
{
...
void UpdateEndpointGroupRequest::setEndpointConfigurations(const std::vector<EndpointConfigurations>& endpointConfigurations)
{
