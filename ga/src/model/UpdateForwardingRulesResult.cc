...
UpdateForwardingRulesResult::UpdateForwardingRulesResult() :
	ServiceResult()
{}

UpdateForwardingRulesResult::UpdateForwardingRulesResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateForwardingRulesResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<UpdateForwardingRulesResult::ForwardingRulesItem> UpdateForwardingRulesResult::getForwardingRules()const
{
