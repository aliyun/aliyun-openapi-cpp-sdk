...
ListCustomRoutingPortMappingsByDestinationResult::ListCustomRoutingPortMappingsByDestinationResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListCustomRoutingPortMappingsByDestinationResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
int ListCustomRoutingPortMappingsByDestinationResult::getTotalCount()const
{
	return totalCount_;
}

std::vector<ListCustomRoutingPortMappingsByDestinationResult::PortMappingsItem> ListCustomRoutingPortMappingsByDestinationResult::getPortMappings()const
{
	return portMappings_;
}

int ListCustomRoutingPortMappingsByDestinationResult::getPageSize()const
{
	return pageSize_;
}

int ListCustomRoutingPortMappingsByDestinationResult::getPageNumber()const
{
	return pageNumber_;
}
