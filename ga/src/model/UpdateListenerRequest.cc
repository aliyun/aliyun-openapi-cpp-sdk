...
void UpdateListenerRequest::setBackendPorts(const std::vector<BackendPorts>& backendPorts)
{
...
void UpdateListenerRequest::setProxyProtocol(const std::string& proxyProtocol)
{
	...
	setParameter("ProxyProtocol", proxyProtocol);
}
...
void UpdateListenerRequest::setPortRanges(const std::vector<PortRanges>& portRanges)
{
...
void UpdateListenerRequest::setCertificates(const std::vector<Certificates>& certificates)
{
