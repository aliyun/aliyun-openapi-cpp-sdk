...
#ifndef ALIBABACLOUD_GA_MODEL_LISTCUSTOMROUTINGENDPOINTGROUPSREQUEST_H_
...
namespace Ga {
namespace Model {
class ALIBABACLOUD_GA_EXPORT ListCustomRoutingEndpointGroupsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_GA_MODEL_LISTCUSTOMROUTINGENDPOINTGROUPSREQUEST_H_
