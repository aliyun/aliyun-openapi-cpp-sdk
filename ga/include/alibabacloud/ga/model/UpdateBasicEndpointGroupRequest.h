...
#ifndef ALIBABACLOUD_GA_MODEL_UPDATEBASICENDPOINTGROUPREQUEST_H_
#define ALIBABACLOUD_GA_MODEL_UPDATEBASICENDPOINTGROUPREQUEST_H_
...
namespace Ga {
namespace Model {
class ALIBABACLOUD_GA_EXPORT UpdateBasicEndpointGroupRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_GA_MODEL_UPDATEBASICENDPOINTGROUPREQUEST_H_
