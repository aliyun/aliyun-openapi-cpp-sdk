...
#ifndef ALIBABACLOUD_GA_MODEL_LISTLISTENERCERTIFICATESREQUEST_H_
...
namespace Ga {
namespace Model {
class ALIBABACLOUD_GA_EXPORT ListListenerCertificatesRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_GA_MODEL_LISTLISTENERCERTIFICATESREQUEST_H_
