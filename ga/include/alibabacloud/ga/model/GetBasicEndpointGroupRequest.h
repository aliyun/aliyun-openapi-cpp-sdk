...
#ifndef ALIBABACLOUD_GA_MODEL_GETBASICENDPOINTGROUPREQUEST_H_
...
namespace Ga {
namespace Model {
class ALIBABACLOUD_GA_EXPORT GetBasicEndpointGroupRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_GA_MODEL_GETBASICENDPOINTGROUPREQUEST_H_
