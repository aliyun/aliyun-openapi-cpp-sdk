...
#ifndef ALIBABACLOUD_GA_MODEL_GETBASICENDPOINTRESULT_H_
#define ALIBABACLOUD_GA_MODEL_GETBASICENDPOINTRESULT_H_
...
namespace AlibabaCloud
{
	namespace Ga
	{
		namespace Model
		{
			class ALIBABACLOUD_GA_EXPORT GetBasicEndpointResult : public ServiceResult
			{
			public:


				GetBasicEndpointResult();
				explicit GetBasicEndpointResult(const std::string &payload);
				~GetBasicEndpointResult();
...
#endif // !ALIBABACLOUD_GA_MODEL_GETBASICENDPOINTRESULT_H_