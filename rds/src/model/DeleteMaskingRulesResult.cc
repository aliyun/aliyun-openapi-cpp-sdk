...
#include <alibabacloud/rds/model/DeleteMaskingRulesResult.h>
#include <json/json.h>
...
std::string DeleteMaskingRulesResult::getData()const
{
	return data_;
}

std::string DeleteMaskingRulesResult::getSuccess()const
{
	return success_;
}
