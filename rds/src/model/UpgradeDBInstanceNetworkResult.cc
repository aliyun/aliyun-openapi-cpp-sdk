...
UpgradeDBInstanceNetworkResult::UpgradeDBInstanceNetworkResult() :
	ServiceResult()
{}

UpgradeDBInstanceNetworkResult::UpgradeDBInstanceNetworkResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpgradeDBInstanceNetworkResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
