...
PreCheckCreateOrderForModifyResult::PreCheckCreateOrderForModifyResult() :
	ServiceResult()
{}

PreCheckCreateOrderForModifyResult::PreCheckCreateOrderForModifyResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void PreCheckCreateOrderForModifyResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
bool PreCheckCreateOrderForModifyResult::getPreCheckResult()const
{
	return preCheckResult_;
}

std::vector<PreCheckCreateOrderForModifyResult::FailuresItem> PreCheckCreateOrderForModifyResult::getFailures()const
{
	return failures_;
}
