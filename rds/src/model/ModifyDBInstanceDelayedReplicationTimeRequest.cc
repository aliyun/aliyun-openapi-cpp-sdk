...
#include <alibabacloud/rds/model/ModifyDBInstanceDelayedReplicationTimeRequest.h>

using AlibabaCloud::Rds::Model::ModifyDBInstanceDelayedReplicationTimeRequest;

ModifyDBInstanceDelayedReplicationTimeRequest::ModifyDBInstanceDelayedReplicationTimeRequest()
    : RpcServiceRequest("rds", "2014-08-15", "ModifyDBInstanceDelayedReplicationTime") {
  setMethod(HttpRequest::Method::Post);
}

ModifyDBInstanceDelayedReplicationTimeRequest::~ModifyDBInstanceDelayedReplicationTimeRequest() {}

long ModifyDBInstanceDelayedReplicationTimeRequest::getResourceOwnerId() const {
  return resourceOwnerId_;
}

void ModifyDBInstanceDelayedReplicationTimeRequest::setResourceOwnerId(long resourceOwnerId) {
