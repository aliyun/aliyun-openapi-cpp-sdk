...
PreCheckCreateOrderForRebuildResult::PreCheckCreateOrderForRebuildResult() :
	ServiceResult()
{}

PreCheckCreateOrderForRebuildResult::PreCheckCreateOrderForRebuildResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void PreCheckCreateOrderForRebuildResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
bool PreCheckCreateOrderForRebuildResult::getPreCheckResult()const
{
	return preCheckResult_;
}

std::vector<PreCheckCreateOrderForRebuildResult::FailuresItem> PreCheckCreateOrderForRebuildResult::getFailures()const
{
	return failures_;
}
