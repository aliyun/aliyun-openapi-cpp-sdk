...
PreCheckCreateOrderForDeferResult::PreCheckCreateOrderForDeferResult() :
	ServiceResult()
{}

PreCheckCreateOrderForDeferResult::PreCheckCreateOrderForDeferResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void PreCheckCreateOrderForDeferResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
bool PreCheckCreateOrderForDeferResult::getPreCheckResult()const
{
	return preCheckResult_;
}

std::vector<PreCheckCreateOrderForDeferResult::FailuresItem> PreCheckCreateOrderForDeferResult::getFailures()const
{
	return failures_;
}
