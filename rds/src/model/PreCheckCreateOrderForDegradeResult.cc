...
PreCheckCreateOrderForDegradeResult::PreCheckCreateOrderForDegradeResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void PreCheckCreateOrderForDegradeResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
bool PreCheckCreateOrderForDegradeResult::getPreCheckResult()const
{
	return preCheckResult_;
}

std::vector<PreCheckCreateOrderForDegradeResult::FailuresItem> PreCheckCreateOrderForDegradeResult::getFailures()const
{
	return failures_;
}
