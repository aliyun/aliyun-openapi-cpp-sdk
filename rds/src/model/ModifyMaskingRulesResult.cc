...
#include <alibabacloud/rds/model/ModifyMaskingRulesResult.h>
#include <json/json.h>
...
std::string ModifyMaskingRulesResult::getData()const
{
	return data_;
}

std::string ModifyMaskingRulesResult::getSuccess()const
{
	return success_;
}
