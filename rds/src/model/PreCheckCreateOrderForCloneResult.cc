...
PreCheckCreateOrderForCloneResult::PreCheckCreateOrderForCloneResult() :
	ServiceResult()
{}

PreCheckCreateOrderForCloneResult::PreCheckCreateOrderForCloneResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void PreCheckCreateOrderForCloneResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
bool PreCheckCreateOrderForCloneResult::getPreCheckResult()const
{
	return preCheckResult_;
}

std::vector<PreCheckCreateOrderForCloneResult::FailuresItem> PreCheckCreateOrderForCloneResult::getFailures()const
{
	return failures_;
}
