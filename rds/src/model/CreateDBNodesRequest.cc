...
#include <alibabacloud/rds/model/CreateDBNodesRequest.h>

using AlibabaCloud::Rds::Model::CreateDBNodesRequest;

CreateDBNodesRequest::CreateDBNodesRequest()
    : RpcServiceRequest("rds", "2014-08-15", "CreateDBNodes") {
...
void CreateDBNodesRequest::setDBNode(const std::string &dBNode) {
  dBNode_ = dBNode;
