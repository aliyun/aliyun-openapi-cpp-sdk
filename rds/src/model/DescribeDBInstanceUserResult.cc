...
DescribeDBInstanceUserResult::DescribeDBInstanceUserResult() :
	ServiceResult()
{}

DescribeDBInstanceUserResult::DescribeDBInstanceUserResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeDBInstanceUserResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeDBInstanceUserResult::getInternalDBFlag()const
{
