...
std::vector<QueryPriceForBuyResult::Rule> QueryPriceForBuyResult::getRules()const
{
	return rules_;
}

std::vector<QueryPriceForBuyResult::PriceInfo> QueryPriceForBuyResult::getPriceInfo()const
{
	return priceInfo_;
}
