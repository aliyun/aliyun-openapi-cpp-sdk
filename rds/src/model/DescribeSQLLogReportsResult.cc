...
void DescribeSQLLogReportsResult::setTotalRecordCount(int totalRecordCount)
{
...
void DescribeSQLLogReportsResult::setPageRecordCount(int pageRecordCount)
{
...
void DescribeSQLLogReportsResult::setPageNumber(int pageNumber)
{
