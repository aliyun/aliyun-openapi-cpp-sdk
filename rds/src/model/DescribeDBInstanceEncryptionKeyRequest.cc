...
#include <alibabacloud/rds/model/DescribeDBInstanceEncryptionKeyRequest.h>

using AlibabaCloud::Rds::Model::DescribeDBInstanceEncryptionKeyRequest;

DescribeDBInstanceEncryptionKeyRequest::DescribeDBInstanceEncryptionKeyRequest()
    : RpcServiceRequest("rds", "2014-08-15", "DescribeDBInstanceEncryptionKey") {
...
std::string DescribeDBInstanceEncryptionKeyRequest::getRegionId() const {
  return regionId_;
}

void DescribeDBInstanceEncryptionKeyRequest::setRegionId(const std::string &regionId) {
  regionId_ = regionId;
...
std::string DescribeDBInstanceEncryptionKeyRequest::getTargetRegionId() const {
  return targetRegionId_;
}

void DescribeDBInstanceEncryptionKeyRequest::setTargetRegionId(const std::string &targetRegionId) {
