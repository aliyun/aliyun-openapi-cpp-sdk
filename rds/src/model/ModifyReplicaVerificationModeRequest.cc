...
using AlibabaCloud::Rds::Model::ModifyReplicaVerificationModeRequest;

ModifyReplicaVerificationModeRequest::ModifyReplicaVerificationModeRequest() :
	RpcServiceRequest("rds", "2014-08-15", "ModifyReplicaVerificationMode")
{}
...
void ModifyReplicaVerificationModeRequest::setVerificationMode(const std::string& verificationMode)
{
	...
	setParameter("VerificationMode", verificationMode);
}
