...
void LoginDBInstancefromCloudDBAResult::setAttrData(const std::string& attrData)
{
	attrData_ = attrData;
}
...
void LoginDBInstancefromCloudDBAResult::setListData(const std::string& listData)
{
	listData_ = listData;
}
