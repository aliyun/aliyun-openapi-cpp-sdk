...
#include <alibabacloud/rds/model/ModifyActiveOperationTasksRequest.h>

using AlibabaCloud::Rds::Model::ModifyActiveOperationTasksRequest;

ModifyActiveOperationTasksRequest::ModifyActiveOperationTasksRequest()
    : RpcServiceRequest("rds", "2014-08-15", "ModifyActiveOperationTasks") {
