...
void DescribeBackupSetsForSecurityResult::setTotalRecordCount(const std::string& totalRecordCount)
{
...
void DescribeBackupSetsForSecurityResult::setPageRecordCount(const std::string& pageRecordCount)
{
...
void DescribeBackupSetsForSecurityResult::setPageNumber(const std::string& pageNumber)
{
...
void DescribeBackupSetsForSecurityResult::setTotalBackupSize(long totalBackupSize)
{
