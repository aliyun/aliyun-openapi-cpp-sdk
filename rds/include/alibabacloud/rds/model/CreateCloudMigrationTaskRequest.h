...
#ifndef ALIBABACLOUD_RDS_MODEL_CREATECLOUDMIGRATIONTASKREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_CREATECLOUDMIGRATIONTASKREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT CreateCloudMigrationTaskRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_CREATECLOUDMIGRATIONTASKREQUEST_H_
