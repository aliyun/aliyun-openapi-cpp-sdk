...
#ifndef ALIBABACLOUD_RDS_MODEL_DESCRIBEHISTORYTASKSRESULT_H_
#define ALIBABACLOUD_RDS_MODEL_DESCRIBEHISTORYTASKSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Rds
	{
		namespace Model
		{
			class ALIBABACLOUD_RDS_EXPORT DescribeHistoryTasksResult : public ServiceResult
			{
			public:
				struct ItemsItem
				{
...
#endif // !ALIBABACLOUD_RDS_MODEL_DESCRIBEHISTORYTASKSRESULT_H_