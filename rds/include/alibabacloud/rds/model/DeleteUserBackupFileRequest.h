...
#ifndef ALIBABACLOUD_RDS_MODEL_DELETEUSERBACKUPFILEREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT DeleteUserBackupFileRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_DELETEUSERBACKUPFILEREQUEST_H_
