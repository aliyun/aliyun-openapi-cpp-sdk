...
#ifndef ALIBABACLOUD_RDS_MODEL_MODIFYMASKINGRULESREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_MODIFYMASKINGRULESREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT ModifyMaskingRulesRequest : public RpcServiceRequest {
public:
	struct RuleConfig {
		std::string string;
...
#endif // !ALIBABACLOUD_RDS_MODEL_MODIFYMASKINGRULESREQUEST_H_
