...
#ifndef ALIBABACLOUD_RDS_MODEL_RESTOREDDRTABLEREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_RESTOREDDRTABLEREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT RestoreDdrTableRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_RESTOREDDRTABLEREQUEST_H_
