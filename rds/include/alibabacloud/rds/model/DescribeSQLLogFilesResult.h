...
#ifndef ALIBABACLOUD_RDS_MODEL_DESCRIBESQLLOGFILESRESULT_H_
#define ALIBABACLOUD_RDS_MODEL_DESCRIBESQLLOGFILESRESULT_H_
...
namespace AlibabaCloud
{
	namespace Rds
	{
		namespace Model
		{
			class ALIBABACLOUD_RDS_EXPORT DescribeSQLLogFilesResult : public ServiceResult
			{
			public:
				struct LogFile
				{
				...
				void setItems(const std::vector<LogFile>& items);
...
#endif // !ALIBABACLOUD_RDS_MODEL_DESCRIBESQLLOGFILESRESULT_H_