...
#ifndef ALIBABACLOUD_RDS_MODEL_DESCRIBECLOUDDBASERVICEREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_DESCRIBECLOUDDBASERVICEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Rds
	{
		namespace Model
		{
			class ALIBABACLOUD_RDS_EXPORT DescribeCloudDBAServiceRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_RDS_MODEL_DESCRIBECLOUDDBASERVICEREQUEST_H_