...
public:
	...
	bool getUseSpecifyRegionFilterCommodityResource() const;
	void setUseSpecifyRegionFilterCommodityResource(bool useSpecifyRegionFilterCommodityResource);
...
private:
	...
	bool useSpecifyRegionFilterCommodityResource_;
