...
#ifndef ALIBABACLOUD_RDS_MODEL_CREATESTATICVERIFICATIONREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_CREATESTATICVERIFICATIONREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Rds
	{
		namespace Model
		{
			class ALIBABACLOUD_RDS_EXPORT CreateStaticVerificationRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_RDS_MODEL_CREATESTATICVERIFICATIONREQUEST_H_