...
#ifndef ALIBABACLOUD_RDS_MODEL_RUNRCINSTANCESREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_RUNRCINSTANCESREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT RunRCInstancesRequest : public RpcServiceRequest {
public:
	struct SystemDisk {
		int size;
	...
	~RunRCInstancesRequest();
	std::string getCreateExtraParam() const;
	void setCreateExtraParam(const std::string &createExtraParam);
	...
	CreateAckEdgeParam getCreateAckEdgeParam() const;
	void setCreateAckEdgeParam(const CreateAckEdgeParam &createAckEdgeParam);
	...
	bool getUserDataInBase64() const;
	void setUserDataInBase64(bool userDataInBase64);
...
private:
	...
	int period_;
	bool dryRun_;
	CreateAckEdgeParam createAckEdgeParam_;
...
#endif // !ALIBABACLOUD_RDS_MODEL_RUNRCINSTANCESREQUEST_H_
