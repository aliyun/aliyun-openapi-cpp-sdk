...
#ifndef ALIBABACLOUD_RDS_MODEL_PRECHECKBEFOREIMPORTDATARESULT_H_
...
namespace AlibabaCloud
{
	namespace Rds
	{
		namespace Model
		{
			class ALIBABACLOUD_RDS_EXPORT PreCheckBeforeImportDataResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_PRECHECKBEFOREIMPORTDATARESULT_H_