...
#ifndef ALIBABACLOUD_RDS_MODEL_MODIFYDBNODEREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_MODIFYDBNODEREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT ModifyDBNodeRequest : public RpcServiceRequest {
public:
	ModifyDBNodeRequest();
	~ModifyDBNodeRequest();
	...
	bool getProduceAsync() const;
	void setProduceAsync(bool produceAsync);
...
#endif // !ALIBABACLOUD_RDS_MODEL_MODIFYDBNODEREQUEST_H_
