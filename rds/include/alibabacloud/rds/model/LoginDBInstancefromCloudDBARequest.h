...
#ifndef ALIBABACLOUD_RDS_MODEL_LOGINDBINSTANCEFROMCLOUDDBAREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_LOGINDBINSTANCEFROMCLOUDDBAREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Rds
	{
		namespace Model
		{
			class ALIBABACLOUD_RDS_EXPORT LoginDBInstancefromCloudDBARequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_RDS_MODEL_LOGINDBINSTANCEFROMCLOUDDBAREQUEST_H_