...
#ifndef ALIBABACLOUD_RDS_MODEL_QUERYPRICEFORBUYREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_QUERYPRICEFORBUYREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Rds
	{
		namespace Model
		{
			class ALIBABACLOUD_RDS_EXPORT QueryPriceForBuyRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_RDS_MODEL_QUERYPRICEFORBUYREQUEST_H_