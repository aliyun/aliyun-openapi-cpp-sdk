...
#ifndef ALIBABACLOUD_RDS_MODEL_MODIFYDBINSTANCEAUTOUPGRADEMINORVERSIONREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT ModifyDBInstanceAutoUpgradeMinorVersionRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_MODIFYDBINSTANCEAUTOUPGRADEMINORVERSIONREQUEST_H_
