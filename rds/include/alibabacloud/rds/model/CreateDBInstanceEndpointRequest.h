...
#ifndef ALIBABACLOUD_RDS_MODEL_CREATEDBINSTANCEENDPOINTREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_CREATEDBINSTANCEENDPOINTREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT CreateDBInstanceEndpointRequest : public RpcServiceRequest {
public:
	...
	std::string getDBInstanceEndpointType() const;
	void setDBInstanceEndpointType(const std::string &dBInstanceEndpointType);
...
#endif // !ALIBABACLOUD_RDS_MODEL_CREATEDBINSTANCEENDPOINTREQUEST_H_
