...
#ifndef ALIBABACLOUD_RDS_MODEL_CREATEDBINSTANCEENDPOINTADDRESSREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_CREATEDBINSTANCEENDPOINTADDRESSREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT CreateDBInstanceEndpointAddressRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_CREATEDBINSTANCEENDPOINTADDRESSREQUEST_H_
