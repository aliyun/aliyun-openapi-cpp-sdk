...
#ifndef ALIBABACLOUD_RDS_MODEL_SWITCHDBINSTANCENETTYPEREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_SWITCHDBINSTANCENETTYPEREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT SwitchDBInstanceNetTypeRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_SWITCHDBINSTANCENETTYPEREQUEST_H_
