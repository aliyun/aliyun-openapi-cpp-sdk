...
#ifndef ALIBABACLOUD_RDS_MODEL_SWITCHDBINSTANCENETTYPERESULT_H_
...
namespace AlibabaCloud
{
	namespace Rds
	{
		namespace Model
		{
			class ALIBABACLOUD_RDS_EXPORT SwitchDBInstanceNetTypeResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_SWITCHDBINSTANCENETTYPERESULT_H_