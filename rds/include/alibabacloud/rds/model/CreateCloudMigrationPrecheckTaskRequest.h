...
#ifndef ALIBABACLOUD_RDS_MODEL_CREATECLOUDMIGRATIONPRECHECKTASKREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_CREATECLOUDMIGRATIONPRECHECKTASKREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT CreateCloudMigrationPrecheckTaskRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_CREATECLOUDMIGRATIONPRECHECKTASKREQUEST_H_
