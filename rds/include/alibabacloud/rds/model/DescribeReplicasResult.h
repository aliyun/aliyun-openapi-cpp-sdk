...
#ifndef ALIBABACLOUD_RDS_MODEL_DESCRIBEREPLICASRESULT_H_
#define ALIBABACLOUD_RDS_MODEL_DESCRIBEREPLICASRESULT_H_
...
namespace AlibabaCloud
{
	namespace Rds
	{
		namespace Model
		{
			class ALIBABACLOUD_RDS_EXPORT DescribeReplicasResult : public ServiceResult
			{
			public:
				struct Items
				{
...
#endif // !ALIBABACLOUD_RDS_MODEL_DESCRIBEREPLICASRESULT_H_