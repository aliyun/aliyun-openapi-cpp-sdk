...
#ifndef ALIBABACLOUD_RDS_MODEL_DESCRIBESTRATEGYRESULT_H_
#define ALIBABACLOUD_RDS_MODEL_DESCRIBESTRATEGYRESULT_H_
...
namespace AlibabaCloud
{
	namespace Rds
	{
		namespace Model
		{
			class ALIBABACLOUD_RDS_EXPORT DescribeStrategyResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_DESCRIBESTRATEGYRESULT_H_