...
#ifndef ALIBABACLOUD_RDS_MODEL_PRECHECKBEFOREIMPORTDATAREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_PRECHECKBEFOREIMPORTDATAREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Rds
	{
		namespace Model
		{
			class ALIBABACLOUD_RDS_EXPORT PreCheckBeforeImportDataRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_RDS_MODEL_PRECHECKBEFOREIMPORTDATAREQUEST_H_