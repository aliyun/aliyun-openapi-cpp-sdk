...
#ifndef ALIBABACLOUD_RDS_MODEL_CLONEPARAMETERGROUPREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_CLONEPARAMETERGROUPREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT CloneParameterGroupRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_CLONEPARAMETERGROUPREQUEST_H_
