...
#ifndef ALIBABACLOUD_RDS_MODEL_MODIFYSQLCOLLECTORPOLICYREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT ModifySQLCollectorPolicyRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_MODIFYSQLCOLLECTORPOLICYREQUEST_H_
