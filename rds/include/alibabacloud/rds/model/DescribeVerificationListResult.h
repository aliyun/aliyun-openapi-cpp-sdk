...
#ifndef ALIBABACLOUD_RDS_MODEL_DESCRIBEVERIFICATIONLISTRESULT_H_
#define ALIBABACLOUD_RDS_MODEL_DESCRIBEVERIFICATIONLISTRESULT_H_
...
namespace AlibabaCloud
{
	namespace Rds
	{
		namespace Model
		{
			class ALIBABACLOUD_RDS_EXPORT DescribeVerificationListResult : public ServiceResult
			{
			public:
				struct ItemsItem
				{
...
#endif // !ALIBABACLOUD_RDS_MODEL_DESCRIBEVERIFICATIONLISTRESULT_H_