...
#ifndef ALIBABACLOUD_RDS_MODEL_REMOVETAGSFROMRESOURCEREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_REMOVETAGSFROMRESOURCEREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT RemoveTagsFromResourceRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_REMOVETAGSFROMRESOURCEREQUEST_H_
