...
#ifndef ALIBABACLOUD_RDS_MODEL_STARTDBINSTANCEREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_STARTDBINSTANCEREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT StartDBInstanceRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_STARTDBINSTANCEREQUEST_H_
