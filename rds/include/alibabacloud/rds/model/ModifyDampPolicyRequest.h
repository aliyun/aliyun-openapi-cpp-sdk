...
#ifndef ALIBABACLOUD_RDS_MODEL_MODIFYDAMPPOLICYREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_MODIFYDAMPPOLICYREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Rds
	{
		namespace Model
		{
			class ALIBABACLOUD_RDS_EXPORT ModifyDampPolicyRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_RDS_MODEL_MODIFYDAMPPOLICYREQUEST_H_