...
#ifndef ALIBABACLOUD_RDS_MODEL_MODIFYDBPROXYENDPOINTADDRESSREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_MODIFYDBPROXYENDPOINTADDRESSREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT ModifyDBProxyEndpointAddressRequest : public RpcServiceRequest {
public:
	...
	std::string getDBProxyNewConnectString() const;
	void setDBProxyNewConnectString(const std::string &dBProxyNewConnectString);
...
#endif // !ALIBABACLOUD_RDS_MODEL_MODIFYDBPROXYENDPOINTADDRESSREQUEST_H_
