...
#ifndef ALIBABACLOUD_RDS_MODEL_ACTIVATEMIGRATIONTARGETINSTANCEREQUEST_H_
#define ALIBABACLOUD_RDS_MODEL_ACTIVATEMIGRATIONTARGETINSTANCEREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT ActivateMigrationTargetInstanceRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_ACTIVATEMIGRATIONTARGETINSTANCEREQUEST_H_
