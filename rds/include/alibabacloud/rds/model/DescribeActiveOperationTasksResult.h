...
#ifndef ALIBABACLOUD_RDS_MODEL_DESCRIBEACTIVEOPERATIONTASKSRESULT_H_
#define ALIBABACLOUD_RDS_MODEL_DESCRIBEACTIVEOPERATIONTASKSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Rds
	{
		namespace Model
		{
			class ALIBABACLOUD_RDS_EXPORT DescribeActiveOperationTasksResult : public ServiceResult
			{
			public:
				struct ItemsItem
				{
...
#endif // !ALIBABACLOUD_RDS_MODEL_DESCRIBEACTIVEOPERATIONTASKSRESULT_H_