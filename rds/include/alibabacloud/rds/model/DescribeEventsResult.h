...
#ifndef ALIBABACLOUD_RDS_MODEL_DESCRIBEEVENTSRESULT_H_
#define ALIBABACLOUD_RDS_MODEL_DESCRIBEEVENTSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Rds
	{
		namespace Model
		{
			class ALIBABACLOUD_RDS_EXPORT DescribeEventsResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_DESCRIBEEVENTSRESULT_H_