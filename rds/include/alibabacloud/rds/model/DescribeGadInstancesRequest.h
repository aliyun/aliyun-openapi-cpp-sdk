...
#ifndef ALIBABACLOUD_RDS_MODEL_DESCRIBEGADINSTANCESREQUEST_H_
...
namespace Rds {
namespace Model {
class ALIBABACLOUD_RDS_EXPORT DescribeGadInstancesRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_RDS_MODEL_DESCRIBEGADINSTANCESREQUEST_H_
