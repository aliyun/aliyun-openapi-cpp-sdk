...
#ifndef ALIBABACLOUD_AIREC_MODEL_UPDATEEXPERIMENTSTATUSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Airec
	{
		namespace Model
		{
			class ALIBABACLOUD_AIREC_EXPORT UpdateExperimentStatusRequest : public RoaServiceRequest
			{
...
#endif // !ALIBABACLOUD_AIREC_MODEL_UPDATEEXPERIMENTSTATUSREQUEST_H_