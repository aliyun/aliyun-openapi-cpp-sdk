...
DescribeBaseExperimentResult::DescribeBaseExperimentResult() :
	ServiceResult()
{}

DescribeBaseExperimentResult::DescribeBaseExperimentResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeBaseExperimentResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeBaseExperimentResult::getRequestId()const
{
	return requestId_;
}

DescribeBaseExperimentResult::Result DescribeBaseExperimentResult::getResult()const
{
	return result_;
}
