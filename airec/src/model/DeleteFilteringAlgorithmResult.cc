...
DeleteFilteringAlgorithmResult::DeleteFilteringAlgorithmResult() :
	ServiceResult()
{}

DeleteFilteringAlgorithmResult::DeleteFilteringAlgorithmResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DeleteFilteringAlgorithmResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DeleteFilteringAlgorithmResult::getRequestId()const
{
	return requestId_;
}

DeleteFilteringAlgorithmResult::Result DeleteFilteringAlgorithmResult::getResult()const
{
	return result_;
}
