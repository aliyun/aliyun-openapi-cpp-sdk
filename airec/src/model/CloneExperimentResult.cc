...
CloneExperimentResult::CloneExperimentResult() :
	ServiceResult()
{}

CloneExperimentResult::CloneExperimentResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CloneExperimentResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string CloneExperimentResult::getRequestId()const
{
	return requestId_;
}

CloneExperimentResult::Result CloneExperimentResult::getResult()const
{
	return result_;
}
