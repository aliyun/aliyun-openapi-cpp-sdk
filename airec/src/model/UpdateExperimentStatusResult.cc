...
UpdateExperimentStatusResult::UpdateExperimentStatusResult() :
	ServiceResult()
{}

UpdateExperimentStatusResult::UpdateExperimentStatusResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateExperimentStatusResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string UpdateExperimentStatusResult::getRequestId()const
{
	return requestId_;
}

UpdateExperimentStatusResult::Result UpdateExperimentStatusResult::getResult()const
{
	return result_;
}
