...
OfflineFilteringAlgorithmResult::OfflineFilteringAlgorithmResult() :
	ServiceResult()
{}

OfflineFilteringAlgorithmResult::OfflineFilteringAlgorithmResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void OfflineFilteringAlgorithmResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string OfflineFilteringAlgorithmResult::getRequestId()const
{
	return requestId_;
}

OfflineFilteringAlgorithmResult::Result OfflineFilteringAlgorithmResult::getResult()const
{
	return result_;
}
