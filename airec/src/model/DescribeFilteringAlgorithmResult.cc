...
DescribeFilteringAlgorithmResult::DescribeFilteringAlgorithmResult() :
	ServiceResult()
{}

DescribeFilteringAlgorithmResult::DescribeFilteringAlgorithmResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeFilteringAlgorithmResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeFilteringAlgorithmResult::getRequestId()const
{
	return requestId_;
}

DescribeFilteringAlgorithmResult::Result DescribeFilteringAlgorithmResult::getResult()const
{
	return result_;
}
