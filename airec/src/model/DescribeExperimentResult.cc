...
DescribeExperimentResult::DescribeExperimentResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeExperimentResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeExperimentResult::getRequestId()const
{
	return requestId_;
}

DescribeExperimentResult::Result DescribeExperimentResult::getResult()const
{
	return result_;
}
