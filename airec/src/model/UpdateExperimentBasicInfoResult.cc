...
UpdateExperimentBasicInfoResult::UpdateExperimentBasicInfoResult() :
	ServiceResult()
{}

UpdateExperimentBasicInfoResult::UpdateExperimentBasicInfoResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateExperimentBasicInfoResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string UpdateExperimentBasicInfoResult::getRequestId()const
{
	return requestId_;
}

UpdateExperimentBasicInfoResult::Result UpdateExperimentBasicInfoResult::getResult()const
{
	return result_;
}
