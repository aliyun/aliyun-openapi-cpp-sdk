...
using AlibabaCloud::Polardbx::Model::DescribeParametersRequest;

DescribeParametersRequest::DescribeParametersRequest()
    : RpcServiceRequest("polardbx", "2020-02-02", "DescribeParameters") {
...
std::string DescribeParametersRequest::getParamLevel() const {
  return paramLevel_;
}

void DescribeParametersRequest::setParamLevel(const std::string &paramLevel) {
