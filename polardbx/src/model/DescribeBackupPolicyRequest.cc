...
using AlibabaCloud::Polardbx::Model::DescribeBackupPolicyRequest;

DescribeBackupPolicyRequest::DescribeBackupPolicyRequest()
    : RpcServiceRequest("polardbx", "2020-02-02", "DescribeBackupPolicy") {
  setMethod(HttpRequest::Method::Post);
}

DescribeBackupPolicyRequest::~DescribeBackupPolicyRequest() {}

std::string DescribeBackupPolicyRequest::getDBInstanceName() const {
  return dBInstanceName_;
}

void DescribeBackupPolicyRequest::setDBInstanceName(const std::string &dBInstanceName) {
