...
using AlibabaCloud::Polardbx::Model::ReleaseInstancePublicConnectionRequest;

ReleaseInstancePublicConnectionRequest::ReleaseInstancePublicConnectionRequest()
    : RpcServiceRequest("polardbx", "2020-02-02", "ReleaseInstancePublicConnection") {
  setMethod(HttpRequest::Method::Post);
}

ReleaseInstancePublicConnectionRequest::~ReleaseInstancePublicConnectionRequest() {}

std::string ReleaseInstancePublicConnectionRequest::getDBInstanceName() const {
  return dBInstanceName_;
}

void ReleaseInstancePublicConnectionRequest::setDBInstanceName(const std::string &dBInstanceName) {
