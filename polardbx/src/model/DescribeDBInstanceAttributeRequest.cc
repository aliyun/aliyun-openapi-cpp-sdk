...
using AlibabaCloud::Polardbx::Model::DescribeDBInstanceAttributeRequest;

DescribeDBInstanceAttributeRequest::DescribeDBInstanceAttributeRequest()
    : RpcServiceRequest("polardbx", "2020-02-02", "DescribeDBInstanceAttribute") {
  setMethod(HttpRequest::Method::Post);
}

DescribeDBInstanceAttributeRequest::~DescribeDBInstanceAttributeRequest() {}

std::string DescribeDBInstanceAttributeRequest::getDBInstanceName() const {
  return dBInstanceName_;
}

void DescribeDBInstanceAttributeRequest::setDBInstanceName(const std::string &dBInstanceName) {
