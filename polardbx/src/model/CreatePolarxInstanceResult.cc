...
CreatePolarxInstanceResult::CreatePolarxInstanceResult() :
	ServiceResult()
{}

CreatePolarxInstanceResult::CreatePolarxInstanceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CreatePolarxInstanceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
CreatePolarxInstanceResult::Data CreatePolarxInstanceResult::getData()const
{
	return data_;
}

bool CreatePolarxInstanceResult::getSuccess()const
{
	return success_;
}
