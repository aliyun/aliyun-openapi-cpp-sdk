...
using AlibabaCloud::Polardbx::Model::DescribeDBInstanceTDERequest;

DescribeDBInstanceTDERequest::DescribeDBInstanceTDERequest()
    : RpcServiceRequest("polardbx", "2020-02-02", "DescribeDBInstanceTDE") {
  setMethod(HttpRequest::Method::Post);
}

DescribeDBInstanceTDERequest::~DescribeDBInstanceTDERequest() {}

std::string DescribeDBInstanceTDERequest::getDBInstanceName() const {
  return dBInstanceName_;
}

void DescribeDBInstanceTDERequest::setDBInstanceName(const std::string &dBInstanceName) {
