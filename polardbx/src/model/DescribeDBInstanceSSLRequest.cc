...
using AlibabaCloud::Polardbx::Model::DescribeDBInstanceSSLRequest;

DescribeDBInstanceSSLRequest::DescribeDBInstanceSSLRequest()
    : RpcServiceRequest("polardbx", "2020-02-02", "DescribeDBInstanceSSL") {
  setMethod(HttpRequest::Method::Post);
}

DescribeDBInstanceSSLRequest::~DescribeDBInstanceSSLRequest() {}

std::string DescribeDBInstanceSSLRequest::getDBInstanceName() const {
  return dBInstanceName_;
}

void DescribeDBInstanceSSLRequest::setDBInstanceName(const std::string &dBInstanceName) {
