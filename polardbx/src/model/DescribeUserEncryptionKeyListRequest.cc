...
using AlibabaCloud::Polardbx::Model::DescribeUserEncryptionKeyListRequest;

DescribeUserEncryptionKeyListRequest::DescribeUserEncryptionKeyListRequest()
    : RpcServiceRequest("polardbx", "2020-02-02", "DescribeUserEncryptionKeyList") {
  setMethod(HttpRequest::Method::Post);
}

DescribeUserEncryptionKeyListRequest::~DescribeUserEncryptionKeyListRequest() {}

std::string DescribeUserEncryptionKeyListRequest::getDBInstanceName() const {
  return dBInstanceName_;
}

void DescribeUserEncryptionKeyListRequest::setDBInstanceName(const std::string &dBInstanceName) {
