...
DescribeInstanceDbPerformanceResult::DescribeInstanceDbPerformanceResult() :
	ServiceResult()
{}

DescribeInstanceDbPerformanceResult::DescribeInstanceDbPerformanceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeInstanceDbPerformanceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeInstanceDbPerformanceResult::getMessage()const
{
	return message_;
}

DescribeInstanceDbPerformanceResult::Data DescribeInstanceDbPerformanceResult::getData()const
{
	return data_;
}

bool DescribeInstanceDbPerformanceResult::getSuccess()const
{
	return success_;
}
