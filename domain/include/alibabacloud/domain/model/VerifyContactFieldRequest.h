...
#ifndef ALIBABACLOUD_DOMAIN_MODEL_VERIFYCONTACTFIELDREQUEST_H_
#define ALIBABACLOUD_DOMAIN_MODEL_VERIFYCONTACTFIELDREQUEST_H_
...
namespace Domain {
namespace Model {
class ALIBABACLOUD_DOMAIN_EXPORT VerifyContactFieldRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_DOMAIN_MODEL_VERIFYCONTACTFIELDREQUEST_H_
