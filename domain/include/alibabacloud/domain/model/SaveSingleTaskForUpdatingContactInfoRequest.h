...
#ifndef ALIBABACLOUD_DOMAIN_MODEL_SAVESINGLETASKFORUPDATINGCONTACTINFOREQUEST_H_
#define ALIBABACLOUD_DOMAIN_MODEL_SAVESINGLETASKFORUPDATINGCONTACTINFOREQUEST_H_
...
namespace Domain {
namespace Model {
class ALIBABACLOUD_DOMAIN_EXPORT SaveSingleTaskForUpdatingContactInfoRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_DOMAIN_MODEL_SAVESINGLETASKFORUPDATINGCONTACTINFOREQUEST_H_
