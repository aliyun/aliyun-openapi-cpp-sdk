...
PollTaskResultResult::PollTaskResultResult() :
	ServiceResult()
{}

PollTaskResultResult::PollTaskResultResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
bool PollTaskResultResult::getPrePage()const
{
	return prePage_;
}

int PollTaskResultResult::getCurrentPageNum()const
{
	return currentPageNum_;
}

int PollTaskResultResult::getPageSize()const
{
	return pageSize_;
}

int PollTaskResultResult::getTotalPageNum()const
{
	return totalPageNum_;
}

std::vector<PollTaskResultResult::TaskDetail> PollTaskResultResult::getData()const
{
	return data_;
}

int PollTaskResultResult::getTotalItemNum()const
{
	return totalItemNum_;
}

bool PollTaskResultResult::getNextPage()const
{
	return nextPage_;
}
