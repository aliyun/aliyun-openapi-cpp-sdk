...
using AlibabaCloud::Domain::Model::SaveSingleTaskForCancelingTransferInRequest;

SaveSingleTaskForCancelingTransferInRequest::SaveSingleTaskForCancelingTransferInRequest()
    : RpcServiceRequest("domain", "2018-01-29", "SaveSingleTaskForCancelingTransferIn") {
  setMethod(HttpRequest::Method::Post);
}

SaveSingleTaskForCancelingTransferInRequest::~SaveSingleTaskForCancelingTransferInRequest() {}

std::string SaveSingleTaskForCancelingTransferInRequest::getDomainName() const {
  return domainName_;
}
