...
using AlibabaCloud::Domain::Model::SaveSingleTaskForSynchronizingDnsHostRequest;
...
std::string SaveSingleTaskForSynchronizingDnsHostRequest::getInstanceId() const {
  return instanceId_;
}

void SaveSingleTaskForSynchronizingDnsHostRequest::setInstanceId(const std::string &instanceId) {
...
void SaveSingleTaskForSynchronizingDnsHostRequest::setLang(const std::string &lang) {
  lang_ = lang;
