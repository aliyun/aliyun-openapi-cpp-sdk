...
ResendEmailVerificationResult::ResendEmailVerificationResult() :
	ServiceResult()
{}

ResendEmailVerificationResult::ResendEmailVerificationResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
std::vector<ResendEmailVerificationResult::SendResult> ResendEmailVerificationResult::getSuccessList()const
{
	return successList_;
}

std::vector<ResendEmailVerificationResult::SendResult> ResendEmailVerificationResult::getFailList()const
{
	return failList_;
}
