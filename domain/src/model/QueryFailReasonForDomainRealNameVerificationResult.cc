...
QueryFailReasonForDomainRealNameVerificationResult::QueryFailReasonForDomainRealNameVerificationResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
std::vector<QueryFailReasonForDomainRealNameVerificationResult::FailRecord> QueryFailReasonForDomainRealNameVerificationResult::getData()const
{
	return data_;
}
