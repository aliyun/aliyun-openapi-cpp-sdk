...
UpdateExtendfilesResult::UpdateExtendfilesResult() :
	ServiceResult()
{}

UpdateExtendfilesResult::UpdateExtendfilesResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateExtendfilesResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<UpdateExtendfilesResult::ResultItem> UpdateExtendfilesResult::getResult()const
{
	return result_;
}
