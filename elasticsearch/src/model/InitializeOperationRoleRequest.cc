...
#include <alibabacloud/elasticsearch/model/InitializeOperationRoleRequest.h>

using AlibabaCloud::Elasticsearch::Model::InitializeOperationRoleRequest;

InitializeOperationRoleRequest::InitializeOperationRoleRequest()
    : RoaServiceRequest("elasticsearch", "2017-06-13") {
  setResourcePath("/openapi/user/slr"};
