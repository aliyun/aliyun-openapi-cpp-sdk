...
UpdateSynonymsDictsResult::UpdateSynonymsDictsResult() :
	ServiceResult()
{}

UpdateSynonymsDictsResult::UpdateSynonymsDictsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateSynonymsDictsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<UpdateSynonymsDictsResult::DictList> UpdateSynonymsDictsResult::getResult()const
{
	return result_;
}
