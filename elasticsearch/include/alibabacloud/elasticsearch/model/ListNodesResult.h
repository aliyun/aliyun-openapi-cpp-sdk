...
#ifndef ALIBABACLOUD_ELASTICSEARCH_MODEL_LISTNODESRESULT_H_
#define ALIBABACLOUD_ELASTICSEARCH_MODEL_LISTNODESRESULT_H_
...
namespace AlibabaCloud
{
	namespace Elasticsearch
	{
		namespace Model
		{
			class ALIBABACLOUD_ELASTICSEARCH_EXPORT ListNodesResult : public ServiceResult
			{
			public:
				struct Headers
				{
...
#endif // !ALIBABACLOUD_ELASTICSEARCH_MODEL_LISTNODESRESULT_H_