...
#ifndef ALIBABACLOUD_ELASTICSEARCH_MODEL_UPDATECOLLECTORRESULT_H_
#define ALIBABACLOUD_ELASTICSEARCH_MODEL_UPDATECOLLECTORRESULT_H_
...
namespace AlibabaCloud
{
	namespace Elasticsearch
	{
		namespace Model
		{
			class ALIBABACLOUD_ELASTICSEARCH_EXPORT UpdateCollectorResult : public ServiceResult
			{
			public:
				struct Result
				{
				...
				explicit UpdateCollectorResult(const std::string &payload);
				~UpdateCollectorResult();
...
#endif // !ALIBABACLOUD_ELASTICSEARCH_MODEL_UPDATECOLLECTORRESULT_H_