...
#include "model/SubmitCensorJobRequest.h"
#include "model/SubmitCensorJobResult.h"
...
namespace AlibabaCloud
{
	namespace Mts
	{
		...
		public:
			...
			typedef Outcome<Error, Model::SubmitCensorJobResult> SubmitCensorJobOutcome;
			typedef std::future<SubmitCensorJobOutcome> SubmitCensorJobOutcomeCallable;
			typedef std::function<void(const MtsClient*, const Model::SubmitCensorJobRequest&, const SubmitCensorJobOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> SubmitCensorJobAsyncHandler;
			...
			SubmitCensorJobOutcome submitCensorJob(const Model::SubmitCensorJobRequest &request)const;
			void submitCensorJobAsync(const Model::SubmitCensorJobRequest& request, const SubmitCensorJobAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			SubmitCensorJobOutcomeCallable submitCensorJobCallable(const Model::SubmitCensorJobRequest& request) const;
