...
#ifndef ALIBABACLOUD_MTS_MODEL_REGISTERCUSTOMVIEWREQUEST_H_
#define ALIBABACLOUD_MTS_MODEL_REGISTERCUSTOMVIEWREQUEST_H_
...
namespace Mts {
namespace Model {
class ALIBABACLOUD_MTS_EXPORT RegisterCustomViewRequest : public RpcServiceRequest {
public:
