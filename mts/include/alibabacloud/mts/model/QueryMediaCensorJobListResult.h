...
#ifndef ALIBABACLOUD_MTS_MODEL_QUERYMEDIACENSORJOBLISTRESULT_H_
#define ALIBABACLOUD_MTS_MODEL_QUERYMEDIACENSORJOBLISTRESULT_H_
...
namespace AlibabaCloud
{
	namespace Mts
	{
		namespace Model
		{
			class ALIBABACLOUD_MTS_EXPORT QueryMediaCensorJobListResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_MTS_MODEL_QUERYMEDIACENSORJOBLISTRESULT_H_