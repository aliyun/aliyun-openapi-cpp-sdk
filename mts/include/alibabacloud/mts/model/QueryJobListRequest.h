...
#ifndef ALIBABACLOUD_MTS_MODEL_QUERYJOBLISTREQUEST_H_
...
namespace Mts {
namespace Model {
class ALIBABACLOUD_MTS_EXPORT QueryJobListRequest : public RpcServiceRequest {
public:
	QueryJobListRequest();
	~QueryJobListRequest();
...
#endif // !ALIBABACLOUD_MTS_MODEL_QUERYJOBLISTREQUEST_H_
