...
#ifndef ALIBABACLOUD_MTS_MODEL_UPDATEMEDIAWORKFLOWTRIGGERMODEREQUEST_H_
...
namespace Mts {
namespace Model {
class ALIBABACLOUD_MTS_EXPORT UpdateMediaWorkflowTriggerModeRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_MTS_MODEL_UPDATEMEDIAWORKFLOWTRIGGERMODEREQUEST_H_
