...
#ifndef ALIBABACLOUD_MTS_MODEL_SUBMITSNAPSHOTJOBREQUEST_H_
#define ALIBABACLOUD_MTS_MODEL_SUBMITSNAPSHOTJOBREQUEST_H_
...
namespace Mts {
namespace Model {
class ALIBABACLOUD_MTS_EXPORT SubmitSnapshotJobRequest : public RpcServiceRequest {
public:
