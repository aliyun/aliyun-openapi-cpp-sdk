...
#ifndef ALIBABACLOUD_MTS_MODEL_SUBMITCOMPLEXJOBRESULT_H_
...
namespace Mts {
namespace Model {
class ALIBABACLOUD_MTS_EXPORT SubmitComplexJobResult : public ServiceResult {
public:
  struct ComplexJob {
    ...
    std::vector<ComplexEditingConfigsItem> complexEditingConfigs;
    std::string pipelineId;
    TranscodeOutput transcodeOutput;
    std::vector<InputsItem> inputs;
    std::string code;
    std::string jobId;
  };

  SubmitComplexJobResult();
  explicit SubmitComplexJobResult(const std::string &payload);
  ~SubmitComplexJobResult();
  ComplexJob getComplexJob() const;

protected:
  void parse(const std::string &payload);

private:
  ComplexJob complexJob_;
};
} // namespace Model
} // namespace Mts
} // namespace AlibabaCloud
#endif // !ALIBABACLOUD_MTS_MODEL_SUBMITCOMPLEXJOBRESULT_H_