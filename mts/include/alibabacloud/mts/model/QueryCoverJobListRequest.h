...
#ifndef ALIBABACLOUD_MTS_MODEL_QUERYCOVERJOBLISTREQUEST_H_
#define ALIBABACLOUD_MTS_MODEL_QUERYCOVERJOBLISTREQUEST_H_
...
namespace Mts {
namespace Model {
class ALIBABACLOUD_MTS_EXPORT QueryCoverJobListRequest
...
public:
  ...
  void
  setStartOfJobCreatedTimeRange(const std::string &startOfJobCreatedTimeRange);
...
#endif // !ALIBABACLOUD_MTS_MODEL_QUERYCOVERJOBLISTREQUEST_H_