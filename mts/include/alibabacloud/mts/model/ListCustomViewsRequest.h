...
#ifndef ALIBABACLOUD_MTS_MODEL_LISTCUSTOMVIEWSREQUEST_H_
...
namespace Mts {
namespace Model {
class ALIBABACLOUD_MTS_EXPORT ListCustomViewsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_MTS_MODEL_LISTCUSTOMVIEWSREQUEST_H_
