...
#ifndef ALIBABACLOUD_MTS_MODEL_QUERYMEDIALISTBYURLRESULT_H_
#define ALIBABACLOUD_MTS_MODEL_QUERYMEDIALISTBYURLRESULT_H_
...
namespace AlibabaCloud
{
	namespace Mts
	{
		namespace Model
		{
			class ALIBABACLOUD_MTS_EXPORT QueryMediaListByURLResult : public ServiceResult
			{
			public:
				struct Media
				{
				...
				QueryMediaListByURLResult();
				explicit QueryMediaListByURLResult(const std::string &payload);
				~QueryMediaListByURLResult();
				std::vector<Media> getMediaList()const;
				std::vector<std::string> getNonExistFileURLs()const;

			protected:
				void parse(const std::string &payload);
			private:
				std::vector<Media> mediaList_;
				std::vector<std::string> nonExistFileURLs_;

			};
		}
	}
}
#endif // !ALIBABACLOUD_MTS_MODEL_QUERYMEDIALISTBYURLRESULT_H_