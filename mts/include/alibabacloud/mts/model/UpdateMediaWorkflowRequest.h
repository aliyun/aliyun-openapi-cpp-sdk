...
#ifndef ALIBABACLOUD_MTS_MODEL_UPDATEMEDIAWORKFLOWREQUEST_H_
#define ALIBABACLOUD_MTS_MODEL_UPDATEMEDIAWORKFLOWREQUEST_H_
...
namespace Mts {
namespace Model {
class ALIBABACLOUD_MTS_EXPORT UpdateMediaWorkflowRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_MTS_MODEL_UPDATEMEDIAWORKFLOWREQUEST_H_
