...
UpdateAsrPipelineResult::UpdateAsrPipelineResult() :
	ServiceResult()
{}

UpdateAsrPipelineResult::UpdateAsrPipelineResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateAsrPipelineResult::parse(const std::string &payload)
{
...
UpdateAsrPipelineResult::Pipeline UpdateAsrPipelineResult::getPipeline()const
{
	return pipeline_;
}
