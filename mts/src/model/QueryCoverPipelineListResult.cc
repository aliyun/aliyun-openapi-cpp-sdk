...
QueryCoverPipelineListResult::QueryCoverPipelineListResult() :
	ServiceResult()
{}

QueryCoverPipelineListResult::QueryCoverPipelineListResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryCoverPipelineListResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<QueryCoverPipelineListResult::Pipeline> QueryCoverPipelineListResult::getPipelineList()const
{
	return pipelineList_;
}

std::vector<std::string> QueryCoverPipelineListResult::getNonExistIds()const
{
	return nonExistIds_;
}
