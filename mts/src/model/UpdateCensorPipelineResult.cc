...
UpdateCensorPipelineResult::UpdateCensorPipelineResult() :
	ServiceResult()
{}

UpdateCensorPipelineResult::UpdateCensorPipelineResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateCensorPipelineResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
UpdateCensorPipelineResult::Pipeline UpdateCensorPipelineResult::getPipeline()const
{
	return pipeline_;
}
