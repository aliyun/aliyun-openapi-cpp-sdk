...
UpdateCoverPipelineResult::UpdateCoverPipelineResult() :
	ServiceResult()
{}

UpdateCoverPipelineResult::UpdateCoverPipelineResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateCoverPipelineResult::parse(const std::string &payload)
{
...
UpdateCoverPipelineResult::Pipeline UpdateCoverPipelineResult::getPipeline()const
{
	return pipeline_;
}
