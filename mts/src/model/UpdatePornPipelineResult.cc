...
UpdatePornPipelineResult::UpdatePornPipelineResult() :
	ServiceResult()
{}

UpdatePornPipelineResult::UpdatePornPipelineResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdatePornPipelineResult::parse(const std::string &payload)
{
...
UpdatePornPipelineResult::Pipeline UpdatePornPipelineResult::getPipeline()const
{
	return pipeline_;
}
