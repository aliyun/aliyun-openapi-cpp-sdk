...
UpdateMediaWorkflowResult::UpdateMediaWorkflowResult() :
	ServiceResult()
{}

UpdateMediaWorkflowResult::UpdateMediaWorkflowResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateMediaWorkflowResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
UpdateMediaWorkflowResult::MediaWorkflow UpdateMediaWorkflowResult::getMediaWorkflow()const
{
