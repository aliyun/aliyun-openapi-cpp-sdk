...
DescribeAuditRangeResult::DescribeAuditRangeResult() :
	ServiceResult()
{}

DescribeAuditRangeResult::DescribeAuditRangeResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeAuditRangeResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
DescribeAuditRangeResult::AuditRange DescribeAuditRangeResult::getAuditRange()const
{
	return auditRange_;
}
