...
ExportKeywordsResult::ExportKeywordsResult() :
	ServiceResult()
{}

ExportKeywordsResult::ExportKeywordsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
std::string ExportKeywordsResult::getDownloadUrl()const
{
	return downloadUrl_;
}
