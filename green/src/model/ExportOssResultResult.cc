...
ExportOssResultResult::ExportOssResultResult() :
	ServiceResult()
{}

ExportOssResultResult::ExportOssResultResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
std::string ExportOssResultResult::getFileUrl()const
{
	return fileUrl_;
}
