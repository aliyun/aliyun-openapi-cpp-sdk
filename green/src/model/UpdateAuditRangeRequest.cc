...
#include <alibabacloud/green/model/UpdateAuditRangeRequest.h>

using AlibabaCloud::Green::Model::UpdateAuditRangeRequest;
...
std::string UpdateAuditRangeRequest::getAuditRange()const
{
	return auditRange_;
}
