...
#include <alibabacloud/green/model/DeleteBizTypeRequest.h>

using AlibabaCloud::Green::Model::DeleteBizTypeRequest;
...
std::string DeleteBizTypeRequest::getSourceIp()const
{
	return sourceIp_;
}
