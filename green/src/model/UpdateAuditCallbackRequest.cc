...
#include <alibabacloud/green/model/UpdateAuditCallbackRequest.h>

using AlibabaCloud::Green::Model::UpdateAuditCallbackRequest;
...
std::string UpdateAuditCallbackRequest::getSeed()const
{
	return seed_;
}
