...
#ifndef ALIBABACLOUD_GREEN_MODEL_EXPORTOSSRESULTREQUEST_H_
#define ALIBABACLOUD_GREEN_MODEL_EXPORTOSSRESULTREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Green
	{
		namespace Model
		{
			class ALIBABACLOUD_GREEN_EXPORT ExportOssResultRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_GREEN_MODEL_EXPORTOSSRESULTREQUEST_H_