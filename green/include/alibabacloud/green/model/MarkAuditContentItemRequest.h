...
#ifndef ALIBABACLOUD_GREEN_MODEL_MARKAUDITCONTENTITEMREQUEST_H_
#define ALIBABACLOUD_GREEN_MODEL_MARKAUDITCONTENTITEMREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Green
	{
		namespace Model
		{
			class ALIBABACLOUD_GREEN_EXPORT MarkAuditContentItemRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_GREEN_MODEL_MARKAUDITCONTENTITEMREQUEST_H_