...
#ifndef ALIBABACLOUD_VOD_MODEL_SETCROSSDOMAINCONTENTREQUEST_H_
#define ALIBABACLOUD_VOD_MODEL_SETCROSSDOMAINCONTENTREQUEST_H_
...
namespace Vod {
namespace Model {
class ALIBABACLOUD_VOD_EXPORT SetCrossdomainContentRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VOD_MODEL_SETCROSSDOMAINCONTENTREQUEST_H_
