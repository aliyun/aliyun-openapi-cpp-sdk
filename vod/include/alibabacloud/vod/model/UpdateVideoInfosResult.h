...
#ifndef ALIBABACLOUD_VOD_MODEL_UPDATEVIDEOINFOSRESULT_H_
#define ALIBABACLOUD_VOD_MODEL_UPDATEVIDEOINFOSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Vod
	{
		namespace Model
		{
			class ALIBABACLOUD_VOD_EXPORT UpdateVideoInfosResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_VOD_MODEL_UPDATEVIDEOINFOSRESULT_H_