...
#ifndef ALIBABACLOUD_VOD_MODEL_SETDEFAULTTRANSCODETEMPLATEGROUPREQUEST_H_
...
namespace Vod {
namespace Model {
class ALIBABACLOUD_VOD_EXPORT SetDefaultTranscodeTemplateGroupRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VOD_MODEL_SETDEFAULTTRANSCODETEMPLATEGROUPREQUEST_H_
