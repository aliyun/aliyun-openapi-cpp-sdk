...
RefreshVodObjectCachesResult::RefreshVodObjectCachesResult() :
	ServiceResult()
{}

RefreshVodObjectCachesResult::RefreshVodObjectCachesResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
std::string RefreshVodObjectCachesResult::getRefreshTaskId()const
{
