...
PreloadVodObjectCachesResult::PreloadVodObjectCachesResult() :
	ServiceResult()
{}

PreloadVodObjectCachesResult::PreloadVodObjectCachesResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
std::string PreloadVodObjectCachesResult::getPreloadTaskId()const
{
