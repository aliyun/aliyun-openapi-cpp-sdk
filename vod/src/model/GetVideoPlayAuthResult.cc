...
GetVideoPlayAuthResult::GetVideoPlayAuthResult() :
	ServiceResult()
{}

GetVideoPlayAuthResult::GetVideoPlayAuthResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
std::string GetVideoPlayAuthResult::getPlayAuth()const
{
	return playAuth_;
}

GetVideoPlayAuthResult::VideoMeta GetVideoPlayAuthResult::getVideoMeta()const
{
	return videoMeta_;
}
