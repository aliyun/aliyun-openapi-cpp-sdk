...
CheckBlockVolumeNameResult::CheckBlockVolumeNameResult() :
	ServiceResult()
{}

CheckBlockVolumeNameResult::CheckBlockVolumeNameResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CheckBlockVolumeNameResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string CheckBlockVolumeNameResult::getIsRequireRecovery()const
{
	return isRequireRecovery_;
}

std::string CheckBlockVolumeNameResult::getMessage()const
{
	return message_;
}
