...
#ifndef ALIBABACLOUD_SGW_MODEL_DESCRIBESTORAGEBUNDLEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Sgw
	{
		namespace Model
		{
			class ALIBABACLOUD_SGW_EXPORT DescribeStorageBundleRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_SGW_MODEL_DESCRIBESTORAGEBUNDLEREQUEST_H_