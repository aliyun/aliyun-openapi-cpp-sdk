...
#ifndef ALIBABACLOUD_SGW_MODEL_REPORTFILESHARESREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Sgw
	{
		namespace Model
		{
			class ALIBABACLOUD_SGW_EXPORT ReportFileSharesRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_SGW_MODEL_REPORTFILESHARESREQUEST_H_