...
#ifndef ALIBABACLOUD_SGW_MODEL_DESCRIBEGATEWAYTYPESREQUEST_H_
#define ALIBABACLOUD_SGW_MODEL_DESCRIBEGATEWAYTYPESREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Sgw
	{
		namespace Model
		{
			class ALIBABACLOUD_SGW_EXPORT DescribeGatewayTypesRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_SGW_MODEL_DESCRIBEGATEWAYTYPESREQUEST_H_