...
#ifndef ALIBABACLOUD_SGW_MODEL_MODIFYGATEWAYFILESHAREREQUEST_H_
#define ALIBABACLOUD_SGW_MODEL_MODIFYGATEWAYFILESHAREREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Sgw
	{
		namespace Model
		{
			class ALIBABACLOUD_SGW_EXPORT ModifyGatewayFileShareRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_SGW_MODEL_MODIFYGATEWAYFILESHAREREQUEST_H_