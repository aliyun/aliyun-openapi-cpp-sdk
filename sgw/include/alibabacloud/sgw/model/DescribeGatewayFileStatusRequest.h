...
#ifndef ALIBABACLOUD_SGW_MODEL_DESCRIBEGATEWAYFILESTATUSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Sgw
	{
		namespace Model
		{
			class ALIBABACLOUD_SGW_EXPORT DescribeGatewayFileStatusRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_SGW_MODEL_DESCRIBEGATEWAYFILESTATUSREQUEST_H_