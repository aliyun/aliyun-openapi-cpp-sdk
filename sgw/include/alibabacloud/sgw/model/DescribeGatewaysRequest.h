...
#ifndef ALIBABACLOUD_SGW_MODEL_DESCRIBEGATEWAYSREQUEST_H_
#define ALIBABACLOUD_SGW_MODEL_DESCRIBEGATEWAYSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Sgw
	{
		namespace Model
		{
			class ALIBABACLOUD_SGW_EXPORT DescribeGatewaysRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_SGW_MODEL_DESCRIBEGATEWAYSREQUEST_H_