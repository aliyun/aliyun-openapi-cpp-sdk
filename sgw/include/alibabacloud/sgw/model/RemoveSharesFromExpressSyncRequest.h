...
#ifndef ALIBABACLOUD_SGW_MODEL_REMOVESHARESFROMEXPRESSSYNCREQUEST_H_
#define ALIBABACLOUD_SGW_MODEL_REMOVESHARESFROMEXPRESSSYNCREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Sgw
	{
		namespace Model
		{
			class ALIBABACLOUD_SGW_EXPORT RemoveSharesFromExpressSyncRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_SGW_MODEL_REMOVESHARESFROMEXPRESSSYNCREQUEST_H_