...
#ifndef ALIBABACLOUD_SGW_MODEL_DESCRIBEOSSBUCKETINFOREQUEST_H_
#define ALIBABACLOUD_SGW_MODEL_DESCRIBEOSSBUCKETINFOREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Sgw
	{
		namespace Model
		{
			class ALIBABACLOUD_SGW_EXPORT DescribeOssBucketInfoRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_SGW_MODEL_DESCRIBEOSSBUCKETINFOREQUEST_H_