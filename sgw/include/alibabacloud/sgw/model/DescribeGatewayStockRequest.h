...
#ifndef ALIBABACLOUD_SGW_MODEL_DESCRIBEGATEWAYSTOCKREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Sgw
	{
		namespace Model
		{
			class ALIBABACLOUD_SGW_EXPORT DescribeGatewayStockRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_SGW_MODEL_DESCRIBEGATEWAYSTOCKREQUEST_H_