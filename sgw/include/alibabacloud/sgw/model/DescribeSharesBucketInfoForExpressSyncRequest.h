...
#ifndef ALIBABACLOUD_SGW_MODEL_DESCRIBESHARESBUCKETINFOFOREXPRESSSYNCREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Sgw
	{
		namespace Model
		{
			class ALIBABACLOUD_SGW_EXPORT DescribeSharesBucketInfoForExpressSyncRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_SGW_MODEL_DESCRIBESHARESBUCKETINFOFOREXPRESSSYNCREQUEST_H_