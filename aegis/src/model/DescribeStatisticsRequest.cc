...
using AlibabaCloud::Aegis::Model::DescribeStatisticsRequest;

DescribeStatisticsRequest::DescribeStatisticsRequest() :
	RpcServiceRequest("aegis", "2016-11-11", "DescribeStatistics")
{}

DescribeStatisticsRequest::~DescribeStatisticsRequest()
{}

std::string DescribeStatisticsRequest::getSourceIp()const
{
	return sourceIp_;
}
