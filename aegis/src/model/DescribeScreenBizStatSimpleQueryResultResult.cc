...
DescribeScreenBizStatSimpleQueryResultResult::DescribeScreenBizStatSimpleQueryResultResult() :
	ServiceResult()
{}

DescribeScreenBizStatSimpleQueryResultResult::DescribeScreenBizStatSimpleQueryResultResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
std::vector<DescribeScreenBizStatSimpleQueryResultResult::BizStatTrendDOS> DescribeScreenBizStatSimpleQueryResultResult::getTrendDataArr()const
{
	return trendDataArr_;
}

std::vector<std::string> DescribeScreenBizStatSimpleQueryResultResult::getDataTimeArray()const
{
	return dataTimeArray_;
}

bool DescribeScreenBizStatSimpleQueryResultResult::getSuccess()const
{
	return success_;
}
