...
using AlibabaCloud::Aegis::Model::DescribeScreenSummaryInfoRequest;

DescribeScreenSummaryInfoRequest::DescribeScreenSummaryInfoRequest() :
	RpcServiceRequest("aegis", "2016-11-11", "DescribeScreenSummaryInfo")
{}

DescribeScreenSummaryInfoRequest::~DescribeScreenSummaryInfoRequest()
{}

std::string DescribeScreenSummaryInfoRequest::getSourceIp()const
{
	return sourceIp_;
}
