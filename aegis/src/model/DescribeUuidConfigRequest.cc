...
using AlibabaCloud::Aegis::Model::DescribeUuidConfigRequest;

DescribeUuidConfigRequest::DescribeUuidConfigRequest() :
	RpcServiceRequest("aegis", "2016-11-11", "DescribeUuidConfig")
{}
...
std::string DescribeUuidConfigRequest::getSourceIp()const
{
	return sourceIp_;
}
