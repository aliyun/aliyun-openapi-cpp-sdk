...
using AlibabaCloud::Aegis::Model::ModifyRefreshProcessInfoRequest;

ModifyRefreshProcessInfoRequest::ModifyRefreshProcessInfoRequest() :
	RpcServiceRequest("aegis", "2016-11-11", "ModifyRefreshProcessInfo")
{}
...
std::string ModifyRefreshProcessInfoRequest::getSourceIp()const
{
	return sourceIp_;
}
