...
using AlibabaCloud::Aegis::Model::OpenSasTrialRequest;

OpenSasTrialRequest::OpenSasTrialRequest() :
	RpcServiceRequest("aegis", "2016-11-11", "OpenSasTrial")
{}

OpenSasTrialRequest::~OpenSasTrialRequest()
{}

std::string OpenSasTrialRequest::getSourceIp()const
{
	return sourceIp_;
}
