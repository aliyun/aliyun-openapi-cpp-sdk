...
using AlibabaCloud::Aegis::Model::DescribeOperateInfoRequest;

DescribeOperateInfoRequest::DescribeOperateInfoRequest() :
	RpcServiceRequest("aegis", "2016-11-11", "DescribeOperateInfo")
{}

DescribeOperateInfoRequest::~DescribeOperateInfoRequest()
{}

std::string DescribeOperateInfoRequest::getSourceIp()const
{
	return sourceIp_;
}
