...
using AlibabaCloud::Aegis::Model::DescribeTopRiskyAssetsRequest;

DescribeTopRiskyAssetsRequest::DescribeTopRiskyAssetsRequest() :
	RpcServiceRequest("aegis", "2016-11-11", "DescribeTopRiskyAssets")
{}

DescribeTopRiskyAssetsRequest::~DescribeTopRiskyAssetsRequest()
{}

std::string DescribeTopRiskyAssetsRequest::getSourceIp()const
{
	return sourceIp_;
}
