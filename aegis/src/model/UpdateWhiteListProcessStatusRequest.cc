...
using AlibabaCloud::Aegis::Model::UpdateWhiteListProcessStatusRequest;

UpdateWhiteListProcessStatusRequest::UpdateWhiteListProcessStatusRequest() :
	RpcServiceRequest("aegis", "2016-11-11", "UpdateWhiteListProcessStatus")
{}

UpdateWhiteListProcessStatusRequest::~UpdateWhiteListProcessStatusRequest()
{}

std::string UpdateWhiteListProcessStatusRequest::getProcessIds()const
{
	return processIds_;
}
