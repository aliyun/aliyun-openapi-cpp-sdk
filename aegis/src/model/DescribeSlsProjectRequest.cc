...
using AlibabaCloud::Aegis::Model::DescribeSlsProjectRequest;

DescribeSlsProjectRequest::DescribeSlsProjectRequest() :
	RpcServiceRequest("aegis", "2016-11-11", "DescribeSlsProject")
{}
...
std::string DescribeSlsProjectRequest::getSourceIp()const
{
	return sourceIp_;
}
