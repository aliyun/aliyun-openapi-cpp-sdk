...
DescribeTopicListResult::DescribeTopicListResult() :
	ServiceResult()
{}

DescribeTopicListResult::DescribeTopicListResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
std::vector<std::string> DescribeTopicListResult::getTopicList()const
{
	return topicList_;
}
