...
using AlibabaCloud::Aegis::Model::DescribeFilterFieldsRequest;

DescribeFilterFieldsRequest::DescribeFilterFieldsRequest() :
	RpcServiceRequest("aegis", "2016-11-11", "DescribeFilterFields")
{}
...
std::string DescribeFilterFieldsRequest::getSourceIp()const
{
	return sourceIp_;
}
