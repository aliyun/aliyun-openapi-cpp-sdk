...
using AlibabaCloud::Aegis::Model::ModifyOpenLogShipperRequest;

ModifyOpenLogShipperRequest::ModifyOpenLogShipperRequest() :
	RpcServiceRequest("aegis", "2016-11-11", "ModifyOpenLogShipper")
{}
...
std::string ModifyOpenLogShipperRequest::getLang()const
{
	return lang_;
}

void ModifyOpenLogShipperRequest::setLang(const std::string& lang)
{
	lang_ = lang;
