...
using AlibabaCloud::Aegis::Model::ModifyVulLevelRequest;

ModifyVulLevelRequest::ModifyVulLevelRequest() :
	RpcServiceRequest("aegis", "2016-11-11", "ModifyVulLevel")
{}

ModifyVulLevelRequest::~ModifyVulLevelRequest()
{}

std::string ModifyVulLevelRequest::getConcernLevel()const
{
	return concernLevel_;
}
