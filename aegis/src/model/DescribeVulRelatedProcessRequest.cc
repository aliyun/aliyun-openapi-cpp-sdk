...
using AlibabaCloud::Aegis::Model::DescribeVulRelatedProcessRequest;

DescribeVulRelatedProcessRequest::DescribeVulRelatedProcessRequest() :
	RpcServiceRequest("aegis", "2016-11-11", "DescribeVulRelatedProcess")
{}
...
std::string DescribeVulRelatedProcessRequest::getSourceIp()const
{
	return sourceIp_;
}
