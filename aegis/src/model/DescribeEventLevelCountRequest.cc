...
using AlibabaCloud::Aegis::Model::DescribeEventLevelCountRequest;

DescribeEventLevelCountRequest::DescribeEventLevelCountRequest() :
	RpcServiceRequest("aegis", "2016-11-11", "DescribeEventLevelCount")
{}
...
void DescribeEventLevelCountRequest::setSourceIp(const std::string& sourceIp)
{
	sourceIp_ = sourceIp;
