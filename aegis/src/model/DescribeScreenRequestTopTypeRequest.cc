...
using AlibabaCloud::Aegis::Model::DescribeScreenRequestTopTypeRequest;

DescribeScreenRequestTopTypeRequest::DescribeScreenRequestTopTypeRequest() :
	RpcServiceRequest("aegis", "2016-11-11", "DescribeScreenRequestTopType")
{}
...
void DescribeScreenRequestTopTypeRequest::setType(const std::string& type)
{
	type_ = type;
