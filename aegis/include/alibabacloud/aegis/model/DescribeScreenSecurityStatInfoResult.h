...
#ifndef ALIBABACLOUD_AEGIS_MODEL_DESCRIBESCREENSECURITYSTATINFORESULT_H_
...
namespace AlibabaCloud
{
	namespace Aegis
	{
		namespace Model
		{
			class ALIBABACLOUD_AEGIS_EXPORT DescribeScreenSecurityStatInfoResult : public ServiceResult
			{
			public:
				...
				DescribeScreenSecurityStatInfoResult();
				explicit DescribeScreenSecurityStatInfoResult(const std::string &payload);
				~DescribeScreenSecurityStatInfoResult();
...
#endif // !ALIBABACLOUD_AEGIS_MODEL_DESCRIBESCREENSECURITYSTATINFORESULT_H_