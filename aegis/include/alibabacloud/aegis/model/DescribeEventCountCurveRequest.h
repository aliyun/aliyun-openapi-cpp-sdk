...
#ifndef ALIBABACLOUD_AEGIS_MODEL_DESCRIBEEVENTCOUNTCURVEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Aegis
	{
		namespace Model
		{
			class ALIBABACLOUD_AEGIS_EXPORT DescribeEventCountCurveRequest : public RpcServiceRequest
			{

			public:
				DescribeEventCountCurveRequest();
				~DescribeEventCountCurveRequest();
...
#endif // !ALIBABACLOUD_AEGIS_MODEL_DESCRIBEEVENTCOUNTCURVEREQUEST_H_