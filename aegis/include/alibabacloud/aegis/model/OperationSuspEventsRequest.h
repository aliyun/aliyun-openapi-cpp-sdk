...
#ifndef ALIBABACLOUD_AEGIS_MODEL_OPERATIONSUSPEVENTSREQUEST_H_
#define ALIBABACLOUD_AEGIS_MODEL_OPERATIONSUSPEVENTSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Aegis
	{
		namespace Model
		{
			class ALIBABACLOUD_AEGIS_EXPORT OperationSuspEventsRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_AEGIS_MODEL_OPERATIONSUSPEVENTSREQUEST_H_