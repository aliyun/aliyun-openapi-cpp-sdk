...
#ifndef ALIBABACLOUD_AEGIS_MODEL_DESCRIBESASLEFTCONDITIONREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Aegis
	{
		namespace Model
		{
			class ALIBABACLOUD_AEGIS_EXPORT DescribeSasLeftConditionRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_AEGIS_MODEL_DESCRIBESASLEFTCONDITIONREQUEST_H_