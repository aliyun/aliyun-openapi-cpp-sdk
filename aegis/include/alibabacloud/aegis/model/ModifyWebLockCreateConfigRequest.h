...
#ifndef ALIBABACLOUD_AEGIS_MODEL_MODIFYWEBLOCKCREATECONFIGREQUEST_H_
#define ALIBABACLOUD_AEGIS_MODEL_MODIFYWEBLOCKCREATECONFIGREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Aegis
	{
		namespace Model
		{
			class ALIBABACLOUD_AEGIS_EXPORT ModifyWebLockCreateConfigRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_AEGIS_MODEL_MODIFYWEBLOCKCREATECONFIGREQUEST_H_