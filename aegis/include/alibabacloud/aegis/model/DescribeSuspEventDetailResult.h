...
#ifndef ALIBABACLOUD_AEGIS_MODEL_DESCRIBESUSPEVENTDETAILRESULT_H_
...
namespace AlibabaCloud
{
	namespace Aegis
	{
		namespace Model
		{
			class ALIBABACLOUD_AEGIS_EXPORT DescribeSuspEventDetailResult : public ServiceResult
			{
			public:
				struct QuaraFile
				{
...
#endif // !ALIBABACLOUD_AEGIS_MODEL_DESCRIBESUSPEVENTDETAILRESULT_H_