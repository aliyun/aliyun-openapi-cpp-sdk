...
#ifndef ALIBABACLOUD_AEGIS_MODEL_MODIFYSEARCHCONDITIONREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Aegis
	{
		namespace Model
		{
			class ALIBABACLOUD_AEGIS_EXPORT ModifySearchConditionRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_AEGIS_MODEL_MODIFYSEARCHCONDITIONREQUEST_H_