...
namespace Aegis {
namespace Model {
class ALIBABACLOUD_AEGIS_EXPORT DescribeAgentInstallStatusResult
...
public:
  ...
  ~DescribeAgentInstallStatusResult();
  std::vector<AegisClientInvokeStatusResponse>
  getAegisClientInvokeStatusResponseList() const;
...
private:
  std::vector<AegisClientInvokeStatusResponse>
      aegisClientInvokeStatusResponseList_;
};
} // namespace Model
} // namespace Aegis
} // namespace AlibabaCloud
