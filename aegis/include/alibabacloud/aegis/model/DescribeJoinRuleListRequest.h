...
#ifndef ALIBABACLOUD_AEGIS_MODEL_DESCRIBEJOINRULELISTREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Aegis
	{
		namespace Model
		{
			class ALIBABACLOUD_AEGIS_EXPORT DescribeJoinRuleListRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_AEGIS_MODEL_DESCRIBEJOINRULELISTREQUEST_H_