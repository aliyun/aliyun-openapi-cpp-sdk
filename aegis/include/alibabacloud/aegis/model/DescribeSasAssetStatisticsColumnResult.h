...
#ifndef ALIBABACLOUD_AEGIS_MODEL_DESCRIBESASASSETSTATISTICSCOLUMNRESULT_H_
...
namespace AlibabaCloud
{
	namespace Aegis
	{
		namespace Model
		{
			class ALIBABACLOUD_AEGIS_EXPORT DescribeSasAssetStatisticsColumnResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_AEGIS_MODEL_DESCRIBESASASSETSTATISTICSCOLUMNRESULT_H_