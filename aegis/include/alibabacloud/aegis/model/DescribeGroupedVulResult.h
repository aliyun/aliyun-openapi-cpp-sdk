...
#ifndef ALIBABACLOUD_AEGIS_MODEL_DESCRIBEGROUPEDVULRESULT_H_
...
namespace AlibabaCloud
{
	namespace Aegis
	{
		namespace Model
		{
			class ALIBABACLOUD_AEGIS_EXPORT DescribeGroupedVulResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_AEGIS_MODEL_DESCRIBEGROUPEDVULRESULT_H_