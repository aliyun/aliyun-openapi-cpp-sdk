...
#ifndef ALIBABACLOUD_AEGIS_MODEL_DESCRIBESUSPICIOUSOVERALLCONFIGRESULT_H_
...
namespace AlibabaCloud
{
	namespace Aegis
	{
		namespace Model
		{
			class ALIBABACLOUD_AEGIS_EXPORT DescribeSuspiciousOverallConfigResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_AEGIS_MODEL_DESCRIBESUSPICIOUSOVERALLCONFIGRESULT_H_