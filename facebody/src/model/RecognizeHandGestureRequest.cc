...
void RecognizeHandGestureRequest::setGestureType(const std::string &gestureType) {
  ...
  setBodyParameter(std::string("GestureType"), gestureType);
}

bool RecognizeHandGestureRequest::getFormatResultToJson() const {
  return formatResultToJson_;
}

void RecognizeHandGestureRequest::setFormatResultToJson(bool formatResultToJson) {
  formatResultToJson_ = formatResultToJson;
  setParameter(std::string("FormatResultToJson"), formatResultToJson ? "true" : "false");
}

std::string RecognizeHandGestureRequest::getOssFile() const {
  return ossFile_;
}

void RecognizeHandGestureRequest::setOssFile(const std::string &ossFile) {
  ossFile_ = ossFile;
  setParameter(std::string("OssFile"), ossFile);
}

std::string RecognizeHandGestureRequest::getRequestProxyBy() const {
  return requestProxyBy_;
}

void RecognizeHandGestureRequest::setRequestProxyBy(const std::string &requestProxyBy) {
