...
void GenerateHumanAnimeStyleRequest::setAlgoType(const std::string &algoType) {
  algoType_ = algoType;
  setParameter(std::string("AlgoType"), algoType);
}

bool GenerateHumanAnimeStyleRequest::getFormatResultToJson() const {
  return formatResultToJson_;
}

void GenerateHumanAnimeStyleRequest::setFormatResultToJson(bool formatResultToJson) {
  formatResultToJson_ = formatResultToJson;
  setParameter(std::string("FormatResultToJson"), formatResultToJson ? "true" : "false");
}

std::string GenerateHumanAnimeStyleRequest::getOssFile() const {
  return ossFile_;
}

void GenerateHumanAnimeStyleRequest::setOssFile(const std::string &ossFile) {
  ossFile_ = ossFile;
  setParameter(std::string("OssFile"), ossFile);
}

std::string GenerateHumanAnimeStyleRequest::getRequestProxyBy() const {
  return requestProxyBy_;
}

void GenerateHumanAnimeStyleRequest::setRequestProxyBy(const std::string &requestProxyBy) {
