...
bool GetFaceEntityRequest::getFormatResultToJson() const {
  return formatResultToJson_;
}

void GetFaceEntityRequest::setFormatResultToJson(bool formatResultToJson) {
  formatResultToJson_ = formatResultToJson;
  setParameter(std::string("FormatResultToJson"), formatResultToJson ? "true" : "false");
}

std::string GetFaceEntityRequest::getOssFile() const {
  return ossFile_;
}

void GetFaceEntityRequest::setOssFile(const std::string &ossFile) {
  ossFile_ = ossFile;
  setParameter(std::string("OssFile"), ossFile);
}

std::string GetFaceEntityRequest::getRequestProxyBy() const {
  return requestProxyBy_;
}

void GetFaceEntityRequest::setRequestProxyBy(const std::string &requestProxyBy) {
