...
void UpdateBoardCallbackRequest::setProxy_original_security_transport(bool proxy_original_security_transport)
{
	proxy_original_security_transport_ = proxy_original_security_transport;
	setCoreParameter("Proxy_original_security_transport", proxy_original_security_transport ? "true" : "false");
}

std::string UpdateBoardCallbackRequest::getProxy_original_source_ip()const
{
...
void UpdateBoardCallbackRequest::setProxy_trust_transport_info(bool proxy_trust_transport_info)
{
	proxy_trust_transport_info_ = proxy_trust_transport_info;
	setCoreParameter("Proxy_trust_transport_info", proxy_trust_transport_info ? "true" : "false");
}

bool UpdateBoardCallbackRequest::getAk_mfa_present()const
{
	return ak_mfa_present_;
}

void UpdateBoardCallbackRequest::setAk_mfa_present(bool ak_mfa_present)
{
	ak_mfa_present_ = ak_mfa_present;
	setCoreParameter("Ak_mfa_present", ak_mfa_present ? "true" : "false");
}

bool UpdateBoardCallbackRequest::getSecurity_transport()const
{
	return security_transport_;
}

void UpdateBoardCallbackRequest::setSecurity_transport(bool security_transport)
{
	security_transport_ = security_transport;
	setCoreParameter("Security_transport", security_transport ? "true" : "false");
}

std::string UpdateBoardCallbackRequest::getRequestId()const
{
	return requestId_;
}
