...
std::string UpdateLiveRecordNotifyConfigRequest::getAccessKeyId()const
{
	return accessKeyId_;
}

void UpdateLiveRecordNotifyConfigRequest::setAccessKeyId(const std::string& accessKeyId)
{
