...
std::string ListLiveRealtimeLogDeliveryInfosRequest::getRegionId() const {
  return regionId_;
}

void ListLiveRealtimeLogDeliveryInfosRequest::setRegionId(const std::string &regionId) {
  regionId_ = regionId;
