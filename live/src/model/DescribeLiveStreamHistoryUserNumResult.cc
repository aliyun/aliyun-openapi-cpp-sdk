...
DescribeLiveStreamHistoryUserNumResult::DescribeLiveStreamHistoryUserNumResult() :
	ServiceResult()
{}

DescribeLiveStreamHistoryUserNumResult::DescribeLiveStreamHistoryUserNumResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeLiveStreamHistoryUserNumResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeLiveStreamHistoryUserNumResult::LiveStreamUserNumInfo> DescribeLiveStreamHistoryUserNumResult::getLiveStreamUserNumInfos()const
{
	return liveStreamUserNumInfos_;
}
