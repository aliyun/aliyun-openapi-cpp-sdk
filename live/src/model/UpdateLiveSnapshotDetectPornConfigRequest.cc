...
std::string UpdateLiveSnapshotDetectPornConfigRequest::getAccessKeyId()const
{
	return accessKeyId_;
}

void UpdateLiveSnapshotDetectPornConfigRequest::setAccessKeyId(const std::string& accessKeyId)
{
