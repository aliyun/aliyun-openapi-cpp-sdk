...
void UpdateCasterSceneAudioRequest::setAudioLayer(const std::vector<UpdateCasterSceneAudioRequest::AudioLayer> &audioLayer) {
...
void UpdateCasterSceneAudioRequest::setFollowEnable(int followEnable) {
  ...
  setParameter(std::string("FollowEnable"), std::to_string(followEnable));
}
