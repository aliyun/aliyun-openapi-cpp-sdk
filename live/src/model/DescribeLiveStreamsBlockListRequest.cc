...
std::string DescribeLiveStreamsBlockListRequest::getAccessKeyId()const
{
	return accessKeyId_;
}

void DescribeLiveStreamsBlockListRequest::setAccessKeyId(const std::string& accessKeyId)
{
