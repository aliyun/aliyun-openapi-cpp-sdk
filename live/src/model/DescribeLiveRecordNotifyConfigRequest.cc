...
std::string DescribeLiveRecordNotifyConfigRequest::getAccessKeyId()const
{
	return accessKeyId_;
}

void DescribeLiveRecordNotifyConfigRequest::setAccessKeyId(const std::string& accessKeyId)
{
