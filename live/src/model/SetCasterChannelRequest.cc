...
void SetCasterChannelRequest::setFaceBeauty(const std::string &faceBeauty) {
  ...
  setParameter(std::string("FaceBeauty"), faceBeauty);
}
...
void SetCasterChannelRequest::setSeekOffset(int seekOffset) {
  ...
  setParameter(std::string("SeekOffset"), std::to_string(seekOffset));
}
...
void SetCasterChannelRequest::setReloadFlag(int reloadFlag) {
  ...
  setParameter(std::string("ReloadFlag"), std::to_string(reloadFlag));
}
