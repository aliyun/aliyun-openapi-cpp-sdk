...
std::string DescribeLiveDomainCertificateInfoRequest::getRegionId() const {
  return regionId_;
}

void DescribeLiveDomainCertificateInfoRequest::setRegionId(const std::string &regionId) {
  regionId_ = regionId;
