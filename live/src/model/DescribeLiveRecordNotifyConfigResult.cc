...
DescribeLiveRecordNotifyConfigResult::DescribeLiveRecordNotifyConfigResult() :
	ServiceResult()
{}

DescribeLiveRecordNotifyConfigResult::DescribeLiveRecordNotifyConfigResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
DescribeLiveRecordNotifyConfigResult::LiveRecordNotifyConfig DescribeLiveRecordNotifyConfigResult::getLiveRecordNotifyConfig()const
{
	return liveRecordNotifyConfig_;
}
