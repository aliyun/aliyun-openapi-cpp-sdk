...
std::string UpdateLiveAudioAuditNotifyConfigRequest::getRegionId() const {
  return regionId_;
}

void UpdateLiveAudioAuditNotifyConfigRequest::setRegionId(const std::string &regionId) {
  regionId_ = regionId;
