...
using AlibabaCloud::Live::Model::DescribeLiveUserTagsRequest;

DescribeLiveUserTagsRequest::DescribeLiveUserTagsRequest()
    : RpcServiceRequest("live", "2016-11-01", "DescribeLiveUserTags") {
...
void DescribeLiveUserTagsRequest::setOwnerId(long ownerId) {
  ownerId_ = ownerId;
