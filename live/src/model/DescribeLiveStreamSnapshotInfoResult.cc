...
void DescribeLiveStreamSnapshotInfoResult::parse(const std::string &payload)
{
	...
	for (auto valueLiveStreamSnapshotInfoListLiveStreamSnapshotInfo : allLiveStreamSnapshotInfoListNode)
	{
		...
		if(!valueLiveStreamSnapshotInfoListLiveStreamSnapshotInfo["IsOverlay"].isNull())
			liveStreamSnapshotInfoListObject.isOverlay = valueLiveStreamSnapshotInfoListLiveStreamSnapshotInfo["IsOverlay"].asString() == "true";
		if(!valueLiveStreamSnapshotInfoListLiveStreamSnapshotInfo["CreateTimestamp"].isNull())
			liveStreamSnapshotInfoListObject.createTimestamp = std::stol(valueLiveStreamSnapshotInfoListLiveStreamSnapshotInfo["CreateTimestamp"].asString());
