...
namespace Live {
namespace Model {
class ALIBABACLOUD_LIVE_EXPORT DescribeLiveDomainOnlineUserNumRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LIVE_MODEL_DESCRIBELIVEDOMAINONLINEUSERNUMREQUEST_H_
