...
#ifndef ALIBABACLOUD_LIVE_MODEL_DESCRIBELIVESTREAMSNAPSHOTINFORESULT_H_
#define ALIBABACLOUD_LIVE_MODEL_DESCRIBELIVESTREAMSNAPSHOTINFORESULT_H_
...
namespace AlibabaCloud
{
	namespace Live
	{
		namespace Model
		{
			class ALIBABACLOUD_LIVE_EXPORT DescribeLiveStreamSnapshotInfoResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_LIVE_MODEL_DESCRIBELIVESTREAMSNAPSHOTINFORESULT_H_