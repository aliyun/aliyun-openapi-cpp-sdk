...
#ifndef ALIBABACLOUD_LIVE_MODEL_UPDATELIVERECORDNOTIFYCONFIGREQUEST_H_
#define ALIBABACLOUD_LIVE_MODEL_UPDATELIVERECORDNOTIFYCONFIGREQUEST_H_
...
namespace Live {
namespace Model {
class ALIBABACLOUD_LIVE_EXPORT UpdateLiveRecordNotifyConfigRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LIVE_MODEL_UPDATELIVERECORDNOTIFYCONFIGREQUEST_H_
