...
#ifndef ALIBABACLOUD_LIVE_MODEL_MODIFYSTUDIOLAYOUTREQUEST_H_
#define ALIBABACLOUD_LIVE_MODEL_MODIFYSTUDIOLAYOUTREQUEST_H_
...
namespace Live {
namespace Model {
class ALIBABACLOUD_LIVE_EXPORT ModifyStudioLayoutRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LIVE_MODEL_MODIFYSTUDIOLAYOUTREQUEST_H_
