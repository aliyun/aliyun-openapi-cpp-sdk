...
#ifndef ALIBABACLOUD_LIVE_MODEL_LISTLIVEREALTIMELOGDELIVERYREQUEST_H_
#define ALIBABACLOUD_LIVE_MODEL_LISTLIVEREALTIMELOGDELIVERYREQUEST_H_
...
namespace Live {
namespace Model {
class ALIBABACLOUD_LIVE_EXPORT ListLiveRealtimeLogDeliveryRequest : public RpcServiceRequest {
public:
