...
#ifndef ALIBABACLOUD_LIVE_MODEL_STARTMIXSTREAMSSERVICEREQUEST_H_
#define ALIBABACLOUD_LIVE_MODEL_STARTMIXSTREAMSSERVICEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Live
	{
		namespace Model
		{
			class ALIBABACLOUD_LIVE_EXPORT StartMixStreamsServiceRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_LIVE_MODEL_STARTMIXSTREAMSSERVICEREQUEST_H_