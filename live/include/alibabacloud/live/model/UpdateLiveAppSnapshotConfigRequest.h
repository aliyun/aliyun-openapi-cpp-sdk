...
#ifndef ALIBABACLOUD_LIVE_MODEL_UPDATELIVEAPPSNAPSHOTCONFIGREQUEST_H_
#define ALIBABACLOUD_LIVE_MODEL_UPDATELIVEAPPSNAPSHOTCONFIGREQUEST_H_
...
namespace Live {
namespace Model {
class ALIBABACLOUD_LIVE_EXPORT UpdateLiveAppSnapshotConfigRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LIVE_MODEL_UPDATELIVEAPPSNAPSHOTCONFIGREQUEST_H_
