...
#define ALIBABACLOUD_LIVE_MODEL_DESCRIBELIVELAZYPULLSTREAMCONFIGREQUEST_H_
...
namespace Live {
namespace Model {
class ALIBABACLOUD_LIVE_EXPORT DescribeLiveLazyPullStreamConfigRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LIVE_MODEL_DESCRIBELIVELAZYPULLSTREAMCONFIGREQUEST_H_
