...
#ifndef ALIBABACLOUD_LIVE_MODEL_DESCRIBELIVESTREAMRECORDCONTENTRESULT_H_
...
namespace AlibabaCloud
{
	namespace Live
	{
		namespace Model
		{
			class ALIBABACLOUD_LIVE_EXPORT DescribeLiveStreamRecordContentResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_LIVE_MODEL_DESCRIBELIVESTREAMRECORDCONTENTRESULT_H_