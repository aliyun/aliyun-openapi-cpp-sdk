...
#ifndef ALIBABACLOUD_LIVE_MODEL_ADDLIVEAISUBTITLEREQUEST_H_
#define ALIBABACLOUD_LIVE_MODEL_ADDLIVEAISUBTITLEREQUEST_H_
...
namespace Live {
namespace Model {
class ALIBABACLOUD_LIVE_EXPORT AddLiveAISubtitleRequest : public RpcServiceRequest {
public:
	...
	std::string getCopyFrom() const;
	void setCopyFrom(const std::string &copyFrom);
...
private:
	...
	std::string width_;
	std::string copyFrom_;
};
} // namespace Model
} // namespace Live
} // namespace AlibabaCloud
#endif // !ALIBABACLOUD_LIVE_MODEL_ADDLIVEAISUBTITLEREQUEST_H_
