...
namespace Live {
namespace Model {
class ALIBABACLOUD_LIVE_EXPORT DescribeLiveDomainPushTrafficDataRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LIVE_MODEL_DESCRIBELIVEDOMAINPUSHTRAFFICDATAREQUEST_H_
