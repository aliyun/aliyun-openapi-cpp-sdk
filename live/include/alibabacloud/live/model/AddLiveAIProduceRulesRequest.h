...
#ifndef ALIBABACLOUD_LIVE_MODEL_ADDLIVEAIPRODUCERULESREQUEST_H_
...
namespace Live {
namespace Model {
class ALIBABACLOUD_LIVE_EXPORT AddLiveAIProduceRulesRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LIVE_MODEL_ADDLIVEAIPRODUCERULESREQUEST_H_
