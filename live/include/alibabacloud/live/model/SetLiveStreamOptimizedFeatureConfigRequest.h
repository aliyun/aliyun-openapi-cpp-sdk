...
#ifndef ALIBABACLOUD_LIVE_MODEL_SETLIVESTREAMOPTIMIZEDFEATURECONFIGREQUEST_H_
#define ALIBABACLOUD_LIVE_MODEL_SETLIVESTREAMOPTIMIZEDFEATURECONFIGREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Live
	{
		namespace Model
		{
			class ALIBABACLOUD_LIVE_EXPORT SetLiveStreamOptimizedFeatureConfigRequest : public RpcServiceRequest
			{
			...
			public:
				...
				void setConfigStatus(const std::string& configStatus);
...
#endif // !ALIBABACLOUD_LIVE_MODEL_SETLIVESTREAMOPTIMIZEDFEATURECONFIGREQUEST_H_