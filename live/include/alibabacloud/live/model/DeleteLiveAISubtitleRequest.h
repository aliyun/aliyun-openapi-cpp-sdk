...
#ifndef ALIBABACLOUD_LIVE_MODEL_DELETELIVEAISUBTITLEREQUEST_H_
...
namespace Live {
namespace Model {
class ALIBABACLOUD_LIVE_EXPORT DeleteLiveAISubtitleRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LIVE_MODEL_DELETELIVEAISUBTITLEREQUEST_H_
