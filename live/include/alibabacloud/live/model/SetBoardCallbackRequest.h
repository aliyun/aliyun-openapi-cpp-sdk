...
#ifndef ALIBABACLOUD_LIVE_MODEL_SETBOARDCALLBACKREQUEST_H_
#define ALIBABACLOUD_LIVE_MODEL_SETBOARDCALLBACKREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Live
	{
		namespace Model
		{
			class ALIBABACLOUD_LIVE_EXPORT SetBoardCallbackRequest : public RpcServiceRequest
			{

			public:
				SetBoardCallbackRequest();
				~SetBoardCallbackRequest();
...
#endif // !ALIBABACLOUD_LIVE_MODEL_SETBOARDCALLBACKREQUEST_H_