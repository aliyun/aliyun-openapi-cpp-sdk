...
namespace Live {
namespace Model {
class ALIBABACLOUD_LIVE_EXPORT DescribeLiveRecordNotifyConfigRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LIVE_MODEL_DESCRIBELIVERECORDNOTIFYCONFIGREQUEST_H_
