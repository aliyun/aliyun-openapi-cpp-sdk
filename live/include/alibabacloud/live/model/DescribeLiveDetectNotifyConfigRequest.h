...
namespace Live {
namespace Model {
class ALIBABACLOUD_LIVE_EXPORT DescribeLiveDetectNotifyConfigRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LIVE_MODEL_DESCRIBELIVEDETECTNOTIFYCONFIGREQUEST_H_
