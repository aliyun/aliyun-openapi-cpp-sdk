...
#ifndef ALIBABACLOUD_LIVE_MODEL_STOPMIXSTREAMSSERVICEREQUEST_H_
#define ALIBABACLOUD_LIVE_MODEL_STOPMIXSTREAMSSERVICEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Live
	{
		namespace Model
		{
			class ALIBABACLOUD_LIVE_EXPORT StopMixStreamsServiceRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_LIVE_MODEL_STOPMIXSTREAMSSERVICEREQUEST_H_