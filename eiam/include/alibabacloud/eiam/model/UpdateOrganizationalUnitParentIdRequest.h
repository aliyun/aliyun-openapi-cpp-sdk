...
#ifndef ALIBABACLOUD_EIAM_MODEL_UPDATEORGANIZATIONALUNITPARENTIDREQUEST_H_
...
namespace Eiam {
namespace Model {
class ALIBABACLOUD_EIAM_EXPORT UpdateOrganizationalUnitParentIdRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_EIAM_MODEL_UPDATEORGANIZATIONALUNITPARENTIDREQUEST_H_
