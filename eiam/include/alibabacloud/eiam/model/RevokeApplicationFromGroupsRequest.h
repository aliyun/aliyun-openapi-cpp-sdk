...
#ifndef ALIBABACLOUD_EIAM_MODEL_REVOKEAPPLICATIONFROMGROUPSREQUEST_H_
...
namespace Eiam {
namespace Model {
class ALIBABACLOUD_EIAM_EXPORT RevokeApplicationFromGroupsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_EIAM_MODEL_REVOKEAPPLICATIONFROMGROUPSREQUEST_H_
