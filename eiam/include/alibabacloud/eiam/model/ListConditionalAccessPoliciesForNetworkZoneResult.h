...
#ifndef ALIBABACLOUD_EIAM_MODEL_LISTCONDITIONALACCESSPOLICIESFORNETWORKZONERESULT_H_
...
namespace AlibabaCloud
{
	namespace Eiam
	{
		namespace Model
		{
			class ALIBABACLOUD_EIAM_EXPORT ListConditionalAccessPoliciesForNetworkZoneResult : public ServiceResult
			{
			public:
				...
				ListConditionalAccessPoliciesForNetworkZoneResult();
				explicit ListConditionalAccessPoliciesForNetworkZoneResult(const std::string &payload);
				~ListConditionalAccessPoliciesForNetworkZoneResult();
...
#endif // !ALIBABACLOUD_EIAM_MODEL_LISTCONDITIONALACCESSPOLICIESFORNETWORKZONERESULT_H_