...
#ifndef ALIBABACLOUD_EIAM_MODEL_GETORGANIZATIONALUNITREQUEST_H_
...
namespace Eiam {
namespace Model {
class ALIBABACLOUD_EIAM_EXPORT GetOrganizationalUnitRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_EIAM_MODEL_GETORGANIZATIONALUNITREQUEST_H_
