...
#ifndef ALIBABACLOUD_EIAM_MODEL_LISTORGANIZATIONALUNITSFORAPPLICATIONREQUEST_H_
...
namespace Eiam {
namespace Model {
class ALIBABACLOUD_EIAM_EXPORT ListOrganizationalUnitsForApplicationRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_EIAM_MODEL_LISTORGANIZATIONALUNITSFORAPPLICATIONREQUEST_H_
