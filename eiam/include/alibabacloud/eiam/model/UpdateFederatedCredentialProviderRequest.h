...
#ifndef ALIBABACLOUD_EIAM_MODEL_UPDATEFEDERATEDCREDENTIALPROVIDERREQUEST_H_
#define ALIBABACLOUD_EIAM_MODEL_UPDATEFEDERATEDCREDENTIALPROVIDERREQUEST_H_
...
namespace Eiam {
namespace Model {
class ALIBABACLOUD_EIAM_EXPORT UpdateFederatedCredentialProviderRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_EIAM_MODEL_UPDATEFEDERATEDCREDENTIALPROVIDERREQUEST_H_
