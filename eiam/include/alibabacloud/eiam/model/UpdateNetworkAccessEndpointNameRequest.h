...
#ifndef ALIBABACLOUD_EIAM_MODEL_UPDATENETWORKACCESSENDPOINTNAMEREQUEST_H_
...
namespace Eiam {
namespace Model {
class ALIBABACLOUD_EIAM_EXPORT UpdateNetworkAccessEndpointNameRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_EIAM_MODEL_UPDATENETWORKACCESSENDPOINTNAMEREQUEST_H_
