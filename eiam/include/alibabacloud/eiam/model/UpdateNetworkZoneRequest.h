...
#ifndef ALIBABACLOUD_EIAM_MODEL_UPDATENETWORKZONEREQUEST_H_
#define ALIBABACLOUD_EIAM_MODEL_UPDATENETWORKZONEREQUEST_H_
...
namespace Eiam {
namespace Model {
class ALIBABACLOUD_EIAM_EXPORT UpdateNetworkZoneRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_EIAM_MODEL_UPDATENETWORKZONEREQUEST_H_
