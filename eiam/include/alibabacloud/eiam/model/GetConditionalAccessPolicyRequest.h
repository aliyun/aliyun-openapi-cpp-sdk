...
#ifndef ALIBABACLOUD_EIAM_MODEL_GETCONDITIONALACCESSPOLICYREQUEST_H_
...
namespace Eiam {
namespace Model {
class ALIBABACLOUD_EIAM_EXPORT GetConditionalAccessPolicyRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_EIAM_MODEL_GETCONDITIONALACCESSPOLICYREQUEST_H_
