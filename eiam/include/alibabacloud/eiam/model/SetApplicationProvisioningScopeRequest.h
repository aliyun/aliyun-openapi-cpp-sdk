...
#ifndef ALIBABACLOUD_EIAM_MODEL_SETAPPLICATIONPROVISIONINGSCOPEREQUEST_H_
#define ALIBABACLOUD_EIAM_MODEL_SETAPPLICATIONPROVISIONINGSCOPEREQUEST_H_
...
namespace Eiam {
namespace Model {
class ALIBABACLOUD_EIAM_EXPORT SetApplicationProvisioningScopeRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_EIAM_MODEL_SETAPPLICATIONPROVISIONINGSCOPEREQUEST_H_
