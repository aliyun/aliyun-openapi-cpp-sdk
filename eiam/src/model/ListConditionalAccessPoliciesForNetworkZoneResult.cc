...
ListConditionalAccessPoliciesForNetworkZoneResult::ListConditionalAccessPoliciesForNetworkZoneResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListConditionalAccessPoliciesForNetworkZoneResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<ListConditionalAccessPoliciesForNetworkZoneResult::ConditionalAccessPolicy> ListConditionalAccessPoliciesForNetworkZoneResult::getConditionalAccessPolicies()const
{
