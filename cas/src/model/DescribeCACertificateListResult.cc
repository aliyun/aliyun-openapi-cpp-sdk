...
DescribeCACertificateListResult::DescribeCACertificateListResult() :
	ServiceResult()
{}

DescribeCACertificateListResult::DescribeCACertificateListResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeCACertificateListResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	for (auto valueCertificateListCertificate : allCertificateListNode)
	{
		...
		if(!valueCertificateListCertificate["Years"].isNull())
			certificateListObject.years = std::stoi(valueCertificateListCertificate["Years"].asString());
		...
		if(!valueCertificateListCertificate["Alias"].isNull())
			certificateListObject.alias = valueCertificateListCertificate["Alias"].asString();
		if(!valueCertificateListCertificate["Trial"].isNull())
			certificateListObject.trial = std::stoi(valueCertificateListCertificate["Trial"].asString());
		if(!valueCertificateListCertificate["Gift"].isNull())
			certificateListObject.gift = std::stoi(valueCertificateListCertificate["Gift"].asString());
...
int DescribeCACertificateListResult::getTotalCount()const
{
	return totalCount_;
}

int DescribeCACertificateListResult::getPageCount()const
{
	return pageCount_;
}

int DescribeCACertificateListResult::getCurrentPage()const
{
	return currentPage_;
}

std::vector<DescribeCACertificateListResult::Certificate> DescribeCACertificateListResult::getCertificateList()const
{
	return certificateList_;
}

int DescribeCACertificateListResult::getShowSize()const
{
	return showSize_;
}
