...
using AlibabaCloud::Alb::Model::CreateRulesRequest;

CreateRulesRequest::CreateRulesRequest()
    : RpcServiceRequest("alb", "2020-06-16", "CreateRules") {
  setMethod(HttpRequest::Method::Post);
}

CreateRulesRequest::~CreateRulesRequest() {}

std::string CreateRulesRequest::getClientToken() const {
  return clientToken_;
}

void CreateRulesRequest::setClientToken(const std::string &clientToken) {
  clientToken_ = clientToken;
  setParameter(std::string("ClientToken"), clientToken);
}

std::vector<CreateRulesRequest::Rules> CreateRulesRequest::getRules() const {
  return rules_;
}

void CreateRulesRequest::setRules(const std::vector<CreateRulesRequest::Rules> &rules) {
  rules_ = rules;
...
std::string CreateRulesRequest::getListenerId() const {
  return listenerId_;
}

void CreateRulesRequest::setListenerId(const std::string &listenerId) {
...
void CreateRulesRequest::setDryRun(bool dryRun) {
  dryRun_ = dryRun;
