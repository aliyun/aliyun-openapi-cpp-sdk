...
using AlibabaCloud::Alb::Model::ListTagValuesRequest;

ListTagValuesRequest::ListTagValuesRequest()
    : RpcServiceRequest("alb", "2020-06-16", "ListTagValues") {
...
std::string ListTagValuesRequest::getResourceId() const {
  return resourceId_;
}

void ListTagValuesRequest::setResourceId(const std::string &resourceId) {
