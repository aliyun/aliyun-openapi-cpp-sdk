...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_QUERYRENEWPRICEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT QueryRenewPriceRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_QUERYRENEWPRICEREQUEST_H_