...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_APGROUPBATCHADDAPREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT ApgroupBatchAddApRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_APGROUPBATCHADDAPREQUEST_H_