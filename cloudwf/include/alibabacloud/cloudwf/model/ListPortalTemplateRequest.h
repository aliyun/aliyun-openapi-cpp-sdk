...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_LISTPORTALTEMPLATEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT ListPortalTemplateRequest : public RpcServiceRequest
			{

			public:
				ListPortalTemplateRequest();
				~ListPortalTemplateRequest();
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_LISTPORTALTEMPLATEREQUEST_H_