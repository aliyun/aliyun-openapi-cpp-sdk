...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_BATCHSAVEAPPOSITIONREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT BatchSaveApPositionRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_BATCHSAVEAPPOSITIONREQUEST_H_