...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_SAVEPORTALTEMPLATEREQUEST_H_
#define ALIBABACLOUD_CLOUDWF_MODEL_SAVEPORTALTEMPLATEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT SavePortalTemplateRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_SAVEPORTALTEMPLATEREQUEST_H_