...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_SAVEGROUPAPRADIOCONFIGREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT SaveGroupApRadioConfigRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_SAVEGROUPAPRADIOCONFIGREQUEST_H_