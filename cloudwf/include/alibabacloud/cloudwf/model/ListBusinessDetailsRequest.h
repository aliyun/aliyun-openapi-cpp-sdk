...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_LISTBUSINESSDETAILSREQUEST_H_
#define ALIBABACLOUD_CLOUDWF_MODEL_LISTBUSINESSDETAILSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT ListBusinessDetailsRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_LISTBUSINESSDETAILSREQUEST_H_