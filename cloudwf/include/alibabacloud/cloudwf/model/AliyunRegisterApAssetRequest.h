...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_ALIYUNREGISTERAPASSETREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT AliyunRegisterApAssetRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_ALIYUNREGISTERAPASSETREQUEST_H_