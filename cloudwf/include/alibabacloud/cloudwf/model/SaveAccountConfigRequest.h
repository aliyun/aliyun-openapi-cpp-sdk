...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_SAVEACCOUNTCONFIGREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT SaveAccountConfigRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_SAVEACCOUNTCONFIGREQUEST_H_