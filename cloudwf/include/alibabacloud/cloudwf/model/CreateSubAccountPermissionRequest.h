...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_CREATESUBACCOUNTPERMISSIONREQUEST_H_
#define ALIBABACLOUD_CLOUDWF_MODEL_CREATESUBACCOUNTPERMISSIONREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT CreateSubAccountPermissionRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_CREATESUBACCOUNTPERMISSIONREQUEST_H_