...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_SETUPGRADEIMGBYMODELREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT SetUpgradeImgByModelRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_SETUPGRADEIMGBYMODELREQUEST_H_