...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_SAVEAPSCANCONFIGREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT SaveApScanConfigRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_SAVEAPSCANCONFIGREQUEST_H_