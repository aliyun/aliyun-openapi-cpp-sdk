...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_LISTAPPOSITIONMAPREQUEST_H_
#define ALIBABACLOUD_CLOUDWF_MODEL_LISTAPPOSITIONMAPREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT ListApPositionMapRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_LISTAPPOSITIONMAPREQUEST_H_