...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_DELETEAPRADIOSSIDCONFIGREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT DeleteApRadioSsidConfigRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_DELETEAPRADIOSSIDCONFIGREQUEST_H_