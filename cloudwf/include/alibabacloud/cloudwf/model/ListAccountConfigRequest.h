...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_LISTACCOUNTCONFIGREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT ListAccountConfigRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_LISTACCOUNTCONFIGREQUEST_H_