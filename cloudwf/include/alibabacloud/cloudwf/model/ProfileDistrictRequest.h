...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_PROFILEDISTRICTREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT ProfileDistrictRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_PROFILEDISTRICTREQUEST_H_