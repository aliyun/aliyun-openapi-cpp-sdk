...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_LISTAPRADIOSTATUSREQUEST_H_
#define ALIBABACLOUD_CLOUDWF_MODEL_LISTAPRADIOSTATUSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT ListApRadioStatusRequest : public RpcServiceRequest
			{
			...
			public:
				...
				int getSearchChannelEquals()const;
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_LISTAPRADIOSTATUSREQUEST_H_