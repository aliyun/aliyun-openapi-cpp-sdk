...
#ifndef ALIBABACLOUD_CLOUDWF_MODEL_SENDCOMMANDBYMACREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cloudwf
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDWF_EXPORT SendCommandByMacRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDWF_MODEL_SENDCOMMANDBYMACREQUEST_H_