...
#include <alibabacloud/cloudwf/model/GetSendCommandByMacProgressRequest.h>

using AlibabaCloud::Cloudwf::Model::GetSendCommandByMacProgressRequest;
...
std::string GetSendCommandByMacProgressRequest::getAccessKeyId()const
{
	return accessKeyId_;
}
