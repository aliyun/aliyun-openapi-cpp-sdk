...
#include <alibabacloud/cloudwf/model/PutOssFileRequest.h>

using AlibabaCloud::Cloudwf::Model::PutOssFileRequest;
...
std::string PutOssFileRequest::getJsonData()const
{
	return jsonData_;
}
