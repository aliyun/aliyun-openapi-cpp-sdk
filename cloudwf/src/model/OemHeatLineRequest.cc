...
#include <alibabacloud/cloudwf/model/OemHeatLineRequest.h>

using AlibabaCloud::Cloudwf::Model::OemHeatLineRequest;
...
std::string OemHeatLineRequest::getAccessKeyId()const
{
	return accessKeyId_;
}
