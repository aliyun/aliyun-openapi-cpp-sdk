...
#include <alibabacloud/cloudwf/model/GetUpgradeAPProgressRequest.h>

using AlibabaCloud::Cloudwf::Model::GetUpgradeAPProgressRequest;
...
std::string GetUpgradeAPProgressRequest::getAccessKeyId()const
{
	return accessKeyId_;
}
