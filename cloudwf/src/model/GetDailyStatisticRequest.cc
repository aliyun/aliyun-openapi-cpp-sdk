...
#include <alibabacloud/cloudwf/model/GetDailyStatisticRequest.h>

using AlibabaCloud::Cloudwf::Model::GetDailyStatisticRequest;
...
long GetDailyStatisticRequest::getApgroupId()const
{
	return apgroupId_;
}
