...
#include <alibabacloud/cloudwf/model/GetPagePropertiesRequest.h>

using AlibabaCloud::Cloudwf::Model::GetPagePropertiesRequest;
...
std::string GetPagePropertiesRequest::getAccessKeyId()const
{
	return accessKeyId_;
}
