...
#include <alibabacloud/cloudwf/model/InnerProduceCloudWFRequest.h>

using AlibabaCloud::Cloudwf::Model::InnerProduceCloudWFRequest;
...
std::string InnerProduceCloudWFRequest::getData()const
{
	return data_;
}
