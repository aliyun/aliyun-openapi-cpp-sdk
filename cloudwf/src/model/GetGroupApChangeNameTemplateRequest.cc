...
#include <alibabacloud/cloudwf/model/GetGroupApChangeNameTemplateRequest.h>

using AlibabaCloud::Cloudwf::Model::GetGroupApChangeNameTemplateRequest;
...
std::string GetGroupApChangeNameTemplateRequest::getAccessKeyId()const
{
	return accessKeyId_;
}
