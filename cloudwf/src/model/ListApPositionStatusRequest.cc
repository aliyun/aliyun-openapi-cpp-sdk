...
#include <alibabacloud/cloudwf/model/ListApPositionStatusRequest.h>

using AlibabaCloud::Cloudwf::Model::ListApPositionStatusRequest;
...
std::string ListApPositionStatusRequest::getJsonData()const
{
	return jsonData_;
}
