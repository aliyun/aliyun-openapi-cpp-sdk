...
#include <alibabacloud/cloudwf/model/ShopInfoRequest.h>

using AlibabaCloud::Cloudwf::Model::ShopInfoRequest;

ShopInfoRequest::ShopInfoRequest() :
	RpcServiceRequest("cloudwf", "2017-03-28", "ShopInfo")
{
...
std::string ShopInfoRequest::getAccessKeyId()const
{
	return accessKeyId_;
}
