...
#include <alibabacloud/cloudwf/model/ShopDeletemarketingRequest.h>

using AlibabaCloud::Cloudwf::Model::ShopDeletemarketingRequest;

ShopDeletemarketingRequest::ShopDeletemarketingRequest() :
	RpcServiceRequest("cloudwf", "2017-03-28", "ShopDeletemarketing")
{
