...
#include <alibabacloud/cloudwf/model/GetUmengPagePermission4RootRequest.h>

using AlibabaCloud::Cloudwf::Model::GetUmengPagePermission4RootRequest;
...
std::string GetUmengPagePermission4RootRequest::getAccessKeyId()const
{
	return accessKeyId_;
}
