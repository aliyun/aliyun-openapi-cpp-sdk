...
#include <alibabacloud/cloudwf/model/GetGroupApRadioConfigTemplateRequest.h>

using AlibabaCloud::Cloudwf::Model::GetGroupApRadioConfigTemplateRequest;
...
std::string GetGroupApRadioConfigTemplateRequest::getAccessKeyId()const
{
	return accessKeyId_;
}
