...
#include <alibabacloud/cloudwf/model/GetUpgradeAPGroupProgressRequest.h>

using AlibabaCloud::Cloudwf::Model::GetUpgradeAPGroupProgressRequest;
...
std::string GetUpgradeAPGroupProgressRequest::getAccessKeyId()const
{
	return accessKeyId_;
}
