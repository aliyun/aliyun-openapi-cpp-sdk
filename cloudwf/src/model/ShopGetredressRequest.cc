...
#include <alibabacloud/cloudwf/model/ShopGetredressRequest.h>

using AlibabaCloud::Cloudwf::Model::ShopGetredressRequest;
...
std::string ShopGetredressRequest::getAccessKeyId()const
{
	return accessKeyId_;
}
