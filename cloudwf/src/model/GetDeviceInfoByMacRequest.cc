...
#include <alibabacloud/cloudwf/model/GetDeviceInfoByMacRequest.h>

using AlibabaCloud::Cloudwf::Model::GetDeviceInfoByMacRequest;
...
std::string GetDeviceInfoByMacRequest::getMac()const
{
	return mac_;
}
