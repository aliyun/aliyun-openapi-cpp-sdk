...
#include <alibabacloud/cloudwf/model/ResumeInstanceRequest.h>

using AlibabaCloud::Cloudwf::Model::ResumeInstanceRequest;
...
std::string ResumeInstanceRequest::getTraceId()const
{
	return traceId_;
}
