...
#include <alibabacloud/cloudwf/model/ReleaseInstanceRequest.h>

using AlibabaCloud::Cloudwf::Model::ReleaseInstanceRequest;
...
std::string ReleaseInstanceRequest::getTraceId()const
{
	return traceId_;
}
