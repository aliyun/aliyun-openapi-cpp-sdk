...
#include <alibabacloud/cloudwf/model/RepairGroupApRequest.h>

using AlibabaCloud::Cloudwf::Model::RepairGroupApRequest;
...
void RepairGroupApRequest::setAccessKeyId(const std::string& accessKeyId)
{
