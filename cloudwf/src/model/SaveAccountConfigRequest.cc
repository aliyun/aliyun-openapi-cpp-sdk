...
#include <alibabacloud/cloudwf/model/SaveAccountConfigRequest.h>

using AlibabaCloud::Cloudwf::Model::SaveAccountConfigRequest;
...
std::string SaveAccountConfigRequest::getJsonData()const
{
	return jsonData_;
}
