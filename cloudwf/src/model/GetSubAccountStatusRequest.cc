...
#include <alibabacloud/cloudwf/model/GetSubAccountStatusRequest.h>

using AlibabaCloud::Cloudwf::Model::GetSubAccountStatusRequest;
...
std::string GetSubAccountStatusRequest::getAccessKeyId()const
{
	return accessKeyId_;
}
