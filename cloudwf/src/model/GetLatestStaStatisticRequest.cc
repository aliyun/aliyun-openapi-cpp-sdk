...
#include <alibabacloud/cloudwf/model/GetLatestStaStatisticRequest.h>

using AlibabaCloud::Cloudwf::Model::GetLatestStaStatisticRequest;
...
long GetLatestStaStatisticRequest::getApgroupId()const
{
	return apgroupId_;
}
