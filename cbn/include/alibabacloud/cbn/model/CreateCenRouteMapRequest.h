...
namespace Cbn {
namespace Model {
class ALIBABACLOUD_CBN_EXPORT CreateCenRouteMapRequest
...
public:
  ...
  void setDestinationCidrBlocks(
      const std::vector<std::string> &destinationCidrBlocks);
  std::vector<std::string> getDestinationRouteTableIds() const;
  void setDestinationRouteTableIds(
      const std::vector<std::string> &destinationRouteTableIds);
  ...
  void setDestinationInstanceIds(
      const std::vector<std::string> &destinationInstanceIds);
  ...
  void setDestinationInstanceIdsReverseMatch(
  ...
  void setDestinationChildInstanceTypes(
      const std::vector<std::string> &destinationChildInstanceTypes);
  std::vector<std::string> getSourceRouteTableIds() const;
  void
  setSourceRouteTableIds(const std::vector<std::string> &sourceRouteTableIds);
  ...
  void setSourceChildInstanceTypes(
      const std::vector<std::string> &sourceChildInstanceTypes);
  ...
  void
  setOperateCommunitySet(const std::vector<std::string> &operateCommunitySet);
