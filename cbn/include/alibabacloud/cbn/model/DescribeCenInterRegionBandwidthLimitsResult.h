...
namespace Cbn {
namespace Model {
class ALIBABACLOUD_CBN_EXPORT DescribeCenInterRegionBandwidthLimitsResult
...
public:
  ...
  explicit DescribeCenInterRegionBandwidthLimitsResult(
      const std::string &payload);
  ~DescribeCenInterRegionBandwidthLimitsResult();
  std::vector<CenInterRegionBandwidthLimit>
  getCenInterRegionBandwidthLimits() const;
