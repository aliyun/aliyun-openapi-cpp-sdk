...
QueryRecordPlansResult::QueryRecordPlansResult() :
	ServiceResult()
{}

QueryRecordPlansResult::QueryRecordPlansResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryRecordPlansResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
QueryRecordPlansResult::Data QueryRecordPlansResult::getData()const
{
	return data_;
}

std::string QueryRecordPlansResult::getErrorMessage()const
{
	return errorMessage_;
}

std::string QueryRecordPlansResult::getCode()const
{
	return code_;
}

bool QueryRecordPlansResult::getSuccess()const
{
	return success_;
}
