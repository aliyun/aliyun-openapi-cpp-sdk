...
QueryFaceAllDeviceGroupResult::QueryFaceAllDeviceGroupResult() :
	ServiceResult()
{}

QueryFaceAllDeviceGroupResult::QueryFaceAllDeviceGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryFaceAllDeviceGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
QueryFaceAllDeviceGroupResult::Data QueryFaceAllDeviceGroupResult::getData()const
{
	return data_;
}

std::string QueryFaceAllDeviceGroupResult::getErrorMessage()const
{
	return errorMessage_;
}

std::string QueryFaceAllDeviceGroupResult::getCode()const
{
	return code_;
}

bool QueryFaceAllDeviceGroupResult::getSuccess()const
{
	return success_;
}
