...
QueryEventRecordPlanDeviceByPlanResult::QueryEventRecordPlanDeviceByPlanResult() :
	ServiceResult()
{}

QueryEventRecordPlanDeviceByPlanResult::QueryEventRecordPlanDeviceByPlanResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryEventRecordPlanDeviceByPlanResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
QueryEventRecordPlanDeviceByPlanResult::Data QueryEventRecordPlanDeviceByPlanResult::getData()const
{
	return data_;
}

std::string QueryEventRecordPlanDeviceByPlanResult::getErrorMessage()const
{
	return errorMessage_;
}

std::string QueryEventRecordPlanDeviceByPlanResult::getCode()const
{
	return code_;
}

bool QueryEventRecordPlanDeviceByPlanResult::getSuccess()const
{
	return success_;
}
