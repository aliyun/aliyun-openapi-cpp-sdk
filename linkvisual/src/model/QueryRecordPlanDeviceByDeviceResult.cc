...
QueryRecordPlanDeviceByDeviceResult::QueryRecordPlanDeviceByDeviceResult() :
	ServiceResult()
{}

QueryRecordPlanDeviceByDeviceResult::QueryRecordPlanDeviceByDeviceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryRecordPlanDeviceByDeviceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
QueryRecordPlanDeviceByDeviceResult::Data QueryRecordPlanDeviceByDeviceResult::getData()const
{
	return data_;
}

std::string QueryRecordPlanDeviceByDeviceResult::getErrorMessage()const
{
	return errorMessage_;
}

std::string QueryRecordPlanDeviceByDeviceResult::getCode()const
{
	return code_;
}

bool QueryRecordPlanDeviceByDeviceResult::getSuccess()const
{
	return success_;
}
