...
QueryEventRecordPlanDeviceByDeviceResult::QueryEventRecordPlanDeviceByDeviceResult() :
	ServiceResult()
{}

QueryEventRecordPlanDeviceByDeviceResult::QueryEventRecordPlanDeviceByDeviceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryEventRecordPlanDeviceByDeviceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
QueryEventRecordPlanDeviceByDeviceResult::Data QueryEventRecordPlanDeviceByDeviceResult::getData()const
{
	return data_;
}

std::string QueryEventRecordPlanDeviceByDeviceResult::getErrorMessage()const
{
	return errorMessage_;
}

std::string QueryEventRecordPlanDeviceByDeviceResult::getCode()const
{
	return code_;
}

bool QueryEventRecordPlanDeviceByDeviceResult::getSuccess()const
{
	return success_;
}
