...
QueryPictureSearchAiboxesResult::QueryPictureSearchAiboxesResult() :
	ServiceResult()
{}

QueryPictureSearchAiboxesResult::QueryPictureSearchAiboxesResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryPictureSearchAiboxesResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
QueryPictureSearchAiboxesResult::Data QueryPictureSearchAiboxesResult::getData()const
{
	return data_;
}

std::string QueryPictureSearchAiboxesResult::getErrorMessage()const
{
	return errorMessage_;
}

std::string QueryPictureSearchAiboxesResult::getCode()const
{
	return code_;
}

bool QueryPictureSearchAiboxesResult::getSuccess()const
{
	return success_;
}
