...
std::string TriggerRecordResult::getData()const
{
	return data_;
}

std::string TriggerRecordResult::getErrorMessage()const
{
	return errorMessage_;
}

std::string TriggerRecordResult::getCode()const
{
	return code_;
}

bool TriggerRecordResult::getSuccess()const
{
	return success_;
}
