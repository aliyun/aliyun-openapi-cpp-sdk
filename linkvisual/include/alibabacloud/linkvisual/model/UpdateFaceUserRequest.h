...
#ifndef ALIBABACLOUD_LINKVISUAL_MODEL_UPDATEFACEUSERREQUEST_H_
#define ALIBABACLOUD_LINKVISUAL_MODEL_UPDATEFACEUSERREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_LINKVISUAL_EXPORT UpdateFaceUserRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LINKVISUAL_MODEL_UPDATEFACEUSERREQUEST_H_
