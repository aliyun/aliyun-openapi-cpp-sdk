...
#ifndef ALIBABACLOUD_LINKVISUAL_MODEL_UPDATEFACEUSERGROUPANDDEVICEGROUPRELATIONREQUEST_H_
#define ALIBABACLOUD_LINKVISUAL_MODEL_UPDATEFACEUSERGROUPANDDEVICEGROUPRELATIONREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_LINKVISUAL_EXPORT UpdateFaceUserGroupAndDeviceGroupRelationRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LINKVISUAL_MODEL_UPDATEFACEUSERGROUPANDDEVICEGROUPRELATIONREQUEST_H_
