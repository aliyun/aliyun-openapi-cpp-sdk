...
#ifndef ALIBABACLOUD_LINKVISUAL_MODEL_QUERYDEVICEVODURLBYTIMEREQUEST_H_
#define ALIBABACLOUD_LINKVISUAL_MODEL_QUERYDEVICEVODURLBYTIMEREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_LINKVISUAL_EXPORT QueryDeviceVodUrlByTimeRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LINKVISUAL_MODEL_QUERYDEVICEVODURLBYTIMEREQUEST_H_
