...
#ifndef ALIBABACLOUD_LINKVISUAL_MODEL_QUERYFACEUSERBATCHREQUEST_H_
#define ALIBABACLOUD_LINKVISUAL_MODEL_QUERYFACEUSERBATCHREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_LINKVISUAL_EXPORT QueryFaceUserBatchRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LINKVISUAL_MODEL_QUERYFACEUSERBATCHREQUEST_H_
