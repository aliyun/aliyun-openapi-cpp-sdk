...
#ifndef ALIBABACLOUD_LINKVISUAL_MODEL_QUERYLIVESTREAMINGREQUEST_H_
#define ALIBABACLOUD_LINKVISUAL_MODEL_QUERYLIVESTREAMINGREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_LINKVISUAL_EXPORT QueryLiveStreamingRequest : public RpcServiceRequest {
public:
	...
	bool getForceIFrame() const;
	void setForceIFrame(bool forceIFrame);
...
#endif // !ALIBABACLOUD_LINKVISUAL_MODEL_QUERYLIVESTREAMINGREQUEST_H_
