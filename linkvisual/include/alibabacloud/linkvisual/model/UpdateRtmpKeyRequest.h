...
#ifndef ALIBABACLOUD_LINKVISUAL_MODEL_UPDATERTMPKEYREQUEST_H_
#define ALIBABACLOUD_LINKVISUAL_MODEL_UPDATERTMPKEYREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_LINKVISUAL_EXPORT UpdateRtmpKeyRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LINKVISUAL_MODEL_UPDATERTMPKEYREQUEST_H_
