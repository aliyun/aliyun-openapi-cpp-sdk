...
#ifndef ALIBABACLOUD_LINKVISUAL_MODEL_UNBINDPICTURESEARCHAPPWITHDEVICESREQUEST_H_
#define ALIBABACLOUD_LINKVISUAL_MODEL_UNBINDPICTURESEARCHAPPWITHDEVICESREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_LINKVISUAL_EXPORT UnbindPictureSearchAppWithDevicesRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_LINKVISUAL_MODEL_UNBINDPICTURESEARCHAPPWITHDEVICESREQUEST_H_
