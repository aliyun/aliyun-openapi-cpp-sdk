...
#ifndef ALIBABACLOUD_VERVERICA_MODEL_REPLACEDEPLOYMENTREQUEST_H_
#define ALIBABACLOUD_VERVERICA_MODEL_REPLACEDEPLOYMENTREQUEST_H_
...
namespace Ververica {
namespace Model {
class ALIBABACLOUD_VERVERICA_EXPORT ReplaceDeploymentRequest : public RoaServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VERVERICA_MODEL_REPLACEDEPLOYMENTREQUEST_H_
