...
#ifndef ALIBABACLOUD_VERVERICA_MODEL_UPDATEDEPLOYMENTREQUEST_H_
#define ALIBABACLOUD_VERVERICA_MODEL_UPDATEDEPLOYMENTREQUEST_H_
...
namespace Ververica {
namespace Model {
class ALIBABACLOUD_VERVERICA_EXPORT UpdateDeploymentRequest : public RoaServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VERVERICA_MODEL_UPDATEDEPLOYMENTREQUEST_H_
