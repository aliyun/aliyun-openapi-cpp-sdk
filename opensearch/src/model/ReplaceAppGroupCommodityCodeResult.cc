...
ReplaceAppGroupCommodityCodeResult::ReplaceAppGroupCommodityCodeResult() :
	ServiceResult()
{}

ReplaceAppGroupCommodityCodeResult::ReplaceAppGroupCommodityCodeResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ReplaceAppGroupCommodityCodeResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string ReplaceAppGroupCommodityCodeResult::getRequestId()const
{
	return requestId_;
}

ReplaceAppGroupCommodityCodeResult::Result ReplaceAppGroupCommodityCodeResult::getResult()const
{
	return result_;
}
