...
ModifyAppGroupResult::ModifyAppGroupResult() :
	ServiceResult()
{}

ModifyAppGroupResult::ModifyAppGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ModifyAppGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string ModifyAppGroupResult::getRequestId()const
{
	return requestId_;
}

ModifyAppGroupResult::Result ModifyAppGroupResult::getResult()const
{
	return result_;
}
