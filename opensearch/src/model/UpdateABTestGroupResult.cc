...
UpdateABTestGroupResult::UpdateABTestGroupResult() :
	ServiceResult()
{}

UpdateABTestGroupResult::UpdateABTestGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateABTestGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string UpdateABTestGroupResult::getRequestId()const
{
	return requestId_;
}

UpdateABTestGroupResult::Result UpdateABTestGroupResult::getResult()const
{
	return result_;
}
