...
RemoveFirstRankResult::RemoveFirstRankResult() :
	ServiceResult()
{}

RemoveFirstRankResult::RemoveFirstRankResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RemoveFirstRankResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string RemoveFirstRankResult::getRequestId()const
{
	return requestId_;
}

RemoveFirstRankResult::Result RemoveFirstRankResult::getResult()const
{
	return result_;
}
