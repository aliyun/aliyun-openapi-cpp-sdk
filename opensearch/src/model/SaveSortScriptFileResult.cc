...
SaveSortScriptFileResult::SaveSortScriptFileResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void SaveSortScriptFileResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string SaveSortScriptFileResult::getRequestId()const
{
	return requestId_;
}
