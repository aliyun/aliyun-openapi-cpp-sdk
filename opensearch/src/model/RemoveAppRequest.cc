...
using AlibabaCloud::OpenSearch::Model::RemoveAppRequest;
...
int RemoveAppRequest::getAppId() const {
  return appId_;
}

void RemoveAppRequest::setAppId(int appId) {
  appId_ = appId;
  setParameter(std::string("appId"), std::to_string(appId));
}

std::string RemoveAppRequest::getAppGroupIdentity() const {
  return appGroupIdentity_;
}

void RemoveAppRequest::setAppGroupIdentity(const std::string &appGroupIdentity) {
