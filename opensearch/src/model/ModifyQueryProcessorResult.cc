...
ModifyQueryProcessorResult::ModifyQueryProcessorResult() :
	ServiceResult()
{}

ModifyQueryProcessorResult::ModifyQueryProcessorResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ModifyQueryProcessorResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string ModifyQueryProcessorResult::getRequestId()const
{
	return requestId_;
}

ModifyQueryProcessorResult::Result ModifyQueryProcessorResult::getResult()const
{
	return result_;
}
