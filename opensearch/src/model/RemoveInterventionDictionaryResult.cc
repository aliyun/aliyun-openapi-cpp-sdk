...
RemoveInterventionDictionaryResult::RemoveInterventionDictionaryResult() :
	ServiceResult()
{}

RemoveInterventionDictionaryResult::RemoveInterventionDictionaryResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RemoveInterventionDictionaryResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string RemoveInterventionDictionaryResult::getRequestId()const
{
	return requestId_;
}

RemoveInterventionDictionaryResult::Result RemoveInterventionDictionaryResult::getResult()const
{
	return result_;
}
