...
ModifyAppGroupQuotaResult::ModifyAppGroupQuotaResult() :
	ServiceResult()
{}

ModifyAppGroupQuotaResult::ModifyAppGroupQuotaResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ModifyAppGroupQuotaResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string ModifyAppGroupQuotaResult::getRequestId()const
{
	return requestId_;
}

ModifyAppGroupQuotaResult::Result ModifyAppGroupQuotaResult::getResult()const
{
	return result_;
}
