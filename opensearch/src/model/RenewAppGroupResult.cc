...
RenewAppGroupResult::RenewAppGroupResult() :
	ServiceResult()
{}

RenewAppGroupResult::RenewAppGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RenewAppGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
