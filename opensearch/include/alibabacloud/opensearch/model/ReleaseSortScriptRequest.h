...
#ifndef ALIBABACLOUD_OPENSEARCH_MODEL_RELEASESORTSCRIPTREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_OPENSEARCH_EXPORT ReleaseSortScriptRequest : public RoaServiceRequest {
public:
	ReleaseSortScriptRequest();
	~ReleaseSortScriptRequest();
...
#endif // !ALIBABACLOUD_OPENSEARCH_MODEL_RELEASESORTSCRIPTREQUEST_H_
