...
#ifndef ALIBABACLOUD_OPENSEARCH_MODEL_LISTABTESTFIXEDFLOWDIVIDERSREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_OPENSEARCH_EXPORT ListABTestFixedFlowDividersRequest : public RoaServiceRequest {
public:
	ListABTestFixedFlowDividersRequest();
	~ListABTestFixedFlowDividersRequest();
...
#endif // !ALIBABACLOUD_OPENSEARCH_MODEL_LISTABTESTFIXEDFLOWDIVIDERSREQUEST_H_
