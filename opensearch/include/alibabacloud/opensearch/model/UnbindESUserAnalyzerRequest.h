...
#ifndef ALIBABACLOUD_OPENSEARCH_MODEL_UNBINDESUSERANALYZERREQUEST_H_
#define ALIBABACLOUD_OPENSEARCH_MODEL_UNBINDESUSERANALYZERREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_OPENSEARCH_EXPORT UnbindESUserAnalyzerRequest : public RoaServiceRequest {
public:
...
#endif // !ALIBABACLOUD_OPENSEARCH_MODEL_UNBINDESUSERANALYZERREQUEST_H_
