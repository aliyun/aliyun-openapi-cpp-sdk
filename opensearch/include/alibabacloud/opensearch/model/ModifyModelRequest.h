...
#ifndef ALIBABACLOUD_OPENSEARCH_MODEL_MODIFYMODELREQUEST_H_
...
namespace AlibabaCloud
{
	namespace OpenSearch
	{
		namespace Model
		{
			class ALIBABACLOUD_OPENSEARCH_EXPORT ModifyModelRequest : public RoaServiceRequest
			{
...
#endif // !ALIBABACLOUD_OPENSEARCH_MODEL_MODIFYMODELREQUEST_H_