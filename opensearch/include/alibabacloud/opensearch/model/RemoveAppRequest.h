...
#ifndef ALIBABACLOUD_OPENSEARCH_MODEL_REMOVEAPPREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_OPENSEARCH_EXPORT RemoveAppRequest : public RoaServiceRequest {
public:
	RemoveAppRequest();
	~RemoveAppRequest();
	int getAppId() const;
...
#endif // !ALIBABACLOUD_OPENSEARCH_MODEL_REMOVEAPPREQUEST_H_
