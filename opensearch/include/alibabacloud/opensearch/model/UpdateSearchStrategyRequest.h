...
#ifndef ALIBABACLOUD_OPENSEARCH_MODEL_UPDATESEARCHSTRATEGYREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_OPENSEARCH_EXPORT UpdateSearchStrategyRequest : public RoaServiceRequest {
public:
...
#endif // !ALIBABACLOUD_OPENSEARCH_MODEL_UPDATESEARCHSTRATEGYREQUEST_H_
