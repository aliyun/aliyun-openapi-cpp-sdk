...
#ifndef ALIBABACLOUD_OPENSEARCH_MODEL_UNBINDESINSTANCEREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_OPENSEARCH_EXPORT UnbindEsInstanceRequest : public RoaServiceRequest {
public:
	UnbindEsInstanceRequest();
	~UnbindEsInstanceRequest();
...
#endif // !ALIBABACLOUD_OPENSEARCH_MODEL_UNBINDESINSTANCEREQUEST_H_
