...
#ifndef ALIBABACLOUD_OPENSEARCH_MODEL_UPDATEABTESTFIXEDFLOWDIVIDERSREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_OPENSEARCH_EXPORT UpdateABTestFixedFlowDividersRequest : public RoaServiceRequest {
public:
...
#endif // !ALIBABACLOUD_OPENSEARCH_MODEL_UPDATEABTESTFIXEDFLOWDIVIDERSREQUEST_H_
