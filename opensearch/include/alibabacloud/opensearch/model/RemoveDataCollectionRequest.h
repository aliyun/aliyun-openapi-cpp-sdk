...
#ifndef ALIBABACLOUD_OPENSEARCH_MODEL_REMOVEDATACOLLECTIONREQUEST_H_
#define ALIBABACLOUD_OPENSEARCH_MODEL_REMOVEDATACOLLECTIONREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_OPENSEARCH_EXPORT RemoveDataCollectionRequest : public RoaServiceRequest {
public:
	RemoveDataCollectionRequest();
	~RemoveDataCollectionRequest();
...
#endif // !ALIBABACLOUD_OPENSEARCH_MODEL_REMOVEDATACOLLECTIONREQUEST_H_
