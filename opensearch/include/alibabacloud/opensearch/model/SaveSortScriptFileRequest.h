...
#ifndef ALIBABACLOUD_OPENSEARCH_MODEL_SAVESORTSCRIPTFILEREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_OPENSEARCH_EXPORT SaveSortScriptFileRequest : public RoaServiceRequest {
public:
...
#endif // !ALIBABACLOUD_OPENSEARCH_MODEL_SAVESORTSCRIPTFILEREQUEST_H_
