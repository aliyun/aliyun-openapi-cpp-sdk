...
ModifyChatappTemplateResult::ModifyChatappTemplateResult() :
	ServiceResult()
{}

ModifyChatappTemplateResult::ModifyChatappTemplateResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ModifyChatappTemplateResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
ModifyChatappTemplateResult::Data ModifyChatappTemplateResult::getData()const
{
	return data_;
}

std::string ModifyChatappTemplateResult::getCode()const
{
	return code_;
}
