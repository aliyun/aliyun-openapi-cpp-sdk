...
#ifndef ALIBABACLOUD_DATAWORKS_PUBLIC_MODEL_GETSUCCESSINSTANCETRENDRESULT_H_
...
namespace AlibabaCloud
{
	namespace Dataworks_public
	{
		namespace Model
		{
			class ALIBABACLOUD_DATAWORKS_PUBLIC_EXPORT GetSuccessInstanceTrendResult : public ServiceResult
			{
			public:
				...
				explicit GetSuccessInstanceTrendResult(const std::string &payload);
				~GetSuccessInstanceTrendResult();
...
#endif // !ALIBABACLOUD_DATAWORKS_PUBLIC_MODEL_GETSUCCESSINSTANCETRENDRESULT_H_