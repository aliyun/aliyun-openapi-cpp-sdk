	...
	namespace Dataworks_public
	{
		namespace Model
		{
			...
			public:
				...
				UpdateTableModelInfoResult();
				explicit UpdateTableModelInfoResult(const std::string &payload);
				~UpdateTableModelInfoResult();
...
#endif // !ALIBABACLOUD_DATAWORKS_PUBLIC_MODEL_UPDATETABLEMODELINFORESULT_H_