...
#ifndef ALIBABACLOUD_DATAWORKS_PUBLIC_MODEL_LISTDATASERVICEPUBLISHEDAPISRESULT_H_
...
namespace AlibabaCloud
{
	namespace Dataworks_public
	{
		namespace Model
		{
			class ALIBABACLOUD_DATAWORKS_PUBLIC_EXPORT ListDataServicePublishedApisResult : public ServiceResult
			{
			public:
				struct Data
				{
				...
				ListDataServicePublishedApisResult();
				explicit ListDataServicePublishedApisResult(const std::string &payload);
				~ListDataServicePublishedApisResult();
...
#endif // !ALIBABACLOUD_DATAWORKS_PUBLIC_MODEL_LISTDATASERVICEPUBLISHEDAPISRESULT_H_