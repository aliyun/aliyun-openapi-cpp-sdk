...
namespace AlibabaCloud
{
	namespace Dataworks_public
	{
		namespace Model
		{
			class ALIBABACLOUD_DATAWORKS_PUBLIC_EXPORT GetMetaColumnLineageResult : public ServiceResult
			{
			public:
				struct Data
				{
				...
				explicit GetMetaColumnLineageResult(const std::string &payload);
				~GetMetaColumnLineageResult();
...
#endif // !ALIBABACLOUD_DATAWORKS_PUBLIC_MODEL_GETMETACOLUMNLINEAGERESULT_H_