...
namespace AlibabaCloud
{
	namespace Dataworks_public
	{
		namespace Model
		{
			class ALIBABACLOUD_DATAWORKS_PUBLIC_EXPORT SearchMetaTablesResult : public ServiceResult
			{
			public:
				struct Data
				{
				...
				explicit SearchMetaTablesResult(const std::string &payload);
				~SearchMetaTablesResult();
...
#endif // !ALIBABACLOUD_DATAWORKS_PUBLIC_MODEL_SEARCHMETATABLESRESULT_H_