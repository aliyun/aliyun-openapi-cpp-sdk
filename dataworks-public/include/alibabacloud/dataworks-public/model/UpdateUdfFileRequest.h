...
#ifndef ALIBABACLOUD_DATAWORKS_PUBLIC_MODEL_UPDATEUDFFILEREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_DATAWORKS_PUBLIC_EXPORT UpdateUdfFileRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_DATAWORKS_PUBLIC_MODEL_UPDATEUDFFILEREQUEST_H_
