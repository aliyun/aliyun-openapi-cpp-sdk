...
Dataworks_publicClient::ListTagResourcesOutcome Dataworks_publicClient::listTagResources(const ListTagResourcesRequest &request) const
{
	auto endpointOutcome = endpointProvider_->getEndpoint();
	if (!endpointOutcome.isSuccess())
...
void Dataworks_publicClient::listTagResourcesAsync(const ListTagResourcesRequest& request, const ListTagResourcesAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context) const
{
	auto fn = [this, request, handler, context]()
	{
...
Dataworks_publicClient::ListTagResourcesOutcomeCallable Dataworks_publicClient::listTagResourcesCallable(const ListTagResourcesRequest &request) const
{
...
Dataworks_publicClient::TagResourcesOutcome Dataworks_publicClient::tagResources(const TagResourcesRequest &request) const
{
	auto endpointOutcome = endpointProvider_->getEndpoint();
	if (!endpointOutcome.isSuccess())
...
void Dataworks_publicClient::tagResourcesAsync(const TagResourcesRequest& request, const TagResourcesAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context) const
{
	auto fn = [this, request, handler, context]()
	{
...
Dataworks_publicClient::TagResourcesOutcomeCallable Dataworks_publicClient::tagResourcesCallable(const TagResourcesRequest &request) const
{
...
Dataworks_publicClient::UnTagResourcesOutcome Dataworks_publicClient::unTagResources(const UnTagResourcesRequest &request) const
{
	auto endpointOutcome = endpointProvider_->getEndpoint();
	if (!endpointOutcome.isSuccess())
...
void Dataworks_publicClient::unTagResourcesAsync(const UnTagResourcesRequest& request, const UnTagResourcesAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context) const
{
	auto fn = [this, request, handler, context]()
	{
...
Dataworks_publicClient::UnTagResourcesOutcomeCallable Dataworks_publicClient::unTagResourcesCallable(const UnTagResourcesRequest &request) const
{
