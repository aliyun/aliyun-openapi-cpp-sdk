...
int StopInstanceResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

bool StopInstanceResult::getData()const
{
	return data_;
}

std::string StopInstanceResult::getErrorCode()const
{
	return errorCode_;
}

std::string StopInstanceResult::getErrorMessage()const
{
