...
GetTopicInfluenceResult::GetTopicInfluenceResult() :
	ServiceResult()
{}

GetTopicInfluenceResult::GetTopicInfluenceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetTopicInfluenceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	auto allInfluencesNode = dataNode["Influences"]["InfluencesItem"];
...
int GetTopicInfluenceResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

GetTopicInfluenceResult::Data GetTopicInfluenceResult::getData()const
{
	return data_;
}

std::string GetTopicInfluenceResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetTopicInfluenceResult::getErrorMessage()const
{
	return errorMessage_;
}

bool GetTopicInfluenceResult::getSuccess()const
{
	return success_;
}
