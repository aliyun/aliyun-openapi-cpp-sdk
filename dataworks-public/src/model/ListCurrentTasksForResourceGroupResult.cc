...
#include <alibabacloud/dataworks-public/model/ListCurrentTasksForResourceGroupResult.h>
#include <json/json.h>

using namespace AlibabaCloud::Dataworks_public;
using namespace AlibabaCloud::Dataworks_public::Model;

ListCurrentTasksForResourceGroupResult::ListCurrentTasksForResourceGroupResult() :
	ServiceResult()
{}

ListCurrentTasksForResourceGroupResult::ListCurrentTasksForResourceGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListCurrentTasksForResourceGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	for (auto dataNodeTasksPopTasksForResourceGroupDto : allTasksNode)
	{
		...
		if(!dataNodeTasksPopTasksForResourceGroupDto["Concurrency"].isNull())
			popTasksForResourceGroupDtoObject.concurrency = dataNodeTasksPopTasksForResourceGroupDto["Concurrency"].asString();
		...
		if(!dataNodeTasksPopTasksForResourceGroupDto["TaskSource"].isNull())
			popTasksForResourceGroupDtoObject.taskSource = dataNodeTasksPopTasksForResourceGroupDto["TaskSource"].asString();
...
int ListCurrentTasksForResourceGroupResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

ListCurrentTasksForResourceGroupResult::Data ListCurrentTasksForResourceGroupResult::getData()const
{
	return data_;
}

std::string ListCurrentTasksForResourceGroupResult::getErrorCode()const
{
	return errorCode_;
}

std::string ListCurrentTasksForResourceGroupResult::getErrorMessage()const
{
	return errorMessage_;
}

bool ListCurrentTasksForResourceGroupResult::getSuccess()const
{
	return success_;
}
