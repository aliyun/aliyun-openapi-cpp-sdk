...
GetNodeParentsResult::GetNodeParentsResult() :
	ServiceResult()
{}

GetNodeParentsResult::GetNodeParentsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetNodeParentsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
int GetNodeParentsResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

GetNodeParentsResult::Data GetNodeParentsResult::getData()const
{
	return data_;
}

std::string GetNodeParentsResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetNodeParentsResult::getErrorMessage()const
{
	return errorMessage_;
}

bool GetNodeParentsResult::getSuccess()const
{
	return success_;
}
