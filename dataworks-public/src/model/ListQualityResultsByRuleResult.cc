...
ListQualityResultsByRuleResult::ListQualityResultsByRuleResult() :
	ServiceResult()
{}

ListQualityResultsByRuleResult::ListQualityResultsByRuleResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListQualityResultsByRuleResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
