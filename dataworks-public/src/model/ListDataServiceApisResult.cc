...
ListDataServiceApisResult::ListDataServiceApisResult() :
	ServiceResult()
{}

ListDataServiceApisResult::ListDataServiceApisResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListDataServiceApisResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
int ListDataServiceApisResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

ListDataServiceApisResult::Data ListDataServiceApisResult::getData()const
{
	return data_;
}

std::string ListDataServiceApisResult::getErrorCode()const
{
	return errorCode_;
}

std::string ListDataServiceApisResult::getErrorMessage()const
{
	return errorMessage_;
}

bool ListDataServiceApisResult::getSuccess()const
{
	return success_;
}
