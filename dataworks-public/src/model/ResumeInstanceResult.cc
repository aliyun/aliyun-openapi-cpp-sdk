...
int ResumeInstanceResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

bool ResumeInstanceResult::getData()const
{
	return data_;
}

std::string ResumeInstanceResult::getErrorCode()const
{
	return errorCode_;
}

std::string ResumeInstanceResult::getErrorMessage()const
{
