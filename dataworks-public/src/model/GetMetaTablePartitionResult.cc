...
GetMetaTablePartitionResult::GetMetaTablePartitionResult() :
	ServiceResult()
{}

GetMetaTablePartitionResult::GetMetaTablePartitionResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetMetaTablePartitionResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
int GetMetaTablePartitionResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

GetMetaTablePartitionResult::Data GetMetaTablePartitionResult::getData()const
{
	return data_;
}

std::string GetMetaTablePartitionResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetMetaTablePartitionResult::getErrorMessage()const
{
	return errorMessage_;
}

bool GetMetaTablePartitionResult::getSuccess()const
{
	return success_;
}
