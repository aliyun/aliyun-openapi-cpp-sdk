...
GetInstanceCountTrendResult::GetInstanceCountTrendResult() :
	ServiceResult()
{}

GetInstanceCountTrendResult::GetInstanceCountTrendResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetInstanceCountTrendResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<GetInstanceCountTrendResult::IntanceCounts> GetInstanceCountTrendResult::getInstanceCounts()const
{
