...
#ifndef ALIBABACLOUD_GPDB_MODEL_LISTNAMESPACESREQUEST_H_
...
namespace Gpdb {
namespace Model {
class ALIBABACLOUD_GPDB_EXPORT ListNamespacesRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_GPDB_MODEL_LISTNAMESPACESREQUEST_H_
