...
#ifndef ALIBABACLOUD_GPDB_MODEL_QUERYCOLLECTIONDATAREQUEST_H_
#define ALIBABACLOUD_GPDB_MODEL_QUERYCOLLECTIONDATAREQUEST_H_
...
namespace Gpdb {
namespace Model {
class ALIBABACLOUD_GPDB_EXPORT QueryCollectionDataRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_GPDB_MODEL_QUERYCOLLECTIONDATAREQUEST_H_
