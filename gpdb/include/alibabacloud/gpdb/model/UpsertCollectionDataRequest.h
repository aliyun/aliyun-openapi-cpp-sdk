...
#ifndef ALIBABACLOUD_GPDB_MODEL_UPSERTCOLLECTIONDATAREQUEST_H_
...
namespace Gpdb {
namespace Model {
class ALIBABACLOUD_GPDB_EXPORT UpsertCollectionDataRequest : public RpcServiceRequest {
public:
	struct Rows {
	...
	void setRows(const std::vector<Rows> &rows);
...
#endif // !ALIBABACLOUD_GPDB_MODEL_UPSERTCOLLECTIONDATAREQUEST_H_
