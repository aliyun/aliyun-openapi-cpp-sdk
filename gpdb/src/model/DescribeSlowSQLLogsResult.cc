...
DescribeSlowSQLLogsResult::DescribeSlowSQLLogsResult() :
	ServiceResult()
{}

DescribeSlowSQLLogsResult::DescribeSlowSQLLogsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeSlowSQLLogsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	for (auto valueItemsItem : allItemsNode)
	{
		...
		if(!valueItemsItem["SQLPlan"].isNull())
			itemsObject.sQLPlan = valueItemsItem["SQLPlan"].asString();
...
int DescribeSlowSQLLogsResult::getPageRecordCount()const
{
	return pageRecordCount_;
}

int DescribeSlowSQLLogsResult::getPageNumber()const
{
	return pageNumber_;
}

std::vector<DescribeSlowSQLLogsResult::Item> DescribeSlowSQLLogsResult::getItems()const
{
	return items_;
}
