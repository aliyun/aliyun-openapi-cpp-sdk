...
DescribeSQLLogsResult::DescribeSQLLogsResult() :
	ServiceResult()
{}

DescribeSQLLogsResult::DescribeSQLLogsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeSQLLogsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
int DescribeSQLLogsResult::getPageRecordCount()const
{
	return pageRecordCount_;
}

int DescribeSQLLogsResult::getPageNumber()const
{
	return pageNumber_;
}

std::vector<DescribeSQLLogsResult::Item> DescribeSQLLogsResult::getItems()const
{
	return items_;
}
