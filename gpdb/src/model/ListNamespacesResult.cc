...
std::string ListNamespacesResult::getStatus()const
{
	return status_;
}

std::vector<std::string> ListNamespacesResult::getNamespaces()const
{
	return namespaces_;
}
...
std::string ListNamespacesResult::getDBInstanceId()const
{
	return dBInstanceId_;
}

int ListNamespacesResult::getCount()const
{
	return count_;
}

std::string ListNamespacesResult::getRegionId()const
{
	return regionId_;
}
