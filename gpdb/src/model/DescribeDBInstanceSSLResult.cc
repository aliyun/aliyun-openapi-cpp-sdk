...
bool DescribeDBInstanceSSLResult::getSSLEnabled()const
{
	return sSLEnabled_;
}

std::string DescribeDBInstanceSSLResult::getDBInstanceId()const
{
...
std::string DescribeDBInstanceSSLResult::getDBInstanceName()const
{
