...
using AlibabaCloud::Gpdb::Model::ResumeInstanceRequest;

ResumeInstanceRequest::ResumeInstanceRequest()
    : RpcServiceRequest("gpdb", "2016-05-03", "ResumeInstance") {
...
void ResumeInstanceRequest::setDBInstanceId(const std::string &dBInstanceId) {
  dBInstanceId_ = dBInstanceId;
  setParameter(std::string("DBInstanceId"), dBInstanceId);
}

long ResumeInstanceRequest::getOwnerId() const {
  return ownerId_;
}

void ResumeInstanceRequest::setOwnerId(long ownerId) {
  ownerId_ = ownerId;
