...
#ifndef ALIBABACLOUD_ICE_MODEL_LISTPACKAGEJOBSREQUEST_H_
#define ALIBABACLOUD_ICE_MODEL_LISTPACKAGEJOBSREQUEST_H_
...
namespace ICE {
namespace Model {
class ALIBABACLOUD_ICE_EXPORT ListPackageJobsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ICE_MODEL_LISTPACKAGEJOBSREQUEST_H_
