...
#ifndef ALIBABACLOUD_ICE_MODEL_SUBMITTRANSCODEJOBRESULT_H_
#define ALIBABACLOUD_ICE_MODEL_SUBMITTRANSCODEJOBRESULT_H_
...
namespace AlibabaCloud
{
	namespace ICE
	{
		namespace Model
		{
			class ALIBABACLOUD_ICE_EXPORT SubmitTranscodeJobResult : public ServiceResult
			{
			public:
				...
				SubmitTranscodeJobResult();
				explicit SubmitTranscodeJobResult(const std::string &payload);
				~SubmitTranscodeJobResult();
...
#endif // !ALIBABACLOUD_ICE_MODEL_SUBMITTRANSCODEJOBRESULT_H_