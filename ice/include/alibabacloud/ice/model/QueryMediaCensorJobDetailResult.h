...
#ifndef ALIBABACLOUD_ICE_MODEL_QUERYMEDIACENSORJOBDETAILRESULT_H_
#define ALIBABACLOUD_ICE_MODEL_QUERYMEDIACENSORJOBDETAILRESULT_H_
...
namespace AlibabaCloud
{
	namespace ICE
	{
		namespace Model
		{
			class ALIBABACLOUD_ICE_EXPORT QueryMediaCensorJobDetailResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_ICE_MODEL_QUERYMEDIACENSORJOBDETAILRESULT_H_