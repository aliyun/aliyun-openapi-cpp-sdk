...
#ifndef ALIBABACLOUD_ICE_MODEL_LISTMEDIAINFOJOBSRESULT_H_
#define ALIBABACLOUD_ICE_MODEL_LISTMEDIAINFOJOBSRESULT_H_
...
namespace AlibabaCloud
{
	namespace ICE
	{
		namespace Model
		{
			class ALIBABACLOUD_ICE_EXPORT ListMediaInfoJobsResult : public ServiceResult
			{
			public:
				struct Job
				{
				...
				ListMediaInfoJobsResult();
				explicit ListMediaInfoJobsResult(const std::string &payload);
				~ListMediaInfoJobsResult();
...
#endif // !ALIBABACLOUD_ICE_MODEL_LISTMEDIAINFOJOBSRESULT_H_