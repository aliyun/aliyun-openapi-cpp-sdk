...
#ifndef ALIBABACLOUD_ICE_MODEL_SUBMITLIVETRANSCODEJOBREQUEST_H_
#define ALIBABACLOUD_ICE_MODEL_SUBMITLIVETRANSCODEJOBREQUEST_H_
...
namespace ICE {
namespace Model {
class ALIBABACLOUD_ICE_EXPORT SubmitLiveTranscodeJobRequest : public RpcServiceRequest {
public:
	struct StreamInput {
		std::string inputUrl;
		std::string type;
...
#endif // !ALIBABACLOUD_ICE_MODEL_SUBMITLIVETRANSCODEJOBREQUEST_H_
