...
#ifndef ALIBABACLOUD_ICE_MODEL_DESCRIBEPLAYLISTREQUEST_H_
#define ALIBABACLOUD_ICE_MODEL_DESCRIBEPLAYLISTREQUEST_H_
...
namespace ICE {
namespace Model {
class ALIBABACLOUD_ICE_EXPORT DescribePlayListRequest : public RpcServiceRequest {
public:
	...
	void setPlayType(const std::string &playType);
...
#endif // !ALIBABACLOUD_ICE_MODEL_DESCRIBEPLAYLISTREQUEST_H_
