...
#ifndef ALIBABACLOUD_ICE_MODEL_GETMEDIAINFOJOBRESULT_H_
#define ALIBABACLOUD_ICE_MODEL_GETMEDIAINFOJOBRESULT_H_
...
namespace AlibabaCloud
{
	namespace ICE
	{
		namespace Model
		{
			class ALIBABACLOUD_ICE_EXPORT GetMediaInfoJobResult : public ServiceResult
			{
			public:
				struct MediaInfoJob
				{
				...
				GetMediaInfoJobResult();
				explicit GetMediaInfoJobResult(const std::string &payload);
				~GetMediaInfoJobResult();
...
#endif // !ALIBABACLOUD_ICE_MODEL_GETMEDIAINFOJOBRESULT_H_