...
#ifndef ALIBABACLOUD_ICE_MODEL_SUBMITAUDIOPRODUCEJOBREQUEST_H_
#define ALIBABACLOUD_ICE_MODEL_SUBMITAUDIOPRODUCEJOBREQUEST_H_
...
namespace ICE {
namespace Model {
class ALIBABACLOUD_ICE_EXPORT SubmitAudioProduceJobRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ICE_MODEL_SUBMITAUDIOPRODUCEJOBREQUEST_H_
