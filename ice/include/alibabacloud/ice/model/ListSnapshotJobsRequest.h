...
#ifndef ALIBABACLOUD_ICE_MODEL_LISTSNAPSHOTJOBSREQUEST_H_
#define ALIBABACLOUD_ICE_MODEL_LISTSNAPSHOTJOBSREQUEST_H_
...
namespace ICE {
namespace Model {
class ALIBABACLOUD_ICE_EXPORT ListSnapshotJobsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ICE_MODEL_LISTSNAPSHOTJOBSREQUEST_H_
