...
#ifndef ALIBABACLOUD_ICE_MODEL_LISTDYNAMICIMAGEJOBSREQUEST_H_
#define ALIBABACLOUD_ICE_MODEL_LISTDYNAMICIMAGEJOBSREQUEST_H_
...
namespace ICE {
namespace Model {
class ALIBABACLOUD_ICE_EXPORT ListDynamicImageJobsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ICE_MODEL_LISTDYNAMICIMAGEJOBSREQUEST_H_
