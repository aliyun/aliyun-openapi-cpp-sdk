...
#ifndef ALIBABACLOUD_ICE_MODEL_SUBMITSYNCMEDIAINFOJOBRESULT_H_
#define ALIBABACLOUD_ICE_MODEL_SUBMITSYNCMEDIAINFOJOBRESULT_H_
...
namespace AlibabaCloud
{
	namespace ICE
	{
		namespace Model
		{
			class ALIBABACLOUD_ICE_EXPORT SubmitSyncMediaInfoJobResult : public ServiceResult
			{
			public:
				struct MediaInfoJob
				{
				...
				SubmitSyncMediaInfoJobResult();
				explicit SubmitSyncMediaInfoJobResult(const std::string &payload);
				~SubmitSyncMediaInfoJobResult();
...
#endif // !ALIBABACLOUD_ICE_MODEL_SUBMITSYNCMEDIAINFOJOBRESULT_H_