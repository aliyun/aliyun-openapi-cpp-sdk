...
#ifndef ALIBABACLOUD_ICE_MODEL_UPDATETEMPLATEREQUEST_H_
#define ALIBABACLOUD_ICE_MODEL_UPDATETEMPLATEREQUEST_H_
...
namespace ICE {
namespace Model {
class ALIBABACLOUD_ICE_EXPORT UpdateTemplateRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ICE_MODEL_UPDATETEMPLATEREQUEST_H_
