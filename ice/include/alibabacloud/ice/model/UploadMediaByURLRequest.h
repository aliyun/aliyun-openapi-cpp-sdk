...
#ifndef ALIBABACLOUD_ICE_MODEL_UPLOADMEDIABYURLREQUEST_H_
#define ALIBABACLOUD_ICE_MODEL_UPLOADMEDIABYURLREQUEST_H_
...
namespace ICE {
namespace Model {
class ALIBABACLOUD_ICE_EXPORT UploadMediaByURLRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ICE_MODEL_UPLOADMEDIABYURLREQUEST_H_
