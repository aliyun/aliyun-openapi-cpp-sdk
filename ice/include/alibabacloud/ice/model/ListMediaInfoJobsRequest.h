...
#ifndef ALIBABACLOUD_ICE_MODEL_LISTMEDIAINFOJOBSREQUEST_H_
#define ALIBABACLOUD_ICE_MODEL_LISTMEDIAINFOJOBSREQUEST_H_
...
namespace ICE {
namespace Model {
class ALIBABACLOUD_ICE_EXPORT ListMediaInfoJobsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ICE_MODEL_LISTMEDIAINFOJOBSREQUEST_H_
