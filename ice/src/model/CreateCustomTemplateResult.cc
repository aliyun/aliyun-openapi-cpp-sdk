...
void CreateCustomTemplateResult::parse(const std::string &payload)
{
	...
	if(!customTemplateNode["Subtype"].isNull())
		customTemplate_.subtype = customTemplateNode["Subtype"].asString();
...
CreateCustomTemplateResult::CustomTemplate CreateCustomTemplateResult::getCustomTemplate()const
{
