...
GetMediaInfoJobResult::GetMediaInfoJobResult() :
	ServiceResult()
{}

GetMediaInfoJobResult::GetMediaInfoJobResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetMediaInfoJobResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
GetMediaInfoJobResult::MediaInfoJob GetMediaInfoJobResult::getMediaInfoJob()const
{
