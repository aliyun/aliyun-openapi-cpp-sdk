...
using AlibabaCloud::ICE::Model::CreateAuditRequest;

CreateAuditRequest::CreateAuditRequest()
    : RpcServiceRequest("ice", "2020-11-09", "CreateAudit") {
...
std::string CreateAuditRequest::getAppId() const {
  return appId_;
}

void CreateAuditRequest::setAppId(const std::string &appId) {
  appId_ = appId;
