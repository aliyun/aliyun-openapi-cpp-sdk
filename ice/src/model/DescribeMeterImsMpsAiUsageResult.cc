...
DescribeMeterImsMpsAiUsageResult::DescribeMeterImsMpsAiUsageResult() :
	ServiceResult()
{}

DescribeMeterImsMpsAiUsageResult::DescribeMeterImsMpsAiUsageResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeMeterImsMpsAiUsageResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeMeterImsMpsAiUsageResult::DataItem> DescribeMeterImsMpsAiUsageResult::getData()const
{
	return data_;
}
