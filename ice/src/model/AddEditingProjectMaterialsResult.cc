...
std::vector<AddEditingProjectMaterialsResult::LiveStreamConfig> AddEditingProjectMaterialsResult::getLiveMaterials()const
{
	return liveMaterials_;
}

std::string AddEditingProjectMaterialsResult::getProjectId()const
{
	return projectId_;
}

std::vector<AddEditingProjectMaterialsResult::MediaInfo> AddEditingProjectMaterialsResult::getMediaInfos()const
{
	return mediaInfos_;
}

std::vector<std::string> AddEditingProjectMaterialsResult::getProjectMaterials()const
{
