...
GetImageModerationResultResult::GetImageModerationResultResult() :
	ServiceResult()
{}

GetImageModerationResultResult::GetImageModerationResultResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetImageModerationResultResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetImageModerationResultResult::getStatus()const
{
	return status_;
}

std::string GetImageModerationResultResult::getTaskId()const
{
	return taskId_;
}

std::string GetImageModerationResultResult::getMessage()const
{
	return message_;
}

std::string GetImageModerationResultResult::getEndTime()const
{
	return endTime_;
}

std::string GetImageModerationResultResult::getProjectName()const
{
	return projectName_;
}

std::string GetImageModerationResultResult::getUserData()const
{
	return userData_;
}

GetImageModerationResultResult::ModerationResult GetImageModerationResultResult::getModerationResult()const
{
	return moderationResult_;
}

std::string GetImageModerationResultResult::getTaskType()const
{
	return taskType_;
}

std::string GetImageModerationResultResult::getStartTime()const
{
	return startTime_;
}

std::string GetImageModerationResultResult::getEventId()const
{
	return eventId_;
}

std::string GetImageModerationResultResult::getCode()const
{
	return code_;
}
