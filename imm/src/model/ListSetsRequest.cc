...
using AlibabaCloud::Imm::Model::ListSetsRequest;

ListSetsRequest::ListSetsRequest() :
	RpcServiceRequest("imm", "2017-09-06", "ListSets")
{}

ListSetsRequest::~ListSetsRequest()
{}

std::string ListSetsRequest::getRegionId()const
{
	return regionId_;
}
