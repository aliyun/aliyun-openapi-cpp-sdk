...
QueryFigureClustersResult::QueryFigureClustersResult() :
	ServiceResult()
{}

QueryFigureClustersResult::QueryFigureClustersResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryFigureClustersResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<QueryFigureClustersResult::FigureClustersItem> QueryFigureClustersResult::getFigureClusters()const
{
