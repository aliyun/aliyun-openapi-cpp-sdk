...
#ifndef ALIBABACLOUD_IMM_MODEL_QUERYSTORIESRESULT_H_
#define ALIBABACLOUD_IMM_MODEL_QUERYSTORIESRESULT_H_
...
namespace AlibabaCloud
{
	namespace Imm
	{
		namespace Model
		{
			class ALIBABACLOUD_IMM_EXPORT QueryStoriesResult : public ServiceResult
			{
			public:
				struct StoriesItem
				{
					...
					std::vector<StoriesItem::FilesItem> files;
				};


				QueryStoriesResult();
				explicit QueryStoriesResult(const std::string &payload);
				~QueryStoriesResult();
				std::string getNextToken()const;
				std::vector<StoriesItem> getStories()const;

			protected:
				void parse(const std::string &payload);
			private:
				std::string nextToken_;
				std::vector<StoriesItem> stories_;

			};
		}
	}
}
#endif // !ALIBABACLOUD_IMM_MODEL_QUERYSTORIESRESULT_H_