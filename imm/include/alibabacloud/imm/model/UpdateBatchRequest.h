...
#ifndef ALIBABACLOUD_IMM_MODEL_UPDATEBATCHREQUEST_H_
#define ALIBABACLOUD_IMM_MODEL_UPDATEBATCHREQUEST_H_
...
namespace Imm {
namespace Model {
class ALIBABACLOUD_IMM_EXPORT UpdateBatchRequest : public RpcServiceRequest {
public:
	struct Notification {
		std::string endpoint;
		std::string topic;
...
#endif // !ALIBABACLOUD_IMM_MODEL_UPDATEBATCHREQUEST_H_
