...
#ifndef ALIBABACLOUD_IMM_MODEL_SIMPLEQUERYRESULT_H_
#define ALIBABACLOUD_IMM_MODEL_SIMPLEQUERYRESULT_H_
...
namespace AlibabaCloud
{
	namespace Imm
	{
		namespace Model
		{
			class ALIBABACLOUD_IMM_EXPORT SimpleQueryResult : public ServiceResult
			{
			public:
				struct FilesItem
				{
				...
				SimpleQueryResult();
				explicit SimpleQueryResult(const std::string &payload);
				~SimpleQueryResult();
...
#endif // !ALIBABACLOUD_IMM_MODEL_SIMPLEQUERYRESULT_H_