...
#ifndef ALIBABACLOUD_IMM_MODEL_UPDATETRIGGERREQUEST_H_
#define ALIBABACLOUD_IMM_MODEL_UPDATETRIGGERREQUEST_H_
...
namespace Imm {
namespace Model {
class ALIBABACLOUD_IMM_EXPORT UpdateTriggerRequest : public RpcServiceRequest {
public:
	struct Notification {
		std::string endpoint;
		std::string topic;
...
#endif // !ALIBABACLOUD_IMM_MODEL_UPDATETRIGGERREQUEST_H_
