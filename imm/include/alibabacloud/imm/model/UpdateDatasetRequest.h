...
#ifndef ALIBABACLOUD_IMM_MODEL_UPDATEDATASETREQUEST_H_
#define ALIBABACLOUD_IMM_MODEL_UPDATEDATASETREQUEST_H_
...
namespace Imm {
namespace Model {
class ALIBABACLOUD_IMM_EXPORT UpdateDatasetRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMM_MODEL_UPDATEDATASETREQUEST_H_
