...
#ifndef ALIBABACLOUD_IMM_MODEL_GETFILEMETARESULT_H_
#define ALIBABACLOUD_IMM_MODEL_GETFILEMETARESULT_H_
...
namespace AlibabaCloud
{
	namespace Imm
	{
		namespace Model
		{
			class ALIBABACLOUD_IMM_EXPORT GetFileMetaResult : public ServiceResult
			{
			public:
				struct FilesItem
				{
				...
				GetFileMetaResult();
				explicit GetFileMetaResult(const std::string &payload);
				~GetFileMetaResult();
...
#endif // !ALIBABACLOUD_IMM_MODEL_GETFILEMETARESULT_H_