...
#ifndef ALIBABACLOUD_IMM_MODEL_QUERYFIGURECLUSTERSRESULT_H_
#define ALIBABACLOUD_IMM_MODEL_QUERYFIGURECLUSTERSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Imm
	{
		namespace Model
		{
			class ALIBABACLOUD_IMM_EXPORT QueryFigureClustersResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_IMM_MODEL_QUERYFIGURECLUSTERSRESULT_H_