...
CreateTaskGroupResult::CreateTaskGroupResult() :
	ServiceResult()
{}

CreateTaskGroupResult::CreateTaskGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CreateTaskGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string CreateTaskGroupResult::getMessage()const
{
	return message_;
}

CreateTaskGroupResult::Data CreateTaskGroupResult::getData()const
{
	return data_;
}

std::string CreateTaskGroupResult::getCode()const
{
	return code_;
}
