...
#include "model/DeleteLocalImageRequest.h"
#include "model/DeleteLocalImageResult.h"
...
#include "model/DescribeEstackImageRequest.h"
#include "model/DescribeEstackImageResult.h"
...
#include "model/GetCommonImageRequest.h"
#include "model/GetCommonImageResult.h"
...
#include "model/GetUserImageRequest.h"
#include "model/GetUserImageResult.h"
...
#include "model/InspectImageRequest.h"
#include "model/InspectImageResult.h"
...
#include "model/ListCommunityImagesRequest.h"
#include "model/ListCommunityImagesResult.h"
...
#include "model/ListJobsWithFiltersRequest.h"
#include "model/ListJobsWithFiltersResult.h"
...
#include "model/ListUpgradeClientsRequest.h"
#include "model/ListUpgradeClientsResult.h"
#include "model/ListUsersRequest.h"
#include "model/ListUsersResult.h"
#include "model/ListUsersAsyncRequest.h"
#include "model/ListUsersAsyncResult.h"
...
#include "model/SetPostScriptsRequest.h"
#include "model/SetPostScriptsResult.h"
...
#include "model/SummaryImagesInfoResult.h"
#include "model/SyncUsersRequest.h"
#include "model/SyncUsersResult.h"
...
namespace AlibabaCloud
{
	namespace EHPC
	{
		...
		public:
			...
			typedef Outcome<Error, Model::DeleteLocalImageResult> DeleteLocalImageOutcome;
			typedef std::future<DeleteLocalImageOutcome> DeleteLocalImageOutcomeCallable;
			typedef std::function<void(const EHPCClient*, const Model::DeleteLocalImageRequest&, const DeleteLocalImageOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> DeleteLocalImageAsyncHandler;
			...
			typedef Outcome<Error, Model::DescribeEstackImageResult> DescribeEstackImageOutcome;
			typedef std::future<DescribeEstackImageOutcome> DescribeEstackImageOutcomeCallable;
			typedef std::function<void(const EHPCClient*, const Model::DescribeEstackImageRequest&, const DescribeEstackImageOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> DescribeEstackImageAsyncHandler;
			...
			typedef Outcome<Error, Model::GetCommonImageResult> GetCommonImageOutcome;
			typedef std::future<GetCommonImageOutcome> GetCommonImageOutcomeCallable;
			typedef std::function<void(const EHPCClient*, const Model::GetCommonImageRequest&, const GetCommonImageOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> GetCommonImageAsyncHandler;
			...
			typedef Outcome<Error, Model::GetUserImageResult> GetUserImageOutcome;
			typedef std::future<GetUserImageOutcome> GetUserImageOutcomeCallable;
			typedef std::function<void(const EHPCClient*, const Model::GetUserImageRequest&, const GetUserImageOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> GetUserImageAsyncHandler;
			...
			typedef Outcome<Error, Model::InspectImageResult> InspectImageOutcome;
			typedef std::future<InspectImageOutcome> InspectImageOutcomeCallable;
			typedef std::function<void(const EHPCClient*, const Model::InspectImageRequest&, const InspectImageOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> InspectImageAsyncHandler;
			...
			typedef Outcome<Error, Model::ListCommunityImagesResult> ListCommunityImagesOutcome;
			typedef std::future<ListCommunityImagesOutcome> ListCommunityImagesOutcomeCallable;
			typedef std::function<void(const EHPCClient*, const Model::ListCommunityImagesRequest&, const ListCommunityImagesOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> ListCommunityImagesAsyncHandler;
			...
			typedef Outcome<Error, Model::ListJobsWithFiltersResult> ListJobsWithFiltersOutcome;
			typedef std::future<ListJobsWithFiltersOutcome> ListJobsWithFiltersOutcomeCallable;
			typedef std::function<void(const EHPCClient*, const Model::ListJobsWithFiltersRequest&, const ListJobsWithFiltersOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> ListJobsWithFiltersAsyncHandler;
			...
			typedef std::function<void(const EHPCClient*, const Model::ListTagResourcesRequest&, const ListTagResourcesOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> ListTagResourcesAsyncHandler;
			...
			typedef Outcome<Error, Model::ListUpgradeClientsResult> ListUpgradeClientsOutcome;
			typedef std::future<ListUpgradeClientsOutcome> ListUpgradeClientsOutcomeCallable;
			typedef std::function<void(const EHPCClient*, const Model::ListUpgradeClientsRequest&, const ListUpgradeClientsOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> ListUpgradeClientsAsyncHandler;
			...
			typedef Outcome<Error, Model::ListUsersAsyncResult> ListUsersAsyncOutcome;
			typedef std::future<ListUsersAsyncOutcome> ListUsersAsyncOutcomeCallable;
			typedef std::function<void(const EHPCClient*, const Model::ListUsersAsyncRequest&, const ListUsersAsyncOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> ListUsersAsyncAsyncHandler;
			...
			typedef Outcome<Error, Model::SetPostScriptsResult> SetPostScriptsOutcome;
			typedef std::future<SetPostScriptsOutcome> SetPostScriptsOutcomeCallable;
			typedef std::function<void(const EHPCClient*, const Model::SetPostScriptsRequest&, const SetPostScriptsOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> SetPostScriptsAsyncHandler;
			...
			typedef Outcome<Error, Model::SummaryImagesInfoResult> SummaryImagesInfoOutcome;
			typedef std::future<SummaryImagesInfoOutcome> SummaryImagesInfoOutcomeCallable;
			typedef std::function<void(const EHPCClient*, const Model::SummaryImagesInfoRequest&, const SummaryImagesInfoOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> SummaryImagesInfoAsyncHandler;
			typedef Outcome<Error, Model::SyncUsersResult> SyncUsersOutcome;
			typedef std::future<SyncUsersOutcome> SyncUsersOutcomeCallable;
			typedef std::function<void(const EHPCClient*, const Model::SyncUsersRequest&, const SyncUsersOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> SyncUsersAsyncHandler;
			typedef Outcome<Error, Model::TagResourcesResult> TagResourcesOutcome;
			typedef std::future<TagResourcesOutcome> TagResourcesOutcomeCallable;
			typedef std::function<void(const EHPCClient*, const Model::TagResourcesRequest&, const TagResourcesOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> TagResourcesAsyncHandler;
			typedef Outcome<Error, Model::UnTagResourcesResult> UnTagResourcesOutcome;
			typedef std::future<UnTagResourcesOutcome> UnTagResourcesOutcomeCallable;
			typedef std::function<void(const EHPCClient*, const Model::UnTagResourcesRequest&, const UnTagResourcesOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> UnTagResourcesAsyncHandler;
			...
			DeleteLocalImageOutcome deleteLocalImage(const Model::DeleteLocalImageRequest &request)const;
			void deleteLocalImageAsync(const Model::DeleteLocalImageRequest& request, const DeleteLocalImageAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			DeleteLocalImageOutcomeCallable deleteLocalImageCallable(const Model::DeleteLocalImageRequest& request) const;
			...
			DescribeEstackImageOutcome describeEstackImage(const Model::DescribeEstackImageRequest &request)const;
			void describeEstackImageAsync(const Model::DescribeEstackImageRequest& request, const DescribeEstackImageAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			DescribeEstackImageOutcomeCallable describeEstackImageCallable(const Model::DescribeEstackImageRequest& request) const;
			...
			GetCommonImageOutcome getCommonImage(const Model::GetCommonImageRequest &request)const;
			void getCommonImageAsync(const Model::GetCommonImageRequest& request, const GetCommonImageAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			GetCommonImageOutcomeCallable getCommonImageCallable(const Model::GetCommonImageRequest& request) const;
			...
			GetUserImageOutcome getUserImage(const Model::GetUserImageRequest &request)const;
			void getUserImageAsync(const Model::GetUserImageRequest& request, const GetUserImageAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			GetUserImageOutcomeCallable getUserImageCallable(const Model::GetUserImageRequest& request) const;
			...
			InspectImageOutcome inspectImage(const Model::InspectImageRequest &request)const;
			void inspectImageAsync(const Model::InspectImageRequest& request, const InspectImageAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			InspectImageOutcomeCallable inspectImageCallable(const Model::InspectImageRequest& request) const;
			...
			ListCommunityImagesOutcome listCommunityImages(const Model::ListCommunityImagesRequest &request)const;
			void listCommunityImagesAsync(const Model::ListCommunityImagesRequest& request, const ListCommunityImagesAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			ListCommunityImagesOutcomeCallable listCommunityImagesCallable(const Model::ListCommunityImagesRequest& request) const;
			...
			ListJobsWithFiltersOutcome listJobsWithFilters(const Model::ListJobsWithFiltersRequest &request)const;
			void listJobsWithFiltersAsync(const Model::ListJobsWithFiltersRequest& request, const ListJobsWithFiltersAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			ListJobsWithFiltersOutcomeCallable listJobsWithFiltersCallable(const Model::ListJobsWithFiltersRequest& request) const;
			...
			ListUpgradeClientsOutcome listUpgradeClients(const Model::ListUpgradeClientsRequest &request)const;
			void listUpgradeClientsAsync(const Model::ListUpgradeClientsRequest& request, const ListUpgradeClientsAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			ListUpgradeClientsOutcomeCallable listUpgradeClientsCallable(const Model::ListUpgradeClientsRequest& request) const;
			ListUsersOutcome listUsers(const Model::ListUsersRequest &request)const;
			void listUsersAsync(const Model::ListUsersRequest& request, const ListUsersAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			ListUsersOutcomeCallable listUsersCallable(const Model::ListUsersRequest& request) const;
			ListUsersAsyncOutcome listUsersAsync(const Model::ListUsersAsyncRequest &request)const;
			void listUsersAsyncAsync(const Model::ListUsersAsyncRequest& request, const ListUsersAsyncAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			ListUsersAsyncOutcomeCallable listUsersAsyncCallable(const Model::ListUsersAsyncRequest& request) const;
			...
			SetPostScriptsOutcome setPostScripts(const Model::SetPostScriptsRequest &request)const;
			void setPostScriptsAsync(const Model::SetPostScriptsRequest& request, const SetPostScriptsAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			SetPostScriptsOutcomeCallable setPostScriptsCallable(const Model::SetPostScriptsRequest& request) const;
			...
			SummaryImagesInfoOutcome summaryImagesInfo(const Model::SummaryImagesInfoRequest &request)const;
			void summaryImagesInfoAsync(const Model::SummaryImagesInfoRequest& request, const SummaryImagesInfoAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			SummaryImagesInfoOutcomeCallable summaryImagesInfoCallable(const Model::SummaryImagesInfoRequest& request) const;
			SyncUsersOutcome syncUsers(const Model::SyncUsersRequest &request)const;
			void syncUsersAsync(const Model::SyncUsersRequest& request, const SyncUsersAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			SyncUsersOutcomeCallable syncUsersCallable(const Model::SyncUsersRequest& request) const;
