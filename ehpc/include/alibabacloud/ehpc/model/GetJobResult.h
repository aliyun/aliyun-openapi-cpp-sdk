...
#ifndef ALIBABACLOUD_EHPC_MODEL_GETJOBRESULT_H_
#define ALIBABACLOUD_EHPC_MODEL_GETJOBRESULT_H_
...
namespace AlibabaCloud
{
	namespace EHPC
	{
		namespace Model
		{
			class ALIBABACLOUD_EHPC_EXPORT GetJobResult : public ServiceResult
			{
			public:
				struct JobInfo
				{
...
#endif // !ALIBABACLOUD_EHPC_MODEL_GETJOBRESULT_H_