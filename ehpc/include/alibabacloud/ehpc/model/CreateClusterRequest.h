...
public:
  ...
  void
  setAdditionalVolumes(const std::vector<AdditionalVolumes> &additionalVolumes);
  std::string getEcsOrderManagerInstanceType() const;
  void setEcsOrderManagerInstanceType(
      const std::string &ecsOrderManagerInstanceType);
  ...
  void setEcsOrderComputeInstanceType(
      const std::string &ecsOrderComputeInstanceType);
  ...
  void
  setPostInstallScript(const std::vector<PostInstallScript> &postInstallScript);
  ...
  void
  setEcsOrderLoginInstanceType(const std::string &ecsOrderLoginInstanceType);
