...
namespace EHPC {
namespace Model {
class ALIBABACLOUD_EHPC_EXPORT CreateHybridClusterRequest
...
public:
  ...
  void
  setOnPremiseVolumeRemotePath(const std::string &onPremiseVolumeRemotePath);
  ...
  void
  setOnPremiseVolumeMountPoint(const std::string &onPremiseVolumeMountPoint);
