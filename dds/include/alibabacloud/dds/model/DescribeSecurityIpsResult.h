...
#ifndef ALIBABACLOUD_DDS_MODEL_DESCRIBESECURITYIPSRESULT_H_
#define ALIBABACLOUD_DDS_MODEL_DESCRIBESECURITYIPSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Dds
	{
		namespace Model
		{
			class ALIBABACLOUD_DDS_EXPORT DescribeSecurityIpsResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_DDS_MODEL_DESCRIBESECURITYIPSRESULT_H_