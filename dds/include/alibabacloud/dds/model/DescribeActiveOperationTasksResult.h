...
#ifndef ALIBABACLOUD_DDS_MODEL_DESCRIBEACTIVEOPERATIONTASKSRESULT_H_
#define ALIBABACLOUD_DDS_MODEL_DESCRIBEACTIVEOPERATIONTASKSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Dds
	{
		namespace Model
		{
			class ALIBABACLOUD_DDS_EXPORT DescribeActiveOperationTasksResult : public ServiceResult
			{
			public:
				struct ItemsItem
				{
...
#endif // !ALIBABACLOUD_DDS_MODEL_DESCRIBEACTIVEOPERATIONTASKSRESULT_H_