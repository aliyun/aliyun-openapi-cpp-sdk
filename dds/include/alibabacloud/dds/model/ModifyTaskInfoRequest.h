...
#ifndef ALIBABACLOUD_DDS_MODEL_MODIFYTASKINFOREQUEST_H_
...
namespace Dds {
namespace Model {
class ALIBABACLOUD_DDS_EXPORT ModifyTaskInfoRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_DDS_MODEL_MODIFYTASKINFOREQUEST_H_
