...
#ifndef ALIBABACLOUD_DDS_MODEL_DESCRIBEHISTORYTASKSREQUEST_H_
#define ALIBABACLOUD_DDS_MODEL_DESCRIBEHISTORYTASKSREQUEST_H_
...
namespace Dds {
namespace Model {
class ALIBABACLOUD_DDS_EXPORT DescribeHistoryTasksRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_DDS_MODEL_DESCRIBEHISTORYTASKSREQUEST_H_
