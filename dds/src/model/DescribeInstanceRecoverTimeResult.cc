...
#include <alibabacloud/dds/model/DescribeInstanceRecoverTimeResult.h>
#include <json/json.h>

using namespace AlibabaCloud::Dds;
using namespace AlibabaCloud::Dds::Model;

DescribeInstanceRecoverTimeResult::DescribeInstanceRecoverTimeResult() :
	ServiceResult()
{}

DescribeInstanceRecoverTimeResult::DescribeInstanceRecoverTimeResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeInstanceRecoverTimeResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeInstanceRecoverTimeResult::AvailableRestoreTime> DescribeInstanceRecoverTimeResult::getRestoreRanges()const
{
