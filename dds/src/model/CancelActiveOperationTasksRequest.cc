...
#include <alibabacloud/dds/model/CancelActiveOperationTasksRequest.h>

using AlibabaCloud::Dds::Model::CancelActiveOperationTasksRequest;

CancelActiveOperationTasksRequest::CancelActiveOperationTasksRequest()
    : RpcServiceRequest("dds", "2015-12-01", "CancelActiveOperationTasks") {
