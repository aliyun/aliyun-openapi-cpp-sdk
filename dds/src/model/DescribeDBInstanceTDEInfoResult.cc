...
DescribeDBInstanceTDEInfoResult::DescribeDBInstanceTDEInfoResult() :
	ServiceResult()
{}

DescribeDBInstanceTDEInfoResult::DescribeDBInstanceTDEInfoResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeDBInstanceTDEInfoResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
