...
#include <alibabacloud/dds/model/DescribeVpcsForMongoDBResult.h>
#include <json/json.h>

using namespace AlibabaCloud::Dds;
using namespace AlibabaCloud::Dds::Model;

DescribeVpcsForMongoDBResult::DescribeVpcsForMongoDBResult() :
	ServiceResult()
{}

DescribeVpcsForMongoDBResult::DescribeVpcsForMongoDBResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeVpcsForMongoDBResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeVpcsForMongoDBResult::Vpc> DescribeVpcsForMongoDBResult::getVpcs()const
{
	return vpcs_;
}

int DescribeVpcsForMongoDBResult::getTotalCount()const
{
	return totalCount_;
}

int DescribeVpcsForMongoDBResult::getPageSize()const
{
	return pageSize_;
}

int DescribeVpcsForMongoDBResult::getPageNumber()const
{
	return pageNumber_;
}
