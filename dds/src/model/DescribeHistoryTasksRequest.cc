...
#include <alibabacloud/dds/model/DescribeHistoryTasksRequest.h>

using AlibabaCloud::Dds::Model::DescribeHistoryTasksRequest;

DescribeHistoryTasksRequest::DescribeHistoryTasksRequest()
    : RpcServiceRequest("dds", "2015-12-01", "DescribeHistoryTasks") {
...
std::string DescribeHistoryTasksRequest::getResourceOwnerAccount() const {
  return resourceOwnerAccount_;
}

void DescribeHistoryTasksRequest::setResourceOwnerAccount(const std::string &resourceOwnerAccount) {
