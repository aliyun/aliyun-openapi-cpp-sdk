...
std::string DescribeClusterRecoverTimeRequest::getSecurityToken() const {
  return securityToken_;
}

void DescribeClusterRecoverTimeRequest::setSecurityToken(const std::string &securityToken) {
