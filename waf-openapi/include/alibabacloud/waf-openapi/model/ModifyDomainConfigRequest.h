...
#ifndef ALIBABACLOUD_WAF_OPENAPI_MODEL_MODIFYDOMAINCONFIGREQUEST_H_
#define ALIBABACLOUD_WAF_OPENAPI_MODEL_MODIFYDOMAINCONFIGREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Waf_openapi
	{
		namespace Model
		{
			class ALIBABACLOUD_WAF_OPENAPI_EXPORT ModifyDomainConfigRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_WAF_OPENAPI_MODEL_MODIFYDOMAINCONFIGREQUEST_H_