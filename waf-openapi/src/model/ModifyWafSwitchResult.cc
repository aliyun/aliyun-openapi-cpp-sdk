...
#include <alibabacloud/waf-openapi/model/ModifyWafSwitchResult.h>
#include <json/json.h>
...
ModifyWafSwitchResult::ModifyWafSwitchResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ModifyWafSwitchResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
ModifyWafSwitchResult::Result ModifyWafSwitchResult::getResult()const
{
	return result_;
}
