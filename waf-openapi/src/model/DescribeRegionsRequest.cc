...
#include <alibabacloud/waf-openapi/model/DescribeRegionsRequest.h>

using AlibabaCloud::Waf_openapi::Model::DescribeRegionsRequest;

DescribeRegionsRequest::DescribeRegionsRequest() :
	RpcServiceRequest("waf-openapi", "2018-01-17", "DescribeRegions")
{
