...
using AlibabaCloud::Slb::Model::TagResourcesRequest;

TagResourcesRequest::TagResourcesRequest()
    : RpcServiceRequest("slb", "2014-05-15", "TagResources") {
  setMethod(HttpRequest::Method::Post);
}

TagResourcesRequest::~TagResourcesRequest() {}

std::string TagResourcesRequest::getAccess_key_id() const {
  return access_key_id_;
}

void TagResourcesRequest::setAccess_key_id(const std::string &access_key_id) {
