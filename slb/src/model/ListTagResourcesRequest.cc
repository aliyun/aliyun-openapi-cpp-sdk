...
using AlibabaCloud::Slb::Model::ListTagResourcesRequest;

ListTagResourcesRequest::ListTagResourcesRequest()
    : RpcServiceRequest("slb", "2014-05-15", "ListTagResources") {
  setMethod(HttpRequest::Method::Post);
}

ListTagResourcesRequest::~ListTagResourcesRequest() {}

std::string ListTagResourcesRequest::getAccess_key_id() const {
  return access_key_id_;
}

void ListTagResourcesRequest::setAccess_key_id(const std::string &access_key_id) {
