...
#ifndef ALIBABACLOUD_SLB_MODEL_REMOVEBACKENDSERVERSREQUEST_H_
...
namespace Slb {
namespace Model {
class ALIBABACLOUD_SLB_EXPORT RemoveBackendServersRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SLB_MODEL_REMOVEBACKENDSERVERSREQUEST_H_
