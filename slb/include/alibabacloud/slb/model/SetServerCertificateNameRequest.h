...
#ifndef ALIBABACLOUD_SLB_MODEL_SETSERVERCERTIFICATENAMEREQUEST_H_
#define ALIBABACLOUD_SLB_MODEL_SETSERVERCERTIFICATENAMEREQUEST_H_
...
namespace Slb {
namespace Model {
class ALIBABACLOUD_SLB_EXPORT SetServerCertificateNameRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SLB_MODEL_SETSERVERCERTIFICATENAMEREQUEST_H_
