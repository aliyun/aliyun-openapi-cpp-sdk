...
#ifndef ALIBABACLOUD_SLB_MODEL_SETCACERTIFICATENAMEREQUEST_H_
#define ALIBABACLOUD_SLB_MODEL_SETCACERTIFICATENAMEREQUEST_H_
...
namespace Slb {
namespace Model {
class ALIBABACLOUD_SLB_EXPORT SetCACertificateNameRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SLB_MODEL_SETCACERTIFICATENAMEREQUEST_H_
