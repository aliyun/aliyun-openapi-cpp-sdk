...
namespace Slb {
namespace Model {
class ALIBABACLOUD_SLB_EXPORT CreateMasterSlaveVServerGroupRequest
...
public:
  ...
  void
  setMasterSlaveBackendServers(const std::string &masterSlaveBackendServers);
  ...
  void setMasterSlaveVServerGroupName(
      const std::string &masterSlaveVServerGroupName);
