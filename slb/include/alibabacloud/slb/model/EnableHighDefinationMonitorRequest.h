...
#ifndef ALIBABACLOUD_SLB_MODEL_ENABLEHIGHDEFINATIONMONITORREQUEST_H_
...
namespace Slb {
namespace Model {
class ALIBABACLOUD_SLB_EXPORT EnableHighDefinationMonitorRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SLB_MODEL_ENABLEHIGHDEFINATIONMONITORREQUEST_H_
