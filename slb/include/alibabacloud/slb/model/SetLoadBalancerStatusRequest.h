...
#ifndef ALIBABACLOUD_SLB_MODEL_SETLOADBALANCERSTATUSREQUEST_H_
...
namespace Slb {
namespace Model {
class ALIBABACLOUD_SLB_EXPORT SetLoadBalancerStatusRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SLB_MODEL_SETLOADBALANCERSTATUSREQUEST_H_
