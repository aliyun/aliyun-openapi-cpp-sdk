...
#ifndef ALIBABACLOUD_ECD_MODEL_MODIFYOFFICESITEATTRIBUTEREQUEST_H_
#define ALIBABACLOUD_ECD_MODEL_MODIFYOFFICESITEATTRIBUTEREQUEST_H_
...
namespace Ecd {
namespace Model {
class ALIBABACLOUD_ECD_EXPORT ModifyOfficeSiteAttributeRequest : public RpcServiceRequest {
public:
	...
	bool getNeedVerifyLoginRisk() const;
	void setNeedVerifyLoginRisk(bool needVerifyLoginRisk);
...
#endif // !ALIBABACLOUD_ECD_MODEL_MODIFYOFFICESITEATTRIBUTEREQUEST_H_
