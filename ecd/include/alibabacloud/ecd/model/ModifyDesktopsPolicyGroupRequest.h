...
#ifndef ALIBABACLOUD_ECD_MODEL_MODIFYDESKTOPSPOLICYGROUPREQUEST_H_
#define ALIBABACLOUD_ECD_MODEL_MODIFYDESKTOPSPOLICYGROUPREQUEST_H_
...
namespace Ecd {
namespace Model {
class ALIBABACLOUD_ECD_EXPORT ModifyDesktopsPolicyGroupRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ECD_MODEL_MODIFYDESKTOPSPOLICYGROUPREQUEST_H_
