...
#ifndef ALIBABACLOUD_ECD_MODEL_MOVECDSFILEREQUEST_H_
#define ALIBABACLOUD_ECD_MODEL_MOVECDSFILEREQUEST_H_
...
namespace Ecd {
namespace Model {
class ALIBABACLOUD_ECD_EXPORT MoveCdsFileRequest : public RpcServiceRequest {
public:
	MoveCdsFileRequest();
	~MoveCdsFileRequest();
...
#endif // !ALIBABACLOUD_ECD_MODEL_MOVECDSFILEREQUEST_H_
