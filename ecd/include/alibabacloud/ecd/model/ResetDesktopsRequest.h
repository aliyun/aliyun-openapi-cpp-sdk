...
#ifndef ALIBABACLOUD_ECD_MODEL_RESETDESKTOPSREQUEST_H_
#define ALIBABACLOUD_ECD_MODEL_RESETDESKTOPSREQUEST_H_
...
namespace Ecd {
namespace Model {
class ALIBABACLOUD_ECD_EXPORT ResetDesktopsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ECD_MODEL_RESETDESKTOPSREQUEST_H_
