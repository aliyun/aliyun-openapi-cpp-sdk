...
#ifndef ALIBABACLOUD_ECD_MODEL_REMOVEUSERFROMDESKTOPGROUPREQUEST_H_
#define ALIBABACLOUD_ECD_MODEL_REMOVEUSERFROMDESKTOPGROUPREQUEST_H_
...
namespace Ecd {
namespace Model {
class ALIBABACLOUD_ECD_EXPORT RemoveUserFromDesktopGroupRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ECD_MODEL_REMOVEUSERFROMDESKTOPGROUPREQUEST_H_
