...
#ifndef ALIBABACLOUD_ECD_MODEL_GETCONNECTIONTICKETREQUEST_H_
#define ALIBABACLOUD_ECD_MODEL_GETCONNECTIONTICKETREQUEST_H_
...
namespace Ecd {
namespace Model {
class ALIBABACLOUD_ECD_EXPORT GetConnectionTicketRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ECD_MODEL_GETCONNECTIONTICKETREQUEST_H_
