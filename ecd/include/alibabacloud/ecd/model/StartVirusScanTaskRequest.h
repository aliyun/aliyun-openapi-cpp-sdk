...
#ifndef ALIBABACLOUD_ECD_MODEL_STARTVIRUSSCANTASKREQUEST_H_
#define ALIBABACLOUD_ECD_MODEL_STARTVIRUSSCANTASKREQUEST_H_
...
namespace Ecd {
namespace Model {
class ALIBABACLOUD_ECD_EXPORT StartVirusScanTaskRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ECD_MODEL_STARTVIRUSSCANTASKREQUEST_H_
