...
#ifndef ALIBABACLOUD_ECD_MODEL_STOPINVOCATIONREQUEST_H_
#define ALIBABACLOUD_ECD_MODEL_STOPINVOCATIONREQUEST_H_
...
namespace Ecd {
namespace Model {
class ALIBABACLOUD_ECD_EXPORT StopInvocationRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ECD_MODEL_STOPINVOCATIONREQUEST_H_
