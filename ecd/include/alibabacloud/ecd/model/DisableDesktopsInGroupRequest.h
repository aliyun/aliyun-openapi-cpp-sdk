...
#ifndef ALIBABACLOUD_ECD_MODEL_DISABLEDESKTOPSINGROUPREQUEST_H_
#define ALIBABACLOUD_ECD_MODEL_DISABLEDESKTOPSINGROUPREQUEST_H_
...
namespace Ecd {
namespace Model {
class ALIBABACLOUD_ECD_EXPORT DisableDesktopsInGroupRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ECD_MODEL_DISABLEDESKTOPSINGROUPREQUEST_H_
