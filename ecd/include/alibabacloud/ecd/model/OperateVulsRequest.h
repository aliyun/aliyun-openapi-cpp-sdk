...
#ifndef ALIBABACLOUD_ECD_MODEL_OPERATEVULSREQUEST_H_
#define ALIBABACLOUD_ECD_MODEL_OPERATEVULSREQUEST_H_
...
namespace Ecd {
namespace Model {
class ALIBABACLOUD_ECD_EXPORT OperateVulsRequest : public RpcServiceRequest {
public:
	OperateVulsRequest();
	~OperateVulsRequest();
...
#endif // !ALIBABACLOUD_ECD_MODEL_OPERATEVULSREQUEST_H_
