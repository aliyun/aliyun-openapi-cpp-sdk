...
#ifndef ALIBABACLOUD_ECD_MODEL_REMOVEFILEPERMISSIONREQUEST_H_
...
namespace Ecd {
namespace Model {
class ALIBABACLOUD_ECD_EXPORT RemoveFilePermissionRequest : public RpcServiceRequest {
public:
	struct MemberList {
		std::string roleId;
		struct CdsIdentity {
...
#endif // !ALIBABACLOUD_ECD_MODEL_REMOVEFILEPERMISSIONREQUEST_H_
