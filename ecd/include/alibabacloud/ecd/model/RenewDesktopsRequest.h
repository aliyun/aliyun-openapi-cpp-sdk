...
#ifndef ALIBABACLOUD_ECD_MODEL_RENEWDESKTOPSREQUEST_H_
#define ALIBABACLOUD_ECD_MODEL_RENEWDESKTOPSREQUEST_H_
...
namespace Ecd {
namespace Model {
class ALIBABACLOUD_ECD_EXPORT RenewDesktopsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ECD_MODEL_RENEWDESKTOPSREQUEST_H_
