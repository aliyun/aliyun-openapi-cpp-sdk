...
#ifndef ALIBABACLOUD_ECD_MODEL_EXPORTCLIENTEVENTSREQUEST_H_
#define ALIBABACLOUD_ECD_MODEL_EXPORTCLIENTEVENTSREQUEST_H_
...
namespace Ecd {
namespace Model {
class ALIBABACLOUD_ECD_EXPORT ExportClientEventsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ECD_MODEL_EXPORTCLIENTEVENTSREQUEST_H_
