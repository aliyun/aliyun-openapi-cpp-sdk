...
ListOfficeSiteUsersResult::ListOfficeSiteUsersResult() :
	ServiceResult()
{}

ListOfficeSiteUsersResult::ListOfficeSiteUsersResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListOfficeSiteUsersResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string ListOfficeSiteUsersResult::getNextToken()const
{
	return nextToken_;
}

std::vector<ListOfficeSiteUsersResult::User> ListOfficeSiteUsersResult::getUsers()const
{
	return users_;
}
