...
#ifndef ALIBABACLOUD_OPENANALYTICS_OPEN_MODEL_RESETMAINPASSWORDREQUEST_H_
#define ALIBABACLOUD_OPENANALYTICS_OPEN_MODEL_RESETMAINPASSWORDREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Openanalytics_open
	{
		namespace Model
		{
			class ALIBABACLOUD_OPENANALYTICS_OPEN_EXPORT ResetMainPasswordRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_OPENANALYTICS_OPEN_MODEL_RESETMAINPASSWORDREQUEST_H_