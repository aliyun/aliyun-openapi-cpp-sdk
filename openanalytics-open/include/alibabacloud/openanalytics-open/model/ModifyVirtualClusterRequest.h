...
#ifndef ALIBABACLOUD_OPENANALYTICS_OPEN_MODEL_MODIFYVIRTUALCLUSTERREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Openanalytics_open
	{
		namespace Model
		{
			class ALIBABACLOUD_OPENANALYTICS_OPEN_EXPORT ModifyVirtualClusterRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_OPENANALYTICS_OPEN_MODEL_MODIFYVIRTUALCLUSTERREQUEST_H_