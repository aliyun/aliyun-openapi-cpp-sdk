...
#ifndef ALIBABACLOUD_NAS_MODEL_MODIFYPROTOCOLMOUNTTARGETREQUEST_H_
#define ALIBABACLOUD_NAS_MODEL_MODIFYPROTOCOLMOUNTTARGETREQUEST_H_
...
namespace NAS {
namespace Model {
class ALIBABACLOUD_NAS_EXPORT ModifyProtocolMountTargetRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_NAS_MODEL_MODIFYPROTOCOLMOUNTTARGETREQUEST_H_
