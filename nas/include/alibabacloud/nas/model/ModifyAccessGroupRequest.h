...
#ifndef ALIBABACLOUD_NAS_MODEL_MODIFYACCESSGROUPREQUEST_H_
#define ALIBABACLOUD_NAS_MODEL_MODIFYACCESSGROUPREQUEST_H_
...
namespace NAS {
namespace Model {
class ALIBABACLOUD_NAS_EXPORT ModifyAccessGroupRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_NAS_MODEL_MODIFYACCESSGROUPREQUEST_H_
