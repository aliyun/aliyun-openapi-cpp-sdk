...
#ifndef ALIBABACLOUD_NAS_MODEL_MODIFYAUTOSNAPSHOTPOLICYREQUEST_H_
#define ALIBABACLOUD_NAS_MODEL_MODIFYAUTOSNAPSHOTPOLICYREQUEST_H_
...
namespace NAS {
namespace Model {
class ALIBABACLOUD_NAS_EXPORT ModifyAutoSnapshotPolicyRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_NAS_MODEL_MODIFYAUTOSNAPSHOTPOLICYREQUEST_H_
