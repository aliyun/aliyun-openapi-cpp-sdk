...
OpenNASServiceResult::OpenNASServiceResult() :
	ServiceResult()
{}

OpenNASServiceResult::OpenNASServiceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void OpenNASServiceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
