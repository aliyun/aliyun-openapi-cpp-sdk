...
void CreateMountTargetResult::parse(const std::string &payload)
{
	...
	auto mountTargetExtraNode = value["MountTargetExtra"];
	if(!mountTargetExtraNode["DualStackMountTargetDomain"].isNull())
		mountTargetExtra_.dualStackMountTargetDomain = mountTargetExtraNode["DualStackMountTargetDomain"].asString();
	if(!value["MountTargetDomain"].isNull())
		mountTargetDomain_ = value["MountTargetDomain"].asString();

}

std::string CreateMountTargetResult::getMountTargetDomain()const
{
	return mountTargetDomain_;
}

CreateMountTargetResult::MountTargetExtra CreateMountTargetResult::getMountTargetExtra()const
{
	return mountTargetExtra_;
}
