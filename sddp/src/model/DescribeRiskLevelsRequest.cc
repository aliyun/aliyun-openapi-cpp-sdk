...
using AlibabaCloud::Sddp::Model::DescribeRiskLevelsRequest;

DescribeRiskLevelsRequest::DescribeRiskLevelsRequest()
    : RpcServiceRequest("sddp", "2019-01-03", "DescribeRiskLevels") {
...
void DescribeRiskLevelsRequest::setSourceIp(const std::string &sourceIp) {
  sourceIp_ = sourceIp;
  setParameter(std::string("SourceIp"), sourceIp);
}

std::string DescribeRiskLevelsRequest::getLang() const {
  return lang_;
}

void DescribeRiskLevelsRequest::setLang(const std::string &lang) {
  lang_ = lang;
