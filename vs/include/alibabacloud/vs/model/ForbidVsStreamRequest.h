...
#ifndef ALIBABACLOUD_VS_MODEL_FORBIDVSSTREAMREQUEST_H_
#define ALIBABACLOUD_VS_MODEL_FORBIDVSSTREAMREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Vs
	{
		namespace Model
		{
			class ALIBABACLOUD_VS_EXPORT ForbidVsStreamRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_VS_MODEL_FORBIDVSSTREAMREQUEST_H_