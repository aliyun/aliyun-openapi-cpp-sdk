...
#ifndef ALIBABACLOUD_VS_MODEL_MODIFYGROUPREQUEST_H_
#define ALIBABACLOUD_VS_MODEL_MODIFYGROUPREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Vs
	{
		namespace Model
		{
			class ALIBABACLOUD_VS_EXPORT ModifyGroupRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_VS_MODEL_MODIFYGROUPREQUEST_H_