...
#ifndef ALIBABACLOUD_VS_MODEL_BATCHRESUMEVSSTREAMREQUEST_H_
#define ALIBABACLOUD_VS_MODEL_BATCHRESUMEVSSTREAMREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Vs
	{
		namespace Model
		{
			class ALIBABACLOUD_VS_EXPORT BatchResumeVsStreamRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_VS_MODEL_BATCHRESUMEVSSTREAMREQUEST_H_