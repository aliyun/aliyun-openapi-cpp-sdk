...
#ifndef ALIBABACLOUD_VS_MODEL_MODIFYDEVICEREQUEST_H_
#define ALIBABACLOUD_VS_MODEL_MODIFYDEVICEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Vs
	{
		namespace Model
		{
			class ALIBABACLOUD_VS_EXPORT ModifyDeviceRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_VS_MODEL_MODIFYDEVICEREQUEST_H_