...
#ifndef ALIBABACLOUD_VS_MODEL_MODIFYPARENTPLATFORMREQUEST_H_
#define ALIBABACLOUD_VS_MODEL_MODIFYPARENTPLATFORMREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Vs
	{
		namespace Model
		{
			class ALIBABACLOUD_VS_EXPORT ModifyParentPlatformRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_VS_MODEL_MODIFYPARENTPLATFORMREQUEST_H_