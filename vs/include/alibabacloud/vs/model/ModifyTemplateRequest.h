...
#ifndef ALIBABACLOUD_VS_MODEL_MODIFYTEMPLATEREQUEST_H_
#define ALIBABACLOUD_VS_MODEL_MODIFYTEMPLATEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Vs
	{
		namespace Model
		{
			class ALIBABACLOUD_VS_EXPORT ModifyTemplateRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_VS_MODEL_MODIFYTEMPLATEREQUEST_H_