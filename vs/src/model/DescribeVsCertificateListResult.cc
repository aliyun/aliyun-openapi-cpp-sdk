...
DescribeVsCertificateListResult::DescribeVsCertificateListResult() :
	ServiceResult()
{}

DescribeVsCertificateListResult::DescribeVsCertificateListResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeVsCertificateListResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
DescribeVsCertificateListResult::CertificateListModel DescribeVsCertificateListResult::getCertificateListModel()const
{
