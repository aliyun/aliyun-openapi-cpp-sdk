...
DescribeVsStreamsPublishListResult::DescribeVsStreamsPublishListResult() :
	ServiceResult()
{}

DescribeVsStreamsPublishListResult::DescribeVsStreamsPublishListResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeVsStreamsPublishListResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
int DescribeVsStreamsPublishListResult::getTotalNum()const
{
	return totalNum_;
}

int DescribeVsStreamsPublishListResult::getPageNum()const
{
	return pageNum_;
}

int DescribeVsStreamsPublishListResult::getPageSize()const
{
	return pageSize_;
}

int DescribeVsStreamsPublishListResult::getTotalPage()const
{
	return totalPage_;
}

std::vector<DescribeVsStreamsPublishListResult::LiveStreamPublishInfo> DescribeVsStreamsPublishListResult::getPublishInfo()const
{
	return publishInfo_;
}
