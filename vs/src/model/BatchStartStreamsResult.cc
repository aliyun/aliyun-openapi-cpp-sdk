...
BatchStartStreamsResult::BatchStartStreamsResult() :
	ServiceResult()
{}

BatchStartStreamsResult::BatchStartStreamsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void BatchStartStreamsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<BatchStartStreamsResult::Result> BatchStartStreamsResult::getResults()const
{
	return results_;
}
