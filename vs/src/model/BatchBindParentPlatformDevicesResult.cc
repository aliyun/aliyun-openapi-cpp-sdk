...
BatchBindParentPlatformDevicesResult::BatchBindParentPlatformDevicesResult() :
	ServiceResult()
{}

BatchBindParentPlatformDevicesResult::BatchBindParentPlatformDevicesResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void BatchBindParentPlatformDevicesResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<BatchBindParentPlatformDevicesResult::Result> BatchBindParentPlatformDevicesResult::getResults()const
{
	return results_;
}
