...
BatchStopDevicesResult::BatchStopDevicesResult() :
	ServiceResult()
{}

BatchStopDevicesResult::BatchStopDevicesResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void BatchStopDevicesResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<BatchStopDevicesResult::Result> BatchStopDevicesResult::getResults()const
{
	return results_;
}
