...
BatchUnbindTemplateResult::BatchUnbindTemplateResult() :
	ServiceResult()
{}

BatchUnbindTemplateResult::BatchUnbindTemplateResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void BatchUnbindTemplateResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<BatchUnbindTemplateResult::Binding> BatchUnbindTemplateResult::getBindings()const
{
	return bindings_;
}
