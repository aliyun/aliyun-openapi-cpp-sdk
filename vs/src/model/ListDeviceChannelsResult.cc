...
ListDeviceChannelsResult::ListDeviceChannelsResult() :
	ServiceResult()
{}

ListDeviceChannelsResult::ListDeviceChannelsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListDeviceChannelsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
long ListDeviceChannelsResult::getTotalCount()const
{
	return totalCount_;
}

long ListDeviceChannelsResult::getPageSize()const
{
	return pageSize_;
}

long ListDeviceChannelsResult::getPageNum()const
{
	return pageNum_;
}

long ListDeviceChannelsResult::getPageCount()const
{
	return pageCount_;
}

std::vector<ListDeviceChannelsResult::Channel> ListDeviceChannelsResult::getChannels()const
{
	return channels_;
}
