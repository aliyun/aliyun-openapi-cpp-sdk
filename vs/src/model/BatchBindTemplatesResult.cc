...
BatchBindTemplatesResult::BatchBindTemplatesResult() :
	ServiceResult()
{}

BatchBindTemplatesResult::BatchBindTemplatesResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void BatchBindTemplatesResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<BatchBindTemplatesResult::Result> BatchBindTemplatesResult::getResults()const
{
	return results_;
}
