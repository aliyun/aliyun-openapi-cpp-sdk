...
DescribeVsDomainCertificateInfoResult::DescribeVsDomainCertificateInfoResult() :
	ServiceResult()
{}

DescribeVsDomainCertificateInfoResult::DescribeVsDomainCertificateInfoResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeVsDomainCertificateInfoResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeVsDomainCertificateInfoResult::CertInfo> DescribeVsDomainCertificateInfoResult::getCertInfos()const
{
	return certInfos_;
}
