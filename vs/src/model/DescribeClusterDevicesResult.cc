...
DescribeClusterDevicesResult::DescribeClusterDevicesResult() :
	ServiceResult()
{}

DescribeClusterDevicesResult::DescribeClusterDevicesResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeClusterDevicesResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	for (auto valueDevicesDevice : allDevicesNode)
	{
		...
		if(!valueDevicesDevice["Server"].isNull())
			devicesObject.server = valueDevicesDevice["Server"].asString();
...
long DescribeClusterDevicesResult::getTotal()const
{
	return total_;
}

std::vector<DescribeClusterDevicesResult::Device> DescribeClusterDevicesResult::getDevices()const
{
	return devices_;
}
