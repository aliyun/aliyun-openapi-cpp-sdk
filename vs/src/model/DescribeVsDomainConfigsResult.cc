...
DescribeVsDomainConfigsResult::DescribeVsDomainConfigsResult() :
	ServiceResult()
{}

DescribeVsDomainConfigsResult::DescribeVsDomainConfigsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeVsDomainConfigsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeVsDomainConfigsResult::DomainConfig> DescribeVsDomainConfigsResult::getDomainConfigs()const
{
