...
#include <alibabacloud/sas/model/ListUninstallAegisMachinesResult.h>
#include <json/json.h>

using namespace AlibabaCloud::Sas;
using namespace AlibabaCloud::Sas::Model;

ListUninstallAegisMachinesResult::ListUninstallAegisMachinesResult() :
	ServiceResult()
{}

ListUninstallAegisMachinesResult::ListUninstallAegisMachinesResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListUninstallAegisMachinesResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<ListUninstallAegisMachinesResult::Machine> ListUninstallAegisMachinesResult::getMachineList()const
{
	return machineList_;
}

int ListUninstallAegisMachinesResult::getTotalCount()const
{
	return totalCount_;
}

int ListUninstallAegisMachinesResult::getPageSize()const
{
	return pageSize_;
}

int ListUninstallAegisMachinesResult::getCurrentPage()const
{
	return currentPage_;
}
