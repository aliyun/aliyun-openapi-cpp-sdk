...
#include <alibabacloud/sas/model/UpdateHoneypotResult.h>
#include <json/json.h>

using namespace AlibabaCloud::Sas;
using namespace AlibabaCloud::Sas::Model;

UpdateHoneypotResult::UpdateHoneypotResult() :
	ServiceResult()
{}

UpdateHoneypotResult::UpdateHoneypotResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateHoneypotResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string UpdateHoneypotResult::getMessage()const
{
	return message_;
}

int UpdateHoneypotResult::getHttpStatusCode()const
{
	return httpStatusCode_;
}

UpdateHoneypotResult::Data UpdateHoneypotResult::getData()const
{
	return data_;
}

std::string UpdateHoneypotResult::getCode()const
{
	return code_;
}

bool UpdateHoneypotResult::getSuccess()const
{
	return success_;
}
