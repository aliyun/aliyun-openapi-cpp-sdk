...
#include <alibabacloud/sas/model/DescribeImageRepoCriteriaResult.h>
#include <json/json.h>

using namespace AlibabaCloud::Sas;
using namespace AlibabaCloud::Sas::Model;

DescribeImageRepoCriteriaResult::DescribeImageRepoCriteriaResult() :
	ServiceResult()
{}

DescribeImageRepoCriteriaResult::DescribeImageRepoCriteriaResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeImageRepoCriteriaResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeImageRepoCriteriaResult::Criteria> DescribeImageRepoCriteriaResult::getCriteriaList()const
{
