...
#include <alibabacloud/sas/model/DescribeImageCriteriaResult.h>
#include <json/json.h>

using namespace AlibabaCloud::Sas;
using namespace AlibabaCloud::Sas::Model;

DescribeImageCriteriaResult::DescribeImageCriteriaResult() :
	ServiceResult()
{}

DescribeImageCriteriaResult::DescribeImageCriteriaResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeImageCriteriaResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeImageCriteriaResult::Criteria> DescribeImageCriteriaResult::getCriteriaList()const
{
