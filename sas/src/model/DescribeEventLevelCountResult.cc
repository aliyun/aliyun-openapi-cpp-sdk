...
#include <alibabacloud/sas/model/DescribeEventLevelCountResult.h>
#include <json/json.h>
...
std::string DescribeEventLevelCountResult::getMessage()const
{
	return message_;
}

std::string DescribeEventLevelCountResult::getCode()const
{
	return code_;
}

bool DescribeEventLevelCountResult::getSuccess()const
{
	return success_;
}
