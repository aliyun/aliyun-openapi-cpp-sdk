...
DescribeVpcHoneyPotCriteriaResult::DescribeVpcHoneyPotCriteriaResult() :
	ServiceResult()
{}

DescribeVpcHoneyPotCriteriaResult::DescribeVpcHoneyPotCriteriaResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeVpcHoneyPotCriteriaResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeVpcHoneyPotCriteriaResult::Criteria> DescribeVpcHoneyPotCriteriaResult::getCriteriaList()const
{
