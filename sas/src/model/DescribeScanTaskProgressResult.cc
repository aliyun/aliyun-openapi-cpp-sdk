...
std::string DescribeScanTaskProgressResult::getTargetInfo()const
{
	return targetInfo_;
}

std::string DescribeScanTaskProgressResult::getScanTaskProgress()const
{
	return scanTaskProgress_;
}
