...
using AlibabaCloud::Sas::Model::RollbackSuspEventQuaraFileRequest;

RollbackSuspEventQuaraFileRequest::RollbackSuspEventQuaraFileRequest() :
	RpcServiceRequest("sas", "2018-12-03", "RollbackSuspEventQuaraFile")
{
...
void RollbackSuspEventQuaraFileRequest::setQuaraFileId(int quaraFileId)
{
	...
	setParameter("QuaraFileId", std::to_string(quaraFileId));
}
