...
#include <alibabacloud/sas/model/DescribeAgentInstallStatusRequest.h>

using AlibabaCloud::Sas::Model::DescribeAgentInstallStatusRequest;

DescribeAgentInstallStatusRequest::DescribeAgentInstallStatusRequest()
    : RpcServiceRequest("sas", "2018-12-03", "DescribeAgentInstallStatus") {
