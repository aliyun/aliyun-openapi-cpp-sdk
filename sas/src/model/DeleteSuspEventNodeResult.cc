...
#include <alibabacloud/sas/model/DeleteSuspEventNodeResult.h>
#include <json/json.h>
...
std::string DeleteSuspEventNodeResult::getMessage()const
{
	return message_;
}

std::string DeleteSuspEventNodeResult::getCode()const
{
	return code_;
}
