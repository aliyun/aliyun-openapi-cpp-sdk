...
void CreateVulAutoRepairConfigRequest::setVulAutoRepairConfigList(const std::vector<VulAutoRepairConfigList>& vulAutoRepairConfigList)
{
	...
	for(int dep1 = 0; dep1!= vulAutoRepairConfigList.size(); dep1++) {
		...
		std::string vulAutoRepairConfigListObjStr = "VulAutoRepairConfigList." + std::to_string(dep1 + 1);
