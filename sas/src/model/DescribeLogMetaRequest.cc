...
#include <alibabacloud/sas/model/DescribeLogMetaRequest.h>

using AlibabaCloud::Sas::Model::DescribeLogMetaRequest;

DescribeLogMetaRequest::DescribeLogMetaRequest()
    : RpcServiceRequest("sas", "2018-12-03", "DescribeLogMeta") {
