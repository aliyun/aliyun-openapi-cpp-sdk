...
#include <alibabacloud/sas/model/DescribeContainerCriteriaResult.h>
#include <json/json.h>

using namespace AlibabaCloud::Sas;
using namespace AlibabaCloud::Sas::Model;

DescribeContainerCriteriaResult::DescribeContainerCriteriaResult() :
	ServiceResult()
{}

DescribeContainerCriteriaResult::DescribeContainerCriteriaResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeContainerCriteriaResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeContainerCriteriaResult::Criteria> DescribeContainerCriteriaResult::getCriteriaList()const
{
