...
#include <alibabacloud/sas/model/OperateVirusEventsRequest.h>

using AlibabaCloud::Sas::Model::OperateVirusEventsRequest;

OperateVirusEventsRequest::OperateVirusEventsRequest()
    : RpcServiceRequest("sas", "2018-12-03", "OperateVirusEvents") {
...
void OperateVirusEventsRequest::setSourceIp(const std::string &sourceIp) {
  sourceIp_ = sourceIp;
  setParameter(std::string("SourceIp"), sourceIp);
}

std::string OperateVirusEventsRequest::getOperationCode() const {
