...
using AlibabaCloud::Sas::Model::ExportRecordRequest;

ExportRecordRequest::ExportRecordRequest()
    : RpcServiceRequest("sas", "2018-12-03", "ExportRecord") {
...
void ExportRecordRequest::setSourceIp(const std::string &sourceIp) {
  sourceIp_ = sourceIp;
  setParameter(std::string("SourceIp"), sourceIp);
}

std::string ExportRecordRequest::getLang() const {
  return lang_;
}
