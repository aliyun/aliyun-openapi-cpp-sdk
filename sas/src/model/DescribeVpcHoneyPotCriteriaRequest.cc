...
using AlibabaCloud::Sas::Model::DescribeVpcHoneyPotCriteriaRequest;

DescribeVpcHoneyPotCriteriaRequest::DescribeVpcHoneyPotCriteriaRequest()
    : RpcServiceRequest("sas", "2018-12-03", "DescribeVpcHoneyPotCriteria") {
  setMethod(HttpRequest::Method::Post);
}

DescribeVpcHoneyPotCriteriaRequest::~DescribeVpcHoneyPotCriteriaRequest() {}

std::string DescribeVpcHoneyPotCriteriaRequest::getSourceIp() const {
  return sourceIp_;
}

void DescribeVpcHoneyPotCriteriaRequest::setSourceIp(const std::string &sourceIp) {
  sourceIp_ = sourceIp;
