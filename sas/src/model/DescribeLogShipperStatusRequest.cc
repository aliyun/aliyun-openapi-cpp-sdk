...
#include <alibabacloud/sas/model/DescribeLogShipperStatusRequest.h>

using AlibabaCloud::Sas::Model::DescribeLogShipperStatusRequest;

DescribeLogShipperStatusRequest::DescribeLogShipperStatusRequest()
    : RpcServiceRequest("sas", "2018-12-03", "DescribeLogShipperStatus") {
  setMethod(HttpRequest::Method::Post);
}

DescribeLogShipperStatusRequest::~DescribeLogShipperStatusRequest() {}

std::string DescribeLogShipperStatusRequest::getSourceIp() const {
  return sourceIp_;
}
