...
#ifndef ALIBABACLOUD_SAS_MODEL_GETCLOUDASSETDETAILREQUEST_H_
#define ALIBABACLOUD_SAS_MODEL_GETCLOUDASSETDETAILREQUEST_H_
...
namespace Sas {
namespace Model {
class ALIBABACLOUD_SAS_EXPORT GetCloudAssetDetailRequest : public RpcServiceRequest {
public:
	struct CloudAssetInstances {
...
#endif // !ALIBABACLOUD_SAS_MODEL_GETCLOUDASSETDETAILREQUEST_H_
