...
#ifndef ALIBABACLOUD_SAS_MODEL_UNINSTALLBACKUPCLIENTREQUEST_H_
...
namespace Sas {
namespace Model {
class ALIBABACLOUD_SAS_EXPORT UninstallBackupClientRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SAS_MODEL_UNINSTALLBACKUPCLIENTREQUEST_H_
