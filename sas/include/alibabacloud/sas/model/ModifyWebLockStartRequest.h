...
#ifndef ALIBABACLOUD_SAS_MODEL_MODIFYWEBLOCKSTARTREQUEST_H_
#define ALIBABACLOUD_SAS_MODEL_MODIFYWEBLOCKSTARTREQUEST_H_
...
namespace Sas {
namespace Model {
class ALIBABACLOUD_SAS_EXPORT ModifyWebLockStartRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SAS_MODEL_MODIFYWEBLOCKSTARTREQUEST_H_
