...
#ifndef ALIBABACLOUD_SAS_MODEL_GETMODULECONFIGREQUEST_H_
#define ALIBABACLOUD_SAS_MODEL_GETMODULECONFIGREQUEST_H_
...
namespace Sas {
namespace Model {
class ALIBABACLOUD_SAS_EXPORT GetModuleConfigRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SAS_MODEL_GETMODULECONFIGREQUEST_H_
