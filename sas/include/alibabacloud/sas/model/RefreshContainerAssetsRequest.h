...
#ifndef ALIBABACLOUD_SAS_MODEL_REFRESHCONTAINERASSETSREQUEST_H_
#define ALIBABACLOUD_SAS_MODEL_REFRESHCONTAINERASSETSREQUEST_H_
...
namespace Sas {
namespace Model {
class ALIBABACLOUD_SAS_EXPORT RefreshContainerAssetsRequest : public RpcServiceRequest {
public:
