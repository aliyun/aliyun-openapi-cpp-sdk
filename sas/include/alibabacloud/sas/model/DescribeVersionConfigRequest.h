...
#ifndef ALIBABACLOUD_SAS_MODEL_DESCRIBEVERSIONCONFIGREQUEST_H_
...
namespace Sas {
namespace Model {
class ALIBABACLOUD_SAS_EXPORT DescribeVersionConfigRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SAS_MODEL_DESCRIBEVERSIONCONFIGREQUEST_H_
