...
#ifndef ALIBABACLOUD_SAS_MODEL_DESCRIBEPROPERTYSCAITEMREQUEST_H_
#define ALIBABACLOUD_SAS_MODEL_DESCRIBEPROPERTYSCAITEMREQUEST_H_
...
namespace Sas {
namespace Model {
class ALIBABACLOUD_SAS_EXPORT DescribePropertyScaItemRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SAS_MODEL_DESCRIBEPROPERTYSCAITEMREQUEST_H_
