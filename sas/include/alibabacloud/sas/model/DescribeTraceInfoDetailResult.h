...
#ifndef ALIBABACLOUD_SAS_MODEL_DESCRIBETRACEINFODETAILRESULT_H_
#define ALIBABACLOUD_SAS_MODEL_DESCRIBETRACEINFODETAILRESULT_H_
...
namespace AlibabaCloud
{
	namespace Sas
	{
		namespace Model
		{
			class ALIBABACLOUD_SAS_EXPORT DescribeTraceInfoDetailResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_SAS_MODEL_DESCRIBETRACEINFODETAILRESULT_H_