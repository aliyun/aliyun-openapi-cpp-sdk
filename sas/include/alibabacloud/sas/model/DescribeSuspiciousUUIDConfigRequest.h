...
namespace Sas {
namespace Model {
class ALIBABACLOUD_SAS_EXPORT DescribeSuspiciousUUIDConfigRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SAS_MODEL_DESCRIBESUSPICIOUSUUIDCONFIGREQUEST_H_
