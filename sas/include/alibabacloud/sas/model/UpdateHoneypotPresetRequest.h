...
#ifndef ALIBABACLOUD_SAS_MODEL_UPDATEHONEYPOTPRESETREQUEST_H_
#define ALIBABACLOUD_SAS_MODEL_UPDATEHONEYPOTPRESETREQUEST_H_
...
namespace Sas {
namespace Model {
class ALIBABACLOUD_SAS_EXPORT UpdateHoneypotPresetRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SAS_MODEL_UPDATEHONEYPOTPRESETREQUEST_H_
