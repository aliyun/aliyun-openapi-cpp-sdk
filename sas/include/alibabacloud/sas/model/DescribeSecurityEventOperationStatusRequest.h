...
#ifndef ALIBABACLOUD_SAS_MODEL_DESCRIBESECURITYEVENTOPERATIONSTATUSREQUEST_H_
...
namespace Sas {
namespace Model {
class ALIBABACLOUD_SAS_EXPORT DescribeSecurityEventOperationStatusRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SAS_MODEL_DESCRIBESECURITYEVENTOPERATIONSTATUSREQUEST_H_
