...
#ifndef ALIBABACLOUD_SAS_MODEL_MODIFYTAGWITHUUIDREQUEST_H_
#define ALIBABACLOUD_SAS_MODEL_MODIFYTAGWITHUUIDREQUEST_H_
...
namespace Sas {
namespace Model {
class ALIBABACLOUD_SAS_EXPORT ModifyTagWithUuidRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SAS_MODEL_MODIFYTAGWITHUUIDREQUEST_H_
