...
#ifndef ALIBABACLOUD_SAS_MODEL_DESCRIBETOTALSTATISTICSRESULT_H_
#define ALIBABACLOUD_SAS_MODEL_DESCRIBETOTALSTATISTICSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Sas
	{
		namespace Model
		{
			class ALIBABACLOUD_SAS_EXPORT DescribeTotalStatisticsResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_SAS_MODEL_DESCRIBETOTALSTATISTICSRESULT_H_