	...
	namespace Sas
	{
		namespace Model
		{
			...
			public:
				...
				ModifyPropertyScheduleConfigResult();
				explicit ModifyPropertyScheduleConfigResult(const std::string &payload);
				~ModifyPropertyScheduleConfigResult();
				bool getModifyResult()const;
...
#endif // !ALIBABACLOUD_SAS_MODEL_MODIFYPROPERTYSCHEDULECONFIGRESULT_H_