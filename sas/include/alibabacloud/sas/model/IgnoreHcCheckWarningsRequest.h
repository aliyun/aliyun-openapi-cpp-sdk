...
#ifndef ALIBABACLOUD_SAS_MODEL_IGNOREHCCHECKWARNINGSREQUEST_H_
#define ALIBABACLOUD_SAS_MODEL_IGNOREHCCHECKWARNINGSREQUEST_H_
...
namespace Sas {
namespace Model {
class ALIBABACLOUD_SAS_EXPORT IgnoreHcCheckWarningsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SAS_MODEL_IGNOREHCCHECKWARNINGSREQUEST_H_
