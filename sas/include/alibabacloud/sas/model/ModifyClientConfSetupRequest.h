...
#ifndef ALIBABACLOUD_SAS_MODEL_MODIFYCLIENTCONFSETUPREQUEST_H_
#define ALIBABACLOUD_SAS_MODEL_MODIFYCLIENTCONFSETUPREQUEST_H_
...
namespace Sas {
namespace Model {
class ALIBABACLOUD_SAS_EXPORT ModifyClientConfSetupRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SAS_MODEL_MODIFYCLIENTCONFSETUPREQUEST_H_
