...
#ifndef ALIBABACLOUD_SAS_MODEL_MODIFYWEBLOCKUPDATECONFIGREQUEST_H_
#define ALIBABACLOUD_SAS_MODEL_MODIFYWEBLOCKUPDATECONFIGREQUEST_H_
...
namespace Sas {
namespace Model {
class ALIBABACLOUD_SAS_EXPORT ModifyWebLockUpdateConfigRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SAS_MODEL_MODIFYWEBLOCKUPDATECONFIGREQUEST_H_
