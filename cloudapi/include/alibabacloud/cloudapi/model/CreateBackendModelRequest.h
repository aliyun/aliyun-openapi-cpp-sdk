...
#ifndef ALIBABACLOUD_CLOUDAPI_MODEL_CREATEBACKENDMODELREQUEST_H_
#define ALIBABACLOUD_CLOUDAPI_MODEL_CREATEBACKENDMODELREQUEST_H_
...
namespace CloudAPI {
namespace Model {
class ALIBABACLOUD_CLOUDAPI_EXPORT CreateBackendModelRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLOUDAPI_MODEL_CREATEBACKENDMODELREQUEST_H_
