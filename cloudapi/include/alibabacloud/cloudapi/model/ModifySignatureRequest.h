...
#ifndef ALIBABACLOUD_CLOUDAPI_MODEL_MODIFYSIGNATUREREQUEST_H_
#define ALIBABACLOUD_CLOUDAPI_MODEL_MODIFYSIGNATUREREQUEST_H_
...
namespace CloudAPI {
namespace Model {
class ALIBABACLOUD_CLOUDAPI_EXPORT ModifySignatureRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLOUDAPI_MODEL_MODIFYSIGNATUREREQUEST_H_
