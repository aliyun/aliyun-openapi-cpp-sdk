...
#ifndef ALIBABACLOUD_CLOUDAPI_MODEL_SETAPPSAUTHORITIESREQUEST_H_
...
namespace CloudAPI {
namespace Model {
class ALIBABACLOUD_CLOUDAPI_EXPORT SetAppsAuthoritiesRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLOUDAPI_MODEL_SETAPPSAUTHORITIESREQUEST_H_
