...
#ifndef ALIBABACLOUD_CLOUDAPI_MODEL_REMOVEAPPSAUTHORITIESREQUEST_H_
...
namespace CloudAPI {
namespace Model {
class ALIBABACLOUD_CLOUDAPI_EXPORT RemoveAppsAuthoritiesRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CLOUDAPI_MODEL_REMOVEAPPSAUTHORITIESREQUEST_H_
