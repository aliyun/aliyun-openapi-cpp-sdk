...
std::string ResetAppCodeRequest::getNewAppCode() const {
  return newAppCode_;
}

void ResetAppCodeRequest::setNewAppCode(const std::string &newAppCode) {
  newAppCode_ = newAppCode;
  setParameter(std::string("NewAppCode"), newAppCode);
}
