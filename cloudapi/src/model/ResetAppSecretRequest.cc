...
std::string ResetAppSecretRequest::getNewAppSecret() const {
  return newAppSecret_;
}

void ResetAppSecretRequest::setNewAppSecret(const std::string &newAppSecret) {
  newAppSecret_ = newAppSecret;
  setParameter(std::string("NewAppSecret"), newAppSecret);
}
