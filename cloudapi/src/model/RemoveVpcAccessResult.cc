...
RemoveVpcAccessResult::RemoveVpcAccessResult() :
	ServiceResult()
{}

RemoveVpcAccessResult::RemoveVpcAccessResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RemoveVpcAccessResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
