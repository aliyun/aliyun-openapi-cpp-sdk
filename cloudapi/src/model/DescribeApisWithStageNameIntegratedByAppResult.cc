...
#include <alibabacloud/cloudapi/model/DescribeApisWithStageNameIntegratedByAppResult.h>
#include <json/json.h>

using namespace AlibabaCloud::CloudAPI;
using namespace AlibabaCloud::CloudAPI::Model;

DescribeApisWithStageNameIntegratedByAppResult::DescribeApisWithStageNameIntegratedByAppResult() :
	ServiceResult()
{}

DescribeApisWithStageNameIntegratedByAppResult::DescribeApisWithStageNameIntegratedByAppResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeApisWithStageNameIntegratedByAppResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	for (auto valueAppApiRelationInfosAppApiRelationInfo : allAppApiRelationInfosNode)
	{
		...
		if(!valueAppApiRelationInfosAppApiRelationInfo["StageNameAndAuth"].isNull())
			appApiRelationInfosObject.stageNameAndAuth = valueAppApiRelationInfosAppApiRelationInfo["StageNameAndAuth"].asString();
...
std::vector<DescribeApisWithStageNameIntegratedByAppResult::AppApiRelationInfo> DescribeApisWithStageNameIntegratedByAppResult::getAppApiRelationInfos()const
{
	return appApiRelationInfos_;
}

int DescribeApisWithStageNameIntegratedByAppResult::getTotalCount()const
{
	return totalCount_;
}

int DescribeApisWithStageNameIntegratedByAppResult::getPageSize()const
{
	return pageSize_;
}

int DescribeApisWithStageNameIntegratedByAppResult::getPageNumber()const
{
	return pageNumber_;
}
