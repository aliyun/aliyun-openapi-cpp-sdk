...
std::string SetDomainWebSocketStatusRequest::getWSSEnable() const {
  return wSSEnable_;
}

void SetDomainWebSocketStatusRequest::setWSSEnable(const std::string &wSSEnable) {
  wSSEnable_ = wSSEnable;
  setParameter(std::string("WSSEnable"), wSSEnable);
}
...
void SetDomainWebSocketStatusRequest::setActionValue(const std::string &actionValue) {
  ...
  setParameter(std::string("ActionValue"), actionValue);
}
