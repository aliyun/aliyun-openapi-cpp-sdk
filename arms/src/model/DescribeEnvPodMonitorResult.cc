...
DescribeEnvPodMonitorResult::DescribeEnvPodMonitorResult() :
	ServiceResult()
{}

DescribeEnvPodMonitorResult::DescribeEnvPodMonitorResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeEnvPodMonitorResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeEnvPodMonitorResult::getMessage()const
{
	return message_;
}

DescribeEnvPodMonitorResult::Data DescribeEnvPodMonitorResult::getData()const
{
	return data_;
}

int DescribeEnvPodMonitorResult::getCode()const
{
	return code_;
}
