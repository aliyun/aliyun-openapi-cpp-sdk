...
ListPrometheusGlobalViewResult::ListPrometheusGlobalViewResult() :
	ServiceResult()
{}

ListPrometheusGlobalViewResult::ListPrometheusGlobalViewResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListPrometheusGlobalViewResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
