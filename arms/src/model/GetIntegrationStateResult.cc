...
GetIntegrationStateResult::GetIntegrationStateResult() :
	ServiceResult()
{}

GetIntegrationStateResult::GetIntegrationStateResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetIntegrationStateResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
