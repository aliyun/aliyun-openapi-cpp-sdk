...
RemoveAliClusterIdsFromPrometheusGlobalViewResult::RemoveAliClusterIdsFromPrometheusGlobalViewResult() :
	ServiceResult()
{}

RemoveAliClusterIdsFromPrometheusGlobalViewResult::RemoveAliClusterIdsFromPrometheusGlobalViewResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RemoveAliClusterIdsFromPrometheusGlobalViewResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
