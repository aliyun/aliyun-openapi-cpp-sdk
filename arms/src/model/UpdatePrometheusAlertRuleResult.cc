...
std::string UpdatePrometheusAlertRuleResult::getMessage()const
{
	return message_;
}
...
long UpdatePrometheusAlertRuleResult::getCode()const
{
	return code_;
}

bool UpdatePrometheusAlertRuleResult::getSuccess()const
{
	return success_;
}
