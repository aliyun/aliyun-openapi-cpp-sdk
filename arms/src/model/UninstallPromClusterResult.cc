...
UninstallPromClusterResult::UninstallPromClusterResult() :
	ServiceResult()
{}

UninstallPromClusterResult::UninstallPromClusterResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UninstallPromClusterResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
