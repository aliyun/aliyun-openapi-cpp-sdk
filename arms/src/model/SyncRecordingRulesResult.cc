...
SyncRecordingRulesResult::SyncRecordingRulesResult() :
	ServiceResult()
{}

SyncRecordingRulesResult::SyncRecordingRulesResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void SyncRecordingRulesResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
