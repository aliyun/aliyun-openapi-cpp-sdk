...
DescribeEnvServiceMonitorResult::DescribeEnvServiceMonitorResult() :
	ServiceResult()
{}

DescribeEnvServiceMonitorResult::DescribeEnvServiceMonitorResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeEnvServiceMonitorResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeEnvServiceMonitorResult::getMessage()const
{
	return message_;
}

DescribeEnvServiceMonitorResult::Data DescribeEnvServiceMonitorResult::getData()const
{
	return data_;
}

int DescribeEnvServiceMonitorResult::getCode()const
{
	return code_;
}
