...
#ifndef ALIBABACLOUD_ARMS_MODEL_UPGRADEENVIRONMENTFEATUREREQUEST_H_
#define ALIBABACLOUD_ARMS_MODEL_UPGRADEENVIRONMENTFEATUREREQUEST_H_
...
namespace ARMS {
namespace Model {
class ALIBABACLOUD_ARMS_EXPORT UpgradeEnvironmentFeatureRequest : public RpcServiceRequest {
public:
	...
	void setFeatureVersion(const std::string &featureVersion);
...
#endif // !ALIBABACLOUD_ARMS_MODEL_UPGRADEENVIRONMENTFEATUREREQUEST_H_
