...
#ifndef ALIBABACLOUD_ARMS_MODEL_GETGRAFANAWORKSPACERESULT_H_
#define ALIBABACLOUD_ARMS_MODEL_GETGRAFANAWORKSPACERESULT_H_
...
namespace AlibabaCloud
{
	namespace ARMS
	{
		namespace Model
		{
			class ALIBABACLOUD_ARMS_EXPORT GetGrafanaWorkspaceResult : public ServiceResult
			{
			public:
				struct Data
				{
				...
				GetGrafanaWorkspaceResult();
				explicit GetGrafanaWorkspaceResult(const std::string &payload);
				~GetGrafanaWorkspaceResult();
...
#endif // !ALIBABACLOUD_ARMS_MODEL_GETGRAFANAWORKSPACERESULT_H_