...
#ifndef ALIBABACLOUD_ARMS_MODEL_UPDATEENVSERVICEMONITORREQUEST_H_
#define ALIBABACLOUD_ARMS_MODEL_UPDATEENVSERVICEMONITORREQUEST_H_
...
namespace ARMS {
namespace Model {
class ALIBABACLOUD_ARMS_EXPORT UpdateEnvServiceMonitorRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ARMS_MODEL_UPDATEENVSERVICEMONITORREQUEST_H_
