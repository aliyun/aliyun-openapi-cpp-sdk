...
DescribePortViewSourceProvincesResult::DescribePortViewSourceProvincesResult() :
	ServiceResult()
{}

DescribePortViewSourceProvincesResult::DescribePortViewSourceProvincesResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribePortViewSourceProvincesResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribePortViewSourceProvincesResult::Province> DescribePortViewSourceProvincesResult::getSourceProvinces()const
{
