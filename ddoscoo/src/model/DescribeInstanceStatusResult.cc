...
void DescribeInstanceStatusResult::parse(const std::string &payload)
{
	...
	if(!value["InstanceStatus"].isNull())
		instanceStatus_ = std::stoi(value["InstanceStatus"].asString());
	if(!value["InstanceId"].isNull())
		instanceId_ = value["InstanceId"].asString();

}

std::string DescribeInstanceStatusResult::getInstanceId()const
{
	return instanceId_;
}

int DescribeInstanceStatusResult::getInstanceStatus()const
{
