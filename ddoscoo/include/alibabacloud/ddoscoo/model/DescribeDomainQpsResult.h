...
#ifndef ALIBABACLOUD_DDOSCOO_MODEL_DESCRIBEDOMAINQPSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Ddoscoo
	{
		namespace Model
		{
			class ALIBABACLOUD_DDOSCOO_EXPORT DescribeDomainQpsResult : public ServiceResult
			{
			public:


				DescribeDomainQpsResult();
				explicit DescribeDomainQpsResult(const std::string &payload);
				~DescribeDomainQpsResult();
...
#endif // !ALIBABACLOUD_DDOSCOO_MODEL_DESCRIBEDOMAINQPSRESULT_H_