...
namespace AlibabaCloud
{
	namespace Ddoscoo
	{
		namespace Model
		{
			class ALIBABACLOUD_DDOSCOO_EXPORT DescribeLayer7CCRulesRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_DDOSCOO_MODEL_DESCRIBELAYER7CCRULESREQUEST_H_