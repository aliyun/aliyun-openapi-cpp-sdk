...
#ifndef ALIBABACLOUD_DDOSCOO_MODEL_MODIFYPORTREQUEST_H_
#define ALIBABACLOUD_DDOSCOO_MODEL_MODIFYPORTREQUEST_H_
...
namespace Ddoscoo {
namespace Model {
class ALIBABACLOUD_DDOSCOO_EXPORT ModifyPortRequest : public RpcServiceRequest {
public:
	ModifyPortRequest();
	~ModifyPortRequest();
...
#endif // !ALIBABACLOUD_DDOSCOO_MODEL_MODIFYPORTREQUEST_H_
