...
#ifndef ALIBABACLOUD_DDOSCOO_MODEL_DESCRIBEWEBRULESREQUEST_H_
...
namespace Ddoscoo {
namespace Model {
class ALIBABACLOUD_DDOSCOO_EXPORT DescribeWebRulesRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_DDOSCOO_MODEL_DESCRIBEWEBRULESREQUEST_H_
