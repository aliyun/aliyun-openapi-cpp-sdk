...
DescribeDcdnDomainIpaTrafficDataResult::DescribeDcdnDomainIpaTrafficDataResult() :
	ServiceResult()
{}

DescribeDcdnDomainIpaTrafficDataResult::DescribeDcdnDomainIpaTrafficDataResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeDcdnDomainIpaTrafficDataResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeDcdnDomainIpaTrafficDataResult::getEndTime()const
{
	return endTime_;
}

std::vector<DescribeDcdnDomainIpaTrafficDataResult::DataModule> DescribeDcdnDomainIpaTrafficDataResult::getTrafficDataPerInterval()const
{
	return trafficDataPerInterval_;
}

std::string DescribeDcdnDomainIpaTrafficDataResult::getDomainName()const
{
	return domainName_;
}

std::string DescribeDcdnDomainIpaTrafficDataResult::getStartTime()const
{
	return startTime_;
}

std::string DescribeDcdnDomainIpaTrafficDataResult::getDataInterval()const
{
