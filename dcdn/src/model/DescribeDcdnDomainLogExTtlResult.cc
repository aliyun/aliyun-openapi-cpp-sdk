...
DescribeDcdnDomainLogExTtlResult::DescribeDcdnDomainLogExTtlResult() :
	ServiceResult()
{}

DescribeDcdnDomainLogExTtlResult::DescribeDcdnDomainLogExTtlResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeDcdnDomainLogExTtlResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeDcdnDomainLogExTtlResult::DomainLogDetail> DescribeDcdnDomainLogExTtlResult::getDomainLogDetails()const
{
