...
#include <alibabacloud/dcdn/model/UpdateDcdnSLSRealtimeLogDeliveryResult.h>
#include <json/json.h>

using namespace AlibabaCloud::Dcdn;
using namespace AlibabaCloud::Dcdn::Model;

UpdateDcdnSLSRealtimeLogDeliveryResult::UpdateDcdnSLSRealtimeLogDeliveryResult() :
	ServiceResult()
{}

UpdateDcdnSLSRealtimeLogDeliveryResult::UpdateDcdnSLSRealtimeLogDeliveryResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateDcdnSLSRealtimeLogDeliveryResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<UpdateDcdnSLSRealtimeLogDeliveryResult::Domains> UpdateDcdnSLSRealtimeLogDeliveryResult::getContent()const
{
	return content_;
}
