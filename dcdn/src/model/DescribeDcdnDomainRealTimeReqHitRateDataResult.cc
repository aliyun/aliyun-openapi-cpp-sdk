...
DescribeDcdnDomainRealTimeReqHitRateDataResult::DescribeDcdnDomainRealTimeReqHitRateDataResult() :
	ServiceResult()
{}

DescribeDcdnDomainRealTimeReqHitRateDataResult::DescribeDcdnDomainRealTimeReqHitRateDataResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeDcdnDomainRealTimeReqHitRateDataResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeDcdnDomainRealTimeReqHitRateDataResult::ReqHitRateDataModel> DescribeDcdnDomainRealTimeReqHitRateDataResult::getData()const
{
	return data_;
}
