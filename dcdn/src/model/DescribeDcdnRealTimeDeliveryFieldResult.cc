...
DescribeDcdnRealTimeDeliveryFieldResult::DescribeDcdnRealTimeDeliveryFieldResult() :
	ServiceResult()
{}

DescribeDcdnRealTimeDeliveryFieldResult::DescribeDcdnRealTimeDeliveryFieldResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeDcdnRealTimeDeliveryFieldResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeDcdnRealTimeDeliveryFieldResult::Fields> DescribeDcdnRealTimeDeliveryFieldResult::getContent()const
{
	return content_;
}
