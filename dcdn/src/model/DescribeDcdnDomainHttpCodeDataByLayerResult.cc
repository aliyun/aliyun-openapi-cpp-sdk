...
DescribeDcdnDomainHttpCodeDataByLayerResult::DescribeDcdnDomainHttpCodeDataByLayerResult() :
	ServiceResult()
{}

DescribeDcdnDomainHttpCodeDataByLayerResult::DescribeDcdnDomainHttpCodeDataByLayerResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeDcdnDomainHttpCodeDataByLayerResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeDcdnDomainHttpCodeDataByLayerResult::getDataInterval()const
{
	return dataInterval_;
}

std::vector<DescribeDcdnDomainHttpCodeDataByLayerResult::DataModule> DescribeDcdnDomainHttpCodeDataByLayerResult::getHttpCodeDataInterval()const
{
