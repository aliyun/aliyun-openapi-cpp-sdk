...
DescribeDcdnIpaDomainDetailResult::DescribeDcdnIpaDomainDetailResult() :
	ServiceResult()
{}

DescribeDcdnIpaDomainDetailResult::DescribeDcdnIpaDomainDetailResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeDcdnIpaDomainDetailResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
DescribeDcdnIpaDomainDetailResult::DomainDetail DescribeDcdnIpaDomainDetailResult::getDomainDetail()const
{
