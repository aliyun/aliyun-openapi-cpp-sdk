...
#ifndef ALIBABACLOUD_DCDN_MODEL_UPDATEDCDNSLSREALTIMELOGDELIVERYREQUEST_H_
#define ALIBABACLOUD_DCDN_MODEL_UPDATEDCDNSLSREALTIMELOGDELIVERYREQUEST_H_
...
namespace Dcdn {
namespace Model {
class ALIBABACLOUD_DCDN_EXPORT UpdateDcdnSLSRealtimeLogDeliveryRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_DCDN_MODEL_UPDATEDCDNSLSREALTIMELOGDELIVERYREQUEST_H_
