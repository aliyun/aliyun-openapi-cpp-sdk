...
#ifndef ALIBABACLOUD_DCDN_MODEL_SETDCDNFULLDOMAINSBLOCKIPREQUEST_H_
...
namespace Dcdn {
namespace Model {
class ALIBABACLOUD_DCDN_EXPORT SetDcdnFullDomainsBlockIPRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_DCDN_MODEL_SETDCDNFULLDOMAINSBLOCKIPREQUEST_H_
