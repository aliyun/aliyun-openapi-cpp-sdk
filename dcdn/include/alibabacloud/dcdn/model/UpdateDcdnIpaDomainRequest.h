...
#ifndef ALIBABACLOUD_DCDN_MODEL_UPDATEDCDNIPADOMAINREQUEST_H_
...
namespace Dcdn {
namespace Model {
class ALIBABACLOUD_DCDN_EXPORT UpdateDcdnIpaDomainRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_DCDN_MODEL_UPDATEDCDNIPADOMAINREQUEST_H_
