...
namespace Dcdn {
namespace Model {
class ALIBABACLOUD_DCDN_EXPORT DescribeDcdnDomainWebsocketHttpCodeDataResult
...
public:
  struct DataModule {
    ...
    std::vector<DataModule::HttpCodeDataModule>
        websocketHttpCodeDataPerInterval;
    std::string timeStamp;
  };

  DescribeDcdnDomainWebsocketHttpCodeDataResult();
  explicit DescribeDcdnDomainWebsocketHttpCodeDataResult(
