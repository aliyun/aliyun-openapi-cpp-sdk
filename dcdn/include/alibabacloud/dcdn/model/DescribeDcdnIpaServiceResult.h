...
#ifndef ALIBABACLOUD_DCDN_MODEL_DESCRIBEDCDNIPASERVICERESULT_H_
...
namespace AlibabaCloud
{
	namespace Dcdn
	{
		namespace Model
		{
			class ALIBABACLOUD_DCDN_EXPORT DescribeDcdnIpaServiceResult : public ServiceResult
			{
			public:
				struct LockReason
				{
				...
				DescribeDcdnIpaServiceResult();
				explicit DescribeDcdnIpaServiceResult(const std::string &payload);
				~DescribeDcdnIpaServiceResult();
...
#endif // !ALIBABACLOUD_DCDN_MODEL_DESCRIBEDCDNIPASERVICERESULT_H_