...
#ifndef ALIBABACLOUD_LINKWAN_MODEL_LISTRENTEDJOINPERMISSIONSREQUEST_H_
#define ALIBABACLOUD_LINKWAN_MODEL_LISTRENTEDJOINPERMISSIONSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace LinkWAN
	{
		namespace Model
		{
			class ALIBABACLOUD_LINKWAN_EXPORT ListRentedJoinPermissionsRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_LINKWAN_MODEL_LISTRENTEDJOINPERMISSIONSREQUEST_H_