...
#ifndef ALIBABACLOUD_LINKWAN_MODEL_SUBMITGATEWAYLOCALCONFIGADDINGTASKREQUEST_H_
...
namespace AlibabaCloud
{
	namespace LinkWAN
	{
		namespace Model
		{
			class ALIBABACLOUD_LINKWAN_EXPORT SubmitGatewayLocalConfigAddingTaskRequest : public RpcServiceRequest
			{

			public:
				SubmitGatewayLocalConfigAddingTaskRequest();
				~SubmitGatewayLocalConfigAddingTaskRequest();
...
#endif // !ALIBABACLOUD_LINKWAN_MODEL_SUBMITGATEWAYLOCALCONFIGADDINGTASKREQUEST_H_