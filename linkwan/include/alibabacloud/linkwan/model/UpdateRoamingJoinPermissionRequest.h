...
#ifndef ALIBABACLOUD_LINKWAN_MODEL_UPDATEROAMINGJOINPERMISSIONREQUEST_H_
#define ALIBABACLOUD_LINKWAN_MODEL_UPDATEROAMINGJOINPERMISSIONREQUEST_H_
...
namespace AlibabaCloud
{
	namespace LinkWAN
	{
		namespace Model
		{
			class ALIBABACLOUD_LINKWAN_EXPORT UpdateRoamingJoinPermissionRequest : public RpcServiceRequest
			{

			public:
				UpdateRoamingJoinPermissionRequest();
				~UpdateRoamingJoinPermissionRequest();
...
#endif // !ALIBABACLOUD_LINKWAN_MODEL_UPDATEROAMINGJOINPERMISSIONREQUEST_H_