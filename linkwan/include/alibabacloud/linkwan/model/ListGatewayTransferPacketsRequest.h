...
#ifndef ALIBABACLOUD_LINKWAN_MODEL_LISTGATEWAYTRANSFERPACKETSREQUEST_H_
#define ALIBABACLOUD_LINKWAN_MODEL_LISTGATEWAYTRANSFERPACKETSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace LinkWAN
	{
		namespace Model
		{
			class ALIBABACLOUD_LINKWAN_EXPORT ListGatewayTransferPacketsRequest : public RpcServiceRequest
			{

			public:
				ListGatewayTransferPacketsRequest();
				~ListGatewayTransferPacketsRequest();
...
#endif // !ALIBABACLOUD_LINKWAN_MODEL_LISTGATEWAYTRANSFERPACKETSREQUEST_H_