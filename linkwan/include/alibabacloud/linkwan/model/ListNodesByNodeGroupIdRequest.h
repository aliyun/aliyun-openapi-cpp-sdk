...
#ifndef ALIBABACLOUD_LINKWAN_MODEL_LISTNODESBYNODEGROUPIDREQUEST_H_
#define ALIBABACLOUD_LINKWAN_MODEL_LISTNODESBYNODEGROUPIDREQUEST_H_
...
namespace AlibabaCloud
{
	namespace LinkWAN
	{
		namespace Model
		{
			class ALIBABACLOUD_LINKWAN_EXPORT ListNodesByNodeGroupIdRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_LINKWAN_MODEL_LISTNODESBYNODEGROUPIDREQUEST_H_