...
ListNodesByOwnedJoinPermissionIdResult::ListNodesByOwnedJoinPermissionIdResult() :
	ServiceResult()
{}

ListNodesByOwnedJoinPermissionIdResult::ListNodesByOwnedJoinPermissionIdResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListNodesByOwnedJoinPermissionIdResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
ListNodesByOwnedJoinPermissionIdResult::Data ListNodesByOwnedJoinPermissionIdResult::getData()const
{
	return data_;
}

bool ListNodesByOwnedJoinPermissionIdResult::getSuccess()const
{
	return success_;
}
