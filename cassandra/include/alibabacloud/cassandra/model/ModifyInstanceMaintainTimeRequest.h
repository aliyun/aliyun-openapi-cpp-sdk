...
#ifndef ALIBABACLOUD_CASSANDRA_MODEL_MODIFYINSTANCEMAINTAINTIMEREQUEST_H_
#define ALIBABACLOUD_CASSANDRA_MODEL_MODIFYINSTANCEMAINTAINTIMEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cassandra
	{
		namespace Model
		{
			class ALIBABACLOUD_CASSANDRA_EXPORT ModifyInstanceMaintainTimeRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CASSANDRA_MODEL_MODIFYINSTANCEMAINTAINTIMEREQUEST_H_