...
#ifndef ALIBABACLOUD_CASSANDRA_MODEL_MODIFYDATACENTERREQUEST_H_
#define ALIBABACLOUD_CASSANDRA_MODEL_MODIFYDATACENTERREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cassandra
	{
		namespace Model
		{
			class ALIBABACLOUD_CASSANDRA_EXPORT ModifyDataCenterRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CASSANDRA_MODEL_MODIFYDATACENTERREQUEST_H_