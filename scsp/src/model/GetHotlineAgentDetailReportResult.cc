...
GetHotlineAgentDetailReportResult::GetHotlineAgentDetailReportResult() :
	ServiceResult()
{}

GetHotlineAgentDetailReportResult::GetHotlineAgentDetailReportResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetHotlineAgentDetailReportResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetHotlineAgentDetailReportResult::getMessage()const
{
	return message_;
}

GetHotlineAgentDetailReportResult::Data GetHotlineAgentDetailReportResult::getData()const
{
	return data_;
}

std::string GetHotlineAgentDetailReportResult::getCode()const
{
	return code_;
}

std::string GetHotlineAgentDetailReportResult::getSuccess()const
{
	return success_;
}
