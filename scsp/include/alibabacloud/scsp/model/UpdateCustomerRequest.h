...
#ifndef ALIBABACLOUD_SCSP_MODEL_UPDATECUSTOMERREQUEST_H_
#define ALIBABACLOUD_SCSP_MODEL_UPDATECUSTOMERREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Scsp
	{
		namespace Model
		{
			class ALIBABACLOUD_SCSP_EXPORT UpdateCustomerRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_SCSP_MODEL_UPDATECUSTOMERREQUEST_H_