...
#ifndef ALIBABACLOUD_SCSP_MODEL_SEARCHTICKETLISTREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Scsp
	{
		namespace Model
		{
			class ALIBABACLOUD_SCSP_EXPORT SearchTicketListRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_SCSP_MODEL_SEARCHTICKETLISTREQUEST_H_