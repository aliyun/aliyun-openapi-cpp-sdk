...
GetResourceComplianceByConfigRuleResult::GetResourceComplianceByConfigRuleResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetResourceComplianceByConfigRuleResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
GetResourceComplianceByConfigRuleResult::ComplianceResult GetResourceComplianceByConfigRuleResult::getComplianceResult()const
{
