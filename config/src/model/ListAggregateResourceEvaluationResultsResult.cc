...
ListAggregateResourceEvaluationResultsResult::ListAggregateResourceEvaluationResultsResult() :
	ServiceResult()
{}

ListAggregateResourceEvaluationResultsResult::ListAggregateResourceEvaluationResultsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListAggregateResourceEvaluationResultsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
ListAggregateResourceEvaluationResultsResult::EvaluationResults ListAggregateResourceEvaluationResultsResult::getEvaluationResults()const
{
