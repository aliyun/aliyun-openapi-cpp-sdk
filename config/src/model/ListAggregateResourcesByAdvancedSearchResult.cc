...
ListAggregateResourcesByAdvancedSearchResult::ListAggregateResourcesByAdvancedSearchResult() :
	ServiceResult()
{}

ListAggregateResourcesByAdvancedSearchResult::ListAggregateResourcesByAdvancedSearchResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListAggregateResourcesByAdvancedSearchResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
ListAggregateResourcesByAdvancedSearchResult::QueryResults ListAggregateResourcesByAdvancedSearchResult::getQueryResults()const
{
