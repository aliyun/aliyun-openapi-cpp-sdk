...
ListConfigRuleEvaluationResultsResult::ListConfigRuleEvaluationResultsResult() :
	ServiceResult()
{}

ListConfigRuleEvaluationResultsResult::ListConfigRuleEvaluationResultsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListConfigRuleEvaluationResultsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
ListConfigRuleEvaluationResultsResult::EvaluationResults ListConfigRuleEvaluationResultsResult::getEvaluationResults()const
{
