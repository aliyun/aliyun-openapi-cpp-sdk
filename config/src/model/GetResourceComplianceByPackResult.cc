...
GetResourceComplianceByPackResult::GetResourceComplianceByPackResult() :
	ServiceResult()
{}

GetResourceComplianceByPackResult::GetResourceComplianceByPackResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetResourceComplianceByPackResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
GetResourceComplianceByPackResult::ResourceComplianceResult GetResourceComplianceByPackResult::getResourceComplianceResult()const
{
