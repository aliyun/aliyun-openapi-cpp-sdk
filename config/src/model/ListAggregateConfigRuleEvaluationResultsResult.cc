...
ListAggregateConfigRuleEvaluationResultsResult::ListAggregateConfigRuleEvaluationResultsResult() :
	ServiceResult()
{}

ListAggregateConfigRuleEvaluationResultsResult::ListAggregateConfigRuleEvaluationResultsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListAggregateConfigRuleEvaluationResultsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	for (auto evaluationResultsNodeEvaluationResultListEvaluationResult : allEvaluationResultListNode)
	{
		...
		if(!evaluationResultQualifierNode["ResourceOwnerId"].isNull())
			evaluationResultObject.evaluationResultIdentifier.evaluationResultQualifier.resourceOwnerId = std::stol(evaluationResultQualifierNode["ResourceOwnerId"].asString());
...
ListAggregateConfigRuleEvaluationResultsResult::EvaluationResults ListAggregateConfigRuleEvaluationResultsResult::getEvaluationResults()const
{
