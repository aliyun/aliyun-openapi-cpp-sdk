...
GetConfigurationRecorderResult::GetConfigurationRecorderResult() :
	ServiceResult()
{}

GetConfigurationRecorderResult::GetConfigurationRecorderResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetConfigurationRecorderResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
GetConfigurationRecorderResult::ConfigurationRecorder GetConfigurationRecorderResult::getConfigurationRecorder()const
{
