...
std::string ListAggregateResourceEvaluationResultsRequest::getConfigRuleId() const {
  return configRuleId_;
}

void ListAggregateResourceEvaluationResultsRequest::setConfigRuleId(const std::string &configRuleId) {
