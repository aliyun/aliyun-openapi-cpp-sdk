...
ListAggregateResourceRelationsResult::ListAggregateResourceRelationsResult() :
	ServiceResult()
{}

ListAggregateResourceRelationsResult::ListAggregateResourceRelationsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListAggregateResourceRelationsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
ListAggregateResourceRelationsResult::ResourceRelations ListAggregateResourceRelationsResult::getResourceRelations()const
{
