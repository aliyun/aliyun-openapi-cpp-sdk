...
GetResourceInventoryResult::GetResourceInventoryResult() :
	ServiceResult()
{}

GetResourceInventoryResult::GetResourceInventoryResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetResourceInventoryResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
GetResourceInventoryResult::ResourceInventory GetResourceInventoryResult::getResourceInventory()const
{
