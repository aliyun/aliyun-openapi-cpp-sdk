...
ListRemediationExecutionsResult::ListRemediationExecutionsResult() :
	ServiceResult()
{}

ListRemediationExecutionsResult::ListRemediationExecutionsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListRemediationExecutionsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
ListRemediationExecutionsResult::RemediationExecutionData ListRemediationExecutionsResult::getRemediationExecutionData()const
{
