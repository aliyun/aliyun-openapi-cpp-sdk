...
#ifndef ALIBABACLOUD_CONFIG_MODEL_UPDATECOMPLIANCEPACKREQUEST_H_
#define ALIBABACLOUD_CONFIG_MODEL_UPDATECOMPLIANCEPACKREQUEST_H_
...
namespace Config {
namespace Model {
class ALIBABACLOUD_CONFIG_EXPORT UpdateCompliancePackRequest : public RpcServiceRequest {
public:
	struct ConfigRules {
...
#endif // !ALIBABACLOUD_CONFIG_MODEL_UPDATECOMPLIANCEPACKREQUEST_H_
