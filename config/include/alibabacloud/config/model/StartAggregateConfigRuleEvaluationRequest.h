...
#ifndef ALIBABACLOUD_CONFIG_MODEL_STARTAGGREGATECONFIGRULEEVALUATIONREQUEST_H_
#define ALIBABACLOUD_CONFIG_MODEL_STARTAGGREGATECONFIGRULEEVALUATIONREQUEST_H_
...
namespace Config {
namespace Model {
class ALIBABACLOUD_CONFIG_EXPORT StartAggregateConfigRuleEvaluationRequest : public RpcServiceRequest {
public:
