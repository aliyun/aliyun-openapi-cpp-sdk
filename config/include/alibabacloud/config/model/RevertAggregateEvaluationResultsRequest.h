...
#ifndef ALIBABACLOUD_CONFIG_MODEL_REVERTAGGREGATEEVALUATIONRESULTSREQUEST_H_
...
namespace Config {
namespace Model {
class ALIBABACLOUD_CONFIG_EXPORT RevertAggregateEvaluationResultsRequest : public RpcServiceRequest {
public:
	struct Resources {
...
#endif // !ALIBABACLOUD_CONFIG_MODEL_REVERTAGGREGATEEVALUATIONRESULTSREQUEST_H_
