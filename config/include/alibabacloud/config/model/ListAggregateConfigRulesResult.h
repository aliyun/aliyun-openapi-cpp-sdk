...
#define ALIBABACLOUD_CONFIG_MODEL_LISTAGGREGATECONFIGRULESRESULT_H_
...
namespace AlibabaCloud
{
	namespace Config
	{
		namespace Model
		{
			class ALIBABACLOUD_CONFIG_EXPORT ListAggregateConfigRulesResult : public ServiceResult
			{
			public:
				struct ConfigRules
				{
				...
				ListAggregateConfigRulesResult();
				explicit ListAggregateConfigRulesResult(const std::string &payload);
				~ListAggregateConfigRulesResult();
...
#endif // !ALIBABACLOUD_CONFIG_MODEL_LISTAGGREGATECONFIGRULESRESULT_H_