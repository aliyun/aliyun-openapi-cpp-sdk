...
#ifndef ALIBABACLOUD_CONFIG_MODEL_UPDATEDELIVERYCHANNELREQUEST_H_
#define ALIBABACLOUD_CONFIG_MODEL_UPDATEDELIVERYCHANNELREQUEST_H_
...
namespace Config {
namespace Model {
class ALIBABACLOUD_CONFIG_EXPORT UpdateDeliveryChannelRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CONFIG_MODEL_UPDATEDELIVERYCHANNELREQUEST_H_
