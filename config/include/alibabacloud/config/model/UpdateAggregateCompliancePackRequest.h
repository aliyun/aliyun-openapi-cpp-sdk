...
#ifndef ALIBABACLOUD_CONFIG_MODEL_UPDATEAGGREGATECOMPLIANCEPACKREQUEST_H_
#define ALIBABACLOUD_CONFIG_MODEL_UPDATEAGGREGATECOMPLIANCEPACKREQUEST_H_
...
namespace Config {
namespace Model {
class ALIBABACLOUD_CONFIG_EXPORT UpdateAggregateCompliancePackRequest : public RpcServiceRequest {
public:
	struct ConfigRules {
...
#endif // !ALIBABACLOUD_CONFIG_MODEL_UPDATEAGGREGATECOMPLIANCEPACKREQUEST_H_
