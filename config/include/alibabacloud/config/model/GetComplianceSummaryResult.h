...
#ifndef ALIBABACLOUD_CONFIG_MODEL_GETCOMPLIANCESUMMARYRESULT_H_
#define ALIBABACLOUD_CONFIG_MODEL_GETCOMPLIANCESUMMARYRESULT_H_
...
namespace AlibabaCloud
{
	namespace Config
	{
		namespace Model
		{
			class ALIBABACLOUD_CONFIG_EXPORT GetComplianceSummaryResult : public ServiceResult
			{
			public:
				...
				explicit GetComplianceSummaryResult(const std::string &payload);
				~GetComplianceSummaryResult();
...
#endif // !ALIBABACLOUD_CONFIG_MODEL_GETCOMPLIANCESUMMARYRESULT_H_