...
#ifndef ALIBABACLOUD_CONFIG_MODEL_GETREMEDIATIONTEMPLATERESULT_H_
...
namespace AlibabaCloud
{
	namespace Config
	{
		namespace Model
		{
			class ALIBABACLOUD_CONFIG_EXPORT GetRemediationTemplateResult : public ServiceResult
			{
			public:
				...
				explicit GetRemediationTemplateResult(const std::string &payload);
				~GetRemediationTemplateResult();
...
#endif // !ALIBABACLOUD_CONFIG_MODEL_GETREMEDIATIONTEMPLATERESULT_H_