...
#ifndef ALIBABACLOUD_CONFIG_MODEL_LISTCONFIGRULEEVALUATIONRESULTSRESULT_H_
#define ALIBABACLOUD_CONFIG_MODEL_LISTCONFIGRULEEVALUATIONRESULTSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Config
	{
		namespace Model
		{
			class ALIBABACLOUD_CONFIG_EXPORT ListConfigRuleEvaluationResultsResult : public ServiceResult
			{
			public:
				...
				explicit ListConfigRuleEvaluationResultsResult(const std::string &payload);
				~ListConfigRuleEvaluationResultsResult();
...
#endif // !ALIBABACLOUD_CONFIG_MODEL_LISTCONFIGRULEEVALUATIONRESULTSRESULT_H_