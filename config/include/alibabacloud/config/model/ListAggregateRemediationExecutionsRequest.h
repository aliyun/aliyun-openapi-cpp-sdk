...
#ifndef ALIBABACLOUD_CONFIG_MODEL_LISTAGGREGATEREMEDIATIONEXECUTIONSREQUEST_H_
#define ALIBABACLOUD_CONFIG_MODEL_LISTAGGREGATEREMEDIATIONEXECUTIONSREQUEST_H_
...
namespace Config {
namespace Model {
class ALIBABACLOUD_CONFIG_EXPORT ListAggregateRemediationExecutionsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CONFIG_MODEL_LISTAGGREGATEREMEDIATIONEXECUTIONSREQUEST_H_
