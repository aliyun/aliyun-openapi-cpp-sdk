...
#ifndef ALIBABACLOUD_CONFIG_MODEL_LISTAGGREGATEREMEDIATIONEXECUTIONSRESULT_H_
#define ALIBABACLOUD_CONFIG_MODEL_LISTAGGREGATEREMEDIATIONEXECUTIONSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Config
	{
		namespace Model
		{
			class ALIBABACLOUD_CONFIG_EXPORT ListAggregateRemediationExecutionsResult : public ServiceResult
			{
			public:
				...
				explicit ListAggregateRemediationExecutionsResult(const std::string &payload);
				~ListAggregateRemediationExecutionsResult();
...
#endif // !ALIBABACLOUD_CONFIG_MODEL_LISTAGGREGATEREMEDIATIONEXECUTIONSRESULT_H_