...
using AlibabaCloud::Cms::Model::DescribeTagKeyListRequest;

DescribeTagKeyListRequest::DescribeTagKeyListRequest()
    : RpcServiceRequest("cms", "2019-01-01", "DescribeTagKeyList") {
  setMethod(HttpRequest::Method::Post);
}

DescribeTagKeyListRequest::~DescribeTagKeyListRequest() {}

int DescribeTagKeyListRequest::getPageNumber() const {
  return pageNumber_;
}
