...
DeleteMetricRulesRequest::DeleteMetricRulesRequest() :
	RpcServiceRequest("cms", "2018-03-08", "DeleteMetricRules")
{
...
std::string DeleteMetricRulesRequest::getCmsUserInner()const
{
	return cmsUserInner_;
}

void DeleteMetricRulesRequest::setCmsUserInner(const std::string& cmsUserInner)
{
