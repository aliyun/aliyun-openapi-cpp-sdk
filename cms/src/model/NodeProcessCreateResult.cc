...
NodeProcessCreateResult::NodeProcessCreateResult() :
	ServiceResult()
{}

NodeProcessCreateResult::NodeProcessCreateResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
bool NodeProcessCreateResult::getSuccess()const
{
	return success_;
}
