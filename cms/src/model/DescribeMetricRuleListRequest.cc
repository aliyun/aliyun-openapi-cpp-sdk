...
DescribeMetricRuleListRequest::DescribeMetricRuleListRequest() :
	RpcServiceRequest("cms", "2018-03-08", "DescribeMetricRuleList")
{
...
std::string DescribeMetricRuleListRequest::getCmsUserInner()const
{
	return cmsUserInner_;
}

void DescribeMetricRuleListRequest::setCmsUserInner(const std::string& cmsUserInner)
{
