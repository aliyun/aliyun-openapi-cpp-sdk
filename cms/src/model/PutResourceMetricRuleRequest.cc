...
PutResourceMetricRuleRequest::PutResourceMetricRuleRequest() :
	RpcServiceRequest("cms", "2018-03-08", "PutResourceMetricRule")
{
...
std::string PutResourceMetricRuleRequest::getTargetUserId()const
{
	return targetUserId_;
}

void PutResourceMetricRuleRequest::setTargetUserId(const std::string& targetUserId)
{
	targetUserId_ = targetUserId;
	setCoreParameter("TargetUserId", targetUserId);
}
...
bool PutResourceMetricRuleRequest::getIsS2SDispatch()const
{
	return isS2SDispatch_;
}

void PutResourceMetricRuleRequest::setIsS2SDispatch(bool isS2SDispatch)
{
	isS2SDispatch_ = isS2SDispatch;
	setCoreParameter("IsS2SDispatch", isS2SDispatch ? "true" : "false");
}
