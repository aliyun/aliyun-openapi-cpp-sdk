	...
	namespace Cms
	{
		namespace Model
		{
			...
			public:
				...
				DescribeSiteMonitorQuotaResult();
				explicit DescribeSiteMonitorQuotaResult(const std::string &payload);
				~DescribeSiteMonitorQuotaResult();
...
#endif // !ALIBABACLOUD_CMS_MODEL_DESCRIBESITEMONITORQUOTARESULT_H_