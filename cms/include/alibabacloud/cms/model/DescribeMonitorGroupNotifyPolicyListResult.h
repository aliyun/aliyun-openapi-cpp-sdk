	...
	namespace Cms
	{
		namespace Model
		{
			...
			public:
				...
				DescribeMonitorGroupNotifyPolicyListResult();
				explicit DescribeMonitorGroupNotifyPolicyListResult(const std::string &payload);
				~DescribeMonitorGroupNotifyPolicyListResult();
...
#endif // !ALIBABACLOUD_CMS_MODEL_DESCRIBEMONITORGROUPNOTIFYPOLICYLISTRESULT_H_