...
#ifndef ALIBABACLOUD_CMS_MODEL_DESCRIBEMONITORINGAGENTPROCESSESRESULT_H_
	...
	namespace Cms
	{
		namespace Model
		{
			...
			public:
				...
				DescribeMonitoringAgentProcessesResult();
				explicit DescribeMonitoringAgentProcessesResult(const std::string &payload);
				~DescribeMonitoringAgentProcessesResult();
...
#endif // !ALIBABACLOUD_CMS_MODEL_DESCRIBEMONITORINGAGENTPROCESSESRESULT_H_