...
#ifndef ALIBABACLOUD_CMS_MODEL_ENABLEEVENTRULESREQUEST_H_
...
namespace Cms {
namespace Model {
class ALIBABACLOUD_CMS_EXPORT EnableEventRulesRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CMS_MODEL_ENABLEEVENTRULESREQUEST_H_
