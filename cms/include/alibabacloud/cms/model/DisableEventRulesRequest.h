...
#define ALIBABACLOUD_CMS_MODEL_DISABLEEVENTRULESREQUEST_H_
...
namespace Cms {
namespace Model {
class ALIBABACLOUD_CMS_EXPORT DisableEventRulesRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CMS_MODEL_DISABLEEVENTRULESREQUEST_H_
