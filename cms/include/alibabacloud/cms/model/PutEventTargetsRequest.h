...
namespace Cms {
namespace Model {
class ALIBABACLOUD_CMS_EXPORT PutEventTargetsRequest
...
public:
  ...
  void
  setWebhookParameters(const std::vector<WebhookParameters> &webhookParameters);
  std::vector<ContactParameters> getContactParameters() const;
  void
  setContactParameters(const std::vector<ContactParameters> &contactParameters);
