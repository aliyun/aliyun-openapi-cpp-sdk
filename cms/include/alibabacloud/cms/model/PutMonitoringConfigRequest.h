...
#ifndef ALIBABACLOUD_CMS_MODEL_PUTMONITORINGCONFIGREQUEST_H_
...
namespace Cms {
namespace Model {
class ALIBABACLOUD_CMS_EXPORT PutMonitoringConfigRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CMS_MODEL_PUTMONITORINGCONFIGREQUEST_H_
