...
using AlibabaCloud::Dysmsapi::Model::UntagResourcesRequest;

UntagResourcesRequest::UntagResourcesRequest() :
	RpcServiceRequest("dysmsapi", "2017-05-25", "UntagResources")
{
...
std::string UntagResourcesRequest::getProdCode()const
{
	return prodCode_;
}

void UntagResourcesRequest::setProdCode(const std::string& prodCode)
{
	prodCode_ = prodCode;
