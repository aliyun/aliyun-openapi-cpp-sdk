...
SmsConversionResult::SmsConversionResult() :
	ServiceResult()
{}

SmsConversionResult::SmsConversionResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void SmsConversionResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string SmsConversionResult::getResponseCode()const
{
	return responseCode_;
}

std::string SmsConversionResult::getResponseDescription()const
{
