...
#ifndef ALIBABACLOUD_POLARDB_MODEL_MODIFYGLOBALSECURITYIPGROUPNAMERESULT_H_
#define ALIBABACLOUD_POLARDB_MODEL_MODIFYGLOBALSECURITYIPGROUPNAMERESULT_H_
...
namespace AlibabaCloud
{
	namespace Polardb
	{
		namespace Model
		{
			class ALIBABACLOUD_POLARDB_EXPORT ModifyGlobalSecurityIPGroupNameResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_POLARDB_MODEL_MODIFYGLOBALSECURITYIPGROUPNAMERESULT_H_