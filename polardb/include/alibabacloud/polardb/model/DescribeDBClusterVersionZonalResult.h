...
#ifndef ALIBABACLOUD_POLARDB_MODEL_DESCRIBEDBCLUSTERVERSIONZONALRESULT_H_
#define ALIBABACLOUD_POLARDB_MODEL_DESCRIBEDBCLUSTERVERSIONZONALRESULT_H_
...
namespace AlibabaCloud
{
	namespace Polardb
	{
		namespace Model
		{
			class ALIBABACLOUD_POLARDB_EXPORT DescribeDBClusterVersionZonalResult : public ServiceResult
			{
			public:
				...
				explicit DescribeDBClusterVersionZonalResult(const std::string &payload);
				~DescribeDBClusterVersionZonalResult();
...
#endif // !ALIBABACLOUD_POLARDB_MODEL_DESCRIBEDBCLUSTERVERSIONZONALRESULT_H_