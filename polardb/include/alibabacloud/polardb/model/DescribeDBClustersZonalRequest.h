...
#ifndef ALIBABACLOUD_POLARDB_MODEL_DESCRIBEDBCLUSTERSZONALREQUEST_H_
#define ALIBABACLOUD_POLARDB_MODEL_DESCRIBEDBCLUSTERSZONALREQUEST_H_
...
namespace Polardb {
namespace Model {
class ALIBABACLOUD_POLARDB_EXPORT DescribeDBClustersZonalRequest : public RpcServiceRequest {
public:
	struct Tag {
		std::string value;
		std::string key;
...
#endif // !ALIBABACLOUD_POLARDB_MODEL_DESCRIBEDBCLUSTERSZONALREQUEST_H_
