...
#ifndef ALIBABACLOUD_POLARDB_MODEL_DESCRIBEDBCLUSTERENDPOINTSZONALRESULT_H_
#define ALIBABACLOUD_POLARDB_MODEL_DESCRIBEDBCLUSTERENDPOINTSZONALRESULT_H_
...
namespace AlibabaCloud
{
	namespace Polardb
	{
		namespace Model
		{
			class ALIBABACLOUD_POLARDB_EXPORT DescribeDBClusterEndpointsZonalResult : public ServiceResult
			{
			public:
				struct DBEndpoint
				{
				...
				explicit DescribeDBClusterEndpointsZonalResult(const std::string &payload);
				~DescribeDBClusterEndpointsZonalResult();
...
#endif // !ALIBABACLOUD_POLARDB_MODEL_DESCRIBEDBCLUSTERENDPOINTSZONALRESULT_H_