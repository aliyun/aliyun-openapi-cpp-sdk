...
#ifndef ALIBABACLOUD_POLARDB_MODEL_MODIFYDBNODESCLASSREQUEST_H_
#define ALIBABACLOUD_POLARDB_MODEL_MODIFYDBNODESCLASSREQUEST_H_
...
namespace Polardb {
namespace Model {
class ALIBABACLOUD_POLARDB_EXPORT ModifyDBNodesClassRequest : public RpcServiceRequest {
public:
	struct DBNode {
		std::string dBNodeId;
...
#endif // !ALIBABACLOUD_POLARDB_MODEL_MODIFYDBNODESCLASSREQUEST_H_
