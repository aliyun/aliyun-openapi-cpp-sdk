...
#ifndef ALIBABACLOUD_POLARDB_MODEL_DESCRIBEDBMINIENGINEVERSIONSRESULT_H_
#define ALIBABACLOUD_POLARDB_MODEL_DESCRIBEDBMINIENGINEVERSIONSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Polardb
	{
		namespace Model
		{
			class ALIBABACLOUD_POLARDB_EXPORT DescribeDBMiniEngineVersionsResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_POLARDB_MODEL_DESCRIBEDBMINIENGINEVERSIONSRESULT_H_