...
#ifndef ALIBABACLOUD_POLARDB_MODEL_FAILOVERDBCLUSTERZONALREQUEST_H_
#define ALIBABACLOUD_POLARDB_MODEL_FAILOVERDBCLUSTERZONALREQUEST_H_
...
namespace Polardb {
namespace Model {
class ALIBABACLOUD_POLARDB_EXPORT FailoverDBClusterZonalRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_POLARDB_MODEL_FAILOVERDBCLUSTERZONALREQUEST_H_
