...
#ifndef ALIBABACLOUD_POLARDB_MODEL_MODIFYSCHEDULETASKREQUEST_H_
...
namespace Polardb {
namespace Model {
class ALIBABACLOUD_POLARDB_EXPORT ModifyScheduleTaskRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_POLARDB_MODEL_MODIFYSCHEDULETASKREQUEST_H_
