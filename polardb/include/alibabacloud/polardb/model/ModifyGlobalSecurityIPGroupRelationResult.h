...
#ifndef ALIBABACLOUD_POLARDB_MODEL_MODIFYGLOBALSECURITYIPGROUPRELATIONRESULT_H_
#define ALIBABACLOUD_POLARDB_MODEL_MODIFYGLOBALSECURITYIPGROUPRELATIONRESULT_H_
...
namespace AlibabaCloud
{
	namespace Polardb
	{
		namespace Model
		{
			class ALIBABACLOUD_POLARDB_EXPORT ModifyGlobalSecurityIPGroupRelationResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_POLARDB_MODEL_MODIFYGLOBALSECURITYIPGROUPRELATIONRESULT_H_