...
#ifndef ALIBABACLOUD_POLARDB_MODEL_DESCRIBEDBLOGFILESRESULT_H_
#define ALIBABACLOUD_POLARDB_MODEL_DESCRIBEDBLOGFILESRESULT_H_
...
namespace AlibabaCloud
{
	namespace Polardb
	{
		namespace Model
		{
			class ALIBABACLOUD_POLARDB_EXPORT DescribeDBLogFilesResult : public ServiceResult
			{
			public:
				...
				explicit DescribeDBLogFilesResult(const std::string &payload);
				~DescribeDBLogFilesResult();
...
#endif // !ALIBABACLOUD_POLARDB_MODEL_DESCRIBEDBLOGFILESRESULT_H_