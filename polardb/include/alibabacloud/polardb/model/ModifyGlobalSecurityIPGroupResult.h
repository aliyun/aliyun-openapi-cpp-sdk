...
#ifndef ALIBABACLOUD_POLARDB_MODEL_MODIFYGLOBALSECURITYIPGROUPRESULT_H_
#define ALIBABACLOUD_POLARDB_MODEL_MODIFYGLOBALSECURITYIPGROUPRESULT_H_
...
namespace AlibabaCloud
{
	namespace Polardb
	{
		namespace Model
		{
			class ALIBABACLOUD_POLARDB_EXPORT ModifyGlobalSecurityIPGroupResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_POLARDB_MODEL_MODIFYGLOBALSECURITYIPGROUPRESULT_H_