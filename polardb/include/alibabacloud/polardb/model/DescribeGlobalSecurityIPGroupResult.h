...
#ifndef ALIBABACLOUD_POLARDB_MODEL_DESCRIBEGLOBALSECURITYIPGROUPRESULT_H_
#define ALIBABACLOUD_POLARDB_MODEL_DESCRIBEGLOBALSECURITYIPGROUPRESULT_H_
...
namespace AlibabaCloud
{
	namespace Polardb
	{
		namespace Model
		{
			class ALIBABACLOUD_POLARDB_EXPORT DescribeGlobalSecurityIPGroupResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_POLARDB_MODEL_DESCRIBEGLOBALSECURITYIPGROUPRESULT_H_