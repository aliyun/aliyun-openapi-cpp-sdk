...
#ifndef ALIBABACLOUD_POLARDB_MODEL_MODIFYDBCLUSTERENDPOINTZONALREQUEST_H_
#define ALIBABACLOUD_POLARDB_MODEL_MODIFYDBCLUSTERENDPOINTZONALREQUEST_H_
...
namespace Polardb {
namespace Model {
class ALIBABACLOUD_POLARDB_EXPORT ModifyDBClusterEndpointZonalRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_POLARDB_MODEL_MODIFYDBCLUSTERENDPOINTZONALREQUEST_H_
