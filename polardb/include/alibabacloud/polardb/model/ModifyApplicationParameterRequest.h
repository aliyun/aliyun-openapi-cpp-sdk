...
#ifndef ALIBABACLOUD_POLARDB_MODEL_MODIFYAPPLICATIONPARAMETERREQUEST_H_
...
namespace Polardb {
namespace Model {
class ALIBABACLOUD_POLARDB_EXPORT ModifyApplicationParameterRequest : public RpcServiceRequest {
public:
	struct Parameters {
	...
	~ModifyApplicationParameterRequest();
	std::string getParameterTemplateId() const;
	void setParameterTemplateId(const std::string &parameterTemplateId);
...
private:
	std::string parameterTemplateId_;
...
#endif // !ALIBABACLOUD_POLARDB_MODEL_MODIFYAPPLICATIONPARAMETERREQUEST_H_
