...
DescribeHALogsResult::DescribeHALogsResult() :
	ServiceResult()
{}

DescribeHALogsResult::DescribeHALogsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeHALogsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
int DescribeHALogsResult::getItemsNumbers()const
{
	return itemsNumbers_;
}

std::vector<DescribeHALogsResult::HaSwitchLogItem> DescribeHALogsResult::getHaLogItems()const
{
	return haLogItems_;
}

int DescribeHALogsResult::getPageSize()const
{
	return pageSize_;
}

int DescribeHALogsResult::getPageNumber()const
{
	return pageNumber_;
}

int DescribeHALogsResult::getHaStatus()const
{
	return haStatus_;
}

int DescribeHALogsResult::getTotalRecords()const
{
	return totalRecords_;
}

std::string DescribeHALogsResult::getDBInstanceType()const
{
	return dBInstanceType_;
}

std::vector<DescribeHALogsResult::SwitchListItem> DescribeHALogsResult::getSwitchListItems()const
{
	return switchListItems_;
}

std::vector<DescribeHALogsResult::SwitchLogItem3> DescribeHALogsResult::getSwitchLogItems()const
{
	return switchLogItems_;
}

std::string DescribeHALogsResult::getDBInstanceName()const
{
