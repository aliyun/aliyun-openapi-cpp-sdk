...
using AlibabaCloud::Polardb::Model::ResetAccountPasswordRequest;

ResetAccountPasswordRequest::ResetAccountPasswordRequest()
    : RpcServiceRequest("polardb", "2017-08-01", "ResetAccountPassword") {
...
std::string ResetAccountPasswordRequest::getPasswordType() const {
  return passwordType_;
}

void ResetAccountPasswordRequest::setPasswordType(const std::string &passwordType) {
