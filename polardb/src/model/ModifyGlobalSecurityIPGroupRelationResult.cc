...
std::string ModifyGlobalSecurityIPGroupRelationResult::getDBClusterId()const
{
	return dBClusterId_;
}

std::vector<ModifyGlobalSecurityIPGroupRelationResult::GlobalSecurityIPGroupRelItem> ModifyGlobalSecurityIPGroupRelationResult::getGlobalSecurityIPGroupRel()const
{
