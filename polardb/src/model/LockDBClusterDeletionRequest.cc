...
#include <alibabacloud/polardb/model/LockDBClusterDeletionRequest.h>

using AlibabaCloud::Polardb::Model::LockDBClusterDeletionRequest;

LockDBClusterDeletionRequest::LockDBClusterDeletionRequest() :
	RpcServiceRequest("polardb", "2017-08-01", "LockDBClusterDeletion")
{}

LockDBClusterDeletionRequest::~LockDBClusterDeletionRequest()
{}

long LockDBClusterDeletionRequest::getResourceOwnerId()const
{
