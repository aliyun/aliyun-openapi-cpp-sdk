...
#ifndef ALIBABACLOUD_REID_CLOUD_MODEL_DESCRIBEBASESTATISTICSREQUEST_H_
#define ALIBABACLOUD_REID_CLOUD_MODEL_DESCRIBEBASESTATISTICSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Reid_cloud
	{
		namespace Model
		{
			class ALIBABACLOUD_REID_CLOUD_EXPORT DescribeBaseStatisticsRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_REID_CLOUD_MODEL_DESCRIBEBASESTATISTICSREQUEST_H_