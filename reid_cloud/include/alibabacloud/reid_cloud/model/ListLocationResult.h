...
#ifndef ALIBABACLOUD_REID_CLOUD_MODEL_LISTLOCATIONRESULT_H_
#define ALIBABACLOUD_REID_CLOUD_MODEL_LISTLOCATIONRESULT_H_
...
namespace AlibabaCloud
{
	namespace Reid_cloud
	{
		namespace Model
		{
			class ALIBABACLOUD_REID_CLOUD_EXPORT ListLocationResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_REID_CLOUD_MODEL_LISTLOCATIONRESULT_H_