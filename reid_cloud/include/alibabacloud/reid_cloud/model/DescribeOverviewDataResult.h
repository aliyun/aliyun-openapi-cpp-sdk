...
#ifndef ALIBABACLOUD_REID_CLOUD_MODEL_DESCRIBEOVERVIEWDATARESULT_H_
#define ALIBABACLOUD_REID_CLOUD_MODEL_DESCRIBEOVERVIEWDATARESULT_H_
...
namespace AlibabaCloud
{
	namespace Reid_cloud
	{
		namespace Model
		{
			class ALIBABACLOUD_REID_CLOUD_EXPORT DescribeOverviewDataResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_REID_CLOUD_MODEL_DESCRIBEOVERVIEWDATARESULT_H_