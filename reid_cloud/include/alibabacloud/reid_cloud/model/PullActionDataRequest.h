...
#ifndef ALIBABACLOUD_REID_CLOUD_MODEL_PULLACTIONDATAREQUEST_H_
#define ALIBABACLOUD_REID_CLOUD_MODEL_PULLACTIONDATAREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Reid_cloud
	{
		namespace Model
		{
			class ALIBABACLOUD_REID_CLOUD_EXPORT PullActionDataRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_REID_CLOUD_MODEL_PULLACTIONDATAREQUEST_H_