...
#ifndef ALIBABACLOUD_REID_CLOUD_MODEL_LISTPERSONBYIMAGERESULT_H_
#define ALIBABACLOUD_REID_CLOUD_MODEL_LISTPERSONBYIMAGERESULT_H_
...
namespace AlibabaCloud
{
	namespace Reid_cloud
	{
		namespace Model
		{
			class ALIBABACLOUD_REID_CLOUD_EXPORT ListPersonByImageResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_REID_CLOUD_MODEL_LISTPERSONBYIMAGERESULT_H_