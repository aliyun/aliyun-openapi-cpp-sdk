...
#ifndef ALIBABACLOUD_REID_CLOUD_MODEL_DESCRIBECAMERASTATISTICSRESULT_H_
#define ALIBABACLOUD_REID_CLOUD_MODEL_DESCRIBECAMERASTATISTICSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Reid_cloud
	{
		namespace Model
		{
			class ALIBABACLOUD_REID_CLOUD_EXPORT DescribeCameraStatisticsResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_REID_CLOUD_MODEL_DESCRIBECAMERASTATISTICSRESULT_H_