...
#ifndef ALIBABACLOUD_REID_CLOUD_MODEL_LISTACTIONDATARESULT_H_
#define ALIBABACLOUD_REID_CLOUD_MODEL_LISTACTIONDATARESULT_H_
...
namespace AlibabaCloud
{
	namespace Reid_cloud
	{
		namespace Model
		{
			class ALIBABACLOUD_REID_CLOUD_EXPORT ListActionDataResult : public ServiceResult
			{
			public:
				struct Action
				{
...
#endif // !ALIBABACLOUD_REID_CLOUD_MODEL_LISTACTIONDATARESULT_H_