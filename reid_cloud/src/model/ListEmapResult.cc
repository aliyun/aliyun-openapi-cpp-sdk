...
std::string ListEmapResult::getMessage()const
{
	return message_;
}
...
std::string ListEmapResult::getDynamicCode()const
{
	return dynamicCode_;
}
...
std::string ListEmapResult::getDynamicMessage()const
{
...
std::string ListEmapResult::getCode()const
{
	return code_;
}
