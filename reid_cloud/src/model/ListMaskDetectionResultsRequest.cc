...
using AlibabaCloud::Reid_cloud::Model::ListMaskDetectionResultsRequest;

ListMaskDetectionResultsRequest::ListMaskDetectionResultsRequest() :
	RpcServiceRequest("reid_cloud", "2020-10-29", "ListMaskDetectionResults")
{
...
std::string ListMaskDetectionResultsRequest::getName()const
{
	return name_;
}

void ListMaskDetectionResultsRequest::setName(const std::string& name)
{
	name_ = name;
