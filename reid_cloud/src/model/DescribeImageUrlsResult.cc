...
std::string DescribeImageUrlsResult::getMessage()const
{
	return message_;
}

std::string DescribeImageUrlsResult::getDynamicCode()const
{
	return dynamicCode_;
}
...
std::string DescribeImageUrlsResult::getDynamicMessage()const
{
...
std::string DescribeImageUrlsResult::getCode()const
{
	return code_;
}
