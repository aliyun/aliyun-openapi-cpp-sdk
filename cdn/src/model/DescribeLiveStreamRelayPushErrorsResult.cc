...
DescribeLiveStreamRelayPushErrorsResult::DescribeLiveStreamRelayPushErrorsResult() :
	ServiceResult()
{}

DescribeLiveStreamRelayPushErrorsResult::DescribeLiveStreamRelayPushErrorsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeLiveStreamRelayPushErrorsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
