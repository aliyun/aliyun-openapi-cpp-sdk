...
DescribeDomainUpstreamOfCenterResult::DescribeDomainUpstreamOfCenterResult() :
	ServiceResult()
{}

DescribeDomainUpstreamOfCenterResult::DescribeDomainUpstreamOfCenterResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeDomainUpstreamOfCenterResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
