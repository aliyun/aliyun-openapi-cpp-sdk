...
DescribeLiveStreamStreamStatusResult::DescribeLiveStreamStreamStatusResult() :
	ServiceResult()
{}

DescribeLiveStreamStreamStatusResult::DescribeLiveStreamStreamStatusResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeLiveStreamStreamStatusResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
