...
RefreshObjectCachesResult::RefreshObjectCachesResult() :
	ServiceResult()
{}

RefreshObjectCachesResult::RefreshObjectCachesResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RefreshObjectCachesResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
