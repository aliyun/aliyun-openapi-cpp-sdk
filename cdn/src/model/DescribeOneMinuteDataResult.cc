...
DescribeOneMinuteDataResult::DescribeOneMinuteDataResult() :
	ServiceResult()
{}

DescribeOneMinuteDataResult::DescribeOneMinuteDataResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeOneMinuteDataResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
