...
DescribeCdnDomainStagingConfigResult::DescribeCdnDomainStagingConfigResult() :
	ServiceResult()
{}

DescribeCdnDomainStagingConfigResult::DescribeCdnDomainStagingConfigResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeCdnDomainStagingConfigResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeCdnDomainStagingConfigResult::getDomainName()const
{
	return domainName_;
}

std::vector<DescribeCdnDomainStagingConfigResult::DomainConfig> DescribeCdnDomainStagingConfigResult::getDomainConfigs()const
{
