...
DescribeL2VipsByDomainResult::DescribeL2VipsByDomainResult() :
	ServiceResult()
{}

DescribeL2VipsByDomainResult::DescribeL2VipsByDomainResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeL2VipsByDomainResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
