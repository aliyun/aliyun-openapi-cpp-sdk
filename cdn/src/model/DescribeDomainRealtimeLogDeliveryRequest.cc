...
using AlibabaCloud::Cdn::Model::DescribeDomainRealtimeLogDeliveryRequest;

DescribeDomainRealtimeLogDeliveryRequest::DescribeDomainRealtimeLogDeliveryRequest()
    : RpcServiceRequest("cdn", "2018-05-10", "DescribeDomainRealtimeLogDelivery") {
  setMethod(HttpRequest::Method::Get);
}

DescribeDomainRealtimeLogDeliveryRequest::~DescribeDomainRealtimeLogDeliveryRequest() {}

long DescribeDomainRealtimeLogDeliveryRequest::getOwnerId() const {
  return ownerId_;
}
