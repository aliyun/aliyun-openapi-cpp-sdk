...
DescribeDomainSrcTopUrlVisitResult::DescribeDomainSrcTopUrlVisitResult() :
	ServiceResult()
{}

DescribeDomainSrcTopUrlVisitResult::DescribeDomainSrcTopUrlVisitResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeDomainSrcTopUrlVisitResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeDomainSrcTopUrlVisitResult::UrlList> DescribeDomainSrcTopUrlVisitResult::getUrl200List()const
{
	return url200List_;
}

std::vector<DescribeDomainSrcTopUrlVisitResult::UrlList> DescribeDomainSrcTopUrlVisitResult::getUrl500List()const
{
	return url500List_;
}

std::vector<DescribeDomainSrcTopUrlVisitResult::UrlList> DescribeDomainSrcTopUrlVisitResult::getUrl400List()const
{
	return url400List_;
}

std::string DescribeDomainSrcTopUrlVisitResult::getDomainName()const
{
	return domainName_;
}

std::string DescribeDomainSrcTopUrlVisitResult::getStartTime()const
{
	return startTime_;
}

std::vector<DescribeDomainSrcTopUrlVisitResult::UrlList> DescribeDomainSrcTopUrlVisitResult::getUrl300List()const
{
	return url300List_;
}

std::vector<DescribeDomainSrcTopUrlVisitResult::UrlList> DescribeDomainSrcTopUrlVisitResult::getAllUrlList()const
{
	return allUrlList_;
}
