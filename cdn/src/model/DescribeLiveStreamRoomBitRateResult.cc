...
DescribeLiveStreamRoomBitRateResult::DescribeLiveStreamRoomBitRateResult() :
	ServiceResult()
{}

DescribeLiveStreamRoomBitRateResult::DescribeLiveStreamRoomBitRateResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeLiveStreamRoomBitRateResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
