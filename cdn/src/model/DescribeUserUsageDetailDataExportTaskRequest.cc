...
long DescribeUserUsageDetailDataExportTaskRequest::getResourceOwnerId()const
{
	return resourceOwnerId_;
}

void DescribeUserUsageDetailDataExportTaskRequest::setResourceOwnerId(long resourceOwnerId)
{
