...
ListRealtimeLogDeliveryDomainsResult::ListRealtimeLogDeliveryDomainsResult() :
	ServiceResult()
{}

ListRealtimeLogDeliveryDomainsResult::ListRealtimeLogDeliveryDomainsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListRealtimeLogDeliveryDomainsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<ListRealtimeLogDeliveryDomainsResult::Domains> ListRealtimeLogDeliveryDomainsResult::getContent()const
{
	return content_;
}
