...
ListRealtimeLogDeliveryInfosResult::ListRealtimeLogDeliveryInfosResult() :
	ServiceResult()
{}

ListRealtimeLogDeliveryInfosResult::ListRealtimeLogDeliveryInfosResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListRealtimeLogDeliveryInfosResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<ListRealtimeLogDeliveryInfosResult::RealtimeLogDeliveryInfos> ListRealtimeLogDeliveryInfosResult::getContent()const
{
	return content_;
}
