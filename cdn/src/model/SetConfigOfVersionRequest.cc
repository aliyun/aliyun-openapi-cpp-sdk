...
std::string SetConfigOfVersionRequest::getFunctionMatches()const
{
	return functionMatches_;
}

void SetConfigOfVersionRequest::setFunctionMatches(const std::string& functionMatches)
{
	functionMatches_ = functionMatches;
	setParameter("FunctionMatches", functionMatches);
}
