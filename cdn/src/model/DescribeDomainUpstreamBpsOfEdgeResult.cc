...
DescribeDomainUpstreamBpsOfEdgeResult::DescribeDomainUpstreamBpsOfEdgeResult() :
	ServiceResult()
{}

DescribeDomainUpstreamBpsOfEdgeResult::DescribeDomainUpstreamBpsOfEdgeResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeDomainUpstreamBpsOfEdgeResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
