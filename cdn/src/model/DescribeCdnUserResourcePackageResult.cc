...
DescribeCdnUserResourcePackageResult::DescribeCdnUserResourcePackageResult() :
	ServiceResult()
{}

DescribeCdnUserResourcePackageResult::DescribeCdnUserResourcePackageResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeCdnUserResourcePackageResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeCdnUserResourcePackageResult::ResourcePackageInfo> DescribeCdnUserResourcePackageResult::getResourcePackageInfos()const
{
