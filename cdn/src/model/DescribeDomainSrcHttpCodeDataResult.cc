...
DescribeDomainSrcHttpCodeDataResult::DescribeDomainSrcHttpCodeDataResult() :
	ServiceResult()
{}

DescribeDomainSrcHttpCodeDataResult::DescribeDomainSrcHttpCodeDataResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
std::string DescribeDomainSrcHttpCodeDataResult::getEndTime()const
{
	return endTime_;
}

std::string DescribeDomainSrcHttpCodeDataResult::getDomainName()const
{
	return domainName_;
}

std::string DescribeDomainSrcHttpCodeDataResult::getStartTime()const
{
	return startTime_;
}

std::string DescribeDomainSrcHttpCodeDataResult::getDataInterval()const
{
	return dataInterval_;
}

std::vector<DescribeDomainSrcHttpCodeDataResult::UsageData> DescribeDomainSrcHttpCodeDataResult::getHttpCodeData()const
{
