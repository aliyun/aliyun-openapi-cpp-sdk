...
using AlibabaCloud::Cdn::Model::DescribeLiveStreamHlsOnlineUserNumByDomainRequest;

DescribeLiveStreamHlsOnlineUserNumByDomainRequest::DescribeLiveStreamHlsOnlineUserNumByDomainRequest() :
	RpcServiceRequest("cdn", "2014-11-11", "DescribeLiveStreamHlsOnlineUserNumByDomain")
{}
