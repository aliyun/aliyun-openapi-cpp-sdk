...
std::string DescribeCdnCertificateDetailRequest::getAccessKeyId()const
{
	return accessKeyId_;
}

void DescribeCdnCertificateDetailRequest::setAccessKeyId(const std::string& accessKeyId)
{
