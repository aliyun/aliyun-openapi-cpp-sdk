...
#ifndef ALIBABACLOUD_CDN_MODEL_DESCRIBEDOMAINUVDATARESULT_H_
#define ALIBABACLOUD_CDN_MODEL_DESCRIBEDOMAINUVDATARESULT_H_
	...
	namespace Cdn
	{
		namespace Model
		{
			...
			public:
				...
				void setUvDataInterval(const std::vector<UsageData>& uvDataInterval);
...
#endif // !ALIBABACLOUD_CDN_MODEL_DESCRIBEDOMAINUVDATARESULT_H_