...
#ifndef ALIBABACLOUD_CDN_MODEL_LISTFCTRIGGERREQUEST_H_
#define ALIBABACLOUD_CDN_MODEL_LISTFCTRIGGERREQUEST_H_
...
namespace Cdn {
namespace Model {
class ALIBABACLOUD_CDN_EXPORT ListFCTriggerRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_CDN_MODEL_LISTFCTRIGGERREQUEST_H_
