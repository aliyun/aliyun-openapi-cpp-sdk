...
namespace AlibabaCloud
{
	namespace Cdn
	{
		namespace Model
		{
			class ALIBABACLOUD_CDN_EXPORT DescribeRangeDataByLocateAndIspServiceRequest : public RpcServiceRequest
			{
			...
			public:
				...
				std::string getWithBug()const;
				void setWithBug(const std::string& withBug);
