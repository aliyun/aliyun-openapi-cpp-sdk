...
#ifndef ALIBABACLOUD_CDN_MODEL_DESCRIBEIPINFORESULT_H_
...
namespace AlibabaCloud
{
	namespace Cdn
	{
		namespace Model
		{
			class ALIBABACLOUD_CDN_EXPORT DescribeIpInfoResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_CDN_MODEL_DESCRIBEIPINFORESULT_H_