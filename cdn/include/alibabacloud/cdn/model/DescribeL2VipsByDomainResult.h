...
#ifndef ALIBABACLOUD_CDN_MODEL_DESCRIBEL2VIPSBYDOMAINRESULT_H_
...
namespace AlibabaCloud
{
	namespace Cdn
	{
		namespace Model
		{
			class ALIBABACLOUD_CDN_EXPORT DescribeL2VipsByDomainResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_CDN_MODEL_DESCRIBEL2VIPSBYDOMAINRESULT_H_