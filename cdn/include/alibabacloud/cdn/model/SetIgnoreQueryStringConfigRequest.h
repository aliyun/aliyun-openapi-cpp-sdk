...
#ifndef ALIBABACLOUD_CDN_MODEL_SETIGNOREQUERYSTRINGCONFIGREQUEST_H_
#define ALIBABACLOUD_CDN_MODEL_SETIGNOREQUERYSTRINGCONFIGREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Cdn
	{
		namespace Model
		{
			class ALIBABACLOUD_CDN_EXPORT SetIgnoreQueryStringConfigRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_CDN_MODEL_SETIGNOREQUERYSTRINGCONFIGREQUEST_H_