...
#ifndef ALIBABACLOUD_CLOUDPHOTO_MODEL_REMOVEALBUMPHOTOSREQUEST_H_
#define ALIBABACLOUD_CLOUDPHOTO_MODEL_REMOVEALBUMPHOTOSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace CloudPhoto
	{
		namespace Model
		{
			class ALIBABACLOUD_CLOUDPHOTO_EXPORT RemoveAlbumPhotosRequest : public CloudPhotoRequest
			{
...
#endif // !ALIBABACLOUD_CLOUDPHOTO_MODEL_REMOVEALBUMPHOTOSREQUEST_H_