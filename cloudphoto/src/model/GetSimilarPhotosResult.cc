...
GetSimilarPhotosResult::GetSimilarPhotosResult() :
	ServiceResult()
{}

GetSimilarPhotosResult::GetSimilarPhotosResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetSimilarPhotosResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetSimilarPhotosResult::getAction()const
{
	return action_;
}

void GetSimilarPhotosResult::setAction(const std::string& action)
{
	action_ = action;
}

std::string GetSimilarPhotosResult::getMessage()const
{
	return message_;
}

void GetSimilarPhotosResult::setMessage(const std::string& message)
{
	message_ = message;
}

std::string GetSimilarPhotosResult::getCode()const
{
	return code_;
}

void GetSimilarPhotosResult::setCode(const std::string& code)
{
	code_ = code;
}
