...
void GetPublicAccessUrlsResult::setAction(const std::string& action)
{
	action_ = action;
}
...
void GetPublicAccessUrlsResult::setMessage(const std::string& message)
{
	message_ = message;
}
...
void GetPublicAccessUrlsResult::setCode(const std::string& code)
{
	code_ = code;
}
