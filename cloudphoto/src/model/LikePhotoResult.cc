...
LikePhotoResult::LikePhotoResult() :
	ServiceResult()
{}

LikePhotoResult::LikePhotoResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void LikePhotoResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string LikePhotoResult::getAction()const
{
	return action_;
}
