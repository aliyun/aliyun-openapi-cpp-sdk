...
void ListTagPhotosResult::setNextCursor(const std::string& nextCursor)
{
...
void ListTagPhotosResult::setTotalCount(int totalCount)
{
...
void ListTagPhotosResult::setAction(const std::string& action)
{
	action_ = action;
}
...
void ListTagPhotosResult::setMessage(const std::string& message)
{
	message_ = message;
}
...
void ListTagPhotosResult::setCode(const std::string& code)
{
	code_ = code;
}
