...
void GetPhotoStoreResult::setAction(const std::string& action)
{
	action_ = action;
}
...
void GetPhotoStoreResult::setMessage(const std::string& message)
{
	message_ = message;
}
...
void GetPhotoStoreResult::setCode(const std::string& code)
{
	code_ = code;
}
