...
void TagPhotoResult::setAction(const std::string& action)
{
	action_ = action;
}
...
void TagPhotoResult::setMessage(const std::string& message)
{
	message_ = message;
}
...
void TagPhotoResult::setCode(const std::string& code)
{
	code_ = code;
}
