...
DeletePhotosResult::DeletePhotosResult() :
	ServiceResult()
{}

DeletePhotosResult::DeletePhotosResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DeletePhotosResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
void DeletePhotosResult::setAction(const std::string& action)
{
	action_ = action;
}
...
void DeletePhotosResult::setMessage(const std::string& message)
{
	message_ = message;
}
...
void DeletePhotosResult::setCode(const std::string& code)
{
	code_ = code;
}
