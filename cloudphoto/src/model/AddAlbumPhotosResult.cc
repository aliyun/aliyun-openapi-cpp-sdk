...
void AddAlbumPhotosResult::setAction(const std::string& action)
{
	action_ = action;
}
...
void AddAlbumPhotosResult::setMessage(const std::string& message)
{
	message_ = message;
}
...
void AddAlbumPhotosResult::setCode(const std::string& code)
{
	code_ = code;
}
