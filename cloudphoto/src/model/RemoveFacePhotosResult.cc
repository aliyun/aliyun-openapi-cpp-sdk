...
void RemoveFacePhotosResult::setAction(const std::string& action)
{
	action_ = action;
}
...
void RemoveFacePhotosResult::setMessage(const std::string& message)
{
	message_ = message;
}
...
void RemoveFacePhotosResult::setCode(const std::string& code)
{
	code_ = code;
}
