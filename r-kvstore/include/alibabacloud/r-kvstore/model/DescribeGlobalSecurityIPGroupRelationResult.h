...
#ifndef ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBEGLOBALSECURITYIPGROUPRELATIONRESULT_H_
#define ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBEGLOBALSECURITYIPGROUPRELATIONRESULT_H_
...
namespace AlibabaCloud
{
	namespace R_kvstore
	{
		namespace Model
		{
			class ALIBABACLOUD_R_KVSTORE_EXPORT DescribeGlobalSecurityIPGroupRelationResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBEGLOBALSECURITYIPGROUPRELATIONRESULT_H_