...
#ifndef ALIBABACLOUD_R_KVSTORE_MODEL_MODIFYREPLICAMODEREQUEST_H_
#define ALIBABACLOUD_R_KVSTORE_MODEL_MODIFYREPLICAMODEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace R_kvstore
	{
		namespace Model
		{
			class ALIBABACLOUD_R_KVSTORE_EXPORT ModifyReplicaModeRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_R_KVSTORE_MODEL_MODIFYREPLICAMODEREQUEST_H_