...
#ifndef ALIBABACLOUD_R_KVSTORE_MODEL_CREATEGLOBALSECURITYIPGROUPRESULT_H_
#define ALIBABACLOUD_R_KVSTORE_MODEL_CREATEGLOBALSECURITYIPGROUPRESULT_H_
...
namespace AlibabaCloud
{
	namespace R_kvstore
	{
		namespace Model
		{
			class ALIBABACLOUD_R_KVSTORE_EXPORT CreateGlobalSecurityIPGroupResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_R_KVSTORE_MODEL_CREATEGLOBALSECURITYIPGROUPRESULT_H_