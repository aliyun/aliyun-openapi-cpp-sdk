...
#ifndef ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBEREPLICAUSAGERESULT_H_
#define ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBEREPLICAUSAGERESULT_H_
...
namespace AlibabaCloud
{
	namespace R_kvstore
	{
		namespace Model
		{
			class ALIBABACLOUD_R_KVSTORE_EXPORT DescribeReplicaUsageResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBEREPLICAUSAGERESULT_H_