...
#ifndef ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBESECURITYIPSRESULT_H_
#define ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBESECURITYIPSRESULT_H_
...
namespace AlibabaCloud
{
	namespace R_kvstore
	{
		namespace Model
		{
			class ALIBABACLOUD_R_KVSTORE_EXPORT DescribeSecurityIpsResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBESECURITYIPSRESULT_H_