...
#ifndef ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBESTATICVERIFICATIONLISTREQUEST_H_
#define ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBESTATICVERIFICATIONLISTREQUEST_H_
...
namespace AlibabaCloud
{
	namespace R_kvstore
	{
		namespace Model
		{
			class ALIBABACLOUD_R_KVSTORE_EXPORT DescribeStaticVerificationListRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_R_KVSTORE_MODEL_DESCRIBESTATICVERIFICATIONLISTREQUEST_H_