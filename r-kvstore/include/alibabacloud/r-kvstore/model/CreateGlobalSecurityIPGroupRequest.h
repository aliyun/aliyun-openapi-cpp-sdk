...
#ifndef ALIBABACLOUD_R_KVSTORE_MODEL_CREATEGLOBALSECURITYIPGROUPREQUEST_H_
#define ALIBABACLOUD_R_KVSTORE_MODEL_CREATEGLOBALSECURITYIPGROUPREQUEST_H_
...
namespace R_kvstore {
namespace Model {
class ALIBABACLOUD_R_KVSTORE_EXPORT CreateGlobalSecurityIPGroupRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_R_KVSTORE_MODEL_CREATEGLOBALSECURITYIPGROUPREQUEST_H_
