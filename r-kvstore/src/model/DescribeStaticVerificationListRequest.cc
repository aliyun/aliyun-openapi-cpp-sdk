...
#include <alibabacloud/r-kvstore/model/DescribeStaticVerificationListRequest.h>

using AlibabaCloud::R_kvstore::Model::DescribeStaticVerificationListRequest;

DescribeStaticVerificationListRequest::DescribeStaticVerificationListRequest() :
	RpcServiceRequest("r-kvstore", "2015-01-01", "DescribeStaticVerificationList")
{}
