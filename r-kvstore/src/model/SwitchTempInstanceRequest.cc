...
#include <alibabacloud/r-kvstore/model/SwitchTempInstanceRequest.h>

using AlibabaCloud::R_kvstore::Model::SwitchTempInstanceRequest;

SwitchTempInstanceRequest::SwitchTempInstanceRequest() :
	RpcServiceRequest("r-kvstore", "2015-01-01", "SwitchTempInstance")
{}

SwitchTempInstanceRequest::~SwitchTempInstanceRequest()
{}

long SwitchTempInstanceRequest::getResourceOwnerId()const
{
	return resourceOwnerId_;
}

void SwitchTempInstanceRequest::setResourceOwnerId(long resourceOwnerId)
{
...
void SwitchTempInstanceRequest::setOwnerId(long ownerId)
{
	ownerId_ = ownerId;
	setCoreParameter("OwnerId", ownerId);
}

std::string SwitchTempInstanceRequest::getAccessKeyId()const
{
	return accessKeyId_;
}
