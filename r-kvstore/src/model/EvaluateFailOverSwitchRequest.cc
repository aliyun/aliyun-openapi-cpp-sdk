...
#include <alibabacloud/r-kvstore/model/EvaluateFailOverSwitchRequest.h>

using AlibabaCloud::R_kvstore::Model::EvaluateFailOverSwitchRequest;

EvaluateFailOverSwitchRequest::EvaluateFailOverSwitchRequest() :
	RpcServiceRequest("r-kvstore", "2015-01-01", "EvaluateFailOverSwitch")
{}
