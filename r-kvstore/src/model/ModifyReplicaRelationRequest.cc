...
#include <alibabacloud/r-kvstore/model/ModifyReplicaRelationRequest.h>

using AlibabaCloud::R_kvstore::Model::ModifyReplicaRelationRequest;

ModifyReplicaRelationRequest::ModifyReplicaRelationRequest() :
	RpcServiceRequest("r-kvstore", "2015-01-01", "ModifyReplicaRelation")
{}
