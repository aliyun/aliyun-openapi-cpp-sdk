...
#include <alibabacloud/r-kvstore/model/DescribeTempInstanceResult.h>
#include <json/json.h>

using namespace AlibabaCloud::R_kvstore;
using namespace AlibabaCloud::R_kvstore::Model;

DescribeTempInstanceResult::DescribeTempInstanceResult() :
	ServiceResult()
{}

DescribeTempInstanceResult::DescribeTempInstanceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeTempInstanceResult::parse(const std::string &payload)
{
...
std::vector<DescribeTempInstanceResult::TempInstance> DescribeTempInstanceResult::getTempInstances()const
{
	return tempInstances_;
}
