...
#include <alibabacloud/r-kvstore/model/ModifyReplicaDescriptionRequest.h>

using AlibabaCloud::R_kvstore::Model::ModifyReplicaDescriptionRequest;

ModifyReplicaDescriptionRequest::ModifyReplicaDescriptionRequest() :
	RpcServiceRequest("r-kvstore", "2015-01-01", "ModifyReplicaDescription")
{}
