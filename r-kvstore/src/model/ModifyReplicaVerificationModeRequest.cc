...
#include <alibabacloud/r-kvstore/model/ModifyReplicaVerificationModeRequest.h>

using AlibabaCloud::R_kvstore::Model::ModifyReplicaVerificationModeRequest;

ModifyReplicaVerificationModeRequest::ModifyReplicaVerificationModeRequest() :
	RpcServiceRequest("r-kvstore", "2015-01-01", "ModifyReplicaVerificationMode")
{}
...
void ModifyReplicaVerificationModeRequest::setVerificationMode(const std::string& verificationMode)
{
	...
	setCoreParameter("VerificationMode", std::to_string(verificationMode));
}
