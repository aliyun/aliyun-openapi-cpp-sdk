...
ModifyInstanceNetExpireTimeResult::ModifyInstanceNetExpireTimeResult() :
	ServiceResult()
{}

ModifyInstanceNetExpireTimeResult::ModifyInstanceNetExpireTimeResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ModifyInstanceNetExpireTimeResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<ModifyInstanceNetExpireTimeResult::NetInfoItem> ModifyInstanceNetExpireTimeResult::getNetInfoItems()const
{
	return netInfoItems_;
}

std::string ModifyInstanceNetExpireTimeResult::getInstanceId()const
{
	return instanceId_;
}
