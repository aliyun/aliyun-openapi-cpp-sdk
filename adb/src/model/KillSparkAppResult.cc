...
KillSparkAppResult::KillSparkAppResult() :
	ServiceResult()
{}

KillSparkAppResult::KillSparkAppResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void KillSparkAppResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
KillSparkAppResult::Data KillSparkAppResult::getData()const
{
	return data_;
}
