...
SubmitSparkLogAnalyzeTaskResult::SubmitSparkLogAnalyzeTaskResult() :
	ServiceResult()
{}

SubmitSparkLogAnalyzeTaskResult::SubmitSparkLogAnalyzeTaskResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void SubmitSparkLogAnalyzeTaskResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
SubmitSparkLogAnalyzeTaskResult::Data SubmitSparkLogAnalyzeTaskResult::getData()const
{
	return data_;
}
