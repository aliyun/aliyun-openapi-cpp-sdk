...
GetSparkAppMetricsResult::GetSparkAppMetricsResult() :
	ServiceResult()
{}

GetSparkAppMetricsResult::GetSparkAppMetricsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetSparkAppMetricsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
GetSparkAppMetricsResult::Data GetSparkAppMetricsResult::getData()const
{
	return data_;
}
