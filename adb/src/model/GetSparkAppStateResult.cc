...
GetSparkAppStateResult::GetSparkAppStateResult() :
	ServiceResult()
{}

GetSparkAppStateResult::GetSparkAppStateResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetSparkAppStateResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
GetSparkAppStateResult::Data GetSparkAppStateResult::getData()const
{
	return data_;
}
