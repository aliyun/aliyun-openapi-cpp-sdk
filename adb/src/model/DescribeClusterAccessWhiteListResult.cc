...
DescribeClusterAccessWhiteListResult::DescribeClusterAccessWhiteListResult() :
	ServiceResult()
{}

DescribeClusterAccessWhiteListResult::DescribeClusterAccessWhiteListResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeClusterAccessWhiteListResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeClusterAccessWhiteListResult::IPArray> DescribeClusterAccessWhiteListResult::getItems()const
{
	return items_;
}
