...
DescribeClusterNetInfoResult::DescribeClusterNetInfoResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeClusterNetInfoResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeClusterNetInfoResult::getClusterNetworkType()const
{
	return clusterNetworkType_;
}

std::vector<DescribeClusterNetInfoResult::Address> DescribeClusterNetInfoResult::getItems()const
{
	return items_;
}
