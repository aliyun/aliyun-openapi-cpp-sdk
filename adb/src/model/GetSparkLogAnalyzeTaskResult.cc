...
GetSparkLogAnalyzeTaskResult::GetSparkLogAnalyzeTaskResult() :
	ServiceResult()
{}

GetSparkLogAnalyzeTaskResult::GetSparkLogAnalyzeTaskResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetSparkLogAnalyzeTaskResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
GetSparkLogAnalyzeTaskResult::Data GetSparkLogAnalyzeTaskResult::getData()const
{
	return data_;
}
