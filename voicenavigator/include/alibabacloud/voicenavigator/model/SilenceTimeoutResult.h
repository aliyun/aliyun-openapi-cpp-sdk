...
#ifndef ALIBABACLOUD_VOICENAVIGATOR_MODEL_SILENCETIMEOUTRESULT_H_
#define ALIBABACLOUD_VOICENAVIGATOR_MODEL_SILENCETIMEOUTRESULT_H_
...
namespace AlibabaCloud
{
	namespace VoiceNavigator
	{
		namespace Model
		{
			class ALIBABACLOUD_VOICENAVIGATOR_EXPORT SilenceTimeoutResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_VOICENAVIGATOR_MODEL_SILENCETIMEOUTRESULT_H_