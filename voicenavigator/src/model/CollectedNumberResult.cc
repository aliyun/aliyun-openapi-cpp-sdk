...
CollectedNumberResult::CollectedNumberResult() :
	ServiceResult()
{}

CollectedNumberResult::CollectedNumberResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CollectedNumberResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string CollectedNumberResult::getTextResponse()const
{
