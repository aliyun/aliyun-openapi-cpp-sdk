...
AuditTTSVoiceResult::AuditTTSVoiceResult() :
	ServiceResult()
{}

AuditTTSVoiceResult::AuditTTSVoiceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void AuditTTSVoiceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string AuditTTSVoiceResult::getAuditionUrl()const
{
	return auditionUrl_;
}
