...
DebugCollectedNumberResult::DebugCollectedNumberResult() :
	ServiceResult()
{}

DebugCollectedNumberResult::DebugCollectedNumberResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DebugCollectedNumberResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DebugCollectedNumberResult::getTextResponse()const
{
