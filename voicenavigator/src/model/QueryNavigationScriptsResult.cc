...
QueryNavigationScriptsResult::QueryNavigationScriptsResult() :
	ServiceResult()
{}

QueryNavigationScriptsResult::QueryNavigationScriptsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryNavigationScriptsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
long QueryNavigationScriptsResult::getTotalCount()const
{
	return totalCount_;
}

int QueryNavigationScriptsResult::getPageSize()const
{
	return pageSize_;
}

int QueryNavigationScriptsResult::getPageNumber()const
{
	return pageNumber_;
}

std::vector<QueryNavigationScriptsResult::NavigationScript> QueryNavigationScriptsResult::getNavigationScripts()const
{
