...
MoveCategoryResult::MoveCategoryResult() :
	ServiceResult()
{}

MoveCategoryResult::MoveCategoryResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void MoveCategoryResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
