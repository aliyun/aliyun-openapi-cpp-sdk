...
ListConversationDetailsResult::ListConversationDetailsResult() :
	ServiceResult()
{}

ListConversationDetailsResult::ListConversationDetailsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListConversationDetailsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	reader.parse(payload, value);
	setRequestId(value["RequestId"].asString());
	auto allConversationDetailsNode = value["ConversationDetails"]["ConversationDetail"];
...
std::vector<ListConversationDetailsResult::ConversationDetail> ListConversationDetailsResult::getConversationDetails()const
{
