...
std::string ListInstancesRequest::getNluServiceTypeListJsonString() const {
  return nluServiceTypeListJsonString_;
}

void ListInstancesRequest::setNluServiceTypeListJsonString(const std::string &nluServiceTypeListJsonString) {
  nluServiceTypeListJsonString_ = nluServiceTypeListJsonString;
  setParameter(std::string("NluServiceTypeListJsonString"), nluServiceTypeListJsonString);
}
