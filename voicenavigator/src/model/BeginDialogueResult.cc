...
BeginDialogueResult::BeginDialogueResult() :
	ServiceResult()
{}

BeginDialogueResult::BeginDialogueResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void BeginDialogueResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string BeginDialogueResult::getTextResponse()const
{
