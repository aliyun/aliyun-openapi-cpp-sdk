...
#ifndef ALIBABACLOUD_MSEAP_MODEL_GETPROXYBYTYPEREQUEST_H_
#define ALIBABACLOUD_MSEAP_MODEL_GETPROXYBYTYPEREQUEST_H_
...
namespace Mseap {
namespace Model {
class ALIBABACLOUD_MSEAP_EXPORT GetProxyByTypeRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_MSEAP_MODEL_GETPROXYBYTYPEREQUEST_H_
