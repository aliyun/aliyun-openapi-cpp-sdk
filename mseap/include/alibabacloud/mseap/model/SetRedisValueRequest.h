...
#ifndef ALIBABACLOUD_MSEAP_MODEL_SETREDISVALUEREQUEST_H_
#define ALIBABACLOUD_MSEAP_MODEL_SETREDISVALUEREQUEST_H_
...
namespace Mseap {
namespace Model {
class ALIBABACLOUD_MSEAP_EXPORT SetRedisValueRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_MSEAP_MODEL_SETREDISVALUEREQUEST_H_
