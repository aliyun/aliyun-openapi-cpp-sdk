...
#ifndef ALIBABACLOUD_MSEAP_MODEL_GETREDISVALUEREQUEST_H_
#define ALIBABACLOUD_MSEAP_MODEL_GETREDISVALUEREQUEST_H_
...
namespace Mseap {
namespace Model {
class ALIBABACLOUD_MSEAP_EXPORT GetRedisValueRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_MSEAP_MODEL_GETREDISVALUEREQUEST_H_
