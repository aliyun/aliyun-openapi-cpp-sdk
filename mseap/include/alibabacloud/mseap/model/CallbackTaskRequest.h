...
#ifndef ALIBABACLOUD_MSEAP_MODEL_CALLBACKTASKREQUEST_H_
#define ALIBABACLOUD_MSEAP_MODEL_CALLBACKTASKREQUEST_H_
...
namespace Mseap {
namespace Model {
class ALIBABACLOUD_MSEAP_EXPORT CallbackTaskRequest : public RpcServiceRequest {
public:
	CallbackTaskRequest();
	~CallbackTaskRequest();
	long getUserCallerParentId() const;
	void setUserCallerParentId(long userCallerParentId);
	std::string getOutTaskId() const;
	void setOutTaskId(const std::string &outTaskId);
	...
	std::string getPrincipalKey() const;
	void setPrincipalKey(const std::string &principalKey);
...
#endif // !ALIBABACLOUD_MSEAP_MODEL_CALLBACKTASKREQUEST_H_
