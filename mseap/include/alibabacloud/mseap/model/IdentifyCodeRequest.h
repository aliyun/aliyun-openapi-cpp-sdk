...
#ifndef ALIBABACLOUD_MSEAP_MODEL_IDENTIFYCODEREQUEST_H_
#define ALIBABACLOUD_MSEAP_MODEL_IDENTIFYCODEREQUEST_H_
...
namespace Mseap {
namespace Model {
class ALIBABACLOUD_MSEAP_EXPORT IdentifyCodeRequest : public RpcServiceRequest {
public:
	IdentifyCodeRequest();
	~IdentifyCodeRequest();
...
#endif // !ALIBABACLOUD_MSEAP_MODEL_IDENTIFYCODEREQUEST_H_
