...
#ifndef ALIBABACLOUD_MSEAP_MODEL_GETNODEBYTEMPLATEIDREQUEST_H_
#define ALIBABACLOUD_MSEAP_MODEL_GETNODEBYTEMPLATEIDREQUEST_H_
...
namespace Mseap {
namespace Model {
class ALIBABACLOUD_MSEAP_EXPORT GetNodeByTemplateIdRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_MSEAP_MODEL_GETNODEBYTEMPLATEIDREQUEST_H_
