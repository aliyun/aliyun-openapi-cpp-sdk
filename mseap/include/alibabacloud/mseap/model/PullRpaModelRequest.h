...
#ifndef ALIBABACLOUD_MSEAP_MODEL_PULLRPAMODELREQUEST_H_
#define ALIBABACLOUD_MSEAP_MODEL_PULLRPAMODELREQUEST_H_
...
namespace Mseap {
namespace Model {
class ALIBABACLOUD_MSEAP_EXPORT PullRpaModelRequest : public RpcServiceRequest {
public:
	PullRpaModelRequest();
	~PullRpaModelRequest();
...
#endif // !ALIBABACLOUD_MSEAP_MODEL_PULLRPAMODELREQUEST_H_
