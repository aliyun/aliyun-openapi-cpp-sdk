...
#ifndef ALIBABACLOUD_MSEAP_MODEL_PULLTASKREQUEST_H_
#define ALIBABACLOUD_MSEAP_MODEL_PULLTASKREQUEST_H_
...
namespace Mseap {
namespace Model {
class ALIBABACLOUD_MSEAP_EXPORT PullTaskRequest : public RpcServiceRequest {
public:
	PullTaskRequest();
	~PullTaskRequest();
...
#endif // !ALIBABACLOUD_MSEAP_MODEL_PULLTASKREQUEST_H_
