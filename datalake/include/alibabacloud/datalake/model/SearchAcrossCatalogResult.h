...
#ifndef ALIBABACLOUD_DATALAKE_MODEL_SEARCHACROSSCATALOGRESULT_H_
#define ALIBABACLOUD_DATALAKE_MODEL_SEARCHACROSSCATALOGRESULT_H_
...
namespace AlibabaCloud
{
	namespace DataLake
	{
		namespace Model
		{
			class ALIBABACLOUD_DATALAKE_EXPORT SearchAcrossCatalogResult : public ServiceResult
			{
			public:
				...
				struct CatalogResult
				{
					struct CatalogsItem
					{
						...
						struct HighLightListItem5
						{
							std::string value;
							std::string key;
						};
						std::vector<CatalogsItem::HighLightListItem5> highLightList4;
						Catalog catalog;
					};
					long totalCount;
					std::vector<CatalogsItem> catalogs;
				};


				SearchAcrossCatalogResult();
				explicit SearchAcrossCatalogResult(const std::string &payload);
				~SearchAcrossCatalogResult();
				TableResult getTableResult()const;
				CatalogResult getCatalogResult()const;
...
#endif // !ALIBABACLOUD_DATALAKE_MODEL_SEARCHACROSSCATALOGRESULT_H_