...
#ifndef ALIBABACLOUD_DATALAKE_MODEL_LISTPARTITIONSRESULT_H_
#define ALIBABACLOUD_DATALAKE_MODEL_LISTPARTITIONSRESULT_H_
...
namespace AlibabaCloud
{
	namespace DataLake
	{
		namespace Model
		{
			class ALIBABACLOUD_DATALAKE_EXPORT ListPartitionsResult : public ServiceResult
			{
			public:
				...
				explicit ListPartitionsResult(const std::string &payload);
				~ListPartitionsResult();
...
#endif // !ALIBABACLOUD_DATALAKE_MODEL_LISTPARTITIONSRESULT_H_