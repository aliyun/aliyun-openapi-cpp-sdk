...
#ifndef ALIBABACLOUD_DATALAKE_MODEL_LISTFUNCTIONNAMESREQUEST_H_
#define ALIBABACLOUD_DATALAKE_MODEL_LISTFUNCTIONNAMESREQUEST_H_
...
namespace DataLake {
namespace Model {
class ALIBABACLOUD_DATALAKE_EXPORT ListFunctionNamesRequest : public RoaServiceRequest {
public:
...
#endif // !ALIBABACLOUD_DATALAKE_MODEL_LISTFUNCTIONNAMESREQUEST_H_
