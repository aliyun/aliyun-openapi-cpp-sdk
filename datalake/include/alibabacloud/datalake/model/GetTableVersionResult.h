...
#ifndef ALIBABACLOUD_DATALAKE_MODEL_GETTABLEVERSIONRESULT_H_
#define ALIBABACLOUD_DATALAKE_MODEL_GETTABLEVERSIONRESULT_H_
...
namespace AlibabaCloud
{
	namespace DataLake
	{
		namespace Model
		{
			class ALIBABACLOUD_DATALAKE_EXPORT GetTableVersionResult : public ServiceResult
			{
			public:
				struct TableVersion
				{
				...
				explicit GetTableVersionResult(const std::string &payload);
				~GetTableVersionResult();
				std::string getMessage()const;
				TableVersion getTableVersion()const;
...
#endif // !ALIBABACLOUD_DATALAKE_MODEL_GETTABLEVERSIONRESULT_H_