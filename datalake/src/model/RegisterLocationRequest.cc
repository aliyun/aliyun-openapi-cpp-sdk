...
using AlibabaCloud::DataLake::Model::RegisterLocationRequest;
...
std::string RegisterLocationRequest::getBody() const {
  return body_;
}

void RegisterLocationRequest::setBody(const std::string &body) {
  body_ = body;
