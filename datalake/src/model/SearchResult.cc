...
SearchResult::TableResult SearchResult::getTableResult()const
{
	return tableResult_;
}

std::string SearchResult::getMessage()const
{
	return message_;
}

SearchResult::DatabaseResult SearchResult::getDatabaseResult()const
{
	return databaseResult_;
}

std::string SearchResult::getCode()const
{
	return code_;
}

bool SearchResult::getSuccess()const
{
	return success_;
}
