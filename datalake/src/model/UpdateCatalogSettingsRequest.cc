...
using AlibabaCloud::DataLake::Model::UpdateCatalogSettingsRequest;
...
std::string UpdateCatalogSettingsRequest::getBody() const {
  return body_;
}

void UpdateCatalogSettingsRequest::setBody(const std::string &body) {
  body_ = body;
