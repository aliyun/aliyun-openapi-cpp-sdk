...
std::string UpdateTableResult::getTaskId()const
{
	return taskId_;
}

std::string UpdateTableResult::getMessage()const
{
	return message_;
}

std::string UpdateTableResult::getCode()const
{
	return code_;
}

bool UpdateTableResult::getSuccess()const
{
	return success_;
}
