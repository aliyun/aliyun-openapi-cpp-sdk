...
UpdateRegisteredLocationResult::UpdateRegisteredLocationResult() :
	ServiceResult()
{}

UpdateRegisteredLocationResult::UpdateRegisteredLocationResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateRegisteredLocationResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
UpdateRegisteredLocationResult::Data UpdateRegisteredLocationResult::getData()const
{
	return data_;
}

bool UpdateRegisteredLocationResult::getSuccess()const
{
	return success_;
}
