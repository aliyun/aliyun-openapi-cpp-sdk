...
using AlibabaCloud::DataLake::Model::UpdateDatabaseRequest;
...
std::string UpdateDatabaseRequest::getBody() const {
  return body_;
}

void UpdateDatabaseRequest::setBody(const std::string &body) {
  body_ = body;
