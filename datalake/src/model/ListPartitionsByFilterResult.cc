...
ListPartitionsByFilterResult::ListPartitionsByFilterResult() :
	ServiceResult()
{}

ListPartitionsByFilterResult::ListPartitionsByFilterResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListPartitionsByFilterResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<ListPartitionsByFilterResult::PartitionsItem> ListPartitionsByFilterResult::getPartitions()const
{
	return partitions_;
}

std::vector<ListPartitionsByFilterResult::PartitionSpecsItem> ListPartitionsByFilterResult::getPartitionSpecs()const
{
	return partitionSpecs_;
}

std::string ListPartitionsByFilterResult::getMessage()const
{
	return message_;
}

std::string ListPartitionsByFilterResult::getNextPageToken()const
{
	return nextPageToken_;
}

std::string ListPartitionsByFilterResult::getCode()const
{
	return code_;
}

bool ListPartitionsByFilterResult::getSuccess()const
{
	return success_;
}
