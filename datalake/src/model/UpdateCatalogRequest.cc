...
using AlibabaCloud::DataLake::Model::UpdateCatalogRequest;
...
std::string UpdateCatalogRequest::getBody() const {
  return body_;
}

void UpdateCatalogRequest::setBody(const std::string &body) {
  body_ = body;
