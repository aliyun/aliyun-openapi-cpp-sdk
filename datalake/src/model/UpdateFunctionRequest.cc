...
using AlibabaCloud::DataLake::Model::UpdateFunctionRequest;
...
std::string UpdateFunctionRequest::getBody() const {
  return body_;
}

void UpdateFunctionRequest::setBody(const std::string &body) {
  body_ = body;
