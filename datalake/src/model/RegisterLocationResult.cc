...
RegisterLocationResult::RegisterLocationResult() :
	ServiceResult()
{}

RegisterLocationResult::RegisterLocationResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RegisterLocationResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
RegisterLocationResult::Data RegisterLocationResult::getData()const
{
	return data_;
}

bool RegisterLocationResult::getSuccess()const
{
	return success_;
}
