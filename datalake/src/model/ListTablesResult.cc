...
std::string ListTablesResult::getMessage()const
{
	return message_;
}

std::string ListTablesResult::getNextPageToken()const
{
	return nextPageToken_;
}

std::vector<ListTablesResult::TablesItem> ListTablesResult::getTables()const
{
	return tables_;
}

std::string ListTablesResult::getCode()const
{
	return code_;
}
