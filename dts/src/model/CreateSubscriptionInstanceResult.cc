...
CreateSubscriptionInstanceResult::CreateSubscriptionInstanceResult() :
	ServiceResult()
{}

CreateSubscriptionInstanceResult::CreateSubscriptionInstanceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void CreateSubscriptionInstanceResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string CreateSubscriptionInstanceResult::getErrCode()const
{
	return errCode_;
}
