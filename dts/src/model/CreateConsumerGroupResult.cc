...
std::string CreateConsumerGroupResult::getConsumerGroupID()const
{
	return consumerGroupID_;
}

std::string CreateConsumerGroupResult::getErrMessage()const
{
	return errMessage_;
}

std::string CreateConsumerGroupResult::getSuccess()const
{
	return success_;
}

std::string CreateConsumerGroupResult::getErrCode()const
{
	return errCode_;
}
