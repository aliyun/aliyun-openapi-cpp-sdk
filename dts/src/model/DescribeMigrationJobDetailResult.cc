...
std::string DescribeMigrationJobDetailResult::getErrMessage()const
{
	return errMessage_;
}
...
std::string DescribeMigrationJobDetailResult::getSuccess()const
{
	return success_;
}

std::string DescribeMigrationJobDetailResult::getErrCode()const
{
	return errCode_;
}
