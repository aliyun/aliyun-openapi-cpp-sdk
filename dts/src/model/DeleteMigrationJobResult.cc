...
std::string DeleteMigrationJobResult::getErrMessage()const
{
	return errMessage_;
}

std::string DeleteMigrationJobResult::getSuccess()const
{
	return success_;
}

std::string DeleteMigrationJobResult::getErrCode()const
{
	return errCode_;
}
