...
std::string DeleteConsumerGroupResult::getErrMessage()const
{
	return errMessage_;
}

std::string DeleteConsumerGroupResult::getSuccess()const
{
	return success_;
}

std::string DeleteConsumerGroupResult::getErrCode()const
{
	return errCode_;
}
