...
#ifndef ALIBABACLOUD_DTS_MODEL_RESETSYNCHRONIZATIONJOBREQUEST_H_
#define ALIBABACLOUD_DTS_MODEL_RESETSYNCHRONIZATIONJOBREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Dts
	{
		namespace Model
		{
			class ALIBABACLOUD_DTS_EXPORT ResetSynchronizationJobRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_DTS_MODEL_RESETSYNCHRONIZATIONJOBREQUEST_H_