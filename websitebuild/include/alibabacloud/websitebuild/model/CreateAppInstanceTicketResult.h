...
#ifndef ALIBABACLOUD_WEBSITEBUILD_MODEL_CREATEAPPINSTANCETICKETRESULT_H_
#define ALIBABACLOUD_WEBSITEBUILD_MODEL_CREATEAPPINSTANCETICKETRESULT_H_
...
namespace AlibabaCloud
{
	namespace WebsiteBuild
	{
		namespace Model
		{
			class ALIBABACLOUD_WEBSITEBUILD_EXPORT CreateAppInstanceTicketResult : public ServiceResult
			{
			public:
				struct Module
				{
				...
				CreateAppInstanceTicketResult();
				explicit CreateAppInstanceTicketResult(const std::string &payload);
				~CreateAppInstanceTicketResult();
...
#endif // !ALIBABACLOUD_WEBSITEBUILD_MODEL_CREATEAPPINSTANCETICKETRESULT_H_