...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT MetastoreDescribeKafkaConsumerGroupResult : public ServiceResult
			{
			public:
				struct Partition
				{
				...
				explicit MetastoreDescribeKafkaConsumerGroupResult(const std::string &payload);
				~MetastoreDescribeKafkaConsumerGroupResult();
