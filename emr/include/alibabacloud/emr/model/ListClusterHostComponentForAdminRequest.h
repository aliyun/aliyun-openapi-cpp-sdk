...
#ifndef ALIBABACLOUD_EMR_MODEL_LISTCLUSTERHOSTCOMPONENTFORADMINREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT ListClusterHostComponentForAdminRequest : public RpcServiceRequest
			{

			public:
				ListClusterHostComponentForAdminRequest();
				~ListClusterHostComponentForAdminRequest();
...
#endif // !ALIBABACLOUD_EMR_MODEL_LISTCLUSTERHOSTCOMPONENTFORADMINREQUEST_H_