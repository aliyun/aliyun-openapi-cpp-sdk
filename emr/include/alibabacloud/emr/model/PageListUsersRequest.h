...
#ifndef ALIBABACLOUD_EMR_MODEL_PAGELISTUSERSREQUEST_H_
...
namespace Emr {
namespace Model {
class ALIBABACLOUD_EMR_EXPORT PageListUsersRequest : public RpcServiceRequest {

public:
  PageListUsersRequest();
  ~PageListUsersRequest();
...
#endif // !ALIBABACLOUD_EMR_MODEL_PAGELISTUSERSREQUEST_H_