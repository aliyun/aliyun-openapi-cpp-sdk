...
#ifndef ALIBABACLOUD_EMR_MODEL_LISTRESOURCEPOOLFORADMINRESULT_H_
#define ALIBABACLOUD_EMR_MODEL_LISTRESOURCEPOOLFORADMINRESULT_H_
...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT ListResourcePoolForAdminResult : public ServiceResult
			{
			public:
				struct PoolInfo
				{
				...
				ListResourcePoolForAdminResult();
				explicit ListResourcePoolForAdminResult(const std::string &payload);
				~ListResourcePoolForAdminResult();
...
#endif // !ALIBABACLOUD_EMR_MODEL_LISTRESOURCEPOOLFORADMINRESULT_H_