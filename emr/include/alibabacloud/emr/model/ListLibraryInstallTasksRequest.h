...
#ifndef ALIBABACLOUD_EMR_MODEL_LISTLIBRARYINSTALLTASKSREQUEST_H_
#define ALIBABACLOUD_EMR_MODEL_LISTLIBRARYINSTALLTASKSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT ListLibraryInstallTasksRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_EMR_MODEL_LISTLIBRARYINSTALLTASKSREQUEST_H_