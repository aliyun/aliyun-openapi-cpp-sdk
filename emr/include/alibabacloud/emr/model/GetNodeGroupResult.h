...
#ifndef ALIBABACLOUD_EMR_MODEL_GETNODEGROUPRESULT_H_
#define ALIBABACLOUD_EMR_MODEL_GETNODEGROUPRESULT_H_
...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT GetNodeGroupResult : public ServiceResult
			{
			public:
				struct NodeGroup
				{
...
#endif // !ALIBABACLOUD_EMR_MODEL_GETNODEGROUPRESULT_H_