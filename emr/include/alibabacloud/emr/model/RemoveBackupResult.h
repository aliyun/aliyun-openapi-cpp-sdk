...
#ifndef ALIBABACLOUD_EMR_MODEL_REMOVEBACKUPRESULT_H_
...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT RemoveBackupResult : public ServiceResult
			{
			public:


				RemoveBackupResult();
				explicit RemoveBackupResult(const std::string &payload);
				~RemoveBackupResult();
...
#endif // !ALIBABACLOUD_EMR_MODEL_REMOVEBACKUPRESULT_H_