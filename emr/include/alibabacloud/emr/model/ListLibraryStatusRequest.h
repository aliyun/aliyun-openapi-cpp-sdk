...
#ifndef ALIBABACLOUD_EMR_MODEL_LISTLIBRARYSTATUSREQUEST_H_
#define ALIBABACLOUD_EMR_MODEL_LISTLIBRARYSTATUSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT ListLibraryStatusRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_EMR_MODEL_LISTLIBRARYSTATUSREQUEST_H_