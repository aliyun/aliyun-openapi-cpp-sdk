...
#ifndef ALIBABACLOUD_EMR_MODEL_LISTAPPLICATIONCONFIGSREQUEST_H_
#define ALIBABACLOUD_EMR_MODEL_LISTAPPLICATIONCONFIGSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT ListApplicationConfigsRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_EMR_MODEL_LISTAPPLICATIONCONFIGSREQUEST_H_