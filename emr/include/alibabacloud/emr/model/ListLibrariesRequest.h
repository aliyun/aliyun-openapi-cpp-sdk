...
#ifndef ALIBABACLOUD_EMR_MODEL_LISTLIBRARIESREQUEST_H_
#define ALIBABACLOUD_EMR_MODEL_LISTLIBRARIESREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT ListLibrariesRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_EMR_MODEL_LISTLIBRARIESREQUEST_H_