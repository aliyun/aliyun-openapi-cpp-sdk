...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT MetastoreUpdateTableRequest : public RpcServiceRequest
			{
				struct AddColumn
				{
					std::string name;
			...
			public:
				...
				void setDeletePartitionName(const std::vector<std::string>& deletePartitionName);
