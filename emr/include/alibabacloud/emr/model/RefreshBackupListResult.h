...
#ifndef ALIBABACLOUD_EMR_MODEL_REFRESHBACKUPLISTRESULT_H_
#define ALIBABACLOUD_EMR_MODEL_REFRESHBACKUPLISTRESULT_H_
...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT RefreshBackupListResult : public ServiceResult
			{
			public:


				RefreshBackupListResult();
				explicit RefreshBackupListResult(const std::string &payload);
				~RefreshBackupListResult();
...
#endif // !ALIBABACLOUD_EMR_MODEL_REFRESHBACKUPLISTRESULT_H_