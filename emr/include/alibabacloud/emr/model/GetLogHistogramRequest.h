...
#ifndef ALIBABACLOUD_EMR_MODEL_GETLOGHISTOGRAMREQUEST_H_
#define ALIBABACLOUD_EMR_MODEL_GETLOGHISTOGRAMREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT GetLogHistogramRequest : public RpcServiceRequest
			{

			public:
				GetLogHistogramRequest();
				~GetLogHistogramRequest();
...
#endif // !ALIBABACLOUD_EMR_MODEL_GETLOGHISTOGRAMREQUEST_H_