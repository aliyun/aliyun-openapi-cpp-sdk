...
#ifndef ALIBABACLOUD_EMR_MODEL_CREATEONKUBECLUSTERREQUEST_H_
#define ALIBABACLOUD_EMR_MODEL_CREATEONKUBECLUSTERREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT CreateOnKubeClusterRequest : public RpcServiceRequest
			{

			public:
				CreateOnKubeClusterRequest();
				~CreateOnKubeClusterRequest();
...
#endif // !ALIBABACLOUD_EMR_MODEL_CREATEONKUBECLUSTERREQUEST_H_