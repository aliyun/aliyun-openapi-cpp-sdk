...
#ifndef ALIBABACLOUD_EMR_MODEL_LISTONKUBECLUSTERSREQUEST_H_
#define ALIBABACLOUD_EMR_MODEL_LISTONKUBECLUSTERSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT ListOnKubeClustersRequest : public RpcServiceRequest
			{

			public:
				ListOnKubeClustersRequest();
				~ListOnKubeClustersRequest();
				...
				Array getClusterStatuses()const;
				void setClusterStatuses(const Array& clusterStatuses);
...
#endif // !ALIBABACLOUD_EMR_MODEL_LISTONKUBECLUSTERSREQUEST_H_