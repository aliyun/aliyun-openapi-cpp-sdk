...
#ifndef ALIBABACLOUD_EMR_MODEL_LISTONKUBECLUSTERINSPECTIONRESULTSREQUEST_H_
#define ALIBABACLOUD_EMR_MODEL_LISTONKUBECLUSTERINSPECTIONRESULTSREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT ListOnKubeClusterInspectionResultsRequest : public RpcServiceRequest
			{

			public:
				ListOnKubeClusterInspectionResultsRequest();
				~ListOnKubeClusterInspectionResultsRequest();
...
#endif // !ALIBABACLOUD_EMR_MODEL_LISTONKUBECLUSTERINSPECTIONRESULTSREQUEST_H_