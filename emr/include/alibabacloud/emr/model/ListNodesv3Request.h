...
#ifndef ALIBABACLOUD_EMR_MODEL_LISTNODESV3REQUEST_H_
#define ALIBABACLOUD_EMR_MODEL_LISTNODESV3REQUEST_H_
...
namespace AlibabaCloud
{
	namespace Emr
	{
		namespace Model
		{
			class ALIBABACLOUD_EMR_EXPORT ListNodesv3Request : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_EMR_MODEL_LISTNODESV3REQUEST_H_