...
#include <alibabacloud/emr/model/MetastoreListDataResourcesRequest.h>

using AlibabaCloud::Emr::Model::MetastoreListDataResourcesRequest;

MetastoreListDataResourcesRequest::MetastoreListDataResourcesRequest() :
	RpcServiceRequest("emr", "2016-04-08", "MetastoreListDataResources")
{}

MetastoreListDataResourcesRequest::~MetastoreListDataResourcesRequest()
{}

long MetastoreListDataResourcesRequest::getResourceOwnerId()const
{
