...
#include <alibabacloud/emr/model/DescribeETLJobSqlSchemaRequest.h>

using AlibabaCloud::Emr::Model::DescribeETLJobSqlSchemaRequest;

DescribeETLJobSqlSchemaRequest::DescribeETLJobSqlSchemaRequest() :
	RpcServiceRequest("emr", "2016-04-08", "DescribeETLJobSqlSchema")
{}

DescribeETLJobSqlSchemaRequest::~DescribeETLJobSqlSchemaRequest()
{}

long DescribeETLJobSqlSchemaRequest::getResourceOwnerId()const
{
...
void DescribeETLJobSqlSchemaRequest::setResolveId(const std::string& resolveId)
{
	...
	setCoreParameter("ResolveId", std::to_string(resolveId));
}
