...
#include <alibabacloud/emr/model/CancelETLJobReleaseRequest.h>

using AlibabaCloud::Emr::Model::CancelETLJobReleaseRequest;

CancelETLJobReleaseRequest::CancelETLJobReleaseRequest() :
	RpcServiceRequest("emr", "2016-04-08", "CancelETLJobRelease")
{}

CancelETLJobReleaseRequest::~CancelETLJobReleaseRequest()
{}

long CancelETLJobReleaseRequest::getResourceOwnerId()const
{
