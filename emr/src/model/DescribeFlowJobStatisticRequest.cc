...
#include <alibabacloud/emr/model/DescribeFlowJobStatisticRequest.h>

using AlibabaCloud::Emr::Model::DescribeFlowJobStatisticRequest;

DescribeFlowJobStatisticRequest::DescribeFlowJobStatisticRequest() :
	RpcServiceRequest("emr", "2016-04-08", "DescribeFlowJobStatistic")
{}

DescribeFlowJobStatisticRequest::~DescribeFlowJobStatisticRequest()
{}

std::string DescribeFlowJobStatisticRequest::getFromApp()const
{
	return fromApp_;
}
