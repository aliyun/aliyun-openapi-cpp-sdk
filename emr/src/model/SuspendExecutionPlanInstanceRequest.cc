...
#include <alibabacloud/emr/model/SuspendExecutionPlanInstanceRequest.h>

using AlibabaCloud::Emr::Model::SuspendExecutionPlanInstanceRequest;

SuspendExecutionPlanInstanceRequest::SuspendExecutionPlanInstanceRequest() :
	RpcServiceRequest("emr", "2016-04-08", "SuspendExecutionPlanInstance")
{}

SuspendExecutionPlanInstanceRequest::~SuspendExecutionPlanInstanceRequest()
{}

long SuspendExecutionPlanInstanceRequest::getResourceOwnerId()const
{
