...
#include <alibabacloud/emr/model/DescribeHostPoolRequest.h>

using AlibabaCloud::Emr::Model::DescribeHostPoolRequest;

DescribeHostPoolRequest::DescribeHostPoolRequest() :
	RpcServiceRequest("emr", "2016-04-08", "DescribeHostPool")
{}

DescribeHostPoolRequest::~DescribeHostPoolRequest()
{}

long DescribeHostPoolRequest::getResourceOwnerId()const
{
	return resourceOwnerId_;
}

void DescribeHostPoolRequest::setResourceOwnerId(long resourceOwnerId)
{
	resourceOwnerId_ = resourceOwnerId;
	setCoreParameter("ResourceOwnerId", std::to_string(resourceOwnerId));
}

std::string DescribeHostPoolRequest::getRegionId()const
{
	return regionId_;
}
