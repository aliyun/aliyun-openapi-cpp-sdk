...
#include <alibabacloud/emr/model/ListSlsLogstoreInfoRequest.h>

using AlibabaCloud::Emr::Model::ListSlsLogstoreInfoRequest;

ListSlsLogstoreInfoRequest::ListSlsLogstoreInfoRequest() :
	RpcServiceRequest("emr", "2016-04-08", "ListSlsLogstoreInfo")
{}

ListSlsLogstoreInfoRequest::~ListSlsLogstoreInfoRequest()
{}

long ListSlsLogstoreInfoRequest::getResourceOwnerId()const
{
