...
#include <alibabacloud/emr/model/MetastoreListKafkaConsumerGroupRequest.h>

using AlibabaCloud::Emr::Model::MetastoreListKafkaConsumerGroupRequest;

MetastoreListKafkaConsumerGroupRequest::MetastoreListKafkaConsumerGroupRequest() :
	RpcServiceRequest("emr", "2016-04-08", "MetastoreListKafkaConsumerGroup")
{}

MetastoreListKafkaConsumerGroupRequest::~MetastoreListKafkaConsumerGroupRequest()
{}

long MetastoreListKafkaConsumerGroupRequest::getResourceOwnerId()const
{
