...
#include <alibabacloud/emr/model/DeleteETLJobRequest.h>

using AlibabaCloud::Emr::Model::DeleteETLJobRequest;

DeleteETLJobRequest::DeleteETLJobRequest() :
	RpcServiceRequest("emr", "2016-04-08", "DeleteETLJob")
{}

DeleteETLJobRequest::~DeleteETLJobRequest()
{}

long DeleteETLJobRequest::getResourceOwnerId()const
{
