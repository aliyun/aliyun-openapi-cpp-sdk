...
#include <alibabacloud/emr/model/DescribeDataSourceSchemaDatabaseRequest.h>

using AlibabaCloud::Emr::Model::DescribeDataSourceSchemaDatabaseRequest;

DescribeDataSourceSchemaDatabaseRequest::DescribeDataSourceSchemaDatabaseRequest() :
	RpcServiceRequest("emr", "2016-04-08", "DescribeDataSourceSchemaDatabase")
{}

DescribeDataSourceSchemaDatabaseRequest::~DescribeDataSourceSchemaDatabaseRequest()
{}

long DescribeDataSourceSchemaDatabaseRequest::getResourceOwnerId()const
{
