...
#include <alibabacloud/emr/model/DescribeETLJobStageOutputSchemaResult.h>
#include <json/json.h>

using namespace AlibabaCloud::Emr;
using namespace AlibabaCloud::Emr::Model;

DescribeETLJobStageOutputSchemaResult::DescribeETLJobStageOutputSchemaResult() :
	ServiceResult()
{}

DescribeETLJobStageOutputSchemaResult::DescribeETLJobStageOutputSchemaResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
DescribeETLJobStageOutputSchemaResult::Schema DescribeETLJobStageOutputSchemaResult::getSchema()const
{
	return schema_;
}
