...
#include <alibabacloud/emr/model/ListOpsOperationRequest.h>

using AlibabaCloud::Emr::Model::ListOpsOperationRequest;

ListOpsOperationRequest::ListOpsOperationRequest() :
	RpcServiceRequest("emr", "2016-04-08", "ListOpsOperation")
{}

ListOpsOperationRequest::~ListOpsOperationRequest()
{}

long ListOpsOperationRequest::getResourceOwnerId()const
{
