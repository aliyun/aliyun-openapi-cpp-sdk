...
#include <alibabacloud/emr/model/DescribeParagraphRequest.h>

using AlibabaCloud::Emr::Model::DescribeParagraphRequest;

DescribeParagraphRequest::DescribeParagraphRequest() :
	RpcServiceRequest("emr", "2016-04-08", "DescribeParagraph")
{}

DescribeParagraphRequest::~DescribeParagraphRequest()
{}

long DescribeParagraphRequest::getResourceOwnerId()const
{
