...
#include <alibabacloud/emr/model/CommonApiWhiteListRequest.h>

using AlibabaCloud::Emr::Model::CommonApiWhiteListRequest;

CommonApiWhiteListRequest::CommonApiWhiteListRequest() :
	RpcServiceRequest("emr", "2016-04-08", "CommonApiWhiteList")
{}

CommonApiWhiteListRequest::~CommonApiWhiteListRequest()
{}

long CommonApiWhiteListRequest::getResourceOwnerId()const
{
