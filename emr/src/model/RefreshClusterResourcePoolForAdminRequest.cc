...
#include <alibabacloud/emr/model/RefreshClusterResourcePoolForAdminRequest.h>

using AlibabaCloud::Emr::Model::RefreshClusterResourcePoolForAdminRequest;

RefreshClusterResourcePoolForAdminRequest::RefreshClusterResourcePoolForAdminRequest() :
	RpcServiceRequest("emr", "2016-04-08", "RefreshClusterResourcePoolForAdmin")
{}

RefreshClusterResourcePoolForAdminRequest::~RefreshClusterResourcePoolForAdminRequest()
{}

long RefreshClusterResourcePoolForAdminRequest::getResourceOwnerId()const
{
