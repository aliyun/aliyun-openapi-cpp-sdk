...
#include <alibabacloud/emr/model/DescribeAvailableInstanceTypeRequest.h>

using AlibabaCloud::Emr::Model::DescribeAvailableInstanceTypeRequest;

DescribeAvailableInstanceTypeRequest::DescribeAvailableInstanceTypeRequest() :
	RpcServiceRequest("emr", "2016-04-08", "DescribeAvailableInstanceType")
{}

DescribeAvailableInstanceTypeRequest::~DescribeAvailableInstanceTypeRequest()
{}

long DescribeAvailableInstanceTypeRequest::getResourceOwnerId()const
{
