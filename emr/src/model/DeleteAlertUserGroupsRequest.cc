...
#include <alibabacloud/emr/model/DeleteAlertUserGroupsRequest.h>

using AlibabaCloud::Emr::Model::DeleteAlertUserGroupsRequest;

DeleteAlertUserGroupsRequest::DeleteAlertUserGroupsRequest() :
	RpcServiceRequest("emr", "2016-04-08", "DeleteAlertUserGroups")
{}

DeleteAlertUserGroupsRequest::~DeleteAlertUserGroupsRequest()
{}

long DeleteAlertUserGroupsRequest::getResourceOwnerId()const
{
