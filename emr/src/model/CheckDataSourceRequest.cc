...
#include <alibabacloud/emr/model/CheckDataSourceRequest.h>

using AlibabaCloud::Emr::Model::CheckDataSourceRequest;

CheckDataSourceRequest::CheckDataSourceRequest() :
	RpcServiceRequest("emr", "2016-04-08", "CheckDataSource")
{}

CheckDataSourceRequest::~CheckDataSourceRequest()
{}

long CheckDataSourceRequest::getResourceOwnerId()const
{
