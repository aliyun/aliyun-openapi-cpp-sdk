...
#include <alibabacloud/emr/model/ListJobExecutionInstanceTrendRequest.h>

using AlibabaCloud::Emr::Model::ListJobExecutionInstanceTrendRequest;

ListJobExecutionInstanceTrendRequest::ListJobExecutionInstanceTrendRequest() :
	RpcServiceRequest("emr", "2016-04-08", "ListJobExecutionInstanceTrend")
{}

ListJobExecutionInstanceTrendRequest::~ListJobExecutionInstanceTrendRequest()
{}

long ListJobExecutionInstanceTrendRequest::getResourceOwnerId()const
{
