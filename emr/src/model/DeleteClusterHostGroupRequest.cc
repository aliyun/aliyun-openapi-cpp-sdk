...
#include <alibabacloud/emr/model/DeleteClusterHostGroupRequest.h>

using AlibabaCloud::Emr::Model::DeleteClusterHostGroupRequest;

DeleteClusterHostGroupRequest::DeleteClusterHostGroupRequest() :
	RpcServiceRequest("emr", "2016-04-08", "DeleteClusterHostGroup")
{}

DeleteClusterHostGroupRequest::~DeleteClusterHostGroupRequest()
{}

long DeleteClusterHostGroupRequest::getResourceOwnerId()const
{
