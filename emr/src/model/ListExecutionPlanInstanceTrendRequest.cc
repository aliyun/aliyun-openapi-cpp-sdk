...
#include <alibabacloud/emr/model/ListExecutionPlanInstanceTrendRequest.h>

using AlibabaCloud::Emr::Model::ListExecutionPlanInstanceTrendRequest;

ListExecutionPlanInstanceTrendRequest::ListExecutionPlanInstanceTrendRequest() :
	RpcServiceRequest("emr", "2016-04-08", "ListExecutionPlanInstanceTrend")
{}

ListExecutionPlanInstanceTrendRequest::~ListExecutionPlanInstanceTrendRequest()
{}

long ListExecutionPlanInstanceTrendRequest::getResourceOwnerId()const
{
