...
#ifndef ALIBABACLOUD_DMS_ENTERPRISE_MODEL_PUBLISHANDDEPLOYTASKFLOWREQUEST_H_
...
namespace Model {
class ALIBABACLOUD_DMS_ENTERPRISE_EXPORT PublishAndDeployTaskFlowRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_DMS_ENTERPRISE_MODEL_PUBLISHANDDEPLOYTASKFLOWREQUEST_H_
