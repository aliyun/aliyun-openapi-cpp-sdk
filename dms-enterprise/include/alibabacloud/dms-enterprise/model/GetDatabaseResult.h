...
#ifndef ALIBABACLOUD_DMS_ENTERPRISE_MODEL_GETDATABASERESULT_H_
...
namespace AlibabaCloud
{
	namespace Dms_enterprise
	{
		namespace Model
		{
			class ALIBABACLOUD_DMS_ENTERPRISE_EXPORT GetDatabaseResult : public ServiceResult
			{
			public:
				struct Database
				{
...
#endif // !ALIBABACLOUD_DMS_ENTERPRISE_MODEL_GETDATABASERESULT_H_