...
GetStandardGroupResult::GetStandardGroupResult() :
	ServiceResult()
{}

GetStandardGroupResult::GetStandardGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetStandardGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
GetStandardGroupResult::StandardGroup GetStandardGroupResult::getStandardGroup()const
{
	return standardGroup_;
}

std::string GetStandardGroupResult::getErrorCode()const
{
	return errorCode_;
}

std::string GetStandardGroupResult::getErrorMessage()const
{
	return errorMessage_;
}

bool GetStandardGroupResult::getSuccess()const
{
	return success_;
}
