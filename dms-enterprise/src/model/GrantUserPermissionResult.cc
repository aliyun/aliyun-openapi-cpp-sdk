...
std::string GrantUserPermissionResult::getErrorCode()const
{
	return errorCode_;
}

std::string GrantUserPermissionResult::getErrorMessage()const
{
	return errorMessage_;
}

bool GrantUserPermissionResult::getSuccess()const
{
	return success_;
}
