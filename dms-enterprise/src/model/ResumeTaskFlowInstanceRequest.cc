...
using AlibabaCloud::Dms_enterprise::Model::ResumeTaskFlowInstanceRequest;

ResumeTaskFlowInstanceRequest::ResumeTaskFlowInstanceRequest()
    : RpcServiceRequest("dms-enterprise", "2018-11-01", "ResumeTaskFlowInstance") {
...
void ResumeTaskFlowInstanceRequest::setDagId(long dagId) {
  dagId_ = dagId;
  setParameter(std::string("DagId"), std::to_string(dagId));
}

long ResumeTaskFlowInstanceRequest::getTid() const {
  return tid_;
}
...
void ResumeTaskFlowInstanceRequest::setDagInstanceId(long dagInstanceId) {
