...
using AlibabaCloud::Dms_enterprise::Model::PublishAndDeployTaskFlowRequest;

PublishAndDeployTaskFlowRequest::PublishAndDeployTaskFlowRequest()
    : RpcServiceRequest("dms-enterprise", "2018-11-01", "PublishAndDeployTaskFlow") {
...
void PublishAndDeployTaskFlowRequest::setDagId(long dagId) {
  dagId_ = dagId;
  setParameter(std::string("DagId"), std::to_string(dagId));
}

long PublishAndDeployTaskFlowRequest::getTid() const {
  return tid_;
}
