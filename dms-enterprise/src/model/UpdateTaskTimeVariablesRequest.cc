...
#include <alibabacloud/dms-enterprise/model/UpdateTaskTimeVariablesRequest.h>

using AlibabaCloud::Dms_enterprise::Model::UpdateTaskTimeVariablesRequest;

UpdateTaskTimeVariablesRequest::UpdateTaskTimeVariablesRequest()
    : RpcServiceRequest("dms-enterprise", "2018-11-01", "UpdateTaskTimeVariables") {
...
void UpdateTaskTimeVariablesRequest::setTid(long tid) {
  tid_ = tid;
  setParameter(std::string("Tid"), std::to_string(tid));
}

std::string UpdateTaskTimeVariablesRequest::getNodeId() const {
  return nodeId_;
}
