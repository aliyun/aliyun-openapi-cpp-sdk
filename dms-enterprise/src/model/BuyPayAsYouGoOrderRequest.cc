...
#include <alibabacloud/dms-enterprise/model/BuyPayAsYouGoOrderRequest.h>

using AlibabaCloud::Dms_enterprise::Model::BuyPayAsYouGoOrderRequest;

BuyPayAsYouGoOrderRequest::BuyPayAsYouGoOrderRequest()
    : RpcServiceRequest("dms-enterprise", "2018-11-01", "BuyPayAsYouGoOrder") {
...
void BuyPayAsYouGoOrderRequest::setTid(long tid) {
  tid_ = tid;
