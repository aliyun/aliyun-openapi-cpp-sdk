...
#include <alibabacloud/dms-enterprise/model/CreateTaskResult.h>
#include <json/json.h>
...
long CreateTaskResult::getNodeId()const
{
	return nodeId_;
}
...
std::string CreateTaskResult::getErrorMessage()const
{
	return errorMessage_;
}

bool CreateTaskResult::getSuccess()const
{
	return success_;
}
