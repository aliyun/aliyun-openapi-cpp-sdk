...
GetConnectionResult::GetConnectionResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetConnectionResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
int GetConnectionResult::getHttpCode()const
{
	return httpCode_;
}

std::string GetConnectionResult::getMessage()const
{
	return message_;
}

GetConnectionResult::Data GetConnectionResult::getData()const
{
	return data_;
}

std::string GetConnectionResult::getCode()const
{
	return code_;
}
