...
using AlibabaCloud::Eventbridge::Model::UpdateEventStreamingRequest;

UpdateEventStreamingRequest::UpdateEventStreamingRequest()
    : RpcServiceRequest("eventbridge", "2020-04-01", "UpdateEventStreaming") {
  setMethod(HttpRequest::Method::Post);
}

UpdateEventStreamingRequest::~UpdateEventStreamingRequest() {}

UpdateEventStreamingRequest::Sink UpdateEventStreamingRequest::getSink() const {
  return sink_;
}

void UpdateEventStreamingRequest::setSink(const UpdateEventStreamingRequest::Sink &sink) {
  sink_ = sink;
...
std::vector<UpdateEventStreamingRequest::Transforms> UpdateEventStreamingRequest::getTransforms() const {
  return transforms_;
}

void UpdateEventStreamingRequest::setTransforms(const std::vector<UpdateEventStreamingRequest::Transforms> &transforms) {
...
std::string UpdateEventStreamingRequest::getDescription() const {
  return description_;
}

void UpdateEventStreamingRequest::setDescription(const std::string &description) {
  description_ = description;
  setBodyParameter(std::string("Description"), description);
}

std::string UpdateEventStreamingRequest::getFilterPattern() const {
  return filterPattern_;
}

void UpdateEventStreamingRequest::setFilterPattern(const std::string &filterPattern) {
  filterPattern_ = filterPattern;
  setBodyParameter(std::string("FilterPattern"), filterPattern);
}

UpdateEventStreamingRequest::Source UpdateEventStreamingRequest::getSource() const {
  return source_;
}

void UpdateEventStreamingRequest::setSource(const UpdateEventStreamingRequest::Source &source) {
  source_ = source;
...
UpdateEventStreamingRequest::RunOptions UpdateEventStreamingRequest::getRunOptions() const {
  return runOptions_;
}

void UpdateEventStreamingRequest::setRunOptions(const UpdateEventStreamingRequest::RunOptions &runOptions) {
...
std::string UpdateEventStreamingRequest::getEventStreamingName() const {
  return eventStreamingName_;
}

void UpdateEventStreamingRequest::setEventStreamingName(const std::string &eventStreamingName) {
  eventStreamingName_ = eventStreamingName;
  setBodyParameter(std::string("EventStreamingName"), eventStreamingName);
}

std::string UpdateEventStreamingRequest::getTag() const {
  return tag_;
}

void UpdateEventStreamingRequest::setTag(const std::string &tag) {
  tag_ = tag;
