...
DeleteTargetsResult::DeleteTargetsResult() :
	ServiceResult()
{}

DeleteTargetsResult::DeleteTargetsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DeleteTargetsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DeleteTargetsResult::getMessage()const
{
	return message_;
}

DeleteTargetsResult::Data DeleteTargetsResult::getData()const
{
	return data_;
}

std::string DeleteTargetsResult::getCode()const
{
	return code_;
}

bool DeleteTargetsResult::getSuccess()const
{
	return success_;
}
