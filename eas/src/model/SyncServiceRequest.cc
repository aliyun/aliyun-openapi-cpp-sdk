...
using AlibabaCloud::Eas::Model::SyncServiceRequest;
...
std::string SyncServiceRequest::getService_name()const
{
	return service_name_;
}

void SyncServiceRequest::setService_name(const std::string& service_name)
{
	service_name_ = service_name;
	setParameter("Service_name", service_name);
}

std::string SyncServiceRequest::getRegion()const
{
	return region_;
}
