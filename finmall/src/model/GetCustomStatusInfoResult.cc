...
GetCustomStatusInfoResult::GetCustomStatusInfoResult() :
	ServiceResult()
{}

GetCustomStatusInfoResult::GetCustomStatusInfoResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetCustomStatusInfoResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetCustomStatusInfoResult::getMessage()const
{
	return message_;
}

GetCustomStatusInfoResult::Data GetCustomStatusInfoResult::getData()const
{
	return data_;
}

std::string GetCustomStatusInfoResult::getCode()const
{
	return code_;
}
