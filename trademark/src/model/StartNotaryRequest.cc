...
using AlibabaCloud::Trademark::Model::StartNotaryRequest;
...
long StartNotaryRequest::getNotaryOrderId()const
{
	return notaryOrderId_;
}

void StartNotaryRequest::setNotaryOrderId(long notaryOrderId)
{
