...
using AlibabaCloud::Trademark::Model::QueryTradeMarkApplicationsByIntentionRequest;
...
std::string QueryTradeMarkApplicationsByIntentionRequest::getChannel()const
{
	return channel_;
}
