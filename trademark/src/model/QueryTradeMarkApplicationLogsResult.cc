...
QueryTradeMarkApplicationLogsResult::QueryTradeMarkApplicationLogsResult() :
	ServiceResult()
{}

QueryTradeMarkApplicationLogsResult::QueryTradeMarkApplicationLogsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryTradeMarkApplicationLogsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<QueryTradeMarkApplicationLogsResult::DataItem> QueryTradeMarkApplicationLogsResult::getData()const
{
	return data_;
}
