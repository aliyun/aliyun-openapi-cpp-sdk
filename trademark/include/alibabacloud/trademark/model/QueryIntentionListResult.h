...
#ifndef ALIBABACLOUD_TRADEMARK_MODEL_QUERYINTENTIONLISTRESULT_H_
#define ALIBABACLOUD_TRADEMARK_MODEL_QUERYINTENTIONLISTRESULT_H_
...
namespace AlibabaCloud
{
	namespace Trademark
	{
		namespace Model
		{
			class ALIBABACLOUD_TRADEMARK_EXPORT QueryIntentionListResult : public ServiceResult
			{
			public:
				struct Intention
				{
...
#endif // !ALIBABACLOUD_TRADEMARK_MODEL_QUERYINTENTIONLISTRESULT_H_