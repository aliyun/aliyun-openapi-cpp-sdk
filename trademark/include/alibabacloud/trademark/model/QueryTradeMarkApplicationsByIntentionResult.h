...
#ifndef ALIBABACLOUD_TRADEMARK_MODEL_QUERYTRADEMARKAPPLICATIONSBYINTENTIONRESULT_H_
#define ALIBABACLOUD_TRADEMARK_MODEL_QUERYTRADEMARKAPPLICATIONSBYINTENTIONRESULT_H_
...
namespace AlibabaCloud
{
	namespace Trademark
	{
		namespace Model
		{
			class ALIBABACLOUD_TRADEMARK_EXPORT QueryTradeMarkApplicationsByIntentionResult : public ServiceResult
			{
			public:
				struct TmProduces
				{
				...
				explicit QueryTradeMarkApplicationsByIntentionResult(const std::string &payload);
				~QueryTradeMarkApplicationsByIntentionResult();
...
#endif // !ALIBABACLOUD_TRADEMARK_MODEL_QUERYTRADEMARKAPPLICATIONSBYINTENTIONRESULT_H_