...
#ifndef ALIBABACLOUD_SCDN_MODEL_SETDOMAINSERVERCERTIFICATEREQUEST_H_
#define ALIBABACLOUD_SCDN_MODEL_SETDOMAINSERVERCERTIFICATEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Scdn
	{
		namespace Model
		{
			class ALIBABACLOUD_SCDN_EXPORT SetDomainServerCertificateRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_SCDN_MODEL_SETDOMAINSERVERCERTIFICATEREQUEST_H_