...
#ifndef ALIBABACLOUD_SCDN_MODEL_DESCRIBESCDNDOMAINTOPURLVISITRESULT_H_
#define ALIBABACLOUD_SCDN_MODEL_DESCRIBESCDNDOMAINTOPURLVISITRESULT_H_
...
namespace AlibabaCloud
{
	namespace Scdn
	{
		namespace Model
		{
			class ALIBABACLOUD_SCDN_EXPORT DescribeScdnDomainTopUrlVisitResult : public ServiceResult
			{
			public:
				struct UrlList
				{
				...
				DescribeScdnDomainTopUrlVisitResult();
				explicit DescribeScdnDomainTopUrlVisitResult(const std::string &payload);
				~DescribeScdnDomainTopUrlVisitResult();
...
#endif // !ALIBABACLOUD_SCDN_MODEL_DESCRIBESCDNDOMAINTOPURLVISITRESULT_H_