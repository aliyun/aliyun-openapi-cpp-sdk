...
DescribeScdnDomainTopReferVisitResult::DescribeScdnDomainTopReferVisitResult() :
	ServiceResult()
{}

DescribeScdnDomainTopReferVisitResult::DescribeScdnDomainTopReferVisitResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeScdnDomainTopReferVisitResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string DescribeScdnDomainTopReferVisitResult::getDomainName()const
{
	return domainName_;
}

std::string DescribeScdnDomainTopReferVisitResult::getStartTime()const
{
	return startTime_;
}

std::vector<DescribeScdnDomainTopReferVisitResult::ReferList> DescribeScdnDomainTopReferVisitResult::getTopReferList()const
{
