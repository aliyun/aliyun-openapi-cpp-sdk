...
TestAmpDescribeScdnDomainIspDataResult::TestAmpDescribeScdnDomainIspDataResult() :
	ServiceResult()
{}

TestAmpDescribeScdnDomainIspDataResult::TestAmpDescribeScdnDomainIspDataResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void TestAmpDescribeScdnDomainIspDataResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string TestAmpDescribeScdnDomainIspDataResult::getEndTime()const
{
	return endTime_;
}

std::string TestAmpDescribeScdnDomainIspDataResult::getDomainName()const
{
	return domainName_;
}

std::vector<TestAmpDescribeScdnDomainIspDataResult::ISPProportionData> TestAmpDescribeScdnDomainIspDataResult::getValue()const
{
	return value_;
}

std::string TestAmpDescribeScdnDomainIspDataResult::getStartTime()const
{
	return startTime_;
}

std::string TestAmpDescribeScdnDomainIspDataResult::getDataInterval()const
{
