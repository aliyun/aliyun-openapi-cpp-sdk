...
std::string DescribeScdnDomainTopUrlVisitRequest::getAccessKeyId()const
{
	return accessKeyId_;
}

void DescribeScdnDomainTopUrlVisitRequest::setAccessKeyId(const std::string& accessKeyId)
{
