...
std::string BatchDeleteScdnDomainConfigsRequest::getAccessKeyId()const
{
	return accessKeyId_;
}

void BatchDeleteScdnDomainConfigsRequest::setAccessKeyId(const std::string& accessKeyId)
{
