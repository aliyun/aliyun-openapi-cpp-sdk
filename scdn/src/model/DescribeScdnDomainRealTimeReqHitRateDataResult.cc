...
DescribeScdnDomainRealTimeReqHitRateDataResult::DescribeScdnDomainRealTimeReqHitRateDataResult() :
	ServiceResult()
{}

DescribeScdnDomainRealTimeReqHitRateDataResult::DescribeScdnDomainRealTimeReqHitRateDataResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeScdnDomainRealTimeReqHitRateDataResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeScdnDomainRealTimeReqHitRateDataResult::ReqHitRateDataModel> DescribeScdnDomainRealTimeReqHitRateDataResult::getData()const
{
	return data_;
}
