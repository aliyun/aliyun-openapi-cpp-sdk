	...
	for (auto value : allDataPerInterval)
	{
		...
		for (auto value : allHttpCodeDataPerInterval)
		{
			...
			if(!value["Code"].isNull())
				httpCodeDataPerIntervalObject.code = value["Code"].asString();
			if(!value["Proportion"].isNull())
				httpCodeDataPerIntervalObject.proportion = value["Proportion"].asString();
			if(!value["Count"].isNull())
				httpCodeDataPerIntervalObject.count = value["Count"].asString();
