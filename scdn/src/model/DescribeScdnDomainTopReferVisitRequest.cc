...
std::string DescribeScdnDomainTopReferVisitRequest::getAccessKeyId()const
{
	return accessKeyId_;
}

void DescribeScdnDomainTopReferVisitRequest::setAccessKeyId(const std::string& accessKeyId)
{
