...
UpdateControlPolicyResult::UpdateControlPolicyResult() :
	ServiceResult()
{}

UpdateControlPolicyResult::UpdateControlPolicyResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateControlPolicyResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
UpdateControlPolicyResult::ControlPolicy UpdateControlPolicyResult::getControlPolicy()const
{
