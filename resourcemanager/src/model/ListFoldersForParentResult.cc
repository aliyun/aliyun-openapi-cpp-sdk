...
ListFoldersForParentResult::ListFoldersForParentResult() :
	ServiceResult()
{}

ListFoldersForParentResult::ListFoldersForParentResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListFoldersForParentResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
int ListFoldersForParentResult::getTotalCount()const
{
	return totalCount_;
}

int ListFoldersForParentResult::getPageSize()const
{
	return pageSize_;
}

int ListFoldersForParentResult::getPageNumber()const
{
	return pageNumber_;
}

std::vector<ListFoldersForParentResult::Folder> ListFoldersForParentResult::getFolders()const
{
	return folders_;
}
