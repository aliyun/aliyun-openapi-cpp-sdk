...
PromoteResourceAccountResult::PromoteResourceAccountResult() :
	ServiceResult()
{}

PromoteResourceAccountResult::PromoteResourceAccountResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void PromoteResourceAccountResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
PromoteResourceAccountResult::Account PromoteResourceAccountResult::getAccount()const
{
	return account_;
}
