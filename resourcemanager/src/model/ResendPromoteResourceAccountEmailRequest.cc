...
using AlibabaCloud::ResourceManager::Model::ResendPromoteResourceAccountEmailRequest;
...
std::string ResendPromoteResourceAccountEmailRequest::getRecordId() const {
  return recordId_;
}

void ResendPromoteResourceAccountEmailRequest::setRecordId(const std::string &recordId) {
  recordId_ = recordId;
