...
ListHandshakesForResourceDirectoryResult::ListHandshakesForResourceDirectoryResult() :
	ServiceResult()
{}

ListHandshakesForResourceDirectoryResult::ListHandshakesForResourceDirectoryResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ListHandshakesForResourceDirectoryResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
int ListHandshakesForResourceDirectoryResult::getTotalCount()const
{
	return totalCount_;
}

int ListHandshakesForResourceDirectoryResult::getPageSize()const
{
	return pageSize_;
}

int ListHandshakesForResourceDirectoryResult::getPageNumber()const
{
	return pageNumber_;
}

std::vector<ListHandshakesForResourceDirectoryResult::Handshake> ListHandshakesForResourceDirectoryResult::getHandshakes()const
{
	return handshakes_;
}
