...
ResendCreateCloudAccountEmailResult::ResendCreateCloudAccountEmailResult() :
	ServiceResult()
{}

ResendCreateCloudAccountEmailResult::ResendCreateCloudAccountEmailResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void ResendCreateCloudAccountEmailResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
ResendCreateCloudAccountEmailResult::Account ResendCreateCloudAccountEmailResult::getAccount()const
{
	return account_;
}
