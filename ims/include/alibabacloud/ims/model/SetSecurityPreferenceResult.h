...
#ifndef ALIBABACLOUD_IMS_MODEL_SETSECURITYPREFERENCERESULT_H_
#define ALIBABACLOUD_IMS_MODEL_SETSECURITYPREFERENCERESULT_H_
...
namespace AlibabaCloud
{
	namespace Ims
	{
		namespace Model
		{
			class ALIBABACLOUD_IMS_EXPORT SetSecurityPreferenceResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_SETSECURITYPREFERENCERESULT_H_