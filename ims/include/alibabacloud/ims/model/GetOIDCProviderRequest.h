...
#ifndef ALIBABACLOUD_IMS_MODEL_GETOIDCPROVIDERREQUEST_H_
#define ALIBABACLOUD_IMS_MODEL_GETOIDCPROVIDERREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT GetOIDCProviderRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_GETOIDCPROVIDERREQUEST_H_
