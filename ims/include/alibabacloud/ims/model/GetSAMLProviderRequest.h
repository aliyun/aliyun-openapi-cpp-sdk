...
#ifndef ALIBABACLOUD_IMS_MODEL_GETSAMLPROVIDERREQUEST_H_
#define ALIBABACLOUD_IMS_MODEL_GETSAMLPROVIDERREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT GetSAMLProviderRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_GETSAMLPROVIDERREQUEST_H_
