...
#ifndef ALIBABACLOUD_IMS_MODEL_REMOVEFINGERPRINTFROMOIDCPROVIDERREQUEST_H_
#define ALIBABACLOUD_IMS_MODEL_REMOVEFINGERPRINTFROMOIDCPROVIDERREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT RemoveFingerprintFromOIDCProviderRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_REMOVEFINGERPRINTFROMOIDCPROVIDERREQUEST_H_
