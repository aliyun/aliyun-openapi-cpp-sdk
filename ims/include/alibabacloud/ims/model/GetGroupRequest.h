...
#ifndef ALIBABACLOUD_IMS_MODEL_GETGROUPREQUEST_H_
#define ALIBABACLOUD_IMS_MODEL_GETGROUPREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT GetGroupRequest : public RpcServiceRequest {
public:
	GetGroupRequest();
	~GetGroupRequest();
...
#endif // !ALIBABACLOUD_IMS_MODEL_GETGROUPREQUEST_H_
