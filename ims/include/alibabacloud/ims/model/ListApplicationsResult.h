...
#ifndef ALIBABACLOUD_IMS_MODEL_LISTAPPLICATIONSRESULT_H_
#define ALIBABACLOUD_IMS_MODEL_LISTAPPLICATIONSRESULT_H_
...
namespace AlibabaCloud
{
	namespace Ims
	{
		namespace Model
		{
			class ALIBABACLOUD_IMS_EXPORT ListApplicationsResult : public ServiceResult
			{
			public:
				struct Application
				{
...
#endif // !ALIBABACLOUD_IMS_MODEL_LISTAPPLICATIONSRESULT_H_