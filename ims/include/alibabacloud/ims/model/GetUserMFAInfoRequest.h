...
#ifndef ALIBABACLOUD_IMS_MODEL_GETUSERMFAINFOREQUEST_H_
#define ALIBABACLOUD_IMS_MODEL_GETUSERMFAINFOREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT GetUserMFAInfoRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_GETUSERMFAINFOREQUEST_H_
