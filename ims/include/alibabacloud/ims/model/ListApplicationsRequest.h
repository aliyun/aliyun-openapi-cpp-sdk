...
#ifndef ALIBABACLOUD_IMS_MODEL_LISTAPPLICATIONSREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT ListApplicationsRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_LISTAPPLICATIONSREQUEST_H_
