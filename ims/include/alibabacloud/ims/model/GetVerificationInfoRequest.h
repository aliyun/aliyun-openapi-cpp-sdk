...
#ifndef ALIBABACLOUD_IMS_MODEL_GETVERIFICATIONINFOREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT GetVerificationInfoRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_GETVERIFICATIONINFOREQUEST_H_
