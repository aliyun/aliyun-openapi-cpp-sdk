...
#ifndef ALIBABACLOUD_IMS_MODEL_REMOVECLIENTIDFROMOIDCPROVIDERREQUEST_H_
#define ALIBABACLOUD_IMS_MODEL_REMOVECLIENTIDFROMOIDCPROVIDERREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT RemoveClientIdFromOIDCProviderRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_REMOVECLIENTIDFROMOIDCPROVIDERREQUEST_H_
