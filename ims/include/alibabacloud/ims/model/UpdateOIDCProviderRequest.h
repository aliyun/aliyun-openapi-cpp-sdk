...
#ifndef ALIBABACLOUD_IMS_MODEL_UPDATEOIDCPROVIDERREQUEST_H_
#define ALIBABACLOUD_IMS_MODEL_UPDATEOIDCPROVIDERREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT UpdateOIDCProviderRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_UPDATEOIDCPROVIDERREQUEST_H_
