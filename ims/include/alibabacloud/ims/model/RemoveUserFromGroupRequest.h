...
#ifndef ALIBABACLOUD_IMS_MODEL_REMOVEUSERFROMGROUPREQUEST_H_
#define ALIBABACLOUD_IMS_MODEL_REMOVEUSERFROMGROUPREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT RemoveUserFromGroupRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_REMOVEUSERFROMGROUPREQUEST_H_
