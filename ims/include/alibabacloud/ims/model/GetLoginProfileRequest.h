...
#ifndef ALIBABACLOUD_IMS_MODEL_GETLOGINPROFILEREQUEST_H_
#define ALIBABACLOUD_IMS_MODEL_GETLOGINPROFILEREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT GetLoginProfileRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_GETLOGINPROFILEREQUEST_H_
