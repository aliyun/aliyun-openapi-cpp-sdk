...
#ifndef ALIBABACLOUD_IMS_MODEL_UNBINDMFADEVICEREQUEST_H_
#define ALIBABACLOUD_IMS_MODEL_UNBINDMFADEVICEREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT UnbindMFADeviceRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_UNBINDMFADEVICEREQUEST_H_
