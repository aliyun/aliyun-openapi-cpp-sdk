...
#ifndef ALIBABACLOUD_IMS_MODEL_LISTGROUPSFORUSERREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT ListGroupsForUserRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_LISTGROUPSFORUSERREQUEST_H_
