...
#ifndef ALIBABACLOUD_IMS_MODEL_LISTUSERSFORGROUPREQUEST_H_
#define ALIBABACLOUD_IMS_MODEL_LISTUSERSFORGROUPREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT ListUsersForGroupRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_LISTUSERSFORGROUPREQUEST_H_
