...
#ifndef ALIBABACLOUD_IMS_MODEL_UPDATELOGINPROFILEREQUEST_H_
#define ALIBABACLOUD_IMS_MODEL_UPDATELOGINPROFILEREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT UpdateLoginProfileRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_UPDATELOGINPROFILEREQUEST_H_
