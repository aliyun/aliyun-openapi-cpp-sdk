...
#ifndef ALIBABACLOUD_IMS_MODEL_GETPASSWORDPOLICYRESULT_H_
#define ALIBABACLOUD_IMS_MODEL_GETPASSWORDPOLICYRESULT_H_
...
namespace AlibabaCloud
{
	namespace Ims
	{
		namespace Model
		{
			class ALIBABACLOUD_IMS_EXPORT GetPasswordPolicyResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_GETPASSWORDPOLICYRESULT_H_