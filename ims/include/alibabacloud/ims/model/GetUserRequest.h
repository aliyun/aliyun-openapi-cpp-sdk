...
#ifndef ALIBABACLOUD_IMS_MODEL_GETUSERREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT GetUserRequest : public RpcServiceRequest {
public:
	GetUserRequest();
	~GetUserRequest();
...
#endif // !ALIBABACLOUD_IMS_MODEL_GETUSERREQUEST_H_
