...
#ifndef ALIBABACLOUD_IMS_MODEL_UPDATEACCESSKEYREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT UpdateAccessKeyRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_UPDATEACCESSKEYREQUEST_H_
