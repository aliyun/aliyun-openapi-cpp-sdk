...
#ifndef ALIBABACLOUD_IMS_MODEL_LISTVIRTUALMFADEVICESRESULT_H_
#define ALIBABACLOUD_IMS_MODEL_LISTVIRTUALMFADEVICESRESULT_H_
...
namespace AlibabaCloud
{
	namespace Ims
	{
		namespace Model
		{
			class ALIBABACLOUD_IMS_EXPORT ListVirtualMFADevicesResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_IMS_MODEL_LISTVIRTUALMFADEVICESRESULT_H_