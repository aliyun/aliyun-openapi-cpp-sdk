...
#ifndef ALIBABACLOUD_IMS_MODEL_UPDATEGROUPREQUEST_H_
#define ALIBABACLOUD_IMS_MODEL_UPDATEGROUPREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT UpdateGroupRequest : public RpcServiceRequest {
public:
	UpdateGroupRequest();
	~UpdateGroupRequest();
	std::string getAkProxySuffix() const;
	void setAkProxySuffix(const std::string &akProxySuffix);
	std::string getNewGroupPrincipalName() const;
	void setNewGroupPrincipalName(const std::string &newGroupPrincipalName);
...
private:
	...
	std::string newGroupPrincipalName_;
...
#endif // !ALIBABACLOUD_IMS_MODEL_UPDATEGROUPREQUEST_H_
