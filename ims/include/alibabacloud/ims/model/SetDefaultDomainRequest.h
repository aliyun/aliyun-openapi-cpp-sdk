...
#ifndef ALIBABACLOUD_IMS_MODEL_SETDEFAULTDOMAINREQUEST_H_
...
namespace Ims {
namespace Model {
class ALIBABACLOUD_IMS_EXPORT SetDefaultDomainRequest : public RpcServiceRequest {
public:
	...
	void setDefaultDomainName(const std::string &defaultDomainName);
...
#endif // !ALIBABACLOUD_IMS_MODEL_SETDEFAULTDOMAINREQUEST_H_
