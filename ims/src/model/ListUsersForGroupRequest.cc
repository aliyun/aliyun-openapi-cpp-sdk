...
using AlibabaCloud::Ims::Model::ListUsersForGroupRequest;

ListUsersForGroupRequest::ListUsersForGroupRequest()
    : RpcServiceRequest("ims", "2019-08-15", "ListUsersForGroup") {
  setMethod(HttpRequest::Method::Post);
}

ListUsersForGroupRequest::~ListUsersForGroupRequest() {}

std::string ListUsersForGroupRequest::getAkProxySuffix() const {
  return akProxySuffix_;
}

void ListUsersForGroupRequest::setAkProxySuffix(const std::string &akProxySuffix) {
...
std::string ListUsersForGroupRequest::getGroupPrincipalName() const {
  return groupPrincipalName_;
}

void ListUsersForGroupRequest::setGroupPrincipalName(const std::string &groupPrincipalName) {
