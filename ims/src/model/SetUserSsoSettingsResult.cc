...
SetUserSsoSettingsResult::SetUserSsoSettingsResult() :
	ServiceResult()
{}

SetUserSsoSettingsResult::SetUserSsoSettingsResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void SetUserSsoSettingsResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
SetUserSsoSettingsResult::UserSsoSettings SetUserSsoSettingsResult::getUserSsoSettings()const
{
