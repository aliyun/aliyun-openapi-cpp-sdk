...
RemoveClientIdFromOIDCProviderResult::RemoveClientIdFromOIDCProviderResult() :
	ServiceResult()
{}

RemoveClientIdFromOIDCProviderResult::RemoveClientIdFromOIDCProviderResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RemoveClientIdFromOIDCProviderResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
RemoveClientIdFromOIDCProviderResult::OIDCProvider RemoveClientIdFromOIDCProviderResult::getOIDCProvider()const
{
