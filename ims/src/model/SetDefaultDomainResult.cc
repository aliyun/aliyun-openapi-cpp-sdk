...
SetDefaultDomainResult::SetDefaultDomainResult() :
	ServiceResult()
{}

SetDefaultDomainResult::SetDefaultDomainResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void SetDefaultDomainResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string SetDefaultDomainResult::getDefaultDomainName()const
{
