...
UpdateOIDCProviderResult::UpdateOIDCProviderResult() :
	ServiceResult()
{}

UpdateOIDCProviderResult::UpdateOIDCProviderResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateOIDCProviderResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
UpdateOIDCProviderResult::OIDCProvider UpdateOIDCProviderResult::getOIDCProvider()const
{
