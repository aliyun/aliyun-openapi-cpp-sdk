...
UpdateLoginProfileResult::UpdateLoginProfileResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
UpdateLoginProfileResult::LoginProfile UpdateLoginProfileResult::getLoginProfile()const
{
