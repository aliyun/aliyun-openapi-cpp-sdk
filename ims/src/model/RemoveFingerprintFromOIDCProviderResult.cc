...
RemoveFingerprintFromOIDCProviderResult::RemoveFingerprintFromOIDCProviderResult() :
	ServiceResult()
{}

RemoveFingerprintFromOIDCProviderResult::RemoveFingerprintFromOIDCProviderResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void RemoveFingerprintFromOIDCProviderResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
RemoveFingerprintFromOIDCProviderResult::OIDCProvider RemoveFingerprintFromOIDCProviderResult::getOIDCProvider()const
{
