...
UnbindMFADeviceResult::UnbindMFADeviceResult() :
	ServiceResult()
{}

UnbindMFADeviceResult::UnbindMFADeviceResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
UnbindMFADeviceResult::MFADevice UnbindMFADeviceResult::getMFADevice()const
{
	return mFADevice_;
}
