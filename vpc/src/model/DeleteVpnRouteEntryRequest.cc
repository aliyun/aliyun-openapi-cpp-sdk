...
#include <alibabacloud/vpc/model/DeleteVpnRouteEntryRequest.h>

using AlibabaCloud::Vpc::Model::DeleteVpnRouteEntryRequest;
...
long DeleteVpnRouteEntryRequest::getResourceOwnerId() const {
