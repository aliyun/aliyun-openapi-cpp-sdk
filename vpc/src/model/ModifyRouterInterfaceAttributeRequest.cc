...
void ModifyRouterInterfaceAttributeRequest::setHcThreshold(int hcThreshold)
{
	...
	setParameter("HcThreshold", std::to_string(hcThreshold));
}
...
void ModifyRouterInterfaceAttributeRequest::setDeleteHealthCheckIp(bool deleteHealthCheckIp)
{
	...
	setParameter("DeleteHealthCheckIp", deleteHealthCheckIp ? "true" : "false");
}
...
{
	hcRate_ = hcRate;
	setParameter("HcRate", std::to_string(hcRate));
}
