...
#ifndef ALIBABACLOUD_VPC_MODEL_CREATEEXPRESSCONNECTTRAFFICQOSRULEREQUEST_H_
#define ALIBABACLOUD_VPC_MODEL_CREATEEXPRESSCONNECTTRAFFICQOSRULEREQUEST_H_
...
namespace Vpc {
namespace Model {
class ALIBABACLOUD_VPC_EXPORT CreateExpressConnectTrafficQosRuleRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VPC_MODEL_CREATEEXPRESSCONNECTTRAFFICQOSRULEREQUEST_H_
