...
#ifndef ALIBABACLOUD_VPC_MODEL_DELETEVCOROUTEENTRYREQUEST_H_
#define ALIBABACLOUD_VPC_MODEL_DELETEVCOROUTEENTRYREQUEST_H_
...
namespace Vpc {
namespace Model {
class ALIBABACLOUD_VPC_EXPORT DeleteVcoRouteEntryRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VPC_MODEL_DELETEVCOROUTEENTRYREQUEST_H_
