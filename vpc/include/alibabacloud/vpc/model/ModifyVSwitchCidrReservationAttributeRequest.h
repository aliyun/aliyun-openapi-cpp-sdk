...
#ifndef ALIBABACLOUD_VPC_MODEL_MODIFYVSWITCHCIDRRESERVATIONATTRIBUTEREQUEST_H_
...
namespace Vpc {
namespace Model {
class ALIBABACLOUD_VPC_EXPORT ModifyVSwitchCidrReservationAttributeRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VPC_MODEL_MODIFYVSWITCHCIDRRESERVATIONATTRIBUTEREQUEST_H_
