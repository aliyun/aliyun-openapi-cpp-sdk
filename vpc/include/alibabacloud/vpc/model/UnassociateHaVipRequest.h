...
#ifndef ALIBABACLOUD_VPC_MODEL_UNASSOCIATEHAVIPREQUEST_H_
...
namespace Vpc {
namespace Model {
class ALIBABACLOUD_VPC_EXPORT UnassociateHaVipRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VPC_MODEL_UNASSOCIATEHAVIPREQUEST_H_
