...
#ifndef ALIBABACLOUD_VPC_MODEL_WITHDRAWVPCPUBLISHEDROUTEENTRIESREQUEST_H_
...
namespace Vpc {
namespace Model {
class ALIBABACLOUD_VPC_EXPORT WithdrawVpcPublishedRouteEntriesRequest : public RpcServiceRequest {
public:
	struct RouteEntries {
...
#endif // !ALIBABACLOUD_VPC_MODEL_WITHDRAWVPCPUBLISHEDROUTEENTRIESREQUEST_H_
