...
#ifndef ALIBABACLOUD_VPC_MODEL_PUBLISHVPCROUTEENTRIESREQUEST_H_
#define ALIBABACLOUD_VPC_MODEL_PUBLISHVPCROUTEENTRIESREQUEST_H_
...
namespace Vpc {
namespace Model {
class ALIBABACLOUD_VPC_EXPORT PublishVpcRouteEntriesRequest : public RpcServiceRequest {
public:
	struct RouteEntries {
...
#endif // !ALIBABACLOUD_VPC_MODEL_PUBLISHVPCROUTEENTRIESREQUEST_H_
