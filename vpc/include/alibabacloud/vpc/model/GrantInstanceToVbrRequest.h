...
#ifndef ALIBABACLOUD_VPC_MODEL_GRANTINSTANCETOVBRREQUEST_H_
#define ALIBABACLOUD_VPC_MODEL_GRANTINSTANCETOVBRREQUEST_H_
...
namespace Vpc {
namespace Model {
class ALIBABACLOUD_VPC_EXPORT GrantInstanceToVbrRequest : public RpcServiceRequest {
public:
	GrantInstanceToVbrRequest();
	~GrantInstanceToVbrRequest();
	long getVbrOwnerUid() const;
	void setVbrOwnerUid(long vbrOwnerUid);
...
#endif // !ALIBABACLOUD_VPC_MODEL_GRANTINSTANCETOVBRREQUEST_H_
