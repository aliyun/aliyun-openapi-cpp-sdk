...
#ifndef ALIBABACLOUD_VPC_MODEL_MODIFYVPNPBRROUTEENTRYPRIORITYREQUEST_H_
#define ALIBABACLOUD_VPC_MODEL_MODIFYVPNPBRROUTEENTRYPRIORITYREQUEST_H_
...
namespace Vpc {
namespace Model {
class ALIBABACLOUD_VPC_EXPORT ModifyVpnPbrRouteEntryPriorityRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VPC_MODEL_MODIFYVPNPBRROUTEENTRYPRIORITYREQUEST_H_
