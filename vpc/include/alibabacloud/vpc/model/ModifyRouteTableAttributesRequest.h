...
#ifndef ALIBABACLOUD_VPC_MODEL_MODIFYROUTETABLEATTRIBUTESREQUEST_H_
...
namespace Vpc {
namespace Model {
class ALIBABACLOUD_VPC_EXPORT ModifyRouteTableAttributesRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VPC_MODEL_MODIFYROUTETABLEATTRIBUTESREQUEST_H_
