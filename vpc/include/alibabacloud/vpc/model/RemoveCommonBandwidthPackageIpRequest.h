...
#ifndef ALIBABACLOUD_VPC_MODEL_REMOVECOMMONBANDWIDTHPACKAGEIPREQUEST_H_
...
namespace Vpc {
namespace Model {
class ALIBABACLOUD_VPC_EXPORT RemoveCommonBandwidthPackageIpRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VPC_MODEL_REMOVECOMMONBANDWIDTHPACKAGEIPREQUEST_H_
