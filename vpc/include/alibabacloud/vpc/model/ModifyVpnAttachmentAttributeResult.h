...
#ifndef ALIBABACLOUD_VPC_MODEL_MODIFYVPNATTACHMENTATTRIBUTERESULT_H_
#define ALIBABACLOUD_VPC_MODEL_MODIFYVPNATTACHMENTATTRIBUTERESULT_H_
...
namespace AlibabaCloud
{
	namespace Vpc
	{
		namespace Model
		{
			class ALIBABACLOUD_VPC_EXPORT ModifyVpnAttachmentAttributeResult : public ServiceResult
			{
			public:
				struct IkeConfig
				{
				...
				ModifyVpnAttachmentAttributeResult();
				explicit ModifyVpnAttachmentAttributeResult(const std::string &payload);
				~ModifyVpnAttachmentAttributeResult();
...
#endif // !ALIBABACLOUD_VPC_MODEL_MODIFYVPNATTACHMENTATTRIBUTERESULT_H_