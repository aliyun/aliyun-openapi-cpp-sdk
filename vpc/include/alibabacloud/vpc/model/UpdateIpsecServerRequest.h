...
#ifndef ALIBABACLOUD_VPC_MODEL_UPDATEIPSECSERVERREQUEST_H_
#define ALIBABACLOUD_VPC_MODEL_UPDATEIPSECSERVERREQUEST_H_
...
namespace Vpc {
namespace Model {
class ALIBABACLOUD_VPC_EXPORT UpdateIpsecServerRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VPC_MODEL_UPDATEIPSECSERVERREQUEST_H_
