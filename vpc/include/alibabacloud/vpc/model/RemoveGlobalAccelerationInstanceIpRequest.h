...
#ifndef ALIBABACLOUD_VPC_MODEL_REMOVEGLOBALACCELERATIONINSTANCEIPREQUEST_H_
#define ALIBABACLOUD_VPC_MODEL_REMOVEGLOBALACCELERATIONINSTANCEIPREQUEST_H_
...
namespace Vpc {
namespace Model {
class ALIBABACLOUD_VPC_EXPORT RemoveGlobalAccelerationInstanceIpRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VPC_MODEL_REMOVEGLOBALACCELERATIONINSTANCEIPREQUEST_H_
