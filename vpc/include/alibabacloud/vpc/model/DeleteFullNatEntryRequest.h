...
#ifndef ALIBABACLOUD_VPC_MODEL_DELETEFULLNATENTRYREQUEST_H_
#define ALIBABACLOUD_VPC_MODEL_DELETEFULLNATENTRYREQUEST_H_
...
namespace Vpc {
namespace Model {
class ALIBABACLOUD_VPC_EXPORT DeleteFullNatEntryRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VPC_MODEL_DELETEFULLNATENTRYREQUEST_H_
