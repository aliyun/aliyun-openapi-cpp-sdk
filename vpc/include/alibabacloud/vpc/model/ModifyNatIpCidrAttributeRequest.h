...
#ifndef ALIBABACLOUD_VPC_MODEL_MODIFYNATIPCIDRATTRIBUTEREQUEST_H_
#define ALIBABACLOUD_VPC_MODEL_MODIFYNATIPCIDRATTRIBUTEREQUEST_H_
...
namespace Vpc {
namespace Model {
class ALIBABACLOUD_VPC_EXPORT ModifyNatIpCidrAttributeRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VPC_MODEL_MODIFYNATIPCIDRATTRIBUTEREQUEST_H_
