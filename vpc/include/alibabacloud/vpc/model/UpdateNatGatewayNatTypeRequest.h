...
#define ALIBABACLOUD_VPC_MODEL_UPDATENATGATEWAYNATTYPEREQUEST_H_
...
namespace Vpc {
namespace Model {
class ALIBABACLOUD_VPC_EXPORT UpdateNatGatewayNatTypeRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_VPC_MODEL_UPDATENATGATEWAYNATTYPEREQUEST_H_
