...
#ifndef ALIBABACLOUD_VPC_MODEL_DESCRIBEFORWARDTABLEENTRIESRESULT_H_
#define ALIBABACLOUD_VPC_MODEL_DESCRIBEFORWARDTABLEENTRIESRESULT_H_
	...
	namespace Vpc
	{
		namespace Model
		{
			...
			public:
				...
				void setForwardTableEntries(const std::vector<ForwardTableEntry>& forwardTableEntries);
...
#endif // !ALIBABACLOUD_VPC_MODEL_DESCRIBEFORWARDTABLEENTRIESRESULT_H_