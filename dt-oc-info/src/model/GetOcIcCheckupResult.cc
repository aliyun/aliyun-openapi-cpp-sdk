...
GetOcIcCheckupResult::GetOcIcCheckupResult() :
	ServiceResult()
{}

GetOcIcCheckupResult::GetOcIcCheckupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetOcIcCheckupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
int GetOcIcCheckupResult::getTotalNum()const
{
	return totalNum_;
}

std::string GetOcIcCheckupResult::getMessage()const
{
	return message_;
}

int GetOcIcCheckupResult::getPageNum()const
{
	return pageNum_;
}

std::vector<GetOcIcCheckupResult::DataItem> GetOcIcCheckupResult::getData()const
{
	return data_;
}

int GetOcIcCheckupResult::getPageIndex()const
{
	return pageIndex_;
}

std::string GetOcIcCheckupResult::getCode()const
{
	return code_;
}

bool GetOcIcCheckupResult::getSuccess()const
{
	return success_;
}
