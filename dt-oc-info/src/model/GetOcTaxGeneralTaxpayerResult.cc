...
GetOcTaxGeneralTaxpayerResult::GetOcTaxGeneralTaxpayerResult() :
	ServiceResult()
{}

GetOcTaxGeneralTaxpayerResult::GetOcTaxGeneralTaxpayerResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetOcTaxGeneralTaxpayerResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	for (auto valueDataDataItem : allDataNode)
	{
		...
		if(!valueDataDataItem["Qualification"].isNull())
			dataObject.qualification = valueDataDataItem["Qualification"].asString();
...
int GetOcTaxGeneralTaxpayerResult::getTotalNum()const
{
	return totalNum_;
}

std::string GetOcTaxGeneralTaxpayerResult::getMessage()const
{
	return message_;
}

int GetOcTaxGeneralTaxpayerResult::getPageNum()const
{
	return pageNum_;
}

std::vector<GetOcTaxGeneralTaxpayerResult::DataItem> GetOcTaxGeneralTaxpayerResult::getData()const
{
	return data_;
}

int GetOcTaxGeneralTaxpayerResult::getPageIndex()const
{
	return pageIndex_;
}

std::string GetOcTaxGeneralTaxpayerResult::getCode()const
{
	return code_;
}

bool GetOcTaxGeneralTaxpayerResult::getSuccess()const
{
	return success_;
}
