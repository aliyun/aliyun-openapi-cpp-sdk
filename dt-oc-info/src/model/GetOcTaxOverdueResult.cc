...
GetOcTaxOverdueResult::GetOcTaxOverdueResult() :
	ServiceResult()
{}

GetOcTaxOverdueResult::GetOcTaxOverdueResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetOcTaxOverdueResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	for (auto valueDataDataItem : allDataNode)
	{
		...
		if(!valueDataDataItem["TaxpayerType"].isNull())
			dataObject.taxpayerType = valueDataDataItem["TaxpayerType"].asString();
		...
		if(!valueDataDataItem["CurrOverdueAmount"].isNull())
			dataObject.currOverdueAmount = valueDataDataItem["CurrOverdueAmount"].asString();
...
int GetOcTaxOverdueResult::getTotalNum()const
{
	return totalNum_;
}

std::string GetOcTaxOverdueResult::getMessage()const
{
	return message_;
}

int GetOcTaxOverdueResult::getPageNum()const
{
	return pageNum_;
}

std::vector<GetOcTaxOverdueResult::DataItem> GetOcTaxOverdueResult::getData()const
{
	return data_;
}

int GetOcTaxOverdueResult::getPageIndex()const
{
	return pageIndex_;
}

std::string GetOcTaxOverdueResult::getCode()const
{
	return code_;
}

bool GetOcTaxOverdueResult::getSuccess()const
{
	return success_;
}
