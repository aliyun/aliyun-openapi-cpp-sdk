...
GetOcJusticeExecutedResult::GetOcJusticeExecutedResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetOcJusticeExecutedResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
int GetOcJusticeExecutedResult::getTotalNum()const
{
	return totalNum_;
}

std::string GetOcJusticeExecutedResult::getMessage()const
{
	return message_;
}

int GetOcJusticeExecutedResult::getPageNum()const
{
	return pageNum_;
}

std::vector<GetOcJusticeExecutedResult::DataItem> GetOcJusticeExecutedResult::getData()const
{
	return data_;
}

int GetOcJusticeExecutedResult::getPageIndex()const
{
	return pageIndex_;
}

std::string GetOcJusticeExecutedResult::getCode()const
{
	return code_;
}

bool GetOcJusticeExecutedResult::getSuccess()const
{
	return success_;
}
