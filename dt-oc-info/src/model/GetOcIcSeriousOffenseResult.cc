...
GetOcIcSeriousOffenseResult::GetOcIcSeriousOffenseResult() :
	ServiceResult()
{}

GetOcIcSeriousOffenseResult::GetOcIcSeriousOffenseResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetOcIcSeriousOffenseResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
int GetOcIcSeriousOffenseResult::getTotalNum()const
{
	return totalNum_;
}

std::string GetOcIcSeriousOffenseResult::getMessage()const
{
	return message_;
}

int GetOcIcSeriousOffenseResult::getPageNum()const
{
	return pageNum_;
}

std::vector<GetOcIcSeriousOffenseResult::DataItem> GetOcIcSeriousOffenseResult::getData()const
{
	return data_;
}

int GetOcIcSeriousOffenseResult::getPageIndex()const
{
	return pageIndex_;
}

std::string GetOcIcSeriousOffenseResult::getCode()const
{
	return code_;
}

bool GetOcIcSeriousOffenseResult::getSuccess()const
{
	return success_;
}
