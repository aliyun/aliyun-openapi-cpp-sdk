...
GetOcJusticeCourtAnnouncementResult::GetOcJusticeCourtAnnouncementResult() :
	ServiceResult()
{}

GetOcJusticeCourtAnnouncementResult::GetOcJusticeCourtAnnouncementResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetOcJusticeCourtAnnouncementResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	for (auto valueDataDataItem : allDataNode)
	{
		...
		if(!valueDataDataItem["Tribunal"].isNull())
			dataObject.tribunal = valueDataDataItem["Tribunal"].asString();
...
int GetOcJusticeCourtAnnouncementResult::getTotalNum()const
{
	return totalNum_;
}

std::string GetOcJusticeCourtAnnouncementResult::getMessage()const
{
	return message_;
}

int GetOcJusticeCourtAnnouncementResult::getPageNum()const
{
	return pageNum_;
}

std::vector<GetOcJusticeCourtAnnouncementResult::DataItem> GetOcJusticeCourtAnnouncementResult::getData()const
{
	return data_;
}

int GetOcJusticeCourtAnnouncementResult::getPageIndex()const
{
	return pageIndex_;
}

std::string GetOcJusticeCourtAnnouncementResult::getCode()const
{
	return code_;
}

bool GetOcJusticeCourtAnnouncementResult::getSuccess()const
{
	return success_;
}
