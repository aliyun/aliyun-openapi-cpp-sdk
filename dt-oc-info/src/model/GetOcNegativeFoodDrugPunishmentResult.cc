...
GetOcNegativeFoodDrugPunishmentResult::GetOcNegativeFoodDrugPunishmentResult() :
	ServiceResult()
{}

GetOcNegativeFoodDrugPunishmentResult::GetOcNegativeFoodDrugPunishmentResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetOcNegativeFoodDrugPunishmentResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
int GetOcNegativeFoodDrugPunishmentResult::getTotalNum()const
{
	return totalNum_;
}

std::string GetOcNegativeFoodDrugPunishmentResult::getMessage()const
{
	return message_;
}

int GetOcNegativeFoodDrugPunishmentResult::getPageNum()const
{
	return pageNum_;
}

std::vector<GetOcNegativeFoodDrugPunishmentResult::DataItem> GetOcNegativeFoodDrugPunishmentResult::getData()const
{
	return data_;
}

int GetOcNegativeFoodDrugPunishmentResult::getPageIndex()const
{
	return pageIndex_;
}

std::string GetOcNegativeFoodDrugPunishmentResult::getCode()const
{
	return code_;
}

bool GetOcNegativeFoodDrugPunishmentResult::getSuccess()const
{
	return success_;
}
