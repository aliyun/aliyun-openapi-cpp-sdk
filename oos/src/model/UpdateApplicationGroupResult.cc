...
UpdateApplicationGroupResult::UpdateApplicationGroupResult() :
	ServiceResult()
{}

UpdateApplicationGroupResult::UpdateApplicationGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateApplicationGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	if(!applicationGroupNode["UpdatedDate"].isNull())
		applicationGroup_.updatedDate = applicationGroupNode["UpdatedDate"].asString();
	...
	if(!applicationGroupNode["CreatedDate"].isNull())
		applicationGroup_.createdDate = applicationGroupNode["CreatedDate"].asString();
...
UpdateApplicationGroupResult::ApplicationGroup UpdateApplicationGroupResult::getApplicationGroup()const
{
