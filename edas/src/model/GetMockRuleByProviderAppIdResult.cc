...
GetMockRuleByProviderAppIdResult::GetMockRuleByProviderAppIdResult() :
	ServiceResult()
{}

GetMockRuleByProviderAppIdResult::GetMockRuleByProviderAppIdResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetMockRuleByProviderAppIdResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetMockRuleByProviderAppIdResult::getHttpCode()const
{
	return httpCode_;
}

std::string GetMockRuleByProviderAppIdResult::getMessage()const
{
	return message_;
}

std::vector<GetMockRuleByProviderAppIdResult::RuleItemList> GetMockRuleByProviderAppIdResult::getData()const
{
	return data_;
}

std::string GetMockRuleByProviderAppIdResult::getCode()const
{
	return code_;
}

bool GetMockRuleByProviderAppIdResult::getSuccess()const
{
	return success_;
}
