...
EnableMockRuleResult::EnableMockRuleResult() :
	ServiceResult()
{}

EnableMockRuleResult::EnableMockRuleResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void EnableMockRuleResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string EnableMockRuleResult::getMessage()const
{
	return message_;
}

EnableMockRuleResult::Data EnableMockRuleResult::getData()const
{
	return data_;
}

int EnableMockRuleResult::getCode()const
{
	return code_;
}

bool EnableMockRuleResult::getSuccess()const
{
	return success_;
}
