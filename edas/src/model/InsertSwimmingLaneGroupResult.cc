...
InsertSwimmingLaneGroupResult::InsertSwimmingLaneGroupResult() :
	ServiceResult()
{}

InsertSwimmingLaneGroupResult::InsertSwimmingLaneGroupResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void InsertSwimmingLaneGroupResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string InsertSwimmingLaneGroupResult::getMessage()const
{
	return message_;
}

InsertSwimmingLaneGroupResult::Data InsertSwimmingLaneGroupResult::getData()const
{
	return data_;
}

int InsertSwimmingLaneGroupResult::getCode()const
{
	return code_;
}
