...
DisableApplicationScalingRuleResult::DisableApplicationScalingRuleResult() :
	ServiceResult()
{}

DisableApplicationScalingRuleResult::DisableApplicationScalingRuleResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DisableApplicationScalingRuleResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
DisableApplicationScalingRuleResult::AppScalingRule DisableApplicationScalingRuleResult::getAppScalingRule()const
{
	return appScalingRule_;
}

int DisableApplicationScalingRuleResult::getCode()const
{
	return code_;
}
