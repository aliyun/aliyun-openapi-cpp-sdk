...
GetJvmConfigurationResult::GetJvmConfigurationResult() :
	ServiceResult()
{}

GetJvmConfigurationResult::GetJvmConfigurationResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetJvmConfigurationResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetJvmConfigurationResult::getMessage()const
{
	return message_;
}

GetJvmConfigurationResult::JvmConfiguration GetJvmConfigurationResult::getJvmConfiguration()const
{
	return jvmConfiguration_;
}

int GetJvmConfigurationResult::getCode()const
{
	return code_;
}
