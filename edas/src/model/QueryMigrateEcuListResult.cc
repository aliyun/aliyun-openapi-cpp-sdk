...
QueryMigrateEcuListResult::QueryMigrateEcuListResult() :
	ServiceResult()
{}

QueryMigrateEcuListResult::QueryMigrateEcuListResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void QueryMigrateEcuListResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string QueryMigrateEcuListResult::getMessage()const
{
	return message_;
}

std::vector<QueryMigrateEcuListResult::EcuEntity> QueryMigrateEcuListResult::getEcuEntityList()const
{
	return ecuEntityList_;
}

int QueryMigrateEcuListResult::getCode()const
{
	return code_;
}
