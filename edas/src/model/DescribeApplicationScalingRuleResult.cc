...
DescribeApplicationScalingRuleResult::AppScalingRule DescribeApplicationScalingRuleResult::getAppScalingRule()const
{
	return appScalingRule_;
}

int DescribeApplicationScalingRuleResult::getCode()const
{
	return code_;
}
