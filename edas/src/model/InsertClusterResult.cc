...
InsertClusterResult::InsertClusterResult() :
	ServiceResult()
{}

InsertClusterResult::InsertClusterResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void InsertClusterResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string InsertClusterResult::getMessage()const
{
	return message_;
}

InsertClusterResult::Cluster InsertClusterResult::getCluster()const
{
	return cluster_;
}

int InsertClusterResult::getCode()const
{
	return code_;
}
