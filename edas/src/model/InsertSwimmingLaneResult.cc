...
InsertSwimmingLaneResult::InsertSwimmingLaneResult() :
	ServiceResult()
{}

InsertSwimmingLaneResult::InsertSwimmingLaneResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void InsertSwimmingLaneResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	if(!dataNode["AppInfos"].isNull())
		data_.appInfos = dataNode["AppInfos"].asString();
...
std::string InsertSwimmingLaneResult::getMessage()const
{
	return message_;
}

InsertSwimmingLaneResult::Data InsertSwimmingLaneResult::getData()const
{
	return data_;
}

int InsertSwimmingLaneResult::getCode()const
{
	return code_;
}
