...
UpdateSwimmingLanePriorityResult::UpdateSwimmingLanePriorityResult() :
	ServiceResult()
{}

UpdateSwimmingLanePriorityResult::UpdateSwimmingLanePriorityResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void UpdateSwimmingLanePriorityResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string UpdateSwimmingLanePriorityResult::getMessage()const
{
	return message_;
}

UpdateSwimmingLanePriorityResult::Data UpdateSwimmingLanePriorityResult::getData()const
{
	return data_;
}

int UpdateSwimmingLanePriorityResult::getCode()const
{
	return code_;
}
