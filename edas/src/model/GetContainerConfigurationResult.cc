...
GetContainerConfigurationResult::GetContainerConfigurationResult() :
	ServiceResult()
{}

GetContainerConfigurationResult::GetContainerConfigurationResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void GetContainerConfigurationResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::string GetContainerConfigurationResult::getMessage()const
{
	return message_;
}

GetContainerConfigurationResult::ContainerConfiguration GetContainerConfigurationResult::getContainerConfiguration()const
{
	return containerConfiguration_;
}

int GetContainerConfigurationResult::getCode()const
{
	return code_;
}
