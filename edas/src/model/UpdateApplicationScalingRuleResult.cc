...
UpdateApplicationScalingRuleResult::AppScalingRule UpdateApplicationScalingRuleResult::getAppScalingRule()const
{
	return appScalingRule_;
}

int UpdateApplicationScalingRuleResult::getCode()const
{
	return code_;
}
