...
#ifndef ALIBABACLOUD_EDAS_MODEL_UPDATEAPPLICATIONSCALINGRULERESULT_H_
#define ALIBABACLOUD_EDAS_MODEL_UPDATEAPPLICATIONSCALINGRULERESULT_H_
...
namespace AlibabaCloud
{
	namespace Edas
	{
		namespace Model
		{
			class ALIBABACLOUD_EDAS_EXPORT UpdateApplicationScalingRuleResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_EDAS_MODEL_UPDATEAPPLICATIONSCALINGRULERESULT_H_