...
#ifndef ALIBABACLOUD_EDAS_MODEL_UNTAGRESOURCESREQUEST_H_
#define ALIBABACLOUD_EDAS_MODEL_UNTAGRESOURCESREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Edas
	{
		namespace Model
		{
			class ALIBABACLOUD_EDAS_EXPORT UntagResourcesRequest : public RoaServiceRequest
			{
...
#endif // !ALIBABACLOUD_EDAS_MODEL_UNTAGRESOURCESREQUEST_H_