...
#ifndef ALIBABACLOUD_EDAS_MODEL_UPDATEAPPLICATIONSCALINGRULEREQUEST_H_
#define ALIBABACLOUD_EDAS_MODEL_UPDATEAPPLICATIONSCALINGRULEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Edas
	{
		namespace Model
		{
			class ALIBABACLOUD_EDAS_EXPORT UpdateApplicationScalingRuleRequest : public RoaServiceRequest
			{
...
#endif // !ALIBABACLOUD_EDAS_MODEL_UPDATEAPPLICATIONSCALINGRULEREQUEST_H_