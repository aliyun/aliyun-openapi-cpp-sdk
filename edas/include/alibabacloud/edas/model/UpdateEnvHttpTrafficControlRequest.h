...
#ifndef ALIBABACLOUD_EDAS_MODEL_UPDATEENVHTTPTRAFFICCONTROLREQUEST_H_
#define ALIBABACLOUD_EDAS_MODEL_UPDATEENVHTTPTRAFFICCONTROLREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Edas
	{
		namespace Model
		{
			class ALIBABACLOUD_EDAS_EXPORT UpdateEnvHttpTrafficControlRequest : public RoaServiceRequest
			{

			public:
				UpdateEnvHttpTrafficControlRequest();
				~UpdateEnvHttpTrafficControlRequest();
...
#endif // !ALIBABACLOUD_EDAS_MODEL_UPDATEENVHTTPTRAFFICCONTROLREQUEST_H_