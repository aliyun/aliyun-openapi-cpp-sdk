...
#ifndef ALIBABACLOUD_EDAS_MODEL_DESCRIBEAPPLICATIONSCALINGRULERESULT_H_
#define ALIBABACLOUD_EDAS_MODEL_DESCRIBEAPPLICATIONSCALINGRULERESULT_H_
...
namespace AlibabaCloud
{
	namespace Edas
	{
		namespace Model
		{
			class ALIBABACLOUD_EDAS_EXPORT DescribeApplicationScalingRuleResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_EDAS_MODEL_DESCRIBEAPPLICATIONSCALINGRULERESULT_H_