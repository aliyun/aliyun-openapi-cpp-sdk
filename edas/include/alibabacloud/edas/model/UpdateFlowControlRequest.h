...
#ifndef ALIBABACLOUD_EDAS_MODEL_UPDATEFLOWCONTROLREQUEST_H_
#define ALIBABACLOUD_EDAS_MODEL_UPDATEFLOWCONTROLREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Edas
	{
		namespace Model
		{
			class ALIBABACLOUD_EDAS_EXPORT UpdateFlowControlRequest : public RoaServiceRequest
			{
...
#endif // !ALIBABACLOUD_EDAS_MODEL_UPDATEFLOWCONTROLREQUEST_H_