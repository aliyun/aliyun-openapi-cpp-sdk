...
#ifndef ALIBABACLOUD_EDAS_MODEL_ENABLEAPPLICATIONSCALINGRULERESULT_H_
#define ALIBABACLOUD_EDAS_MODEL_ENABLEAPPLICATIONSCALINGRULERESULT_H_
...
namespace AlibabaCloud
{
	namespace Edas
	{
		namespace Model
		{
			class ALIBABACLOUD_EDAS_EXPORT EnableApplicationScalingRuleResult : public ServiceResult
			{
			public:
...
#endif // !ALIBABACLOUD_EDAS_MODEL_ENABLEAPPLICATIONSCALINGRULERESULT_H_