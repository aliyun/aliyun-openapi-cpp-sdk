...
#ifndef ALIBABACLOUD_ALIDNS_MODEL_SETGTMACCESSMODEREQUEST_H_
...
namespace Alidns {
namespace Model {
class ALIBABACLOUD_ALIDNS_EXPORT SetGtmAccessModeRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_ALIDNS_MODEL_SETGTMACCESSMODEREQUEST_H_
