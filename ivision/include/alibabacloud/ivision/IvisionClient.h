...
#include "model/CreatePredictModelRequest.h"
#include "model/CreatePredictModelResult.h"
#include "model/CreatePredictTemplateRequest.h"
#include "model/CreatePredictTemplateResult.h"
#include "model/CreateProjectRequest.h"
#include "model/CreateProjectResult.h"
#include "model/CreateQuickDeployRequest.h"
#include "model/CreateQuickDeployResult.h"
...
#include "model/DeletePredictModelRequest.h"
#include "model/DeletePredictModelResult.h"
#include "model/DeletePredictTemplateRequest.h"
#include "model/DeletePredictTemplateResult.h"
...
#include "model/DescribePredictModelsRequest.h"
#include "model/DescribePredictModelsResult.h"
#include "model/DescribePredictTemplatesRequest.h"
#include "model/DescribePredictTemplatesResult.h"
#include "model/DescribeProjectsRequest.h"
#include "model/DescribeProjectsResult.h"
#include "model/DescribeQuickDeploysRequest.h"
#include "model/DescribeQuickDeploysResult.h"
...
#include "model/DescribeSystemPredictModelsRequest.h"
#include "model/DescribeSystemPredictModelsResult.h"
...
#include "model/ModifyPredictTemplateAttributeRequest.h"
#include "model/ModifyPredictTemplateAttributeResult.h"
...
#include "model/QuickTestRequest.h"
#include "model/QuickTestResult.h"
...
namespace AlibabaCloud
{
	namespace Ivision
	{
		...
		public:
			...
			typedef Outcome<Error, Model::CreatePredictModelResult> CreatePredictModelOutcome;
			typedef std::future<CreatePredictModelOutcome> CreatePredictModelOutcomeCallable;
			typedef std::function<void(const IvisionClient*, const Model::CreatePredictModelRequest&, const CreatePredictModelOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> CreatePredictModelAsyncHandler;
			typedef Outcome<Error, Model::CreatePredictTemplateResult> CreatePredictTemplateOutcome;
			typedef std::future<CreatePredictTemplateOutcome> CreatePredictTemplateOutcomeCallable;
			typedef std::function<void(const IvisionClient*, const Model::CreatePredictTemplateRequest&, const CreatePredictTemplateOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> CreatePredictTemplateAsyncHandler;
			...
			typedef Outcome<Error, Model::CreateQuickDeployResult> CreateQuickDeployOutcome;
			typedef std::future<CreateQuickDeployOutcome> CreateQuickDeployOutcomeCallable;
			typedef std::function<void(const IvisionClient*, const Model::CreateQuickDeployRequest&, const CreateQuickDeployOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> CreateQuickDeployAsyncHandler;
			...
			typedef Outcome<Error, Model::DeletePredictModelResult> DeletePredictModelOutcome;
			typedef std::future<DeletePredictModelOutcome> DeletePredictModelOutcomeCallable;
			typedef std::function<void(const IvisionClient*, const Model::DeletePredictModelRequest&, const DeletePredictModelOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> DeletePredictModelAsyncHandler;
			typedef Outcome<Error, Model::DeletePredictTemplateResult> DeletePredictTemplateOutcome;
			typedef std::future<DeletePredictTemplateOutcome> DeletePredictTemplateOutcomeCallable;
			typedef std::function<void(const IvisionClient*, const Model::DeletePredictTemplateRequest&, const DeletePredictTemplateOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> DeletePredictTemplateAsyncHandler;
			...
			typedef Outcome<Error, Model::DescribePredictModelsResult> DescribePredictModelsOutcome;
			typedef std::future<DescribePredictModelsOutcome> DescribePredictModelsOutcomeCallable;
			typedef std::function<void(const IvisionClient*, const Model::DescribePredictModelsRequest&, const DescribePredictModelsOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> DescribePredictModelsAsyncHandler;
			typedef Outcome<Error, Model::DescribePredictTemplatesResult> DescribePredictTemplatesOutcome;
			typedef std::future<DescribePredictTemplatesOutcome> DescribePredictTemplatesOutcomeCallable;
			typedef std::function<void(const IvisionClient*, const Model::DescribePredictTemplatesRequest&, const DescribePredictTemplatesOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> DescribePredictTemplatesAsyncHandler;
			...
			typedef Outcome<Error, Model::DescribeQuickDeploysResult> DescribeQuickDeploysOutcome;
			typedef std::future<DescribeQuickDeploysOutcome> DescribeQuickDeploysOutcomeCallable;
			typedef std::function<void(const IvisionClient*, const Model::DescribeQuickDeploysRequest&, const DescribeQuickDeploysOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> DescribeQuickDeploysAsyncHandler;
			...
			typedef Outcome<Error, Model::DescribeSystemPredictModelsResult> DescribeSystemPredictModelsOutcome;
			typedef std::future<DescribeSystemPredictModelsOutcome> DescribeSystemPredictModelsOutcomeCallable;
			typedef std::function<void(const IvisionClient*, const Model::DescribeSystemPredictModelsRequest&, const DescribeSystemPredictModelsOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> DescribeSystemPredictModelsAsyncHandler;
			...
			typedef Outcome<Error, Model::ModifyPredictTemplateAttributeResult> ModifyPredictTemplateAttributeOutcome;
			typedef std::future<ModifyPredictTemplateAttributeOutcome> ModifyPredictTemplateAttributeOutcomeCallable;
			typedef std::function<void(const IvisionClient*, const Model::ModifyPredictTemplateAttributeRequest&, const ModifyPredictTemplateAttributeOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> ModifyPredictTemplateAttributeAsyncHandler;
			...
			typedef Outcome<Error, Model::QuickTestResult> QuickTestOutcome;
			typedef std::future<QuickTestOutcome> QuickTestOutcomeCallable;
			typedef std::function<void(const IvisionClient*, const Model::QuickTestRequest&, const QuickTestOutcome&, const std::shared_ptr<const AsyncCallerContext>&)> QuickTestAsyncHandler;
			...
			CreatePredictModelOutcome createPredictModel(const Model::CreatePredictModelRequest &request)const;
			void createPredictModelAsync(const Model::CreatePredictModelRequest& request, const CreatePredictModelAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			CreatePredictModelOutcomeCallable createPredictModelCallable(const Model::CreatePredictModelRequest& request) const;
			CreatePredictTemplateOutcome createPredictTemplate(const Model::CreatePredictTemplateRequest &request)const;
			void createPredictTemplateAsync(const Model::CreatePredictTemplateRequest& request, const CreatePredictTemplateAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			CreatePredictTemplateOutcomeCallable createPredictTemplateCallable(const Model::CreatePredictTemplateRequest& request) const;
			CreateProjectOutcome createProject(const Model::CreateProjectRequest &request)const;
			void createProjectAsync(const Model::CreateProjectRequest& request, const CreateProjectAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			CreateProjectOutcomeCallable createProjectCallable(const Model::CreateProjectRequest& request) const;
			CreateQuickDeployOutcome createQuickDeploy(const Model::CreateQuickDeployRequest &request)const;
			void createQuickDeployAsync(const Model::CreateQuickDeployRequest& request, const CreateQuickDeployAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			CreateQuickDeployOutcomeCallable createQuickDeployCallable(const Model::CreateQuickDeployRequest& request) const;
			...
			DeletePredictModelOutcome deletePredictModel(const Model::DeletePredictModelRequest &request)const;
			void deletePredictModelAsync(const Model::DeletePredictModelRequest& request, const DeletePredictModelAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			DeletePredictModelOutcomeCallable deletePredictModelCallable(const Model::DeletePredictModelRequest& request) const;
			DeletePredictTemplateOutcome deletePredictTemplate(const Model::DeletePredictTemplateRequest &request)const;
			void deletePredictTemplateAsync(const Model::DeletePredictTemplateRequest& request, const DeletePredictTemplateAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			DeletePredictTemplateOutcomeCallable deletePredictTemplateCallable(const Model::DeletePredictTemplateRequest& request) const;
			...
			DescribePredictModelsOutcome describePredictModels(const Model::DescribePredictModelsRequest &request)const;
			void describePredictModelsAsync(const Model::DescribePredictModelsRequest& request, const DescribePredictModelsAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			DescribePredictModelsOutcomeCallable describePredictModelsCallable(const Model::DescribePredictModelsRequest& request) const;
			DescribePredictTemplatesOutcome describePredictTemplates(const Model::DescribePredictTemplatesRequest &request)const;
			void describePredictTemplatesAsync(const Model::DescribePredictTemplatesRequest& request, const DescribePredictTemplatesAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			DescribePredictTemplatesOutcomeCallable describePredictTemplatesCallable(const Model::DescribePredictTemplatesRequest& request) const;
			...
			DescribeQuickDeploysOutcome describeQuickDeploys(const Model::DescribeQuickDeploysRequest &request)const;
			void describeQuickDeploysAsync(const Model::DescribeQuickDeploysRequest& request, const DescribeQuickDeploysAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			DescribeQuickDeploysOutcomeCallable describeQuickDeploysCallable(const Model::DescribeQuickDeploysRequest& request) const;
			...
			DescribeSystemPredictModelsOutcome describeSystemPredictModels(const Model::DescribeSystemPredictModelsRequest &request)const;
			void describeSystemPredictModelsAsync(const Model::DescribeSystemPredictModelsRequest& request, const DescribeSystemPredictModelsAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			DescribeSystemPredictModelsOutcomeCallable describeSystemPredictModelsCallable(const Model::DescribeSystemPredictModelsRequest& request) const;
			...
			ModifyPredictTemplateAttributeOutcome modifyPredictTemplateAttribute(const Model::ModifyPredictTemplateAttributeRequest &request)const;
			void modifyPredictTemplateAttributeAsync(const Model::ModifyPredictTemplateAttributeRequest& request, const ModifyPredictTemplateAttributeAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			ModifyPredictTemplateAttributeOutcomeCallable modifyPredictTemplateAttributeCallable(const Model::ModifyPredictTemplateAttributeRequest& request) const;
			...
			QuickTestOutcome quickTest(const Model::QuickTestRequest &request)const;
			void quickTestAsync(const Model::QuickTestRequest& request, const QuickTestAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context = nullptr) const;
			QuickTestOutcomeCallable quickTestCallable(const Model::QuickTestRequest& request) const;
