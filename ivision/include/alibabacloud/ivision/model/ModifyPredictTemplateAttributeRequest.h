...
#ifndef ALIBABACLOUD_IVISION_MODEL_MODIFYPREDICTTEMPLATEATTRIBUTEREQUEST_H_
...
namespace AlibabaCloud
{
	namespace Ivision
	{
		namespace Model
		{
			class ALIBABACLOUD_IVISION_EXPORT ModifyPredictTemplateAttributeRequest : public RpcServiceRequest
			{
...
#endif // !ALIBABACLOUD_IVISION_MODEL_MODIFYPREDICTTEMPLATEATTRIBUTEREQUEST_H_