...
ModifyProjectAttributeResult::ModifyProjectAttributeResult() :
	ServiceResult()
{}

ModifyProjectAttributeResult::ModifyProjectAttributeResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
ModifyProjectAttributeResult::Project ModifyProjectAttributeResult::getProject()const
{
	return project_;
}
