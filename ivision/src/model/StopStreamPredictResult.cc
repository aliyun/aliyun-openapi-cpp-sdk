...
StopStreamPredictResult::StopStreamPredictResult() :
	ServiceResult()
{}

StopStreamPredictResult::StopStreamPredictResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
std::string StopStreamPredictResult::getPredictId()const
{
	return predictId_;
}
