...
ModifyTrainDataTagAttributeResult::ModifyTrainDataTagAttributeResult() :
	ServiceResult()
{}

ModifyTrainDataTagAttributeResult::ModifyTrainDataTagAttributeResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
ModifyTrainDataTagAttributeResult::TrainData ModifyTrainDataTagAttributeResult::getTrainData()const
{
	return trainData_;
}
