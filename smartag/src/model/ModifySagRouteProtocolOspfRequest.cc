...
void ModifySagRouteProtocolOspfRequest::setAuthenticationType(const std::string& authenticationType)
{
	...
	setParameter("AuthenticationType", authenticationType);
}
...
{
	areaId_ = areaId;
	setParameter("AreaId", std::to_string(areaId));
}
...
{
	md5KeyId_ = md5KeyId;
	setParameter("Md5KeyId", std::to_string(md5KeyId));
}
...
{
	deadTime_ = deadTime;
	setParameter("DeadTime", std::to_string(deadTime));
}
...
void ModifySagRouteProtocolOspfRequest::setHelloTime(int helloTime)
{
	...
	setParameter("HelloTime", std::to_string(helloTime));
}
