...
DescribeSagPortListResult::DescribeSagPortListResult() :
	ServiceResult()
{}

DescribeSagPortListResult::DescribeSagPortListResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeSagPortListResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
...
std::vector<DescribeSagPortListResult::Port> DescribeSagPortListResult::getPorts()const
{
	return ports_;
}

std::vector<DescribeSagPortListResult::TaskState> DescribeSagPortListResult::getTaskStates()const
{
	return taskStates_;
}
