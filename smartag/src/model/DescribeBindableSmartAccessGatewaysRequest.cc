...
std::string DescribeBindableSmartAccessGatewaysRequest::getResourceGroupId() const {
  return resourceGroupId_;
}

void DescribeBindableSmartAccessGatewaysRequest::setResourceGroupId(const std::string &resourceGroupId) {
...
void DescribeBindableSmartAccessGatewaysRequest::setCrossAccount(bool crossAccount) {
  ...
  setParameter(std::string("CrossAccount"), crossAccount ? "true" : "false");
}
