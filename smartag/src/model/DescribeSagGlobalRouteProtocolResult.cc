...
DescribeSagGlobalRouteProtocolResult::DescribeSagGlobalRouteProtocolResult() :
	ServiceResult()
{}

DescribeSagGlobalRouteProtocolResult::DescribeSagGlobalRouteProtocolResult(const std::string &payload) :
	ServiceResult()
{
	parse(payload);
}
...
void DescribeSagGlobalRouteProtocolResult::parse(const std::string &payload)
{
	Json::Reader reader;
	Json::Value value;
	...
	if(!value["RouteProtocol"].isNull())
		routeProtocol_ = value["RouteProtocol"].asString();

}

std::string DescribeSagGlobalRouteProtocolResult::getRouteProtocol()const
{
	return routeProtocol_;
}

std::vector<DescribeSagGlobalRouteProtocolResult::TaskState> DescribeSagGlobalRouteProtocolResult::getTaskStates()const
{
	return taskStates_;
}
