...
#ifndef ALIBABACLOUD_SMARTAG_MODEL_MODIFYFLOWLOGATTRIBUTEREQUEST_H_
#define ALIBABACLOUD_SMARTAG_MODEL_MODIFYFLOWLOGATTRIBUTEREQUEST_H_
...
namespace Smartag {
namespace Model {
class ALIBABACLOUD_SMARTAG_EXPORT ModifyFlowLogAttributeRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SMARTAG_MODEL_MODIFYFLOWLOGATTRIBUTEREQUEST_H_
