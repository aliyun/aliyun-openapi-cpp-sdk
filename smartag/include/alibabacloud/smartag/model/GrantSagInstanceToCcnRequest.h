...
#ifndef ALIBABACLOUD_SMARTAG_MODEL_GRANTSAGINSTANCETOCCNREQUEST_H_
#define ALIBABACLOUD_SMARTAG_MODEL_GRANTSAGINSTANCETOCCNREQUEST_H_
...
namespace Smartag {
namespace Model {
class ALIBABACLOUD_SMARTAG_EXPORT GrantSagInstanceToCcnRequest : public RpcServiceRequest {
public:
	GrantSagInstanceToCcnRequest();
	~GrantSagInstanceToCcnRequest();
	long getResourceOwnerId() const;
	void setResourceOwnerId(long resourceOwnerId);
	long getCcnUid() const;
	void setCcnUid(long ccnUid);
...
#endif // !ALIBABACLOUD_SMARTAG_MODEL_GRANTSAGINSTANCETOCCNREQUEST_H_
