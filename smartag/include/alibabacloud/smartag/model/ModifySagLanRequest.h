...
#ifndef ALIBABACLOUD_SMARTAG_MODEL_MODIFYSAGLANREQUEST_H_
#define ALIBABACLOUD_SMARTAG_MODEL_MODIFYSAGLANREQUEST_H_
...
namespace Smartag {
namespace Model {
class ALIBABACLOUD_SMARTAG_EXPORT ModifySagLanRequest : public RpcServiceRequest {
public:
	ModifySagLanRequest();
	~ModifySagLanRequest();
	std::string getEndIp() const;
	void setEndIp(const std::string &endIp);
	...
	std::string getLease() const;
	void setLease(const std::string &lease);
...
#endif // !ALIBABACLOUD_SMARTAG_MODEL_MODIFYSAGLANREQUEST_H_
