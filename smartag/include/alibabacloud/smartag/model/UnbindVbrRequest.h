...
#ifndef ALIBABACLOUD_SMARTAG_MODEL_UNBINDVBRREQUEST_H_
#define ALIBABACLOUD_SMARTAG_MODEL_UNBINDVBRREQUEST_H_
...
namespace Smartag {
namespace Model {
class ALIBABACLOUD_SMARTAG_EXPORT UnbindVbrRequest : public RpcServiceRequest {
public:
	UnbindVbrRequest();
	~UnbindVbrRequest();
...
#endif // !ALIBABACLOUD_SMARTAG_MODEL_UNBINDVBRREQUEST_H_
