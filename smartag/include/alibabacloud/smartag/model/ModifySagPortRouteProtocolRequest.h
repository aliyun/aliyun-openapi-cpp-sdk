...
#ifndef ALIBABACLOUD_SMARTAG_MODEL_MODIFYSAGPORTROUTEPROTOCOLREQUEST_H_
#define ALIBABACLOUD_SMARTAG_MODEL_MODIFYSAGPORTROUTEPROTOCOLREQUEST_H_
...
namespace Smartag {
namespace Model {
class ALIBABACLOUD_SMARTAG_EXPORT ModifySagPortRouteProtocolRequest : public RpcServiceRequest {
public:
	...
	std::string getRemoteAs() const;
	void setRemoteAs(const std::string &remoteAs);
...
#endif // !ALIBABACLOUD_SMARTAG_MODEL_MODIFYSAGPORTROUTEPROTOCOLREQUEST_H_
