...
#ifndef ALIBABACLOUD_SMARTAG_MODEL_MODIFYHEALTHCHECKREQUEST_H_
#define ALIBABACLOUD_SMARTAG_MODEL_MODIFYHEALTHCHECKREQUEST_H_
...
namespace Smartag {
namespace Model {
class ALIBABACLOUD_SMARTAG_EXPORT ModifyHealthCheckRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SMARTAG_MODEL_MODIFYHEALTHCHECKREQUEST_H_
