...
#ifndef ALIBABACLOUD_SMARTAG_MODEL_MODIFYDEVICEAUTOUPGRADEPOLICYREQUEST_H_
#define ALIBABACLOUD_SMARTAG_MODEL_MODIFYDEVICEAUTOUPGRADEPOLICYREQUEST_H_
...
namespace Smartag {
namespace Model {
class ALIBABACLOUD_SMARTAG_EXPORT ModifyDeviceAutoUpgradePolicyRequest : public RpcServiceRequest {
public:
...
#endif // !ALIBABACLOUD_SMARTAG_MODEL_MODIFYDEVICEAUTOUPGRADEPOLICYREQUEST_H_
