...
public:
	...
	long getEndLoginTime() const;
	void setEndLoginTime(long endLoginTime);
	...
	long getBeginLoginTime() const;
	void setBeginLoginTime(long beginLoginTime);
